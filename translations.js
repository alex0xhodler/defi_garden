...
const translations = {
  en: {
    ...
    spendYieldCta: "Spend yield →",
    spendYieldHint: "Fund subscriptions • Keep principal intact",
    ...
    forecast14d: "14d Forecast",
    forecastFloor: (rate) => `Floor: ${rate}`,
    defiScore: "DeFi Health Score",
    defiScoreTooltip: (score, rating) => `DeFi Health Score: ${score}/100 (${rating})\n\nInstitutional rating based on 4 pillars:\n• Yield Stability (35%): AI forward volatility via TimesFM\n• Sustainability (25%): Organic fees vs reward emissions\n• Capital Stickiness (25%): Depositor retention & whale concentration\n• Exit Liquidity (15%): Total depth & withdrawal capacity`,
    yieldDecayAlert: (delta) => `Rate Decay Warning: TimesFM models a forward yield decline of ${delta} over the next 14 days.`,
    crashRiskHigh: "High Crash Risk",
    crashRiskLow: "Stable Downside",
    yieldDecomp: "Yield Mix",
...
projectionHeading: "The long game",
    ...
    landing: {
      ...
      spotlightEyebrow: "Bringing DeFi to daily life",
      spotlightTitleBefore: "Never pay for",
      spotlightTitleAccent: "subscriptions again.",
      spotlightSubhead: "Deposit once into audited and curated vaults. Realized yield perpetually settles your monthly software, AI, and cloud subscriptions while your principal stays 100% yours.",
      thesisLabel: "The Invariant:",
      thesisQuote: "\"Buy it outright and the money is gone. Garden it and you keep the money AND get the subscription.\"",
      agentStatus: "DeFi Garden Yield Agent · Live onchain data",
      searchLabel: "Search live DeFi yields",
      searchPlaceholder: "Ask anything in natural language e.g. 'Where can I earn 8%+ on USDC without lockup?' or search pools…",
      searchSubmit: "Ask Agent",
      examplesLabel: "Prompt examples",
      exampleOpenCode: "OpenCode Go",
      ...
      uwEyebrow: "Predictive Intelligence · TimesFM 3.0",
      uwTitleBefore: "DeFi yields,",
      uwTitleAccent: "predictively underwritten.",
      uwSubhead: "Institutional-grade health ratings (0–100 AAA) and TimesFM 3.0 forward volatility forecasting. Discover vetted pools with organic cash flows, deep exit liquidity, and zero surprise cliff decay.",
      uwCta: "Explore Underwritten Yields",
      uwCtaHint: "Curated filter: Popular Chains • TVL ≥ $10M • APY ≥ 5%",
      seoEyebrow: "Live On-Chain Rates",
      pageIndicator: "Landing pages",
      pageIndicatorUnderwriting: "Underwritten Yields",
      pageIndicatorHero: "Underwritten Yields",
      pageIndicatorRates: "Live yield rates",
      pageIndicatorCard: "Virtual Card",
      seoH1: "DeFi Savings & Yield Discovery",
      ...
      seoCalcP: "The Garden Planner compounds monthly deposits at live stablecoin pool rates — illustrative example: at a fixed hypothetical 5% APY, $500/month for 3 years totals $18,000 deposited and about $19,457 in value. Not a live rate; open the planner for today's numbers.",
    ...
    planner: {
      ...
      // Financial Control & Explainer
      tunerTitle: "Fine-tune your plan",
      tunerMonthlyBill: "Monthly Bill ($/mo)",
      tunerCapitalDeposit: "Capital to put to work",
      tunerYieldGenerated: (yieldAmt) => `Yield generated: ${yieldAmt}/mo`,
      tunerCoveredFull: (yieldAmt, billAmt) => `100% Covered! Generates ${yieldAmt}/mo for ${billAmt}/mo bill • Zero principal loss`,
      tunerCoveredPartial: (yieldAmt, billAmt, pct) => `Covers ${yieldAmt}/mo of ${billAmt}/mo (${pct}% covered)`,
      tunerAutoCoverCta: (capAmt) => `✨ Auto-fit 100% (${capAmt})`,
      cardExplainerTitle: "How the Virtual Visa Card Works",
      cardExplainerStep1Title: "Deposit into Curated Base Vaults",
      cardExplainerStep1Desc: "100% Non-custodial (ΔP ≡ 0). Full withdrawal rights at every block.",
      cardExplainerStep2Title: "Keepers Harvest Monthly Yield",
      cardExplainerStep2Desc: "Decentralized keepers automatically sweep realized yield prior to merchant billing.",
      cardExplainerStep3Title: "Virtual Visa Card Settles Merchant",
      cardExplainerStep3Desc: "Your dedicated card pays the subscription invoice directly from harvested yield.",
      cardFaqQuestion: "Do I need a separate card for each subscription?",
      cardFaqAnswer: "You can use a single primary card for multiple bills, or issue dedicated merchant-locked virtual cards with strict spend caps.",
    ...
    yieldCardTwitterShare: "Share on X to Unlock Alpha ⚡",
    yieldCardAlphaUnlock: "+1 Invite = Instant Alpha Access",
    yieldCardInviteProgress: "0 / 1 Invited",
    yieldCardJoinTelegramAlpha: "Claim Alpha in Private Telegram →",
    yieldCardCheckStatus: "Check Invite Status / Claim Alpha",
    ...
    'yieldCard.twitterShare': "Share on X to Unlock Alpha ⚡",
    'yieldCard.alphaUnlock': "+1 Invite = Instant Alpha Access",
    'yieldCard.inviteProgress': "0 / 1 Invited",
    'yieldCard.joinTelegramAlpha': "Claim Alpha in Private Telegram →",
    'yieldCard.checkStatus': "Check Invite Status / Claim Alpha",
    ...
    // HYPE Funding Harvest Module
    'hypeHarvest.title': "HYPE Funding Harvest",
    'hypeHarvest.subtitle': "Delta-Neutral Cash & Carry on Hyperliquid",
    'hypeHarvest.instantApr': "Instant Funding APR",
    'hypeHarvest.projectedApr': "30d Projected APR (33% Decay Haircut)",
    'hypeHarvest.hourlyFunding': "Hourly Funding Rate",
    'hypeHarvest.basisSpread': "Mark / Oracle Basis Spread",
    'hypeHarvest.openInterest': "Total Open Interest",
    'hypeHarvest.dayVolume': "24h Volume",
    'hypeHarvest.crowdedLong': "🔥 Crowded Long Euphoria (High Carry)",
    'hypeHarvest.normalState': "⚖️ Balanced Market State",
    'hypeHarvest.shortSkew': "❄️ Short Skewed",
    'hypeHarvest.calculatorTitle': "Simulate Your Harvest Yield",
    'hypeHarvest.capitalLabel': "Total Capital (USD)",
    'hypeHarvest.spotLeg': "Spot HYPE Leg (50%)",
    'hypeHarvest.shortLeg': "Hyperliquid 1x Short Perp (50%)",
    'hypeHarvest.dailyYield': "Daily Funding Yield",
    'hypeHarvest.monthlyYield': "Monthly Funding Yield",
    'hypeHarvest.projectedMonthly': "Projected Monthly (30d Decay)",
    'hypeHarvest.annualYield': "Annual Harvest Yield",
    'hypeHarvest.executionTitle': "How the Harvest Works",
    'hypeHarvest.step1': "1. Buy & Hold Spot HYPE (or Liquid Staked HYPE)",
    'hypeHarvest.step2': "2. Open an equal 1x Short HYPE Perp on Hyperliquid",
    'hypeHarvest.step3': "3. Delta is 0 (Market Neutral). Collect hourly funding directly into your margin balance.",
    'hypeHarvest.riskNote': "Trust Rails: Perp funding is variable. When funding turns negative, the strategy unwinds. Projected returns apply DeFi Garden's 1/3 decay haircut.",
    'hypeHarvest.divergenceWarning': "⚠ Dual-oracle divergence tripwire active (>15 bps spread). High basis volatility.",
  },
  ...
  ko: {
    ...
    spendYieldCta: "수익 사용하기 →",
    spendYieldHint: "구독 결제 지원 • 원금 100% 보존",
    ...
    forecast14d: "14일 예측",
    forecastFloor: (rate) => `최저: ${rate}`,
    defiScore: "디파이 건전성 점수",
    defiScoreTooltip: (score, rating) => `디파이 건전성 점수: ${score}/100 (${rating})\n\n4가지 핵심 지표 기반 평가:\n• 수익 안정성 (35%): TimesFM AI 모델 기반 변동성 예측\n• 지속 가능성 (25%): 일시적 보상 토큰 대비 순수 거래/대출 수수료 비중\n• 자본 결속력 (25%): 예치자 잔존율 및 고래 지갑 집중도\n• 인출 유동성 (15%): 풀 규모 및 인출 여력`,
    yieldDecayAlert: (delta) => `수익률 하락 경고: TimesFM 모델에 따르면 향후 14일 동안 ${delta}의 수익률 하락이 예상됩니다.`,
    crashRiskHigh: "급락 위험 높음",
    crashRiskLow: "안정적 하방",
    yieldDecomp: "수익 구성",
    organicLabel: "유기적 수수료",
    rewardLabel: "보상 토큰",
    sortByScore: "점수",
    exposure: "익스포저",
    ilRisk: "비영구적 손실 위험",
    ...
    landing: {
      ...
      spotlightEyebrow: "일상으로 들어온 DeFi",
      spotlightTitleBefore: "구독료,",
      spotlightTitleAccent: "이제 내지 마세요.",
      spotlightSubhead: "검증되고 엄선된 볼트에 한 번만 예치하세요. 원금은 100% 안전하게 유지하면서, 매달 발생하는 실현 수익으로 소프트웨어, AI, 클라우드 구독료를 영구 정산합니다.",
      thesisLabel: "핵심 불변성:",
      thesisQuote: "\"직접 구매하면 돈이 사라지지만, 가드닝하면 원금을 지키면서 서비스를 받습니다.\"",
      metricCovered: "매달 지원:",
      metricSettlement: "정산 레일:",
      metricSettlementVal: "큐레이팅된 Base 볼트",
      metricSecurity: "원금 보호:",
      metricSecurityVal: "100% 비수탁형 (ΔP ≡ 0)",
      reserveCta: (name) => `${name} 카드 예약하기`,
      reserveHint: "지갑 연결 및 KYC 불필요 · 무료 예약",
      pagerPage1: "01 구독 볼트",
      agentStatus: "DeFi Garden 수익률 에이전트 · 실시간 온체인 데이터",
      searchLabel: "실시간 DeFi 수익률 검색",
      searchPlaceholder: "자연어로 질문해보세요. 예: '락업 없이 USDC로 8%+ 얻을 수 있는 풀은?' 또는 풀 검색…",
      searchSubmit: "에이전트에 질문",
      examplesLabel: "프롬프트 예시",
      exampleOpenCode: "OpenCode Go",
      ...
      uwEyebrow: "예측 인텔리전스 · TimesFM 3.0",
      uwTitleBefore: "디파이 수익률,",
      uwTitleAccent: "과학적으로 검증하다.",
      uwSubhead: "TimesFM 3.0 인공지능 변동성 예측 모델 및 기관급 디파이 건전성 평가(0~100 AAA). 일시적 보상 소진과 급락 위험을 사전에 걸러낸 신뢰할 수 있는 풀을 탐색하세요.",
      uwCta: "검증된 수익률 탐색하기",
      uwCtaHint: "엄선 기준: 인기 체인 • 최소 TVL $10M • APY ≥ 5%",
      seoEyebrow: "실시간 온체인 금리",
      pageIndicator: "랜딩 페이지",
      pageIndicatorUnderwriting: "건전성 평가",
      pageIndicatorHero: "건전성 평가",
      pageIndicatorRates: "실시간 수익률",
      pageIndicatorCard: "가상 카드",
      seoH1: "DeFi 저축 & 수익률 탐색",
    ...
    planner: {
      ...
      // Financial Control & Explainer
      tunerTitle: "플랜 상세 설정",
      tunerMonthlyBill: "월 청구 금액 ($/월)",
      tunerCapitalDeposit: "운용할 예치 원금",
      tunerYieldGenerated: (yieldAmt) => `발생 월 이자: ${yieldAmt}/월`,
      tunerCoveredFull: (yieldAmt, billAmt) => `100% 완납 충족! 월 ${yieldAmt} 이자로 ${billAmt}/월 구독료 자동 결제 • 원금 100% 보존`,
      tunerCoveredPartial: (yieldAmt, billAmt, pct) => `월 ${billAmt} 중 ${yieldAmt}/월 충당 (${pct}% 충족)`,
      tunerAutoCoverCta: (capAmt) => `✨ 100% 자동 맞춤 (${capAmt})`,
      cardExplainerTitle: "가상 Visa 카드 결제 방식",
      cardExplainerStep1Title: "Base 검증 대출 볼트에 예치",
      cardExplainerStep1Desc: "100% 비수탁형(원금 손실 제로, ΔP ≡ 0). 언제든 전액 인출 가능.",
      cardExplainerStep2Title: "월간 실현 이자 자동 수확",
      cardExplainerStep2Desc: "결제일 전 탈중앙화 키퍼가 볼트에서 실현된 이자만을 자동 수확합니다.",
      cardExplainerStep3Title: "가상 Visa 카드로 가맹점 결제",
      cardExplainerStep3Desc: "수확된 이자 한도로 생성된 전용 가상 카드가 구독료를 자동 납부합니다.",
      cardFaqQuestion: "구독마다 카드를 따로 만들어야 하나요?",
      cardFaqAnswer: "하나의 대표 카드로 여러 구독을 통합 결제하거나, 가맹점별 전용 가상 카드를 발급하여 한도를 잠글 수 있습니다.",
    ...
    'yieldCard.shareLink': "초대 링크 복사",
    'yieldCard.linkCopied': "클립보드에 복사됨!",
    'yieldCard.twitterShare': "X(트위터)에 공유하고 알파 오픈 ⚡",
    'yieldCard.alphaUnlock': "+1명 초대 시 즉시 알파 승인",
    'yieldCard.inviteProgress': "0 / 1명 초대됨",
    'yieldCard.joinTelegramAlpha': "비공개 텔레그램에서 알파 수령하기 →",
    'yieldCard.checkStatus': "초대 현황 확인 / 알파 승인",
    ...
    // HYPE Funding Harvest Module
    'hypeHarvest.title': "HYPE 펀딩비 하베스트",
    'hypeHarvest.subtitle': "Hyperliquid 델타 뉴트럴 캐시 앤 캐리",
    'hypeHarvest.instantApr': "실시간 펀딩 연이율 (APR)",
    'hypeHarvest.projectedApr': "30일 예상 수익률 (33% 감쇄 반영)",
    'hypeHarvest.hourlyFunding': "시간당 펀딩비",
    'hypeHarvest.basisSpread': "마크 / 오라클 베이시스 스프레드",
    'hypeHarvest.openInterest': "총 미결제약정 (OI)",
    'hypeHarvest.dayVolume': "24시간 거래대금",
    'hypeHarvest.crowdedLong': "🔥 롱 과열 상태 (높은 캐시 수익 기회)",
    'hypeHarvest.normalState': "⚖️ 균형 상태",
    'hypeHarvest.shortSkew': "❄️ 숏 우세",
    'hypeHarvest.calculatorTitle': "예상 수확 수익 시뮬레이션",
    'hypeHarvest.capitalLabel': "총 운용 자본 (USD)",
    'hypeHarvest.spotLeg': "현물 HYPE 포지션 (50%)",
    'hypeHarvest.shortLeg': "Hyperliquid 1배 숏 선물 (50%)",
    'hypeHarvest.dailyYield': "일일 펀딩 수익",
    'hypeHarvest.monthlyYield': "월간 펀딩 수익",
    'hypeHarvest.projectedMonthly': "30일 감쇄 반영 월간 수익",
    'hypeHarvest.annualYield': "연간 수확 수익",
    'hypeHarvest.executionTitle': "하베스트 운영 방식",
    'hypeHarvest.step1': "1. 현물 HYPE (또는 유동성 스테이킹 HYPE) 매수 및 보유",
    'hypeHarvest.step2': "2. Hyperliquid에서 동일 금액의 1배 HYPE 숏 선물 오픈",
    'hypeHarvest.step3': "3. 델타 0 (시장 중립). 시간마다 지급되는 펀딩비를 마진 계정으로 자동 수취.",
    'hypeHarvest.riskNote': "신뢰 기준: 선물 펀딩비는 변동적입니다. 펀딩비가 음수로 전환되면 전략을 정리합니다. 예상 수익률에는 DeFi Garden의 1/3 감쇄 원칙이 적용됩니다.",
    'hypeHarvest.divergenceWarning': "⚠ 듀얼 오라클 괴리 경고 발생 (15 bps 초과). 베이시스 변동성 주의.",
  }
};
