...
const translations = {
  en: {
    ...
    rateSharpeNote: (s) => `Rate-stability score ${s} (vs a ~4% risk-free rate): how steady this pool's yield has been relative to how much it pays — not a measure of principal safety.`,
  ...
  ko: {
    ...
    rateSharpeNote: (s) => `이율 안정성 점수 ${s} (~4% 무위험 수익률 기준): 이 풀이 지급하는 이율 대비 얼마나 꾸준했는지를 나타냅니다 — 원금 안전성을 나타내는 지표가 아닙니다.`,
