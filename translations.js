...
projectionHeading: "The long game",
    ...
    landing: {
      ...
      spotlightTitleAccent: "software again.",
      spotlightSubhead: "Deposit once into audited Base lending vaults. Realized yield perpetually settles your monthly software, AI, and cloud subscriptions while your principal stays 100% yours.",
  ...
  ko: {
    ...
    landing: {
      ...
      spotlightSubhead: "검증된 Base 대출 볼트에 한 번만 예치하세요. 원금은 100% 안전하게 유지하면서, 매달 발생하는 실현 수익으로 소프트웨어, AI, 클라우드 구독료를 영구 정산합니다.",
      thesisLabel: "핵심 불변성:",
