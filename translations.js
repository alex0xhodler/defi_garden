...
const translations = {
  en: {
    ...
    yieldDecayAlert: (delta) => `Rate Decay Warning: Quant AI models a forward yield decline of ${delta} over the next 14 days.`,
...
projectionHeading: "The long game",
    ...
    landing: {
      ...
      uwEyebrow: "Quant-Powered Predictive Analytics",
      uwTitleBefore: "DeFi yields,",
      uwTitleAccent: "predictively underwritten.",
      uwSubhead: "Institutional-grade health ratings (0–100 AAA) and Quant AI forward volatility forecasting. Discover vetted pools with organic cash flows, deep exit liquidity, and zero surprise cliff decay.",
  ...
  ko: {
    ...
    landing: {
      ...
      uwEyebrow: "퀀트 AI 기반 예측 분석",
      uwTitleBefore: "디파이 수익률,",
      uwTitleAccent: "과학적으로 검증하다.",
      uwSubhead: "Quant AI 인공지능 변동성 예측 모델 및 기관급 디파이 건전성 평가(0~100 AAA). 일시적 보상 소진과 급락 위험을 사전에 걸러낸 신뢰할 수 있는 풀을 탐색하세요.",
      uwCta: "검증된 수익률 탐색하기",
