...
The highest honest BTCB yield right now is 18.70% on uniswap-v3 (BSC), among 20 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
BTCB shows up in 8 pools here, with rates from 0.01% to 18.70% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 18.70% | 18.25% | Base rate |
| uniswap-v3 | 8.26% | 20.45% | Base rate |
...
20 live pools clear this page's $100K TVL floor, $548.26M in total.
