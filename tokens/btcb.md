...
BTCB shows up in 8 pools here, with rates from 0.01% to 77.36% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 35.27% | 29.54% | Base rate |
| pancakeswap-amm | 1.92% | 2.15% | Base rate |
| kinza-finance | 0.01% | 0.01% | Base rate |
| uniswap-v4 | 0.41% | 45.16% | Base rate |
| uniswap-v3 | 77.36% | 58.01% | Base rate |
...
77.36% APY on uniswap-v3 (BSC), based on live DefiLlama data.

### How many BTCB pools clear the TVL floor?

25 live pools clear this page's $100K TVL floor, $669.29M in total.
