...
STAK shows up in 2 pools here, with rates from 0.04% to 10.67% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| spectra-v2 | 10.67% | 9.97% | Base rate |
...
10.67% APY on spectra-v2 (Ethereum), based on live DefiLlama data.
