...
The highest honest RETH yield right now is 7.00% on convex-finance (Ethereum), among 25 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
RETH shows up in 8 pools here, with rates from 1.23% to 7.00% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| balancer-v3 | 5.35% | 6.03% | 68.15% incentives |
| convex-finance | 7.00% | 6.08% | 69.72% incentives |
| uniswap-v3 | 1.68% | 1.55% | Base rate |
