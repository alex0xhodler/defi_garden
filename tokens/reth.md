...
The highest honest RETH yield right now is 7.99% on balancer-v3 (Ethereum), among 25 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
RETH shows up in 8 pools here, with rates from 2.21% to 7.99% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| balancer-v3 | 7.99% | 6.02% | 40.69% incentives |
| convex-finance | 6.72% | 6.16% | 67.09% incentives |
| uniswap-v3 | 3.67% | 1.72% | Base rate |
| curve-dex | 2.91% | 2.52% | Base rate |
| convex-finance | 2.91% | 2.52% | Base rate |
| curve-dex | 2.78% | 1.26% | Base rate |
...
7.99% APY on balancer-v3 (Ethereum), based on live DefiLlama data.
