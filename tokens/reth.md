...
The highest honest RETH yield right now is 6.58% on convex-finance (Ethereum), among 26 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
RETH shows up in 8 pools here, with rates from 0.40% to 11.08% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| balancer-v3 | 4.68% | 5.98% | 61.53% incentives |
| convex-finance | 6.58% | 6.87% | 68.11% incentives |
| uniswap-v4 | 0.40% | 2.77% | Base rate |
| uniswap-v3 | 4.34% | 3.63% | Base rate |
| uniswap-v3 | 11.08% | 5.11% | Base rate |
...
6.58% APY on convex-finance (Ethereum), based on live DefiLlama data.

### How many RETH pools clear the TVL floor?

26 live pools clear this page's $100K TVL floor, $1.46B in total.
