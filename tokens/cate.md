...
The highest honest CATE yield right now is 0.83% on raydium-amm (Solana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
CATE shows up in 3 pools here, with rates from 0.23% to 41.97% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 0.83% | 0.46% | Base rate |
| raydium-amm | 0.23% | 0.16% | Base rate |
| uniswap-v2 | 41.97% | 287.96% | Base rate |
