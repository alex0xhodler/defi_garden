...
The highest honest 3CRV yield right now is 15.65% on curve-dex (Ethereum), among 12 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
3CRV shows up in 7 pools here, with rates from 0.02% to 15.65% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
