...
The highest honest RBTC yield right now is 0.08% on sovryn-dex (Rootstock), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
RBTC shows up in 2 pools here, with rates from 0.06% to 0.08% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| sovryn-dex | 0.06% | 0.17% | 100.00% incentives |
