...
RBTC shows up in 3 pools here, with rates from 0.19% to 0.52% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
