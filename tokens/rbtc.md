...
RBTC shows up in 2 pools here, with rates from 0.01% to 0.18% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
