...
RBTC shows up in 4 pools here, with rates from 0.09% to 1.67% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 1.67% | 0.36% | Base rate |
| uniswap-v3 | 1.51% | 0.38% | Base rate |
