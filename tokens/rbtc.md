...
RBTC shows up in 5 pools here, with rates from 0.40% to 1.66% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| sovryn-dex | 0.95% | 0.25% | 100.00% incentives |
| sovryn-dex | 0.66% | 0.29% | 100.00% incentives |
