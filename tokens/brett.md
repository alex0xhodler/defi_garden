...
The highest honest BRETT yield right now is 31.37% on aerodrome-slipstream (Base), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
BRETT shows up in 3 pools here, with rates from 0.55% to 31.37% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 1.32% | 2.86% | Base rate |
| aerodrome-slipstream | 31.37% | 82.06% | 76.13% incentives |
...
31.37% APY on aerodrome-slipstream (Base), based on live DefiLlama data.
