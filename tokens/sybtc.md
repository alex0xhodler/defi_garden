...
The highest honest SYBTC yield right now is 2.57% on uniswap-v3 (BSC), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4 of these 4 pools have a trustworthy 30-day average on file, with a median of 8.57% — a useful check against today's number for whether the rate is steady or just having a good day.
...
| uniswap-v4 | 4.88% | 3.21% | Base rate |
| uniswap-v4 | 4.74% | 25.46% | Base rate |
...
2.57% APY on uniswap-v3 (BSC), based on live DefiLlama data.
