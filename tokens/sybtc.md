...
The highest honest SYBTC yield right now is 96.81% on uniswap-v4 (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
96.81% APY on uniswap-v4 (Ethereum), based on live DefiLlama data.
