...
The highest honest DOLO yield right now is 1.33% on uniswap-v3 (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
DOLO shows up in 1 pools here, with rates from 1.33% to 1.33% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 1.33% | 3.49% | Base rate |
