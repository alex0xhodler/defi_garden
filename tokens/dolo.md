...
The highest honest DOLO yield right now is 4.83% on uniswap-v3 (Ethereum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
DOLO shows up in 1 pools here, with rates from 4.83% to 4.83% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 4.83% | 10.39% | Base rate |
