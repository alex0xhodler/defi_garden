...
The highest honest STFLR yield right now is 15.41% on sparkdex-v4 (Flare), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
STFLR shows up in 2 pools here, with rates from 5.52% to 15.41% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| sparkdex-v4 | 5.52% | 4.47% | 93.44% incentives |
