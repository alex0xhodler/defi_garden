...
CASH shows up in 2 pools here, with rates from 0.38% to 4.25% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| orca-dex | 0.38% | 0.97% | Base rate |
| kamino-lend | 4.25% | 3.63% | Base rate |
