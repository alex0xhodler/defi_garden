...
CASH shows up in 2 pools here, with rates from 1.40% to 4.23% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| orca-dex | 1.40% | 0.94% | Base rate |
| kamino-lend | 4.23% | 3.40% | Base rate |
