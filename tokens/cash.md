...
The highest honest CASH yield right now is 4.06% on orca-dex (Solana), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4.06% APY on orca-dex (Solana), based on live DefiLlama data.
