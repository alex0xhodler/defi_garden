...
CASH shows up in 2 pools here, with rates from 0.96% to 4.25% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| orca-dex | 0.96% | 0.95% | Base rate |
| kamino-lend | 4.25% | 3.55% | Base rate |
