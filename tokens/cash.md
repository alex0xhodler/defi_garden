...
The highest honest CASH yield right now is 4.15% on kamino-lend (Solana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
CASH shows up in 2 pools here, with rates from 0.74% to 4.15% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| orca-dex | 0.74% | 1.39% | Base rate |
| kamino-lend | 4.15% | 4.13% | Base rate |
...
4.15% APY on kamino-lend (Solana), based on live DefiLlama data.
