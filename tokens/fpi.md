...
FPI shows up in 2 pools here, with rates from 0.02% to 0.02% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| convex-finance | 0.02% | 0.00% | Base rate |
