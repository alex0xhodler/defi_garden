...
The highest honest FPI yield right now is 0.08% on uniswap-v3 (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
FPI shows up in 1 pools here, with rates from 0.08% to 0.08% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
