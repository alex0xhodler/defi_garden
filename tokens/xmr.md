...
XMR shows up in 8 pools here, with rates from 12.15% to 39.07% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 12.15% | 10.67% | Base rate |
| raydium-amm | 17.53% | 10.96% | Base rate |
