...
SCA shows up in 2 pools here, with rates from 0.04% to 2.53% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| scallop-lend | 2.53% | 3.87% | Base rate |
