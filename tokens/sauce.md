...
The highest honest SAUCE yield right now is 6.51% on saucerswap-v1 (Hedera), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
6.51% APY on saucerswap-v1 (Hedera), based on live DefiLlama data.
