...
The highest honest GNS yield right now is 1.62% on camelot-v3 (Arbitrum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.62% APY on camelot-v3 (Arbitrum), based on live DefiLlama data.
