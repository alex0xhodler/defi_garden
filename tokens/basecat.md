...
Based on APY history only, BASECAT's lower-variability candidates are uniswap-v3 (Base), 632.64% APY, $253.8K TVL, https://www.defi.garden/?pool=3d9c490d-2fba-545d-8b04-164bf5d37e06&src=seo_token; uniswap-v4 (Base), 99.47% APY, $643.7K TVL, https://www.defi.garden/?pool=bd89ae9f-3c2f-5fe4-adcd-64c4a436cdc0&src=seo_token; uniswap-v4 (Base), 0.01% APY, $891.6K TVL, https://www.defi.garden/?pool=743a8ba6-1544-56fa-a896-0d77bc66f162&src=seo_token; uniswap-v4 (Base), 0.02% APY, $329.2K TVL, https://www.defi.garden/?pool=523f4688-ce0a-5dfb-b23f-822dec897425&src=seo_token. This comparison does not measure protocol, exploit, depeg, liquidity, governance, or principal-loss risk.
...
BASECAT shows up in 6 pools here, with rates from 0.01% to 632.64% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

4 of these 6 pools have a trustworthy 30-day average on file, with a median of 86.91% — a useful check against today's number for whether the rate is steady or just having a good day.
...
| uniswap-v4 | 0.01% | 44.96% | Base rate |
| uniswap-v4 | 99.47% | 683.95% | Base rate |
| uniswap-v4 | 0.02% | 128.86% | Base rate |
| uniswap-v3 | 632.64% | — | Base rate |
| uniswap-v3 | 327.66% | — | Base rate |
