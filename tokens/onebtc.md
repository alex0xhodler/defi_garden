...
The highest honest ONEBTC yield right now is 1.43% on sushiswap (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.43% APY on sushiswap (Ethereum), based on live DefiLlama data.
