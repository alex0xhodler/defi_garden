...
The highest honest ASTER yield right now is 5.71% on uniswap-v3 (BSC), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
ASTER shows up in 3 pools here, with rates from 0.03% to 5.71% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| lista-lending | 0.03% | 1.33% | Base rate |
| uniswap-v3 | 5.71% | 7.45% | Base rate |
| uniswap-v3 | 1.10% | 3.51% | Base rate |
...
5.71% APY on uniswap-v3 (BSC), based on live DefiLlama data.
