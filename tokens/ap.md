...
AP shows up in 2 pools here, with rates from 1.05% to 16.93% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v2 | 1.05% | 1.49% | Base rate |
