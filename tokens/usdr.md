...
The highest honest USDR yield right now is 0.22% on uniswap-v4 (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDR shows up in 2 pools here, with rates from 0.07% to 0.22% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 0.22% | 0.21% | Base rate |
