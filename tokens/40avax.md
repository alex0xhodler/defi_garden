...
The highest honest 40AVAX yield right now is 14.08% on 40-acres (Avalanche), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
40AVAX shows up in 1 pools here, with rates from 14.08% to 14.08% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
14.08% APY on 40-acres (Avalanche), based on live DefiLlama data.
