...
HYPERUSDTC shows up in 2 pools here, with rates from 0.26% to 2.66% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| morpho-blue | 0.26% | 0.09% | Base rate |
| morpho-blue | 2.66% | 3.06% | Base rate |
