...
The highest honest SBUSDT yield right now is 2.50% on scallop-lend (Sui), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
2.50% APY on scallop-lend (Sui), based on live DefiLlama data.
