...
The highest honest WAETHWETH yield right now is 7.68% on balancer-v3 (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WAETHWETH shows up in 1 pools here, with rates from 7.68% to 7.68% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
