...
The highest honest SMON yield right now is 14.67% on curve-dex (Monad), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SMON shows up in 3 pools here, with rates from 1.51% to 14.67% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
