...
STSUI shows up in 2 pools here, with rates from 0.05% to 0.09% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| bluefin-spot | 0.09% | 0.36% | Base rate |
