...
The highest honest VBUSDC yield right now is 7.48% on spectra-metavaults (Katana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
VBUSDC shows up in 3 pools here, with rates from 1.96% to 7.48% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| yearn-finance | 4.15% | 4.80% | 62.94% incentives |
| morpho-blue | 1.96% | 4.94% | Base rate |
| spectra-metavaults | 7.48% | 14.21% | 32.49% incentives |
...
7.48% APY on spectra-metavaults (Katana), based on live DefiLlama data.
