...
The highest honest VBUSDC yield right now is 7.41% on spectra-metavaults (Katana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
VBUSDC shows up in 3 pools here, with rates from 1.96% to 7.41% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| yearn-finance | 4.17% | 4.80% | 63.15% incentives |
| morpho-blue | 1.96% | 4.95% | Base rate |
| spectra-metavaults | 7.41% | 14.21% | 31.90% incentives |
...
7.41% APY on spectra-metavaults (Katana), based on live DefiLlama data.
