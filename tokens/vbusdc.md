...
The highest honest VBUSDC yield right now is 4.95% on yearn-finance (Katana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
VBUSDC shows up in 3 pools here, with rates from 1.85% to 5.36% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| yearn-finance | 4.95% | 4.80% | 70.61% incentives |
| morpho-blue | 1.85% | 4.41% | Base rate |
| spectra-metavaults | 5.36% | 14.13% | 41.92% incentives |
...
4.95% APY on yearn-finance (Katana), based on live DefiLlama data.
