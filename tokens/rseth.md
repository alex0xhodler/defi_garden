...
The highest honest RSETH yield right now is 2.28% on kelp (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
RSETH shows up in 1 pools here, with rates from 2.28% to 2.28% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
