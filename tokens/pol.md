...
POL shows up in 2 pools here, with rates from 17.43% to 17.98% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 17.43% | 15.92% | Base rate |
| uniswap-v4 | 17.98% | 20.45% | Base rate |
...
17.98% APY on uniswap-v4 (Polygon), based on live DefiLlama data.
