...
The highest honest MAJOR yield right now is 32.17% on ston.fi (TON), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
32.17% APY on ston.fi (TON), based on live DefiLlama data.
