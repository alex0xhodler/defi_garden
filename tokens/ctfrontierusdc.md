...
The highest honest CTFRONTIERUSDC yield right now is 8.03% on concrete (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
8.03% APY on concrete (Ethereum), based on live DefiLlama data.
