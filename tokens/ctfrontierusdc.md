...
The highest honest CTFRONTIERUSDC yield right now is 9.72% on concrete (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
|---|---|---|---|
| concrete | 9.72% | 6.51% | Base rate |
| concrete | 22.67% | 10.83% | Base rate |
...
9.72% APY on concrete (Ethereum), based on live DefiLlama data.
