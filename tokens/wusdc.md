...
WUSDC shows up in 3 pools here, with rates from 0.94% to 1.48% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| cetus-clmm | 0.94% | 1.86% | Base rate |
