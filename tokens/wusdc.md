...
The highest honest WUSDC yield right now is 1.56% on cetus-clmm (Sui), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [cetus-clmm →](https://www.defi.garden/?pool=58eb1ad4-758f-407d-afc2-0b465b1e76a7&src=seo_token) | Sui | 1.56% | $149.9K |
...
WUSDC shows up in 3 pools here, with rates from 1.19% to 1.56% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| cetus-clmm | 1.56% | 2.24% | Base rate |
...
1.56% APY on cetus-clmm (Sui), based on live DefiLlama data.
