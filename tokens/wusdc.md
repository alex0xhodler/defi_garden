...
The highest honest WUSDC yield right now is 2.12% on cetus-clmm (Sui), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WUSDC shows up in 3 pools here, with rates from 1.19% to 2.12% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| cetus-clmm | 2.12% | 2.31% | Base rate |
...
2.12% APY on cetus-clmm (Sui), based on live DefiLlama data.
