...
|---|---|---|---|
| [cetus-clmm →](https://www.defi.garden/?pool=58eb1ad4-758f-407d-afc2-0b465b1e76a7&src=seo_token) | Sui | 1.89% | $150.6K |
...
WUSDC shows up in 3 pools here, with rates from 1.19% to 1.89% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| cetus-clmm | 1.89% | 2.20% | Base rate |
| navi-lending | 1.48% | 1.47% | Base rate |
| scallop-lend | 1.19% | 1.37% | Base rate |
...
3 live pools clear this page's $100K TVL floor, $420.1K in total.
