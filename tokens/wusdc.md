...
WUSDC shows up in 3 pools here, with rates from 0.48% to 1.48% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| cetus-clmm | 0.48% | 1.92% | Base rate |
...
3 live pools clear this page's $100K TVL floor, $418.3K in total.
