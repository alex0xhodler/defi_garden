...
The highest honest WUSDC yield right now is 1.48% on cetus-clmm (Sui), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.48% APY on cetus-clmm (Sui), based on live DefiLlama data.
