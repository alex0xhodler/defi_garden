...
The highest honest WUSDC yield right now is 1.77% on cetus-clmm (Sui), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [cetus-clmm →](https://www.defi.garden/?pool=58eb1ad4-758f-407d-afc2-0b465b1e76a7&src=seo_token) | Sui | 1.77% | $149.8K |
...
WUSDC shows up in 3 pools here, with rates from 1.19% to 1.77% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| cetus-clmm | 1.77% | 2.18% | Base rate |
| navi-lending | 1.48% | 1.47% | Base rate |
| scallop-lend | 1.19% | 1.36% | Base rate |
...
1.77% APY on cetus-clmm (Sui), based on live DefiLlama data.
