...
The highest honest WUSDC yield right now is 1.95% on cetus-clmm (Sui), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WUSDC shows up in 3 pools here, with rates from 1.19% to 1.95% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| cetus-clmm | 1.95% | 2.26% | Base rate |
...
1.95% APY on cetus-clmm (Sui), based on live DefiLlama data.
