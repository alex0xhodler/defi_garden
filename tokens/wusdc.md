...
|---|---|---|---|
| [cetus-clmm →](https://www.defi.garden/?pool=58eb1ad4-758f-407d-afc2-0b465b1e76a7&src=seo_token) | Sui | 1.98% | $147.8K |
...
WUSDC shows up in 3 pools here, with rates from 1.19% to 1.98% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| cetus-clmm | 1.98% | 2.37% | Base rate |
| navi-lending | 1.48% | 1.47% | Base rate |
| scallop-lend | 1.19% | 1.41% | Base rate |
