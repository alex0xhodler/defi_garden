...
The highest honest WUSDC yield right now is 5.46% on cetus-clmm (Sui), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WUSDC shows up in 3 pools here, with rates from 1.17% to 5.46% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| cetus-clmm | 5.46% | 5.99% | Base rate |
...
5.46% APY on cetus-clmm (Sui), based on live DefiLlama data.

### How many WUSDC pools clear the TVL floor?

3 live pools clear this page's $100K TVL floor, $425.6K in total.
