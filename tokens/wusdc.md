...
The highest honest WUSDC yield right now is 2.17% on cetus-clmm (Sui), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [cetus-clmm →](https://www.defi.garden/?pool=58eb1ad4-758f-407d-afc2-0b465b1e76a7&src=seo_token) | Sui | 2.17% | $151K |
...
WUSDC shows up in 3 pools here, with rates from 1.19% to 2.17% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| cetus-clmm | 2.17% | 2.21% | Base rate |
...
2.17% APY on cetus-clmm (Sui), based on live DefiLlama data.

### How many WUSDC pools clear the TVL floor?

3 live pools clear this page's $100K TVL floor, $420.6K in total.
