...
The highest honest FRXETH yield right now is 11.84% on curve-dex (Ethereum), among 20 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
FRXETH shows up in 8 pools here, with rates from 0.75% to 11.84% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| curve-dex | 0.75% | 0.64% | 94.64% incentives |
| convex-finance | 1.17% | 0.86% | 96.57% incentives |
...
11.84% APY on curve-dex (Ethereum), based on live DefiLlama data.

### How many FRXETH pools clear the TVL floor?

20 live pools clear this page's $100K TVL floor, $57.66M in total.
