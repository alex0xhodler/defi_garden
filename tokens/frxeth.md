...
The highest honest FRXETH yield right now is 12.61% on curve-dex (Ethereum), among 20 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
FRXETH shows up in 8 pools here, with rates from 0.76% to 12.61% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| curve-dex | 1.85% | 1.63% | 52.48% incentives |
| convex-finance | 2.46% | 1.92% | 64.24% incentives |
| curve-dex | 0.76% | 0.64% | 93.43% incentives |
| convex-finance | 1.18% | 0.86% | 95.78% incentives |
...
12.61% APY on curve-dex (Ethereum), based on live DefiLlama data.
