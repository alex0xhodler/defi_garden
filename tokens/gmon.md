...
GMON shows up in 3 pools here, with rates from 0.35% to 16.00% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| neverland | 0.35% | 0.20% | 100.00% incentives |
