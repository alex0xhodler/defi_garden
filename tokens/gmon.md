...
The highest honest GMON yield right now is 24.11% on curve-dex (Monad), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
24.11% APY on curve-dex (Monad), based on live DefiLlama data.
