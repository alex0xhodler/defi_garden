...
The highest honest CUSDO yield right now is 4.38% on curve-dex (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
CUSDO shows up in 2 pools here, with rates from 3.10% to 4.38% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
4.38% APY on curve-dex (Ethereum), based on live DefiLlama data.
