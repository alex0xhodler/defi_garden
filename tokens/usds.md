...
The highest honest USDS yield right now is 5.91% on sky-lending (Ethereum), among 21 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDS shows up in 8 pools here, with rates from 2.04% to 5.91% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
