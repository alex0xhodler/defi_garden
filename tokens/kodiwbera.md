...
The highest honest KODIWBERA yield right now is 32.95% on berapaw (Berachain), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
32.95% APY on berapaw (Berachain), based on live DefiLlama data.
