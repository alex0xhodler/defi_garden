...
The highest honest GMX yield right now is 54.93% on uniswap-v3 (Arbitrum), among 8 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
GMX shows up in 6 pools here, with rates from 0.39% to 54.93% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

6 of these 6 pools have a trustworthy 30-day average on file, with a median of 8.17% — a useful check against today's number for whether the rate is steady or just having a good day.
...
54.93% APY on uniswap-v3 (Arbitrum), based on live DefiLlama data.
