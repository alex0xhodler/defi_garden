...
The highest honest FRAX yield right now is 6.78% on curve-dex (Ethereum), among 36 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
FRAX shows up in 8 pools here, with rates from 0.25% to 6.78% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| frax | 0.52% | 1.31% | Base rate |
| curve-dex | 6.78% | 8.18% | 99.26% incentives |
| frax | 0.80% | 1.01% | Base rate |
| frax | 0.25% | 2.67% | Base rate |
...
6.78% APY on curve-dex (Ethereum), based on live DefiLlama data.

### How many FRAX pools clear the TVL floor?

36 live pools clear this page's $100K TVL floor, $99.1M in total.
