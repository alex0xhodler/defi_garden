...
BOTTO shows up in 3 pools here, with rates from 0.50% to 54.21% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 0.74% | 1.06% | Base rate |
| aerodrome-v1 | 54.21% | 107.23% | 100.00% incentives |
| uniswap-v2 | 0.50% | 0.67% | Base rate |
...
54.21% APY on aerodrome-v1 (Base), based on live DefiLlama data.
