...
The highest honest TONIC yield right now is 1.72% on vvs-standard (Cronos), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
TONIC shows up in 3 pools here, with rates from 0.82% to 12.33% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| vvs-standard | 12.33% | 6.96% | Base rate |
| vvs-standard | 0.82% | 0.90% | Base rate |
| vvs-standard | 1.72% | 1.47% | Base rate |
...
3 live pools clear this page's $100K TVL floor, $539K in total.
