...
The highest honest KODIBRBTC yield right now is 0.69% on berapaw (Berachain), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
0.69% APY on berapaw (Berachain), based on live DefiLlama data.
