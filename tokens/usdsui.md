...
The highest honest USDSUI yield right now is 95.99% on bluefin-spot (Sui), among 7 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDSUI shows up in 7 pools here, with rates from 0.43% to 95.99% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| current | 8.99% | 8.46% | 55.44% incentives |
| cetus-clmm | 3.96% | 3.35% | 86.01% incentives |
| navi-lending | 8.41% | 8.76% | 66.31% incentives |
| bluefin-spot | 18.68% | 18.34% | 82.28% incentives |
| bluefin-spot | 0.43% | 0.58% | Base rate |
| cetus-clmm | 81.00% | 85.89% | 65.48% incentives |
| bluefin-spot | 95.99% | 101.94% | 50.17% incentives |
...
95.99% APY on bluefin-spot (Sui), based on live DefiLlama data.
