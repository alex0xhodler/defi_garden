...
The highest honest STRCX yield right now is 44.26% on raydium-amm (Solana), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
STRCX shows up in 4 pools here, with rates from 21.62% to 44.26% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle-v2 | 24.23% | 27.11% | Base rate |
| pendle-v2 | 21.62% | 32.67% | 14.13% incentives |
| raydium-amm | 44.26% | 38.73% | Base rate |
| raydium-amm | 31.87% | 156.02% | Base rate |
