...
The highest honest VELO yield right now is 61.49% on velodrome-v3 (OP Mainnet), among 8 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
VELO shows up in 8 pools here, with rates from 0.02% to 61.49% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| velodrome-v2 | 14.09% | 18.74% | 100.00% incentives |
| moonwell-lending | 0.02% | 0.06% | Base rate |
| velodrome-v2 | 46.01% | 59.74% | 100.00% incentives |
| extra-finance-leverage-farming | 14.84% | 20.68% | Base rate |
| velodrome-v2 | 13.76% | 17.81% | 100.00% incentives |
| velodrome-v3 | 61.49% | 113.19% | 100.00% incentives |
| velodrome-v3 | 60.37% | 108.11% | 100.00% incentives |
| velodrome-v2 | 11.55% | 18.37% | 100.00% incentives |
...
61.49% APY on velodrome-v3 (OP Mainnet), based on live DefiLlama data.
