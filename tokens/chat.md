...
The highest honest CHAT yield right now is 6.76% on icpswap (ICP), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
6.76% APY on icpswap (ICP), based on live DefiLlama data.
