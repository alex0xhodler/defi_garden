...
The highest honest CHAT yield right now is 1.41% on icpswap (ICP), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
CHAT shows up in 2 pools here, with rates from 0.93% to 1.41% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| raydium-amm | 0.93% | 2.83% | Base rate |
...
1.41% APY on icpswap (ICP), based on live DefiLlama data.
