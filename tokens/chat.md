...
The highest honest CHAT yield right now is 1.49% on raydium-amm (Solana), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
CHAT shows up in 2 pools here, with rates from 1.17% to 1.49% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 1.49% | 5.98% | Base rate |
| icpswap | 1.17% | 4.48% | Base rate |
