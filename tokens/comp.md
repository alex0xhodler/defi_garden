...
The highest honest COMP yield right now is 7.48% on uniswap-v4 (Ethereum), among 7 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
COMP shows up in 3 pools here, with rates from 0.11% to 7.48% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 0.11% | 0.05% | Base rate |
| uniswap-v4 | 7.48% | 14.32% | Base rate |
| uniswap-v2 | 7.26% | 3.19% | Base rate |
...
7.48% APY on uniswap-v4 (Ethereum), based on live DefiLlama data.
