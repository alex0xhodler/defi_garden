...
USDT0 shows up in 8 pools here, with rates from 0.15% to 13.40% APY across 4 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| aave-v3 | 4.19% | 4.23% | Base rate |
| fluid-lending | 4.90% | 5.40% | Base rate |
| aave-v3 | 3.85% | 5.12% | 47.78% incentives |
| aave-v3 | 2.74% | 2.64% | Base rate |
| neverland | 5.33% | 3.56% | 89.97% incentives |
| curve-dex | 13.40% | 14.02% | 100.00% incentives |
| uniswap-v4 | 0.23% | 1.22% | Base rate |
| uniswap-v4 | 0.15% | 1.14% | Base rate |
