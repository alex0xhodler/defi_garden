...
The highest honest AUSDT yield right now is 1.57% on hydration-dex (Polkadot), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
AUSDT shows up in 3 pools here, with rates from 0.33% to 1.57% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
1.57% APY on hydration-dex (Polkadot), based on live DefiLlama data.
