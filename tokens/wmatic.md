...
<<<<<<< HEAD
The highest honest WMATIC yield right now is 15.57% on uniswap-v3 (Polygon), among 9 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [uniswap-v3 →](https://www.defi.garden/?pool=4d6914cc-4df2-4f1a-8b89-7681721d1758&src=seo_token) | Polygon | 76.94% | $1.1M |
...
=======
The highest honest WMATIC yield right now is 46.73% on uniswap-v3 (Polygon), among 9 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
<<<<<<< HEAD
15.57% APY on uniswap-v3 (Polygon), based on live DefiLlama data.
=======
46.73% APY on uniswap-v3 (Polygon), based on live DefiLlama data.
>>>>>>> origin/main
