...
The highest honest WNAUSD yield right now is 15.86% on balancer-v3 (Monad), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WNAUSD shows up in 2 pools here, with rates from 10.60% to 15.86% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
