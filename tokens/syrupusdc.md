...
The highest honest SYRUPUSDC yield right now is 2.89% on orca-dex (Solana), among 19 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [uniswap-v4 →](https://www.defi.garden/?pool=df8851f0-5b1d-4843-88fd-88468d129c78&src=seo_token) | Ethereum | 1.01% | $13.33M |
| [orca-dex →](https://www.defi.garden/?pool=e1c57765-701f-49ba-810c-0785a51d3764&src=seo_token) | Solana | 0.07% | $10.03M |
...
SYRUPUSDC shows up in 8 pools here, with rates from 0.01% to 2.89% APY across 4 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 1.01% | 0.95% | Base rate |
| orca-dex | 0.07% | 0.91% | Base rate |
...
2.89% APY on orca-dex (Solana), based on live DefiLlama data.
