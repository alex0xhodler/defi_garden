...
The highest honest MEX yield right now is 5.05% on xexchange (MultiversX), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
MEX shows up in 3 pools here, with rates from 0.69% to 5.05% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
