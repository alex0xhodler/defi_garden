...
SMUSD shows up in 2 pools here, with rates from 0.60% to 1.94% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
1.94% APY on mezo-vaults (Mezo), based on live DefiLlama data.
