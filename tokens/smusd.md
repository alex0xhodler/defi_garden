...
SMUSD shows up in 2 pools here, with rates from 0.20% to 2.66% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| mezo-vaults | 2.66% | 3.39% | 100.00% incentives |
