...
The highest honest SMUSD yield right now is 1.85% on mezo-vaults (Mezo), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SMUSD shows up in 2 pools here, with rates from 0.33% to 1.85% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| mezo-vaults | 1.85% | 2.92% | 100.00% incentives |
| mezo-vaults | 0.33% | 1.71% | Base rate |
...
1.85% APY on mezo-vaults (Mezo), based on live DefiLlama data.
