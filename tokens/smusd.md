...
SMUSD shows up in 2 pools here, with rates from 0.33% to 1.87% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| mezo-vaults | 1.87% | 2.94% | 100.00% incentives |
| mezo-vaults | 0.33% | 1.72% | Base rate |
