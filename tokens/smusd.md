...
SMUSD shows up in 2 pools here, with rates from 0.26% to 2.63% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| mezo-vaults | 2.63% | 3.76% | 100.00% incentives |
