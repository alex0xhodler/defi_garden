...
SMUSD shows up in 2 pools here, with rates from 0.33% to 1.90% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| mezo-vaults | 1.90% | 2.99% | 100.00% incentives |
| mezo-vaults | 0.33% | 1.73% | Base rate |
