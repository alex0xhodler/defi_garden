...
The highest honest SMUSD yield right now is 2.67% on mezo-vaults (Mezo), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SMUSD shows up in 2 pools here, with rates from 1.07% to 2.67% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| mezo-vaults | 1.07% | 1.99% | 100.00% incentives |
| mezo-vaults | 2.67% | 2.73% | Base rate |
...
2.67% APY on mezo-vaults (Mezo), based on live DefiLlama data.
