...
The highest honest NEST yield right now is 58.98% on nest-cl (Hyperliquid L1), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
58.98% APY on nest-cl (Hyperliquid L1), based on live DefiLlama data.
