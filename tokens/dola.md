...
The highest honest DOLA yield right now is 6.21% on yearn-finance (Ethereum), among 15 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
DOLA shows up in 8 pools here, with rates from 0.75% to 6.21% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| yearn-finance | 5.28% | 4.96% | Base rate |
| curve-dex | 3.18% | 2.97% | 75.17% incentives |
| convex-finance | 4.82% | 4.21% | 83.61% incentives |
| curve-dex | 6.07% | 1.71% | Base rate |
| yearn-finance | 6.21% | 5.67% | Base rate |
| aerodrome-v1 | 0.75% | 0.76% | 100.00% incentives |
...
6.21% APY on yearn-finance (Ethereum), based on live DefiLlama data.

### How many DOLA pools clear the TVL floor?

15 live pools clear this page's $100K TVL floor, $144.97M in total.
