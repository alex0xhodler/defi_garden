...
The highest honest DOLA yield right now is 5.54% on yearn-finance (Ethereum), among 15 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
DOLA shows up in 8 pools here, with rates from 0.71% to 5.54% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
