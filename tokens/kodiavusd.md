...
The highest honest KODIAVUSD yield right now is 4.24% on berapaw (Berachain), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4.24% APY on berapaw (Berachain), based on live DefiLlama data.
