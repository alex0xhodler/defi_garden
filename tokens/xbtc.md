...
The highest honest XBTC yield right now is 37.41% on bluefin-spot (Sui), among 19 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
XBTC shows up in 8 pools here, with rates from 0.37% to 37.41% APY across 5 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| kamino-liquidity | 1.03% | 2.06% | Base rate |
| orca-dex | 1.84% | 2.61% | Base rate |
| liminal-basis | 6.83% | 7.19% | Base rate |
| liminal-basis | 4.40% | 6.52% | Base rate |
| hyperion | 0.37% | 0.37% | Base rate |
| bluefin-spot | 37.41% | 29.42% | 35.19% incentives |
| bluefin-spot | 14.93% | 15.79% | 89.80% incentives |
...
37.41% APY on bluefin-spot (Sui), based on live DefiLlama data.

### How many XBTC pools clear the TVL floor?

19 live pools clear this page's $100K TVL floor, $43.7M in total.
