...
NUSD shows up in 3 pools here, with rates from 0.21% to 6.21% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| curve-dex | 0.21% | 0.34% | Base rate |
| pendle | 1.70% | 2.62% | Base rate |
| pendle | 6.21% | 7.04% | Base rate |
