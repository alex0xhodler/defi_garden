...
The highest honest NUSD yield right now is 7.61% on pendle (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
NUSD shows up in 2 pools here, with rates from 3.38% to 7.61% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle | 3.38% | 2.45% | Base rate |
| pendle | 7.61% | 6.82% | Base rate |
...
7.61% APY on pendle (Ethereum), based on live DefiLlama data.
