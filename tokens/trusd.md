...
TRUSD shows up in 5 pools here, with rates from 0.38% to 9.70% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| fluid-dex | 0.38% | 0.26% | Base rate |
| curve-dex | 2.91% | 3.31% | 97.59% incentives |
| pendle-v2 | 2.47% | 3.04% | 11.09% incentives |
| pendle-v2 | 9.70% | 9.40% | Base rate |
