...
TRUSD shows up in 5 pools here, with rates from 0.21% to 8.29% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| curve-dex | 0.21% | 0.47% | 0.01% incentives |
| curve-dex | 5.80% | 259.57% | 99.31% incentives |
