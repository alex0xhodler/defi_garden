...
TRUSD shows up in 5 pools here, with rates from 0.73% to 10.42% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| curve-dex | 0.73% | 0.46% | 0.00% incentives |
| curve-dex | 5.00% | 328.93% | 98.60% incentives |
