...
The highest honest TRUSD yield right now is 8.81% on pendle (Ethereum), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
TRUSD shows up in 5 pools here, with rates from 0.24% to 8.81% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
