...
The highest honest TRUSD yield right now is 9.51% on pendle (Ethereum), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
TRUSD shows up in 5 pools here, with rates from 0.45% to 9.51% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| curve-dex | 0.45% | 0.46% | 0.00% incentives |
| curve-dex | 6.20% | 234.29% | 99.35% incentives |
| pendle | 4.05% | 5.70% | 38.83% incentives |
| pendle | 9.51% | 11.31% | Base rate |
