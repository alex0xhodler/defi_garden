...
The highest honest SCRVUSD yield right now is 6.09% on convex-finance (Ethereum), among 22 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SCRVUSD shows up in 8 pools here, with rates from 1.28% to 15.90% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| curve-dex | 4.76% | 4.42% | 43.52% incentives |
| convex-finance | 6.09% | 5.73% | 55.80% incentives |
