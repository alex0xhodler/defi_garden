...
SUIUSDE shows up in 2 pools here, with rates from 0.03% to 1.33% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
