...
GAMIUSDC shows up in 3 pools here, with rates from 8.53% to 10.60% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| lagoon | 9.19% | 8.34% | Base rate |
| gami-labs | 8.53% | 8.52% | Base rate |
