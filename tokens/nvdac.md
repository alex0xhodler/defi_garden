...
NVDAC shows up in 8 pools here, with rates from 0.01% to 238.42% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| aerodrome-slipstream | 170.75% | 473.22% | 75.84% incentives |
| uniswap-v4 | 11.05% | 106.84% | Base rate |
| uniswap-v4 | 28.07% | 30.45% | Base rate |
| uniswap-v4 | 0.01% | 0.01% | Base rate |
| uniswap-v4 | 0.86% | 0.86% | Base rate |
| aerodrome-slipstream | 238.42% | 482.89% | 45.75% incentives |
...
12 live pools clear this page's $100K TVL floor, $4.38M in total.
