...
The highest honest AKE yield right now is 0.41% on raydium-amm (Solana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [raydium-amm →](https://www.defi.garden/?pool=04166f2e-694d-518c-b08e-bd36e01d3f76&src=seo_token) | Solana | 0.41% | $3.92M |
...
AKE shows up in 3 pools here, with rates from 0.18% to 0.41% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 0.41% | 0.56% | Base rate |
