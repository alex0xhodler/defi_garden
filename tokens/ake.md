...
The highest honest AKE yield right now is 0.78% on raydium-amm (Solana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
AKE shows up in 3 pools here, with rates from 0.18% to 0.78% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 0.78% | 0.57% | Base rate |
