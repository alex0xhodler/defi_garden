...
The highest honest WBTC.E yield right now is 0.91% on joe-v2.1 (Avalanche), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WBTC.E shows up in 2 pools here, with rates from 0.01% to 0.91% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
0.91% APY on joe-v2.1 (Avalanche), based on live DefiLlama data.
