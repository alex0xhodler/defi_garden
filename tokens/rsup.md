...
The highest honest RSUP yield right now is 24.77% on convex-finance (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
RSUP shows up in 2 pools here, with rates from 15.34% to 24.77% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| curve-dex | 15.34% | 14.41% | 99.48% incentives |
| convex-finance | 24.77% | 21.18% | 99.68% incentives |
...
24.77% APY on convex-finance (Ethereum), based on live DefiLlama data.
