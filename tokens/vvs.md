...
The highest honest VVS yield right now is 0.99% on vvs-standard (Cronos), among 8 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
VVS shows up in 7 pools here, with rates from 0.02% to 0.99% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| vvs-standard | 0.99% | 1.40% | Base rate |
| vvs-standard | 0.81% | 0.86% | Base rate |
| vvs-standard | 0.15% | 0.85% | Base rate |
| vvs-flawless | 0.79% | 1.75% | Base rate |
| vvs-standard | 0.17% | 0.25% | Base rate |
...
0.99% APY on vvs-standard (Cronos), based on live DefiLlama data.

### How many VVS pools clear the TVL floor?

8 live pools clear this page's $100K TVL floor, $27.03M in total.
