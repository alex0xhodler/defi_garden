...
The highest honest VVS yield right now is 0.88% on vvs-standard (Cronos), among 8 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
VVS shows up in 7 pools here, with rates from 0.02% to 0.88% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| vvs-standard | 0.88% | 1.40% | Base rate |
| vvs-standard | 0.72% | 0.86% | Base rate |
| vvs-standard | 0.15% | 0.86% | Base rate |
| vvs-flawless | 0.69% | 1.76% | Base rate |
| vvs-standard | 0.18% | 0.25% | Base rate |
| vvs-standard | 0.02% | 0.34% | Base rate |
...
0.88% APY on vvs-standard (Cronos), based on live DefiLlama data.

### How many VVS pools clear the TVL floor?

8 live pools clear this page's $100K TVL floor, $27.24M in total.
