...
The highest honest WEGLD yield right now is 4.08% on xexchange (MultiversX), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WEGLD shows up in 2 pools here, with rates from 3.78% to 4.08% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| xexchange | 3.78% | 5.12% | 26.25% incentives |
...
2 live pools clear this page's $100K TVL floor, $979.4K in total.
