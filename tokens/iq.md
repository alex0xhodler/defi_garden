...
The highest honest IQ yield right now is 0.74% on frax (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
IQ shows up in 3 pools here, with rates from 0.01% to 71.15% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| curve-dex | 71.15% | 32.35% | 99.93% incentives |
...
0.74% APY on frax (Ethereum), based on live DefiLlama data.
