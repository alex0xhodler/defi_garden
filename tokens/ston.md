...
STON shows up in 3 pools here, with rates from 0.14% to 13.73% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| ston.fi | 13.73% | 15.14% | 96.58% incentives |
| ston.fi | 0.57% | 1.81% | Base rate |
