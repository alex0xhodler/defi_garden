...
The highest honest SNDK yield right now is 114.92% on raydium-amm (Solana), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
114.92% APY on raydium-amm (Solana), based on live DefiLlama data.
