...
The highest honest SNDK yield right now is 86.19% on raydium-amm (Solana), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
86.19% APY on raydium-amm (Solana), based on live DefiLlama data.
