...
LINK shows up in 8 pools here, with rates from 0.03% to 17.05% APY across 4 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 15.23% | 8.01% | Base rate |
| bancor-v3 | 0.05% | 0.03% | Base rate |
| curve-dex | 17.05% | 2.03% | Base rate |
| gmx-v2-perps | 0.85% | 3.70% | Base rate |
...
43 live pools clear this page's $100K TVL floor, $153.69M in total.
