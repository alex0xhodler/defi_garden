...
The highest honest INJ yield right now is 19.12% on uniswap-v4 (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
INJ shows up in 2 pools here, with rates from 4.83% to 19.12% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| sushiswap-v3 | 4.83% | 5.76% | Base rate |
| uniswap-v4 | 19.12% | 22.59% | Base rate |
...
19.12% APY on uniswap-v4 (Ethereum), based on live DefiLlama data.
