...
USDC.E shows up in 8 pools here, with rates from 0.04% to 6.95% APY across 5 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| sparkdex-v3.1 | 0.04% | 0.06% | Base rate |
| sparkdex-v4 | 6.95% | 6.88% | 99.07% incentives |
| uniswap-v3 | 3.44% | 5.88% | Base rate |
| aave-v3 | 2.93% | 2.75% | Base rate |
| curve-dex | 0.10% | 0.18% | Base rate |
| dolomite | 3.85% | 3.90% | Base rate |
| symbiosis | 3.66% | 1.45% | Base rate |
| sushiswap-v3 | 4.02% | 6.93% | Base rate |
...
30 live pools clear this page's $100K TVL floor, $17.28M in total.
