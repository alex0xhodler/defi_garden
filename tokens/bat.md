...
BAT shows up in 2 pools here, with rates from 0.03% to 0.55% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 0.55% | 0.21% | Base rate |
