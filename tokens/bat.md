...
The highest honest BAT yield right now is 0.39% on uniswap-v3 (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
BAT shows up in 2 pools here, with rates from 0.06% to 0.39% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 0.39% | 0.31% | Base rate |
