...
The highest honest SUSHI yield right now is 16.98% on uniswap-v2 (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SUSHI shows up in 3 pools here, with rates from 9.78% to 16.98% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| sushiswap-v3 | 9.78% | 3.74% | Base rate |
| sushiswap | 10.20% | 4.03% | Base rate |
| uniswap-v2 | 16.98% | 4.96% | Base rate |
...
16.98% APY on uniswap-v2 (Ethereum), based on live DefiLlama data.
