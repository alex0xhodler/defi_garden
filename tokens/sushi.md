...
SUSHI shows up in 3 pools here, with rates from 5.37% to 6.18% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| sushiswap-v3 | 5.46% | 9.42% | Base rate |
| sushiswap | 6.18% | 10.72% | Base rate |
| uniswap-v2 | 5.37% | 10.11% | Base rate |
