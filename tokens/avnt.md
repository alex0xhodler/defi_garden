...
The highest honest AVNT yield right now is 45.62% on aerodrome-slipstream (Base), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
45.62% APY on aerodrome-slipstream (Base), based on live DefiLlama data.
