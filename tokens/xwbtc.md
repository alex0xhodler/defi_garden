...
The highest honest XWBTC yield right now is 4.34% on ekubo (Starknet), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
XWBTC shows up in 1 pools here, with rates from 4.34% to 4.34% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| ekubo | 4.34% | 3.49% | 84.24% incentives |
...
4.34% APY on ekubo (Starknet), based on live DefiLlama data.
