...
The highest honest SILOWS yield right now is 10.76% on beets-dex-v3 (Sonic), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
10.76% APY on beets-dex-v3 (Sonic), based on live DefiLlama data.
