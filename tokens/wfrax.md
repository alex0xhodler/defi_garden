...
The highest honest WFRAX yield right now is 29.62% on curve-dex (Fraxtal), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
29.62% APY on curve-dex (Fraxtal), based on live DefiLlama data.
