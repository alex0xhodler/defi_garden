...
MAPOLLO shows up in 2 pools here, with rates from 6.74% to 7.03% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle-v2 | 6.74% | 9.54% | 11.70% incentives |
...
7.03% APY on pendle-v2 (Ethereum), based on live DefiLlama data.
