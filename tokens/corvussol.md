...
The highest honest CORVUSSOL yield right now is 1.04% on project-0 (Solana), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.04% APY on project-0 (Solana), based on live DefiLlama data.
