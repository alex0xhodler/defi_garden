...
TUSD shows up in 4 pools here, with rates from 0.20% to 1.40% APY across 4 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| raydium-amm | 0.95% | 1.26% | Base rate |
| pancakeswap-amm-v3 | 0.20% | 0.04% | Base rate |
| curve-dex | 0.33% | 0.06% | Base rate |
