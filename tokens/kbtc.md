...
The highest honest KBTC yield right now is 7.11% on velodrome-v3 (Ink), among 7 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
KBTC shows up in 3 pools here, with rates from 0.06% to 7.11% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| velodrome-v3 | 7.11% | 8.79% | 100.00% incentives |
| velodrome-v3 | 4.20% | 7.23% | 100.00% incentives |
...
7.11% APY on velodrome-v3 (Ink), based on live DefiLlama data.

### How many KBTC pools clear the TVL floor?

7 live pools clear this page's $100K TVL floor, $397.29M in total.
