...
TRUU shows up in 3 pools here, with rates from 8.30% to 215.89% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 200.87% | 6.60% | Base rate |
...
215.89% APY on uniswap-v4 (Ethereum), based on live DefiLlama data.
