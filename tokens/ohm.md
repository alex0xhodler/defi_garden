...
The highest honest OHM yield right now is 1.61% on uniswap-v3 (Ethereum), among 8 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
OHM shows up in 8 pools here, with rates from 0.02% to 1.61% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
