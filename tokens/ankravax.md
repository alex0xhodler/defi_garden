...
The highest honest ANKRAVAX yield right now is 3.08% on ankr (Avalanche), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
3.08% APY on ankr (Avalanche), based on live DefiLlama data.
