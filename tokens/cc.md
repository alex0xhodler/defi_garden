...
The highest honest CC yield right now is 0.03% on uniswap-v4 (Base), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [uniswap-v4 →](https://www.defi.garden/?pool=4596bc8d-5252-4ffa-9948-1ff245c37f93&src=seo_token) | Base | 0.03% | $198.8K |
...
CC shows up in 1 pools here, with rates from 0.03% to 0.03% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
