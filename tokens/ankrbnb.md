...
ANKRBNB shows up in 1 pools here, with rates from 0.97% to 0.97% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
0.97% APY on ankr (BSC), based on live DefiLlama data.
