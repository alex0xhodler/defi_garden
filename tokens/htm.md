...
The highest honest HTM yield right now is 4.15% on xexchange (MultiversX), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
HTM shows up in 1 pools here, with rates from 4.15% to 4.15% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
4.15% APY on xexchange (MultiversX), based on live DefiLlama data.
