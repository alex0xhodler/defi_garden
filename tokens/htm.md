...
The highest honest HTM yield right now is 7.30% on xexchange (MultiversX), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [xexchange →](https://www.defi.garden/?pool=599d46c8-638e-4759-94b2-bcd2a56cbe54&src=seo_token) | MultiversX | 7.30% | $342.5K |
...
HTM shows up in 1 pools here, with rates from 7.30% to 7.30% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| xexchange | 7.30% | 4.44% | 41.98% incentives |
...
7.30% APY on xexchange (MultiversX), based on live DefiLlama data.

### How many HTM pools clear the TVL floor?

2 live pools clear this page's $100K TVL floor, $938.2K in total.
