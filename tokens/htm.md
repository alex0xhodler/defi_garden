...
The highest honest HTM yield right now is 5.85% on xexchange (MultiversX), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
HTM shows up in 1 pools here, with rates from 5.85% to 5.85% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
5.85% APY on xexchange (MultiversX), based on live DefiLlama data.
