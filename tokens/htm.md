...
The highest honest HTM yield right now is 4.58% on xexchange (MultiversX), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
HTM shows up in 1 pools here, with rates from 4.58% to 4.58% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| xexchange | 4.58% | 4.52% | 66.98% incentives |
...
2 live pools clear this page's $100K TVL floor, $847.7K in total.
