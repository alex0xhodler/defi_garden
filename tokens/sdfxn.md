...
The highest honest SDFXN yield right now is 27.34% on stake-dao (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
27.34% APY on stake-dao (Ethereum), based on live DefiLlama data.
