...
The highest honest SRUSDAT yield right now is 8.99% on strata-markets (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
8.99% APY on strata-markets (Ethereum), based on live DefiLlama data.
