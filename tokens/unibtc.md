...
The highest honest UNIBTC yield right now is 1.16% on symbiotic (Ethereum), among 7 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
UNIBTC shows up in 3 pools here, with rates from 0.16% to 1.16% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| berapaw | 0.38% | 0.33% | 100.00% incentives |
| symbiotic | 1.16% | 1.56% | 100.00% incentives |
...
7 live pools clear this page's $100K TVL floor, $92.63M in total.
