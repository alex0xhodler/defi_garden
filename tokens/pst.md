...
The highest honest PST yield right now is 0.49% on kamino-liquidity (Solana), among 9 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
PST shows up in 2 pools here, with rates from 0.13% to 0.49% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
0.49% APY on kamino-liquidity (Solana), based on live DefiLlama data.
