...
NICP shows up in 2 pools here, with rates from 3.14% to 8.05% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| waterneuron | 8.05% | 8.05% | Base rate |
