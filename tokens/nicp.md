...
NICP shows up in 2 pools here, with rates from 3.14% to 8.03% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
