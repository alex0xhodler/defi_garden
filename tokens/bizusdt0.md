...
The highest honest BIZUSDT0 yield right now is 4.46% on superform (Flare), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4.46% APY on superform (Flare), based on live DefiLlama data.
