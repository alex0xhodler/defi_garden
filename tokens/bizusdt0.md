...
The highest honest BIZUSDT0 yield right now is 5.07% on superform (Flare), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
5.07% APY on superform (Flare), based on live DefiLlama data.
