...
HSOL shows up in 2 pools here, with rates from 0.01% to 5.18% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| helius-staked-sol | 5.18% | 5.15% | Base rate |
...
5.18% APY on helius-staked-sol (Solana), based on live DefiLlama data.
