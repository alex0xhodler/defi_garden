...
The highest honest KODIUSDE yield right now is 8.32% on berapaw (Berachain), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
8.32% APY on berapaw (Berachain), based on live DefiLlama data.
