...
The highest honest HYBR yield right now is 192.70% on hybra-v4 (Hyperliquid L1), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
192.70% APY on hybra-v4 (Hyperliquid L1), based on live DefiLlama data.
