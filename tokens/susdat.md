...
The highest honest SUSDAT yield right now is 18.38% on pendle (Monad), among 14 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
18.38% APY on pendle (Monad), based on live DefiLlama data.
