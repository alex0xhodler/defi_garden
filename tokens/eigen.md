...
EIGEN shows up in 3 pools here, with rates from 2.18% to 4.23% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 3.24% | 4.72% | Base rate |
| curve-dex | 2.18% | 2.68% | Base rate |
| uniswap-v3 | 4.23% | 4.26% | Base rate |
