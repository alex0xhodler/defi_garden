...
The highest honest TSLAX yield right now is 2.76% on raydium-amm (Solana), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
TSLAX shows up in 5 pools here, with rates from 0.15% to 2.76% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

5 of these 5 pools have a trustworthy 30-day average on file, with a median of 8.05% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| raydium-amm | 2.76% | 16.02% | Base rate |
| raydium-amm | 1.97% | 9.66% | Base rate |
| jupiter-lend | 2.02% | 0.76% | Base rate |
| jupiter-lend | 2.02% | 0.76% | Base rate |
| orca-dex | 0.15% | 8.05% | Base rate |
