...
MATIC shows up in 2 pools here, with rates from 1.24% to 17.99% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 17.99% | 23.40% | Base rate |
| uniswap-v3 | 1.24% | 2.71% | Base rate |
...
17.99% APY on uniswap-v2 (Ethereum), based on live DefiLlama data.
