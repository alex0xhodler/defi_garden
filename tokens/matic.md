...
The highest honest MATIC yield right now is 16.90% on uniswap-v2 (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
16.90% APY on uniswap-v2 (Ethereum), based on live DefiLlama data.
