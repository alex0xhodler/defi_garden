...
The highest honest ATXM yield right now is 8.13% on uniswap-v4 (Polygon), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
8.13% APY on uniswap-v4 (Polygon), based on live DefiLlama data.
