...
The highest honest USDT.E yield right now is 11.10% on yuzu-finance (Move), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDT.E shows up in 1 pools here, with rates from 11.10% to 11.10% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
11.10% APY on yuzu-finance (Move), based on live DefiLlama data.
