...
The highest honest SFRXETH yield right now is 4.94% on stake-dao (Fraxtal), among 8 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SFRXETH shows up in 5 pools here, with rates from 2.39% to 4.94% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
