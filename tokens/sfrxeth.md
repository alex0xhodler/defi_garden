...
The highest honest SFRXETH yield right now is 4.44% on stake-dao (Fraxtal), among 8 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4.44% APY on stake-dao (Fraxtal), based on live DefiLlama data.
