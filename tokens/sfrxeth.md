...
SFRXETH shows up in 5 pools here, with rates from 2.57% to 3.41% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| convex-finance | 2.64% | 2.76% | Base rate |
