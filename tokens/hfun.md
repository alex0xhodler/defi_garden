...
The highest honest HFUN yield right now is 4.69% on hyperswap-v2 (Hyperliquid L1), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4.69% APY on hyperswap-v2 (Hyperliquid L1), based on live DefiLlama data.

### How many HFUN pools clear the TVL floor?

1 live pool clear this page's $100K TVL floor, $524.4K in total.
