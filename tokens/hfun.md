...
The highest honest HFUN yield right now is 6.47% on hyperswap-v2 (Hyperliquid L1), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
6.47% APY on hyperswap-v2 (Hyperliquid L1), based on live DefiLlama data.
