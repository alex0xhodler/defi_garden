...
The highest honest ETH0 yield right now is 2.80% on usual-eth0 (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
2.80% APY on usual-eth0 (Ethereum), based on live DefiLlama data.
