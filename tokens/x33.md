...
The highest honest X33 yield right now is 2.30% on shadow-exchange-legacy (Sonic), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
2.30% APY on shadow-exchange-legacy (Sonic), based on live DefiLlama data.
