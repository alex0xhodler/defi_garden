...
The highest honest SOSANA yield right now is 19.79% on raydium-amm (Solana), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
19.79% APY on raydium-amm (Solana), based on live DefiLlama data.
