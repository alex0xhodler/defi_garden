...
The highest honest FXRP yield right now is 18.28% on sparkdex-v4 (Flare), among 11 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
FXRP shows up in 8 pools here, with rates from 1.06% to 18.28% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| kinetic | 1.06% | 1.00% | 90.48% incentives |
...
| sparkdex-v4 | 18.28% | 25.35% | 86.73% incentives |
| sparkdex-v4 | 10.49% | 13.76% | 92.95% incentives |
| sparkdex-v3.1 | 3.78% | 12.05% | Base rate |
...
18.28% APY on sparkdex-v4 (Flare), based on live DefiLlama data.
