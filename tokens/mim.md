...
The highest honest MIM yield right now is 40.56% on convex-finance (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
MIM shows up in 2 pools here, with rates from 15.65% to 40.56% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
