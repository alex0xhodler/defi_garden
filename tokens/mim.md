...
The highest honest MIM yield right now is 34.17% on convex-finance (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
MIM shows up in 2 pools here, with rates from 19.23% to 34.17% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
