...
The highest honest RUSD yield right now is 3.93% on fusion-by-ipor (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
3.93% APY on fusion-by-ipor (Ethereum), based on live DefiLlama data.
