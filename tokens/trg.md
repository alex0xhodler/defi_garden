...
TRG shows up in 2 pools here, with rates from 0.01% to 0.07% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v2 | 0.07% | 0.04% | Base rate |
