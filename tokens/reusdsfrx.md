...
The highest honest REUSDSFRX yield right now is 15.53% on yearn-finance (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
15.53% APY on yearn-finance (Ethereum), based on live DefiLlama data.
