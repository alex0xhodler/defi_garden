...
SW shows up in 2 pools here, with rates from 8.32% to 14.53% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
