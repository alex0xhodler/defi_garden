...
The highest honest SW yield right now is 13.05% on spectra-v2 (Flare), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
13.05% APY on spectra-v2 (Flare), based on live DefiLlama data.
