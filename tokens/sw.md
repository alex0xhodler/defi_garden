...
The highest honest SW yield right now is 14.23% on spectra-v2 (Flare), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SW shows up in 2 pools here, with rates from 7.89% to 14.23% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
