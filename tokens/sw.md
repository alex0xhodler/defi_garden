...
The highest honest SW yield right now is 13.67% on spectra-v2 (Flare), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SW shows up in 2 pools here, with rates from 7.19% to 13.67% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| spectra-v2 | 13.67% | 12.93% | Base rate |
| spectra-v2 | 7.19% | 6.87% | Base rate |
