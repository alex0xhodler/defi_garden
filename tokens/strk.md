...
STRK shows up in 8 pools here, with rates from 0.07% to 54.49% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| ekubo | 54.49% | 81.75% | Base rate |
| ekubo | 47.18% | 62.55% | Base rate |
| ekubo | 5.76% | 11.11% | Base rate |
