...
The highest honest WETH yield right now is 23.60% on uniswap-v3 (Base), among 1,478 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WETH shows up in 8 pools here, with rates from 0.01% to 23.60% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 12.44% | 15.51% | Base rate |
| uniswap-v3 | 10.36% | 21.23% | Base rate |
| euler-v2 | 2.84% | 3.06% | 52.55% incentives |
...
1,478 live pools clear this page's $100K TVL floor, $4.68B in total.
