...
MIN shows up in 2 pools here, with rates from 2.22% to 4.25% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| minswap-dex | 2.22% | 2.32% | Base rate |
