...
The highest honest MIN yield right now is 3.94% on minswap-dex (Cardano), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
MIN shows up in 2 pools here, with rates from 2.26% to 3.94% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
3.94% APY on minswap-dex (Cardano), based on live DefiLlama data.
