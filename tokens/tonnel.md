...
The highest honest TONNEL yield right now is 0.55% on dedust (TON), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
TONNEL shows up in 2 pools here, with rates from 0.36% to 0.55% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
