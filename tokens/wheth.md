...
The highest honest WHETH yield right now is 17.40% on orca-dex (Solana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WHETH shows up in 3 pools here, with rates from 7.38% to 17.40% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
17.40% APY on orca-dex (Solana), based on live DefiLlama data.
