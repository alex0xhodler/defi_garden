...
The highest honest SAVUSD yield right now is 8.74% on avant-avusd (Avalanche), among 8 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SAVUSD shows up in 2 pools here, with rates from 5.00% to 8.74% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| avant-avusd | 8.74% | 9.30% | Base rate |
