...
The highest honest STUSDC yield right now is 1.88% on concrete (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.88% APY on concrete (Ethereum), based on live DefiLlama data.
