...
1 of these 1 pool has a trustworthy 30-day average on file, with a median of 37.09% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| uniswap-v4 | 40.78% | 37.09% | Base rate |
