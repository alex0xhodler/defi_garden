...
BYTE shows up in 2 pools here, with rates from 3.31% to 3.80% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 3.31% | 2.11% | Base rate |
| uniswap-v3 | 3.80% | 20.18% | Base rate |
