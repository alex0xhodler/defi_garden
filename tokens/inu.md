...
The highest honest INU yield right now is 0.89% on uniswap-v2 (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
INU shows up in 1 pools here, with rates from 0.89% to 0.89% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 0.89% | 0.09% | Base rate |
