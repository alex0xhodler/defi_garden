...
The highest honest SNRUSD yield right now is 18.04% on berapaw (Berachain), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
18.04% APY on berapaw (Berachain), based on live DefiLlama data.
