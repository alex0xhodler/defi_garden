...
The highest honest BAL yield right now is 0.23% on balancer-v2 (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
0.23% APY on balancer-v2 (Ethereum), based on live DefiLlama data.
