...
BAL shows up in 2 pools here, with rates from 0.56% to 3.32% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| balancer-v2 | 0.56% | 1.09% | Base rate |
| balancer-v2 | 3.32% | 4.63% | Base rate |
...
3.32% APY on balancer-v2 (Polygon), based on live DefiLlama data.
