...
The highest honest LINK.E yield right now is 2.68% on benqi-lending (Avalanche), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
2.68% APY on benqi-lending (Avalanche), based on live DefiLlama data.
