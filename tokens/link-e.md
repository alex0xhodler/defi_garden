...
LINK.E shows up in 2 pools here, with rates from 0.02% to 16.66% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 16.66% | 5.40% | Base rate |
