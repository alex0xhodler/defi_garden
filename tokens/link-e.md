...
LINK.E shows up in 2 pools here, with rates from 0.02% to 431.05% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 431.05% | 23.91% | Base rate |
