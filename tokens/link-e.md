...
The highest honest LINK.E yield right now is 4.98% on uniswap-v3 (Avalanche), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4.98% APY on uniswap-v3 (Avalanche), based on live DefiLlama data.
