...
The highest honest USD1 yield right now is 10.73% on raydium-amm (Solana), among 22 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USD1 shows up in 8 pools here, with rates from 0.24% to 10.73% APY across 5 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| dolomite | 1.58% | 7.49% | Base rate |
| curve-dex | 0.24% | 0.28% | Base rate |
| raydium-amm | 0.87% | 0.52% | Base rate |
| bitway-earn | 8.00% | 8.00% | Base rate |
| raydium-amm | 10.73% | 12.92% | Base rate |
...
10.73% APY on raydium-amm (Solana), based on live DefiLlama data.

### How many USD1 pools clear the TVL floor?

22 live pools clear this page's $100K TVL floor, $307.29M in total.
