...
The highest honest PEPE yield right now is 2.02% on uniswap-v2 (Ethereum), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
PEPE shows up in 6 pools here, with rates from 0.18% to 5.97% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 2.02% | 2.92% | Base rate |
| raydium-amm | 0.55% | 0.30% | Base rate |
| uniswap-v3 | 0.18% | 5.78% | Base rate |
| uniswap-v3 | 5.97% | 2.55% | Base rate |
| uniswap-v4 | 1.95% | 7.28% | Base rate |
| raydium-amm | 2.98% | 1.84% | Base rate |
...
6 live pools clear this page's $100K TVL floor, $25.42M in total.
