...
ANKRETH shows up in 2 pools here, with rates from 1.18% to 2.55% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
