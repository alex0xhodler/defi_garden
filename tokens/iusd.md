...
IUSD shows up in 3 pools here, with rates from 2.73% to 14.51% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| echelon-market | 2.73% | 1.88% | 18.32% incentives |
| liqwid | 3.52% | 3.84% | Base rate |
| minswap-dex | 14.51% | 15.20% | 22.54% incentives |
