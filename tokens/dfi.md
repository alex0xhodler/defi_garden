...
DFI shows up in 1 pools here, with rates from 0.27% to 0.27% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| defichain-dex | 0.27% | 0.59% | Base rate |
