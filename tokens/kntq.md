...
The highest honest KNTQ yield right now is 70.42% on nest-cl (Hyperliquid L1), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
KNTQ shows up in 4 pools here, with rates from 28.18% to 270.49% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

4 of these 4 pools have a trustworthy 30-day average on file, with a median of 31.52% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| nest-cl | 70.42% | 52.12% | 100.00% incentives |
| project-x | 55.59% | 8.45% | Base rate |
| project-x | 28.18% | 10.92% | Base rate |
| nest-cl | 270.49% | 83.41% | 100.00% incentives |
...
70.42% APY on nest-cl (Hyperliquid L1), based on live DefiLlama data.

### How many KNTQ pools clear the TVL floor?

4 live pools clear this page's $100K TVL floor, $787.7K in total.
