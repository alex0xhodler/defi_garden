...
The highest honest KNTQ yield right now is 38.87% on nest-cl (Hyperliquid L1), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [nest-cl →](https://www.defi.garden/?pool=ece296cb-762f-4926-91f3-0940cb6e1f69&src=seo_token) | Hyperliquid L1 | 38.87% | $231.7K |
...
KNTQ shows up in 3 pools here, with rates from 0.37% to 38.87% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| nest-cl | 38.87% | 54.29% | 100.00% incentives |
| project-x | 3.42% | 7.39% | Base rate |
...
38.87% APY on nest-cl (Hyperliquid L1), based on live DefiLlama data.
