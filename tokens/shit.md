...
SHIT shows up in 2 pools here, with rates from 1.17% to 5.91% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 1.17% | 3.23% | Base rate |
| raydium-amm | 5.91% | 2.69% | Base rate |
...
3 live pools clear this page's $100K TVL floor, $707.1K in total.
