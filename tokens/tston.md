...
The highest honest TSTON yield right now is 36.40% on tonco (TON), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
TSTON shows up in 5 pools here, with rates from 2.09% to 36.40% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| tonco | 36.40% | 42.15% | Base rate |
| affluent | 14.48% | 13.15% | Base rate |
| ston.fi | 3.73% | 3.08% | Base rate |
| affluent | 2.97% | 2.71% | Base rate |
| ston.fi | 2.09% | 3.36% | Base rate |
...
36.40% APY on tonco (TON), based on live DefiLlama data.
