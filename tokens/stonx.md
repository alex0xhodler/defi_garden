...
The highest honest STONX yield right now is 21.70% on ekubo (Robinhood Chain), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
21.70% APY on ekubo (Robinhood Chain), based on live DefiLlama data.
