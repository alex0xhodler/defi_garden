...
The highest honest STONX yield right now is 7.89% on ekubo (Robinhood Chain), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
STONX shows up in 1 pools here, with rates from 7.89% to 7.89% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| ekubo | 7.89% | 14.70% | 100.00% incentives |
...
7.89% APY on ekubo (Robinhood Chain), based on live DefiLlama data.
