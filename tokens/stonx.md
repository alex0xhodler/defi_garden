...
The highest honest STONX yield right now is 13.58% on ekubo (Robinhood Chain), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
STONX shows up in 1 pools here, with rates from 13.58% to 13.58% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| ekubo | 13.58% | 11.96% | 100.00% incentives |
...
13.58% APY on ekubo (Robinhood Chain), based on live DefiLlama data.
