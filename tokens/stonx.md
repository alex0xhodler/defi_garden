...
The highest honest STONX yield right now is 8.71% on ekubo (Robinhood Chain), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
STONX shows up in 1 pools here, with rates from 8.71% to 8.71% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| ekubo | 8.71% | 12.99% | 100.00% incentives |
...
8.71% APY on ekubo (Robinhood Chain), based on live DefiLlama data.
