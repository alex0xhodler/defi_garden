...
The highest honest STONX yield right now is 6.43% on ekubo (Robinhood Chain), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
STONX shows up in 1 pools here, with rates from 6.43% to 6.43% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| ekubo | 6.43% | 14.11% | 100.00% incentives |
...
6.43% APY on ekubo (Robinhood Chain), based on live DefiLlama data.
