...
The highest honest STONX yield right now is 18.78% on ekubo (Robinhood Chain), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
STONX shows up in 1 pools here, with rates from 18.78% to 18.78% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| ekubo | 18.78% | 13.91% | 100.00% incentives |
...
18.78% APY on ekubo (Robinhood Chain), based on live DefiLlama data.
