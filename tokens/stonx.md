...
The highest honest STONX yield right now is 16.60% on ekubo (Robinhood Chain), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
16.60% APY on ekubo (Robinhood Chain), based on live DefiLlama data.
