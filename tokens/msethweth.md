...
The highest honest MSETHWETH yield right now is 4.97% on yearn-finance (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4.97% APY on yearn-finance (Ethereum), based on live DefiLlama data.
