...
BUCK shows up in 4 pools here, with rates from 0.22% to 7.90% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| cetus-clmm | 0.26% | 0.18% | Base rate |
| raydium-amm | 0.90% | 2.58% | Base rate |
| cetus-clmm | 7.90% | 4.96% | Base rate |
