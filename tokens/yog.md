...
YOG shows up in 3 pools here, with rates from 1.68% to 6.54% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| morpho-blue | 1.68% | 1.92% | 10.21% incentives |
| morpho-blue | 6.54% | 6.89% | 11.17% incentives |
| morpho-blue | 5.11% | 5.22% | Base rate |
