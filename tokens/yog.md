...
YOG shows up in 3 pools here, with rates from 6.08% to 7.24% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| morpho-blue | 7.24% | 2.92% | 8.69% incentives |
| morpho-blue | 6.08% | 7.20% | 21.12% incentives |
