...
The highest honest FIDD yield right now is 0.19% on curve-dex (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
FIDD shows up in 2 pools here, with rates from 0.01% to 0.19% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
