...
The highest honest USDCX yield right now is 92.84% on minswap-dex (Cardano), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDCX shows up in 3 pools here, with rates from 8.05% to 92.84% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| yuzu-finance | 11.72% | 9.24% | 97.08% incentives |
| minswap-dex | 92.84% | 90.17% | 1.91% incentives |
| minswap-dex | 8.05% | 20.84% | 33.04% incentives |
