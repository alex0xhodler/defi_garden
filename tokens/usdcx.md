...
<<<<<<< HEAD
The highest honest USDCX yield right now is 93.59% on minswap-dex (Cardano), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
=======
The highest honest USDCX yield right now is 95.65% on minswap-dex (Cardano), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
<<<<<<< HEAD
93.59% APY on minswap-dex (Cardano), based on live DefiLlama data.
=======
95.65% APY on minswap-dex (Cardano), based on live DefiLlama data.
>>>>>>> origin/main
