...
The highest honest SOLVBTC yield right now is 13.81% on ekubo (Starknet), among 14 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
13.81% APY on ekubo (Starknet), based on live DefiLlama data.
