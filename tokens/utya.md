...
The highest honest UTYA yield right now is 19.93% on ston.fi (TON), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
UTYA shows up in 2 pools here, with rates from 8.39% to 19.93% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
19.93% APY on ston.fi (TON), based on live DefiLlama data.
