...
The highest honest VBUSDT yield right now is 2.93% on morpho-blue (Katana), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
VBUSDT shows up in 2 pools here, with rates from 1.97% to 2.93% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| yearn-finance | 1.97% | 4.09% | 8.55% incentives |
...
2.93% APY on morpho-blue (Katana), based on live DefiLlama data.
