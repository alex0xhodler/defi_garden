...
The highest honest VBUSDT yield right now is 2.81% on morpho-blue (Katana), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
VBUSDT shows up in 2 pools here, with rates from 2.00% to 2.81% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
