...
The highest honest ETHFI yield right now is 26.70% on uniswap-v4 (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
ETHFI shows up in 3 pools here, with rates from 26.70% to 205.26% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.

3 of these 3 pools have a trustworthy 30-day average on file, with a median of 26.75% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| uniswap-v4 | 205.26% | 52.12% | Base rate |
| uniswap-v4 | 26.70% | 26.75% | Base rate |
| uniswap-v4 | 78.18% | 17.91% | Base rate |
...
26.70% APY on uniswap-v4 (Ethereum), based on live DefiLlama data.
