...
SHX shows up in 2 pools here, with rates from 8.10% to 13.45% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 8.10% | 4.33% | Base rate |
| uniswap-v4 | 13.45% | 8.69% | Base rate |
