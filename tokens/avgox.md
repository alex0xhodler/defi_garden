...
The highest honest AVGOX yield right now is 22.33% on raydium-amm (Solana), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
22.33% APY on raydium-amm (Solana), based on live DefiLlama data.
