...
The highest honest ARM yield right now is 13.16% on origin-arm (Ethereum), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
ARM shows up in 6 pools here, with rates from 1.55% to 13.16% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| origin-arm | 4.63% | 4.75% | 32.16% incentives |
| origin-arm | 2.28% | 2.26% | Base rate |
| origin-arm | 8.63% | 8.31% | 23.17% incentives |
| origin-arm | 1.55% | 1.55% | Base rate |
| origin-arm | 13.16% | 13.16% | Base rate |
| curve-dex | 3.22% | 2.30% | 41.87% incentives |
...
13.16% APY on origin-arm (Ethereum), based on live DefiLlama data.
