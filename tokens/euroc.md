...
EUROC shows up in 2 pools here, with rates from 0.35% to 7.43% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 0.35% | 0.33% | Base rate |
| uniswap-v3 | 7.43% | 4.73% | Base rate |
