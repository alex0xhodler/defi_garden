...
NVDAX shows up in 4 pools here, with rates from 0.02% to 78.56% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

4 of these 4 pools have a trustworthy 30-day average on file, with a median of 13.13% — a useful check against today's number for whether the rate is steady or just having a good day.
...
| raydium-amm | 55.99% | 13.70% | Base rate |
| raydium-amm | 14.43% | 18.76% | Base rate |
| orca-dex | 78.56% | 12.56% | Base rate |
