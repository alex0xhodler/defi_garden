...
The highest honest DEXT yield right now is 17.13% on uniswap-v2 (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
17.13% APY on uniswap-v2 (Ethereum), based on live DefiLlama data.
