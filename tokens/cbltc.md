...
The highest honest CBLTC yield right now is 11.84% on aerodrome-slipstream (Base), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
CBLTC shows up in 1 pools here, with rates from 11.84% to 11.84% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| aerodrome-slipstream | 11.84% | 23.35% | 87.02% incentives |
...
11.84% APY on aerodrome-slipstream (Base), based on live DefiLlama data.
