...
The highest honest MONERO yield right now is 0.17% on raydium-amm (Solana), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
MONERO shows up in 4 pools here, with rates from 0.05% to 0.17% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
