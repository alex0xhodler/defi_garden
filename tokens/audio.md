...
The highest honest AUDIO yield right now is 0.83% on raydium-amm (Solana), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
AUDIO shows up in 2 pools here, with rates from 0.69% to 0.83% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 0.69% | 3.66% | Base rate |
| raydium-amm | 0.83% | 3.61% | Base rate |
...
2 live pools clear this page's $100K TVL floor, $632.2K in total.
