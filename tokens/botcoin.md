...
BOTCOIN shows up in 2 pools here, with rates from 0.01% to 0.70% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 0.70% | 13.05% | Base rate |
