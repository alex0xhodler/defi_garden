...
The highest honest DIEM yield right now is 18.67% on uniswap-v3 (Base), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
| [aerodrome-slipstream →](https://www.defi.garden/?pool=7944b313-e6ee-42b2-a5c8-a26446e37621&src=seo_token) | Base | 36.25% | $328K |
...
DIEM shows up in 4 pools here, with rates from 4.05% to 36.25% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

4 of these 4 pools have a trustworthy 30-day average on file, with a median of 29.55% — a useful check against today's number for whether the rate is steady or just having a good day.
...
| aerodrome-slipstream | 36.25% | 128.20% | 87.82% incentives |
...
18.67% APY on uniswap-v3 (Base), based on live DefiLlama data.
