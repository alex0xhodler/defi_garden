...
The highest honest RE7HONEY yield right now is 8.56% on berapaw (Berachain), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
8.56% APY on berapaw (Berachain), based on live DefiLlama data.
