...
NAVX shows up in 2 pools here, with rates from 0.01% to 20.55% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| cetus-clmm | 20.55% | 11.23% | Base rate |
