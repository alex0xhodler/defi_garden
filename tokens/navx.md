...
NAVX shows up in 2 pools here, with rates from 0.01% to 93.54% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| cetus-clmm | 93.54% | 20.01% | Base rate |
