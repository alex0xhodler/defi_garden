...
The highest honest NAVX yield right now is 12.83% on cetus-clmm (Sui), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
NAVX shows up in 2 pools here, with rates from 0.01% to 12.83% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| cetus-clmm | 12.83% | 13.17% | Base rate |
...
12.83% APY on cetus-clmm (Sui), based on live DefiLlama data.
