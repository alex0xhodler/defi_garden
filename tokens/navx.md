...
NAVX shows up in 2 pools here, with rates from 0.01% to 3.91% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| cetus-clmm | 3.91% | 11.22% | Base rate |
