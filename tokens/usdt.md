...
The highest honest USDT yield right now is 16.86% on maple (Ethereum), among 416 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
16.86% APY on maple (Ethereum), based on live DefiLlama data.
