...
The highest honest EVA yield right now is 28.33% on uniswap-v3 (Arbitrum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
EVA shows up in 2 pools here, with rates from 9.88% to 28.33% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 28.33% | 4.49% | Base rate |
| uniswap-v4 | 9.88% | 6.02% | Base rate |
...
28.33% APY on uniswap-v3 (Arbitrum), based on live DefiLlama data.
