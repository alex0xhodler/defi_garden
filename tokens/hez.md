...
HEZ shows up in 3 pools here, with rates from 0.07% to 0.28% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v2 | 0.28% | 0.84% | Base rate |
| uniswap-v2 | 0.10% | 0.21% | Base rate |
