...
The highest honest PUFETH yield right now is 6.93% on curve-dex (Ethereum), among 8 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
PUFETH shows up in 7 pools here, with rates from 0.03% to 6.93% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
8 live pools clear this page's $100K TVL floor, $64.97M in total.
