...
SAVAX shows up in 2 pools here, with rates from 2.58% to 3.53% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| benqi-staked-avax | 3.53% | 4.74% | Base rate |
...
8 live pools clear this page's $100K TVL floor, $316.4M in total.
