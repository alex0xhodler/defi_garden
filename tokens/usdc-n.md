...
The highest honest USDC.N yield right now is 0.16% on osmosis-dex (Osmosis), among 7 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDC.N shows up in 1 pools here, with rates from 0.16% to 0.16% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
