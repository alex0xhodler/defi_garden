...
The highest honest USDC.N yield right now is 0.57% on osmosis-dex (Osmosis), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDC.N shows up in 1 pools here, with rates from 0.57% to 0.57% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
