...
The highest honest PYUSD yield right now is 6.53% on sentora (Solana), among 25 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
PYUSD shows up in 8 pools here, with rates from 0.07% to 6.53% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| sentora | 6.53% | 6.95% | 47.99% incentives |
| sparklend | 0.84% | 0.41% | Base rate |
| curve-dex | 4.76% | 5.53% | 98.53% incentives |
| kamino-lend | 2.77% | 2.29% | Base rate |
| orca-dex | 0.13% | 0.69% | Base rate |
| convex-finance | 0.07% | 0.26% | 0.26% incentives |
| euler-v2 | 5.43% | 5.67% | 54.26% incentives |
| kamino-lend | 2.96% | 3.35% | Base rate |
...
6.53% APY on sentora (Solana), based on live DefiLlama data.

### How many PYUSD pools clear the TVL floor?

25 live pools clear this page's $100K TVL floor, $340.41M in total.
