...
The highest honest PYUSD yield right now is 6.56% on sentora (Solana), among 25 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
PYUSD shows up in 8 pools here, with rates from 0.06% to 6.56% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| sentora | 6.56% | 6.95% | 47.72% incentives |
| sparklend | 0.84% | 0.41% | Base rate |
| curve-dex | 4.75% | 5.53% | 98.74% incentives |
| orca-dex | 1.36% | 0.19% | Base rate |
...
6.56% APY on sentora (Solana), based on live DefiLlama data.

### How many PYUSD pools clear the TVL floor?

25 live pools clear this page's $100K TVL floor, $340.25M in total.
