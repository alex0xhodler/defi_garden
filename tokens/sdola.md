...
The highest honest SDOLA yield right now is 11.15% on curve-dex (Ethereum), among 17 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SDOLA shows up in 8 pools here, with rates from 2.88% to 14.43% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| curve-dex | 6.63% | 7.29% | 14.66% incentives |
| stake-dao | 6.61% | 7.59% | 16.77% incentives |
| curve-dex | 11.15% | 9.81% | 81.52% incentives |
| curve-dex | 2.88% | 2.84% | 61.09% incentives |
| stake-dao | 14.43% | 35.36% | 83.44% incentives |
...
11.15% APY on curve-dex (Ethereum), based on live DefiLlama data.

### How many SDOLA pools clear the TVL floor?

17 live pools clear this page's $100K TVL floor, $23.28M in total.
