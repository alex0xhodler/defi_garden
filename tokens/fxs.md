...
FXS shows up in 3 pools here, with rates from 0.08% to 3.57% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| frax | 0.17% | 2.22% | Base rate |
| frax | 3.57% | 4.26% | Base rate |
