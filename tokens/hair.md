...
HAIR shows up in 2 pools here, with rates from 0.11% to 0.49% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 0.49% | 3.16% | Base rate |
| uniswap-v3 | 0.11% | 0.47% | Base rate |
