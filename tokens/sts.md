...
The highest honest STS yield right now is 53.07% on beets-dex (Sonic), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
STS shows up in 3 pools here, with rates from 0.70% to 53.07% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
