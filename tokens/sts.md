...
The highest honest STS yield right now is 52.80% on beets-dex (Sonic), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [beets-dex →](https://www.defi.garden/?pool=f06686d4-25aa-4600-8910-87844cf3b1c3&src=seo_token) | Sonic | 52.80% | $201.9K |
...
STS shows up in 3 pools here, with rates from 0.70% to 52.80% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| beets-dex | 52.80% | 59.10% | 97.88% incentives |
...
52.80% APY on beets-dex (Sonic), based on live DefiLlama data.
