...
STS shows up in 3 pools here, with rates from 0.91% to 30.71% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
