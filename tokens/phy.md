...
The highest honest PHY yield right now is 0.46% on orca-dex (Solana), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
PHY shows up in 2 pools here, with rates from 0.01% to 0.46% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| orca-dex | 0.01% | 1.23% | Base rate |
| orca-dex | 0.46% | 0.10% | Base rate |
