...
The highest honest NLCRD yield right now is 17.21% on nest-credit (Plume Mainnet), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
17.21% APY on nest-credit (Plume Mainnet), based on live DefiLlama data.
