...
The highest honest JRROYAA yield right now is 17.03% on royco-v2 (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
17.03% APY on royco-v2 (Ethereum), based on live DefiLlama data.
