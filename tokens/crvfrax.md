...
CRVFRAX shows up in 2 pools here, with rates from 0.02% to 25.81% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
