...
The highest honest AVAX yield right now is 0.35% on folks-finance-xchain (Avalanche), among 7 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
0.35% APY on folks-finance-xchain (Avalanche), based on live DefiLlama data.
