...
The highest honest GRAIL yield right now is 1.19% on camelot-v3 (Arbitrum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.19% APY on camelot-v3 (Arbitrum), based on live DefiLlama data.
