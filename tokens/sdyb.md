...
The highest honest SDYB yield right now is 21.80% on stake-dao (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SDYB shows up in 4 pools here, with rates from 5.05% to 21.80% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| stake-dao | 5.05% | 11.65% | 100.00% incentives |
...
21.80% APY on stake-dao (Ethereum), based on live DefiLlama data.

### How many SDYB pools clear the TVL floor?

4 live pools clear this page's $100K TVL floor, $872.2K in total.
