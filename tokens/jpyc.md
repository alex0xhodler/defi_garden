...
The highest honest JPYC yield right now is 7.40% on uniswap-v4 (Polygon), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
7.40% APY on uniswap-v4 (Polygon), based on live DefiLlama data.
