...
3 of these 3 pools have a trustworthy 30-day average on file, with a median of 65.61% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| uniswap-v4 | 29.39% | 65.61% | Base rate |
| uniswap-v4 | 0.01% | 0.01% | Base rate |
| native-credit-pool | 126.17% | 118.20% | Base rate |
