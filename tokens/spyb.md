...
3 of these 3 pools have a trustworthy 30-day average on file, with a median of 74.47% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| uniswap-v4 | 42.74% | 74.47% | Base rate |
| uniswap-v4 | 0.01% | 0.01% | Base rate |
| native-credit-pool | 126.17% | 117.93% | Base rate |
