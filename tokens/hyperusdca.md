...
The highest honest HYPERUSDCA yield right now is 8.03% on morpho-blue (Monad), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
HYPERUSDCA shows up in 4 pools here, with rates from 3.11% to 8.03% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
4 live pools clear this page's $100K TVL floor, $53.9M in total.
