...
The highest honest COINX yield right now is 68.68% on raydium-amm (Solana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
COINX shows up in 3 pools here, with rates from 29.12% to 68.68% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 37.98% | 63.82% | Base rate |
| raydium-amm | 68.68% | 59.23% | Base rate |
| raydium-amm | 29.12% | 50.97% | Base rate |
...
68.68% APY on raydium-amm (Solana), based on live DefiLlama data.
