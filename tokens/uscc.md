...
The highest honest USCC yield right now is 4.15% on bitwise-uscc (Ethereum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USCC shows up in 3 pools here, with rates from 4.15% to 4.15% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| bitwise-uscc | 4.15% | 2.98% | Base rate |
| bitwise-uscc | 4.15% | 2.98% | Base rate |
| bitwise-uscc | 4.15% | 2.98% | Base rate |
...
4.15% APY on bitwise-uscc (Ethereum), based on live DefiLlama data.
