...
SUPER shows up in 3 pools here, with rates from 9.99% to 24.25% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 11.59% | 8.01% | Base rate |
| blackhole-amm | 24.25% | 18.81% | 40.89% incentives |
| blackhole-amm | 9.99% | 10.06% | 67.86% incentives |
...
24.25% APY on blackhole-amm (Avalanche), based on live DefiLlama data.
