...
The highest honest XLM yield right now is 1.84% on vvs-standard (Cronos), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
XLM shows up in 3 pools here, with rates from 0.06% to 1.84% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| blend-pools-v2 | 0.51% | 0.51% | 73.40% incentives |
| vvs-standard | 1.84% | 2.08% | Base rate |
...
1.84% APY on vvs-standard (Cronos), based on live DefiLlama data.

### How many XLM pools clear the TVL floor?

3 live pools clear this page's $100K TVL floor, $123.91M in total.
