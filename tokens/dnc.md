...
The highest honest DNC yield right now is 0.11% on pancakeswap-amm (Arbitrum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
0.11% APY on pancakeswap-amm (Arbitrum), based on live DefiLlama data.
