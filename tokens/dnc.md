...
The highest honest DNC yield right now is 0.08% on pancakeswap-amm (Arbitrum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
0.08% APY on pancakeswap-amm (Arbitrum), based on live DefiLlama data.
