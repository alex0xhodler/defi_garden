...
The highest honest BADGER yield right now is 0.25% on uniswap-v3 (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
BADGER shows up in 1 pools here, with rates from 0.25% to 0.25% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 0.25% | 0.13% | Base rate |
