...
The highest honest VNO yield right now is 219.88% on vvs-standard (Cronos), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
219.88% APY on vvs-standard (Cronos), based on live DefiLlama data.
