...
The highest honest BEAM yield right now is 1.70% on uniswap-v2 (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
BEAM shows up in 2 pools here, with rates from 1.70% to 3.22% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 1.70% | 2.94% | Base rate |
| uniswap-v4 | 3.22% | 7.15% | Base rate |
