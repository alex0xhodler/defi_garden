...
BEAM shows up in 2 pools here, with rates from 10.91% to 18.07% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 10.91% | 7.59% | Base rate |
| uniswap-v4 | 18.07% | 15.72% | Base rate |
