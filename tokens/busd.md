...
BUSD shows up in 8 pools here, with rates from 0.02% to 0.40% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| pancakeswap-amm | 0.40% | 1.14% | Base rate |
