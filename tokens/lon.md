...
The highest honest LON yield right now is 0.39% on sushiswap (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
LON shows up in 3 pools here, with rates from 0.13% to 0.39% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 0.16% | 0.37% | Base rate |
| uniswap-v3 | 0.13% | 0.08% | Base rate |
| sushiswap | 0.39% | 0.81% | Base rate |
...
0.39% APY on sushiswap (Ethereum), based on live DefiLlama data.
