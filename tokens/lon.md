...
|---|---|---|---|
| [uniswap-v2 →](https://www.defi.garden/?pool=180bedce-a7e9-42fb-9d0d-b181e975a0d7&src=seo_token) | Ethereum | 0.09% | $1.72M |
...
LON shows up in 1 pools here, with rates from 0.09% to 0.09% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 0.09% | 0.60% | Base rate |
