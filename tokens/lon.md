...
LON shows up in 3 pools here, with rates from 0.19% to 1.93% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 0.19% | 0.51% | Base rate |
| uniswap-v3 | 0.56% | 0.19% | Base rate |
| sushiswap | 1.93% | 1.24% | Base rate |
