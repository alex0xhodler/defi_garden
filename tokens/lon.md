...
LON shows up in 3 pools here, with rates from 0.02% to 0.27% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 0.02% | 0.27% | Base rate |
| uniswap-v3 | 0.06% | 0.07% | Base rate |
| sushiswap | 0.27% | 0.84% | Base rate |
