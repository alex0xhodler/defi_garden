...
The highest honest LON yield right now is 1.35% on sushiswap (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [sushiswap →](https://www.defi.garden/?pool=53327beb-9e23-46f3-ad6e-9be0eb7e3338&src=seo_token) | Ethereum | 1.35% | $141.3K |
...
LON shows up in 1 pools here, with rates from 1.35% to 1.35% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
1.35% APY on sushiswap (Ethereum), based on live DefiLlama data.
