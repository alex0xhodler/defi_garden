...
The highest honest PLASMAUSD yield right now is 3.51% on veda (Plasma), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
3.51% APY on veda (Plasma), based on live DefiLlama data.
