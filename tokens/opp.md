...
The highest honest OPP yield right now is 77.79% on velodrome-v2 (OP Mainnet), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
77.79% APY on velodrome-v2 (OP Mainnet), based on live DefiLlama data.
