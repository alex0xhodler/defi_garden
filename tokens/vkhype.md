...
VKHYPE shows up in 3 pools here, with rates from 0.85% to 3.12% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle | 3.12% | 3.22% | Base rate |
| pendle | 2.95% | 3.07% | Base rate |
| project-x | 0.85% | 0.13% | Base rate |
