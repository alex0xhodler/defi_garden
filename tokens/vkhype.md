...
The highest honest VKHYPE yield right now is 3.12% on pendle (Hyperliquid L1), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
VKHYPE shows up in 3 pools here, with rates from 0.12% to 3.12% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle | 3.12% | 3.23% | Base rate |
| pendle | 2.95% | 3.07% | Base rate |
...
3.12% APY on pendle (Hyperliquid L1), based on live DefiLlama data.
