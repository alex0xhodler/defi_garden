...
The highest honest AUDF yield right now is 16.64% on curve-dex (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
16.64% APY on curve-dex (Ethereum), based on live DefiLlama data.
