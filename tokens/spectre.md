...
The highest honest SPECTRE yield right now is 5.49% on uniswap-v2 (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
5.49% APY on uniswap-v2 (Ethereum), based on live DefiLlama data.
