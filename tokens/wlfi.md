...
WLFI shows up in 4 pools here, with rates from 0.01% to 1.16% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 1.16% | 4.34% | Base rate |
| uniswap-v3 | 1.05% | 2.98% | Base rate |
...
7 live pools clear this page's $100K TVL floor, $275.12M in total.
