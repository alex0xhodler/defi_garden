...
SNUSD shows up in 2 pools here, with rates from 6.25% to 9.51% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle | 6.25% | 6.37% | 5.20% incentives |
| pendle | 9.51% | 9.30% | Base rate |
