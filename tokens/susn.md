...
SUSN shows up in 4 pools here, with rates from 2.87% to 9.87% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| bluefin-spot | 9.87% | 11.17% | 96.27% incentives |
| ekubo | 2.87% | 0.68% | Base rate |
...
9.87% APY on bluefin-spot (Sui), based on live DefiLlama data.
