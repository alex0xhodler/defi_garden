...
SUSN shows up in 3 pools here, with rates from 0.08% to 8.22% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle | 8.22% | 8.57% | Base rate |
| pendle | 7.67% | 7.92% | Base rate |
