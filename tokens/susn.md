...
SUSN shows up in 3 pools here, with rates from 0.12% to 8.22% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle | 8.22% | 8.49% | Base rate |
| pendle | 7.48% | 7.97% | Base rate |
