...
SUSN shows up in 3 pools here, with rates from 0.03% to 8.22% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle | 7.62% | 7.91% | Base rate |
| pendle | 8.22% | 8.56% | Base rate |
