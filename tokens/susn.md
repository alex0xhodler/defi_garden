...
SUSN shows up in 3 pools here, with rates from 0.05% to 8.22% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle | 8.22% | 8.54% | Base rate |
| pendle | 7.67% | 7.89% | Base rate |
