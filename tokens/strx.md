...
STRX shows up in 1 pools here, with rates from 1.24% to 1.24% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 1.24% | 0.98% | Base rate |
...
2 live pools clear this page's $100K TVL floor, $780.25M in total.
