...
WNXM shows up in 3 pools here, with rates from 0.01% to 0.61% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 0.61% | 5.48% | Base rate |
