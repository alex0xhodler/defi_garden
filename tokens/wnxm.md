...
WNXM shows up in 3 pools here, with rates from 0.01% to 2.36% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 2.36% | 5.58% | Base rate |
| bancor-v3 | 0.01% | 0.01% | Base rate |
| uniswap-v2 | 0.03% | 0.46% | Base rate |
