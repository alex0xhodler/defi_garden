...
The highest honest WNXM yield right now is 0.13% on uniswap-v2 (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
|---|---|---|---|
| uniswap-v3 | 0.87% | 5.61% | Base rate |
| bancor-v3 | 0.01% | 0.01% | Base rate |
| uniswap-v2 | 0.13% | 0.46% | Base rate |
