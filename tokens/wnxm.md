...
WNXM shows up in 3 pools here, with rates from 0.01% to 0.74% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 0.74% | 6.86% | Base rate |
| bancor-v3 | 0.01% | 0.01% | Base rate |
| uniswap-v2 | 0.08% | 0.48% | Base rate |
