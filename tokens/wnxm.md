...
The highest honest WNXM yield right now is 0.58% on uniswap-v2 (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WNXM shows up in 3 pools here, with rates from 0.01% to 0.86% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 0.86% | 5.62% | Base rate |
| bancor-v3 | 0.01% | 0.01% | Base rate |
| uniswap-v2 | 0.58% | 0.46% | Base rate |
