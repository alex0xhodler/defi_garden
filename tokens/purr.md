...
The highest honest PURR yield right now is 10.79% on project-x (Hyperliquid L1), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
10.79% APY on project-x (Hyperliquid L1), based on live DefiLlama data.
