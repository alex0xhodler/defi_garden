...
The highest honest ALARSAIL.R yield right now is 17.96% on berapaw (Berachain), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
17.96% APY on berapaw (Berachain), based on live DefiLlama data.
