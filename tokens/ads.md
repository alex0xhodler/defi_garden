...
The highest honest ADS yield right now is 5.94% on uniswap-v3 (Base), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
ADS shows up in 3 pools here, with rates from 0.11% to 5.94% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 0.12% | 28.38% | Base rate |
| uniswap-v4 | 0.11% | 0.13% | Base rate |
| uniswap-v3 | 5.94% | 5.50% | Base rate |
