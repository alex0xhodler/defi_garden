...
The highest honest ADS yield right now is 4.67% on uniswap-v3 (Base), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
ADS shows up in 4 pools here, with rates from 0.04% to 4.67% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 0.04% | 27.91% | Base rate |
| uniswap-v4 | 0.05% | 0.12% | Base rate |
| uniswap-v3 | 4.67% | 5.45% | Base rate |
| uniswap-v3 | 0.15% | 2.15% | Base rate |
...
6 live pools clear this page's $100K TVL floor, $2.93M in total.
