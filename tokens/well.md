...
WELL shows up in 2 pools here, with rates from 0.32% to 10.45% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| aerodrome-v1 | 10.45% | 5.96% | 100.00% incentives |
| moonwell-lending | 0.32% | 0.38% | 47.52% incentives |
