...
The highest honest WELL yield right now is 0.34% on moonwell-lending (Base), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
0.34% APY on moonwell-lending (Base), based on live DefiLlama data.
