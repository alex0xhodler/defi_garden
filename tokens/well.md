...
WELL shows up in 2 pools here, with rates from 0.32% to 10.69% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| aerodrome-v1 | 10.69% | 6.09% | 100.00% incentives |
| moonwell-lending | 0.32% | 0.38% | 47.24% incentives |
