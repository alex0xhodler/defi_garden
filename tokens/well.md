...
WELL shows up in 2 pools here, with rates from 0.32% to 10.75% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| aerodrome-v1 | 10.75% | 5.73% | 100.00% incentives |
| moonwell-lending | 0.32% | 0.39% | 47.51% incentives |
