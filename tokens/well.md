...
WELL shows up in 2 pools here, with rates from 0.33% to 3.52% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| aerodrome-v1 | 3.52% | 6.63% | 100.00% incentives |
| moonwell-lending | 0.33% | 0.36% | 44.70% incentives |
