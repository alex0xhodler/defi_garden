...
The highest honest HLX yield right now is 77.80% on uniswap-v3 (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
HLX shows up in 3 pools here, with rates from 0.41% to 77.80% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 77.80% | 204.51% | Base rate |
| curve-dex | 0.41% | 1.76% | Base rate |
| uniswap-v3 | 2.99% | 6.72% | Base rate |
...
77.80% APY on uniswap-v3 (Ethereum), based on live DefiLlama data.
