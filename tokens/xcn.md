...
The highest honest XCN yield right now is 7.85% on uniswap-v2 (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
XCN shows up in 2 pools here, with rates from 2.07% to 7.85% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 7.85% | 9.56% | Base rate |
| uniswap-v3 | 2.07% | 2.23% | Base rate |
...
7.85% APY on uniswap-v2 (Ethereum), based on live DefiLlama data.
