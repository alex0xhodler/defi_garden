...
The highest honest ORDER yield right now is 8.45% on raydium-amm (Solana), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
ORDER shows up in 1 pools here, with rates from 8.45% to 8.45% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 8.45% | 12.57% | Base rate |
