...
VBETH shows up in 3 pools here, with rates from 1.80% to 3.42% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| yearn-finance | 1.80% | 2.21% | 57.50% incentives |
| morpho-blue | 3.42% | 1.22% | 100.00% incentives |
| morpho-blue | 2.53% | 0.92% | 100.00% incentives |
