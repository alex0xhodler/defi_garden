...
The highest honest VBETH yield right now is 3.02% on yearn-finance (Katana), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
VBETH shows up in 2 pools here, with rates from 0.46% to 3.02% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| yearn-finance | 3.02% | 1.82% | 30.77% incentives |
| yearn-finance | 0.46% | 1.34% | Base rate |
...
3.02% APY on yearn-finance (Katana), based on live DefiLlama data.
