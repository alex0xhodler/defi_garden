...
VBETH shows up in 1 pools here, with rates from 1.89% to 1.89% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| yearn-finance | 1.89% | 2.19% | 39.42% incentives |
