...
The highest honest VBETH yield right now is 2.04% on yearn-finance (Katana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [yearn-finance →](https://www.defi.garden/?pool=23efa6ee-dbe8-4590-9857-5e0a4bcfc9ed&src=seo_token) | Katana | 2.04% | $7.8M |
...
VBETH shows up in 1 pools here, with rates from 2.04% to 2.04% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| yearn-finance | 2.04% | 2.13% | 40.92% incentives |
...
2.04% APY on yearn-finance (Katana), based on live DefiLlama data.

### How many VBETH pools clear the TVL floor?

3 live pools clear this page's $100K TVL floor, $10.53M in total.
