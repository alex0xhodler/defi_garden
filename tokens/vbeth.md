...
The highest honest VBETH yield right now is 4.37% on yearn-finance (Katana), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
VBETH shows up in 2 pools here, with rates from 0.46% to 4.37% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| yearn-finance | 4.37% | 1.84% | 21.19% incentives |
...
4.37% APY on yearn-finance (Katana), based on live DefiLlama data.
