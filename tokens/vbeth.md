...
The highest honest VBETH yield right now is 1.82% on yearn-finance (Katana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [yearn-finance →](https://www.defi.garden/?pool=23efa6ee-dbe8-4590-9857-5e0a4bcfc9ed&src=seo_token) | Katana | 1.82% | $6.01M |
...
VBETH shows up in 1 pools here, with rates from 1.82% to 1.82% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| yearn-finance | 1.82% | 2.18% | 48.71% incentives |
...
1.82% APY on yearn-finance (Katana), based on live DefiLlama data.
