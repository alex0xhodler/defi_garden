...
VBETH shows up in 1 pools here, with rates from 1.80% to 1.80% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| yearn-finance | 1.80% | 2.18% | 48.60% incentives |
