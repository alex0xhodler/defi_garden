...
The highest honest VBETH yield right now is 1.23% on yearn-finance (Katana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
VBETH shows up in 1 pools here, with rates from 1.23% to 1.23% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
1.23% APY on yearn-finance (Katana), based on live DefiLlama data.

### How many VBETH pools clear the TVL floor?

3 live pools clear this page's $100K TVL floor, $10.42M in total.
