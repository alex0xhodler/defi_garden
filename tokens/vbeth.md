...
The highest honest VBETH yield right now is 1.27% on yearn-finance (Katana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
VBETH shows up in 1 pools here, with rates from 1.27% to 1.27% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| yearn-finance | 1.27% | 2.14% | 2.10% incentives |
...
1.27% APY on yearn-finance (Katana), based on live DefiLlama data.
