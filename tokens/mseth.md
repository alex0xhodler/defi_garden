...
The highest honest MSETH yield right now is 47.10% on aerodrome-slipstream (Base), among 17 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
MSETH shows up in 8 pools here, with rates from 0.12% to 47.10% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| vesper | 1.06% | 1.78% | Base rate |
| aerodrome-v1 | 0.12% | 2.96% | 100.00% incentives |
| curve-dex | 2.52% | 6.22% | 87.72% incentives |
| vesper | 0.48% | 1.26% | Base rate |
| stake-dao | 3.59% | 9.33% | 96.11% incentives |
| convex-finance | 13.96% | 12.38% | 97.78% incentives |
| aerodrome-slipstream | 37.93% | 31.13% | 52.19% incentives |
| aerodrome-slipstream | 47.10% | 44.47% | 82.03% incentives |
...
47.10% APY on aerodrome-slipstream (Base), based on live DefiLlama data.

### How many MSETH pools clear the TVL floor?

17 live pools clear this page's $100K TVL floor, $73.36M in total.
