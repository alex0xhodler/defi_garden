...
BITCOIN shows up in 2 pools here, with rates from 0.09% to 4.09% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 4.09% | 11.66% | Base rate |
...
2 live pools clear this page's $100K TVL floor, $950.9K in total.
