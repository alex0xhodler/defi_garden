...
The highest honest EURC yield right now is 4.66% on blend-pools-v2 (Stellar), among 31 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4.66% APY on blend-pools-v2 (Stellar), based on live DefiLlama data.
