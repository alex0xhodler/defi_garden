...
ALNOOR shows up in 3 pools here, with rates from 0.23% to 0.53% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 0.23% | 105.62% | Base rate |
| raydium-amm | 0.41% | 1.29% | Base rate |
...
3 live pools clear this page's $100K TVL floor, $11.63M in total.
