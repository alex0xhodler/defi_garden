...
The highest honest XAVA yield right now is 4.31% on joe-v2.2 (Avalanche), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4.31% APY on joe-v2.2 (Avalanche), based on live DefiLlama data.
