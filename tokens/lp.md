...
The highest honest LP yield right now is 0.28% on wombat-exchange (BSC), among 7 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
0.28% APY on wombat-exchange (BSC), based on live DefiLlama data.
