...
LP shows up in 5 pools here, with rates from 0.01% to 0.10% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| wombat-exchange | 0.10% | 0.27% | 100.00% incentives |
...
0.10% APY on wombat-exchange (Arbitrum), based on live DefiLlama data.
