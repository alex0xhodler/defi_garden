...
The highest honest LP yield right now is 0.63% on wombat-exchange (Arbitrum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
LP shows up in 5 pools here, with rates from 0.01% to 0.63% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| wombat-exchange | 0.05% | 0.06% | 90.82% incentives |
| wombat-exchange | 0.09% | 0.09% | 100.00% incentives |
| wombat-exchange | 0.63% | 0.28% | 16.19% incentives |
...
0.63% APY on wombat-exchange (Arbitrum), based on live DefiLlama data.
