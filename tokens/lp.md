...
The highest honest LP yield right now is 0.43% on wombat-exchange (Arbitrum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
LP shows up in 5 pools here, with rates from 0.01% to 0.43% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| wombat-exchange | 0.06% | 0.06% | 81.22% incentives |
| wombat-exchange | 0.07% | 0.08% | 100.00% incentives |
| wombat-exchange | 0.43% | 0.25% | 23.83% incentives |
...
0.43% APY on wombat-exchange (Arbitrum), based on live DefiLlama data.

### How many LP pools clear the TVL floor?

5 live pools clear this page's $100K TVL floor, $5.75M in total.
