...
The highest honest LP yield right now is 0.22% on wombat-exchange (Arbitrum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
LP shows up in 5 pools here, with rates from 0.01% to 0.22% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| wombat-exchange | 0.07% | 0.06% | 66.42% incentives |
| wombat-exchange | 0.09% | 0.09% | 100.00% incentives |
| wombat-exchange | 0.22% | 0.28% | 46.30% incentives |
