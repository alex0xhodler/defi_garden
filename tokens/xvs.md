...
XVS shows up in 2 pools here, with rates from 0.91% to 7.73% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 7.73% | 26.03% | Base rate |
