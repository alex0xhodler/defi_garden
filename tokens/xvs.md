...
XVS shows up in 2 pools here, with rates from 0.91% to 32.12% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 32.12% | 20.77% | Base rate |
