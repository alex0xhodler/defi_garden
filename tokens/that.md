...
The highest honest THAT yield right now is 11.29% on uniswap-v3 (Polygon), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
11.29% APY on uniswap-v3 (Polygon), based on live DefiLlama data.
