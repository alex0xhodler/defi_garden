...
HARAMBE shows up in 2 pools here, with rates from 0.03% to 111.85% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 111.85% | 4.02% | Base rate |
