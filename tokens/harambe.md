...
HARAMBE shows up in 2 pools here, with rates from 0.03% to 101.10% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 101.10% | 4.30% | Base rate |
