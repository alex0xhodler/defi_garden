...
The highest honest XHYPE yield right now is 8.76% on liminal-basis (Hyperliquid L1), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
8.76% APY on liminal-basis (Hyperliquid L1), based on live DefiLlama data.
