...
EDGE shows up in 2 pools here, with rates from 8.28% to 63.73% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| aerodrome-v1 | 63.73% | 29.56% | 100.00% incentives |
| uniswap-v3 | 8.28% | 2.47% | Base rate |
...
63.73% APY on aerodrome-v1 (Base), based on live DefiLlama data.
