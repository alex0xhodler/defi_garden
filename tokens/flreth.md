...
FLRETH shows up in 2 pools here, with rates from 0.05% to 19.23% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| sparkdex-v4 | 19.23% | 10.75% | 99.77% incentives |
