...
FLRETH shows up in 2 pools here, with rates from 0.07% to 18.89% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| sparkdex-v4 | 18.89% | 12.16% | 97.72% incentives |
