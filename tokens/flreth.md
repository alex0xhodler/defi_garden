...
FLRETH shows up in 2 pools here, with rates from 0.05% to 19.17% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| sparkdex-v4 | 19.17% | 10.72% | 99.73% incentives |
