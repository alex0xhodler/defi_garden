...
The highest honest PRIME yield right now is 6.94% on hastra (Ethereum), among 16 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
PRIME shows up in 8 pools here, with rates from 0.01% to 6.94% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| hastra | 6.94% | 6.96% | Base rate |
| hastra | 6.94% | 5.42% | Base rate |
| morpho-blue | 3.78% | 3.91% | Base rate |
| orca-dex | 0.76% | 0.67% | Base rate |
| uniswap-v3 | 6.29% | 3.19% | Base rate |
...
6.94% APY on hastra (Ethereum), based on live DefiLlama data.

### How many PRIME pools clear the TVL floor?

16 live pools clear this page's $100K TVL floor, $939.08M in total.
