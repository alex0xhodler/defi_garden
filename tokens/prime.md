...
PRIME shows up in 8 pools here, with rates from 0.01% to 6.96% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
