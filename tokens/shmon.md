...
The highest honest SHMON yield right now is 15.39% on curve-dex (Monad), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SHMON shows up in 3 pools here, with rates from 1.35% to 15.39% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| neverland | 1.35% | 0.84% | 100.00% incentives |
