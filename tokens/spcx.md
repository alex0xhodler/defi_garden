...
SPCX shows up in 2 pools here, with rates from 39.26% to 39.60% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 39.26% | 27.50% | Base rate |
| orca-dex | 39.60% | 34.64% | Base rate |
