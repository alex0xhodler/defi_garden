...
The highest honest FXUSD yield right now is 29.48% on curve-dex (Ethereum), among 15 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
29.48% APY on curve-dex (Ethereum), based on live DefiLlama data.
