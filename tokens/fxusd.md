...
The highest honest FXUSD yield right now is 11.47% on curve-dex (Ethereum), among 12 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
FXUSD shows up in 8 pools here, with rates from 0.47% to 11.47% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
11.47% APY on curve-dex (Ethereum), based on live DefiLlama data.
