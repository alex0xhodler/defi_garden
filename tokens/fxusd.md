...
The highest honest FXUSD yield right now is 12.01% on curve-dex (Ethereum), among 12 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
FXUSD shows up in 8 pools here, with rates from 0.11% to 12.01% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| curve-dex | 0.11% | 0.37% | 0.01% incentives |
| convex-finance | 0.11% | 0.38% | 0.12% incentives |
| curve-dex | 0.24% | 0.13% | Base rate |
| convex-finance | 0.24% | 0.14% | Base rate |
| curve-dex | 11.66% | 31.53% | 89.71% incentives |
| aerodrome-slipstream | 0.91% | 1.31% | 99.97% incentives |
| curve-dex | 12.01% | 18.42% | 98.25% incentives |
| curve-dex | 0.30% | 0.33% | 0.05% incentives |
...
12.01% APY on curve-dex (Ethereum), based on live DefiLlama data.

### How many FXUSD pools clear the TVL floor?

12 live pools clear this page's $100K TVL floor, $18.12M in total.
