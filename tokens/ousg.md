...
The highest honest OUSG yield right now is 3.57% on ondo-yield-assets (XRPL), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
OUSG shows up in 2 pools here, with rates from 3.57% to 3.57% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| ondo-yield-assets | 3.57% | 3.45% | Base rate |
| ondo-yield-assets | 3.57% | 3.45% | Base rate |
...
3.57% APY on ondo-yield-assets (XRPL), based on live DefiLlama data.
