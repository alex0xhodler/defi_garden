...
The highest honest BIO yield right now is 10.10% on aerodrome-slipstream (Base), among 8 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
BIO shows up in 5 pools here, with rates from 2.14% to 173.39% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| aerodrome-slipstream | 173.39% | 105.25% | 95.53% incentives |
| raydium-amm | 2.14% | 4.01% | Base rate |
| aerodrome-slipstream | 24.72% | 50.54% | 68.19% incentives |
| uniswap-v4 | 2.46% | 3.76% | Base rate |
| aerodrome-slipstream | 10.10% | 14.22% | 27.65% incentives |
...
10.10% APY on aerodrome-slipstream (Base), based on live DefiLlama data.
