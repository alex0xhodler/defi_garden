...
BIO shows up in 5 pools here, with rates from 1.91% to 47.18% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 4.59% | 5.57% | Base rate |
| uniswap-v4 | 1.91% | 5.07% | Base rate |
| aerodrome-slipstream | 43.25% | 115.74% | 71.38% incentives |
| aerodrome-slipstream | 47.18% | 70.96% | 96.78% incentives |
| aerodrome-slipstream | 10.36% | 9.96% | 47.17% incentives |
...
47.18% APY on aerodrome-slipstream (Base), based on live DefiLlama data.
