...
GTUSDCP shows up in 6 pools here, with rates from 4.17% to 5.53% APY across 4 chains — the rate depends on which protocol and chain you pick, not just the token.
