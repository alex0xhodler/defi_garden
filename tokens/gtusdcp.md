...
The highest honest GTUSDCP yield right now is 4.86% on morpho-blue (OP Mainnet), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
|---|---|---|---|
| morpho-blue | 4.65% | 4.48% | Base rate |
| morpho-blue | 4.60% | 4.48% | Base rate |
| morpho-blue | 3.61% | 3.71% | Base rate |
| morpho-blue | 4.86% | 4.62% | Base rate |
| morpho-blue | 6.13% | 3.41% | Base rate |
| morpho-blue | 6.28% | 3.80% | Base rate |
...
4.86% APY on morpho-blue (OP Mainnet), based on live DefiLlama data.

### How many GTUSDCP pools clear the TVL floor?

6 live pools clear this page's $100K TVL floor, $586.84M in total.
