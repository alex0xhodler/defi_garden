...
The highest honest GTUSDCP yield right now is 4.77% on morpho-blue (OP Mainnet), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
6 of these 6 pools have a trustworthy 30-day average on file, with a median of 4.14% — a useful check against today's number for whether the rate is steady or just having a good day.

All 6 pools pay a plain base rate right now — no incentive or reward APY mixed in.

| Protocol | APY | 30d Mean APY | Yield mix |
|---|---|---|---|
| morpho-blue | 4.61% | 4.48% | Base rate |
| morpho-blue | 4.60% | 4.48% | Base rate |
| morpho-blue | 3.61% | 3.70% | Base rate |
| morpho-blue | 4.77% | 4.62% | Base rate |
| morpho-blue | 6.10% | 3.40% | Base rate |
| morpho-blue | 6.28% | 3.79% | Base rate |
...
4.77% APY on morpho-blue (OP Mainnet), based on live DefiLlama data.

### How many GTUSDCP pools clear the TVL floor?

6 live pools clear this page's $100K TVL floor, $587.43M in total.
