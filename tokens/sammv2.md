...
The highest honest SAMMV2 yield right now is 12.01% on yearn-finance (OP Mainnet), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SAMMV2 shows up in 2 pools here, with rates from 7.11% to 12.01% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| yearn-finance | 12.01% | 11.27% | Base rate |
...
12.01% APY on yearn-finance (OP Mainnet), based on live DefiLlama data.
