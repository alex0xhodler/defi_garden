...
The highest honest SAMMV2 yield right now is 7.67% on yearn-finance (OP Mainnet), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
7.67% APY on yearn-finance (OP Mainnet), based on live DefiLlama data.
