...
SAMMV2 shows up in 2 pools here, with rates from 6.26% to 14.91% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| yearn-finance | 14.91% | 10.77% | Base rate |
...
14.91% APY on yearn-finance (OP Mainnet), based on live DefiLlama data.
