...
The highest honest YIELD yield right now is 5.86% on morpho-blue (Ethereum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
YIELD shows up in 4 pools here, with rates from 2.48% to 25.71% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
5 live pools clear this page's $100K TVL floor, $16.3M in total.
