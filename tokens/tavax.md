...
TAVAX shows up in 2 pools here, with rates from 3.19% to 5.11% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| treehouse-protocol | 5.11% | 5.89% | Base rate |
