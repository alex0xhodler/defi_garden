...
The highest honest ESP yield right now is 2.33% on uniswap-v3 (Arbitrum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [uniswap-v3 →](https://www.defi.garden/?pool=34ccf582-38d6-41e1-9ff2-3cfcbc2888a2&src=seo_token) | Arbitrum | 2.33% | $507.6K |
...
ESP shows up in 1 pools here, with rates from 2.33% to 2.33% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 2.33% | 8.38% | Base rate |
...
2.33% APY on uniswap-v3 (Arbitrum), based on live DefiLlama data.
