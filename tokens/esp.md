...
ESP shows up in 3 pools here, with rates from 2.92% to 4.13% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 4.13% | 4.13% | Base rate |
| uniswap-v4 | 3.62% | 25.12% | Base rate |
| curve-dex | 2.92% | 1.57% | Base rate |
...
4.13% APY on uniswap-v3 (Arbitrum), based on live DefiLlama data.
