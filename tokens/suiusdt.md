...
The highest honest SUIUSDT yield right now is 11.96% on cetus-clmm (Sui), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SUIUSDT shows up in 3 pools here, with rates from 6.61% to 11.96% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| bluefin-spot | 8.04% | 9.85% | 91.70% incentives |
| navi-lending | 6.61% | 6.11% | 3.55% incentives |
| cetus-clmm | 11.96% | 15.55% | 92.84% incentives |
...
11.96% APY on cetus-clmm (Sui), based on live DefiLlama data.
