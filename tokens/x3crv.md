...
The highest honest X3CRV yield right now is 0.51% on curve-dex (Gnosis), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
0.51% APY on curve-dex (Gnosis), based on live DefiLlama data.
