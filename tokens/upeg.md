...
UPEG shows up in 5 pools here, with rates from 0.08% to 60.66% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

5 of these 5 pools have a trustworthy 30-day average on file, with a median of 11.48% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| uniswap-v4 | 60.66% | 54.31% | Base rate |
| uniswap-v4 | 13.69% | 11.48% | Base rate |
| uniswap-v4 | 0.08% | 5.67% | Base rate |
| uniswap-v4 | 1.40% | 0.49% | Base rate |
| uniswap-v4 | 31.78% | 95.32% | Base rate |
