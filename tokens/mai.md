...
MAI shows up in 3 pools here, with rates from 4.02% to 6.48% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| aerodrome-v1 | 6.28% | 6.22% | 100.00% incentives |
| extra-finance-leverage-farming | 6.48% | 6.39% | Base rate |
| curve-dex | 4.02% | 3.90% | 64.15% incentives |
