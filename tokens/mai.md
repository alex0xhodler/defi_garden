...
The highest honest MAI yield right now is 6.34% on extra-finance-leverage-farming (Base), among 8 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
| quickswap-dex | 0.09% | 296.35% | Base rate |
| extra-finance-leverage-farming | 6.34% | 6.36% | Base rate |
| curve-dex | 5.05% | 4.14% | 51.10% incentives |
...
6.34% APY on extra-finance-leverage-farming (Base), based on live DefiLlama data.
