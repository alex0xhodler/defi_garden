...
MAI shows up in 4 pools here, with rates from 0.01% to 11.05% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| aerodrome-v1 | 10.49% | 8.06% | 100.00% incentives |
| uniswap-v3 | 0.01% | 0.01% | Base rate |
| extra-finance-leverage-farming | 11.05% | 8.36% | Base rate |
| curve-dex | 2.73% | 4.65% | 100.00% incentives |
...
11.05% APY on extra-finance-leverage-farming (Base), based on live DefiLlama data.
