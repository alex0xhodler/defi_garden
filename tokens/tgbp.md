...
TGBP shows up in 2 pools here, with rates from 0.01% to 22.61% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| aerodrome-slipstream | 22.61% | 0.72% | 99.84% incentives |
