...
The highest honest USP yield right now is 651.83% on pendle (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
651.83% APY on pendle (Ethereum), based on live DefiLlama data.
