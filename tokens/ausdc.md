...
The highest honest AUSDC yield right now is 6.81% on morpho-blue (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
AUSDC shows up in 3 pools here, with rates from 0.30% to 6.81% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| morpho-blue | 6.81% | 6.39% | Base rate |
