...
The highest honest AUSDC yield right now is 6.30% on hydration-dex (Polkadot), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
6.30% APY on hydration-dex (Polkadot), based on live DefiLlama data.
