...
FLOCK shows up in 3 pools here, with rates from 36.93% to 678.70% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

3 of these 3 pools have a trustworthy 30-day average on file, with a median of 101.14% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| aerodrome-slipstream | 678.70% | 899.12% | 96.80% incentives |
| uniswap-v3 | 36.93% | 101.14% | Base rate |
| aerodrome-v1 | 56.65% | 27.37% | 100.00% incentives |
...
678.70% APY on aerodrome-slipstream (Base), based on live DefiLlama data.
