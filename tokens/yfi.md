...
YFI shows up in 6 pools here, with rates from 4.02% to 13.68% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.

6 of these 6 pools have a trustworthy 30-day average on file, with a median of 6.12% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| aerodrome-v1 | 8.50% | 6.30% | 100.00% incentives |
| curve-dex | 6.04% | 5.95% | 84.26% incentives |
| convex-finance | 8.69% | 8.76% | 89.07% incentives |
| uniswap-v2 | 13.35% | 4.59% | Base rate |
| sushiswap | 4.02% | 3.66% | Base rate |
| sushiswap-v3 | 13.68% | 12.07% | Base rate |
...
13.68% APY on sushiswap-v3 (Ethereum), based on live DefiLlama data.
