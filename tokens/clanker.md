...
The highest honest CLANKER yield right now is 96.81% on aerodrome-slipstream (Base), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
CLANKER shows up in 4 pools here, with rates from 0.99% to 96.81% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 4.62% | 8.89% | Base rate |
| raydium-amm | 2.44% | 3.51% | Base rate |
| uniswap-v4 | 0.99% | 2.36% | Base rate |
| aerodrome-slipstream | 96.81% | 97.81% | 94.32% incentives |
...
96.81% APY on aerodrome-slipstream (Base), based on live DefiLlama data.
