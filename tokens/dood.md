...
The highest honest DOOD yield right now is 199.19% on orca-dex (Solana), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
DOOD shows up in 2 pools here, with rates from 173.47% to 199.19% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 173.47% | 11.43% | Base rate |
| orca-dex | 199.19% | 12.00% | Base rate |
...
199.19% APY on orca-dex (Solana), based on live DefiLlama data.
