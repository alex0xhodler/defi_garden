...
The highest honest BNC4 yield right now is 579.65% on uniswap-v4 (BSC), among 12 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
BNC4 shows up in 8 pools here, with rates from 0.15% to 579.65% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

8 of these 8 pools have a trustworthy 30-day average on file, with a median of 64.41% — a useful check against today's number for whether the rate is steady or just having a good day.
...
12 live pools clear this page's $100K TVL floor, $2.33M in total.
