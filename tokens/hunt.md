...
The highest honest HUNT yield right now is 0.02% on uniswap-v3 (Ethereum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
|---|---|---|---|
| uniswap-v3 | 0.01% | 0.55% | Base rate |
| uniswap-v3 | 0.02% | 0.40% | Base rate |
