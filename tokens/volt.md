...
The highest honest VOLT yield right now is 0.70% on uniswap-v2 (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
VOLT shows up in 2 pools here, with rates from 0.01% to 0.70% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 0.70% | 0.48% | Base rate |
