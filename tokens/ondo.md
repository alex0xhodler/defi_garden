...
The highest honest ONDO yield right now is 44.94% on uniswap-v3 (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
44.94% APY on uniswap-v3 (Ethereum), based on live DefiLlama data.
