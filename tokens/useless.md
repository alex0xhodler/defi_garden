...
USELESS shows up in 3 pools here, with rates from 36.73% to 856.12% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

3 of these 3 pools have a trustworthy 30-day average on file, with a median of 549.75% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| raydium-amm | 99.20% | 109.60% | Base rate |
| orca-dex | 856.12% | 549.75% | Base rate |
...
99.20% APY on raydium-amm (Solana), based on live DefiLlama data.
