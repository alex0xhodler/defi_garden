...
The highest honest USELESS yield right now is 44.94% on orca-dex (Solana), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USELESS shows up in 2 pools here, with rates from 20.87% to 44.94% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 20.87% | 19.28% | Base rate |
| orca-dex | 44.94% | 56.73% | Base rate |
...
44.94% APY on orca-dex (Solana), based on live DefiLlama data.
