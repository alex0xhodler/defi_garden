...
The highest honest APEX yield right now is 1.25% on uniswap-v3 (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
APEX shows up in 2 pools here, with rates from 1.25% to 1.40% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 1.25% | 1.60% | Base rate |
| camelot-v3 | 1.40% | 3.88% | Base rate |
