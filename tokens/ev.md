...
The highest honest EV yield right now is 39.92% on everything (Arbitrum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
EV shows up in 2 pools here, with rates from 24.80% to 39.92% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
39.92% APY on everything (Arbitrum), based on live DefiLlama data.
