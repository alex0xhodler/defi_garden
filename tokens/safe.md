...
The highest honest SAFE yield right now is 127.74% on uniswap-v3 (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
127.74% APY on uniswap-v3 (Ethereum), based on live DefiLlama data.
