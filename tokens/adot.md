...
The highest honest ADOT yield right now is 7.21% on hydration-dex (Polkadot), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
ADOT shows up in 2 pools here, with rates from 0.58% to 7.21% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| hydration-dex | 7.21% | 7.67% | 74.25% incentives |
...
7.21% APY on hydration-dex (Polkadot), based on live DefiLlama data.
