...
ADOT shows up in 2 pools here, with rates from 0.30% to 7.45% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| hydration-dex | 7.45% | 7.75% | 72.82% incentives |
