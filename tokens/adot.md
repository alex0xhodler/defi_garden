...
ADOT shows up in 2 pools here, with rates from 0.36% to 1.79% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| hydration-dex | 1.79% | 7.30% | Base rate |
