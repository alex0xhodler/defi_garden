...
The highest honest BUDDY yield right now is 9.06% on hyperswap-v2 (Hyperliquid L1), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
9.06% APY on hyperswap-v2 (Hyperliquid L1), based on live DefiLlama data.
