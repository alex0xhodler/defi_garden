...
DEEP shows up in 4 pools here, with rates from 14.48% to 155.20% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| navi-lending | 14.48% | 15.61% | 70.91% incentives |
| cetus-clmm | 86.30% | 119.89% | 58.12% incentives |
| bluefin-spot | 59.84% | 60.29% | 60.36% incentives |
| bluefin-spot | 155.20% | 221.79% | 50.32% incentives |
...
155.20% APY on bluefin-spot (Sui), based on live DefiLlama data.
