...
The highest honest DEEP yield right now is 72.58% on cetus-clmm (Sui), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
DEEP shows up in 3 pools here, with rates from 17.41% to 72.58% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

3 of these 3 pools have a trustworthy 30-day average on file, with a median of 47.45% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| navi-lending | 17.41% | 17.08% | 70.74% incentives |
| cetus-clmm | 72.58% | 88.24% | 70.85% incentives |
| bluefin-spot | 47.43% | 47.45% | 75.11% incentives |
...
72.58% APY on cetus-clmm (Sui), based on live DefiLlama data.
