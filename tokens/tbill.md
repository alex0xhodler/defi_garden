...
TBILL shows up in 2 pools here, with rates from 3.60% to 3.60% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| openeden-tbill | 3.60% | 3.30% | Base rate |
| openeden-tbill | 3.60% | 3.30% | Base rate |
