...
The highest honest TBILL yield right now is 3.42% on openeden-tbill (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
TBILL shows up in 2 pools here, with rates from 3.42% to 3.42% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| openeden-tbill | 3.42% | 3.32% | Base rate |
| openeden-tbill | 3.42% | 3.32% | Base rate |
...
3.42% APY on openeden-tbill (Ethereum), based on live DefiLlama data.
