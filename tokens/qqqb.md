...
The highest honest QQQB yield right now is 156.24% on uniswap-v3 (BSC), among 28 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
QQQB shows up in 4 pools here, with rates from 0.39% to 156.24% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 156.24% | 268.53% | Base rate |
| native-credit-pool | 25.33% | 25.17% | Base rate |
...
156.24% APY on uniswap-v3 (BSC), based on live DefiLlama data.

### How many QQQB pools clear the TVL floor?

28 live pools clear this page's $100K TVL floor, $14.58M in total.
