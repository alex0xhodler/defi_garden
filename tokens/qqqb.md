...
The highest honest QQQB yield right now is 23.23% on native-credit-pool (BSC), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
23.23% APY on native-credit-pool (BSC), based on live DefiLlama data.
