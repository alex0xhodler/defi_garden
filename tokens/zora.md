...
The highest honest ZORA yield right now is 1.44% on uniswap-v4 (Base), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
Based on APY history only, ZORA's lower-variability candidates are uniswap-v4 (Base), 47.28% APY, $250K TVL, https://www.defi.garden/?pool=35073fec-dc78-42ab-83c8-91e3c7c7c447&src=seo_token; uniswap-v4 (Base), 1.44% APY, $299.3K TVL, https://www.defi.garden/?pool=9c7ee6ef-37b9-497c-8d30-c2a62649d38b&src=seo_token; uniswap-v4 (Base), 20.20% APY, $992.8K TVL, https://www.defi.garden/?pool=9937ca05-c36e-4acf-9aeb-7a62e131bfcd&src=seo_token; uniswap-v4 (Base), 4.30% APY, $129.4K TVL, https://www.defi.garden/?pool=bace82d1-ca5b-4740-b2a3-1223e6050739&src=seo_token; uniswap-v4 (Base), 5.95% APY, $138.1K TVL, https://www.defi.garden/?pool=cb9230a0-dd93-4403-8308-3e5d45e4e751&src=seo_token. This comparison does not measure protocol, exploit, depeg, liquidity, governance, or principal-loss risk.
...
ZORA shows up in 5 pools here, with rates from 1.44% to 47.28% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

3 of these 5 pools have a trustworthy 30-day average on file, with a median of 5.95% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| uniswap-v4 | 20.20% | 5.95% | Base rate |
| uniswap-v4 | 1.44% | 2.66% | Base rate |
| uniswap-v4 | 47.28% | 8.78% | Base rate |
| uniswap-v4 | 5.95% | — | Base rate |
| uniswap-v4 | 4.30% | — | Base rate |
...
1.44% APY on uniswap-v4 (Base), based on live DefiLlama data.
