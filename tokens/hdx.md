...
The highest honest HDX yield right now is 1.73% on hydration-dex (Polkadot), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.73% APY on hydration-dex (Polkadot), based on live DefiLlama data.
