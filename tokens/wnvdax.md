...
WNVDAX shows up in 3 pools here, with rates from 0.12% to 249.43% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.

3 of these 3 pools have a trustworthy 30-day average on file, with a median of 84.88% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| nest-cl | 56.41% | 84.88% | 100.00% incentives |
| project-x | 249.43% | 465.84% | Base rate |
| fluxion-network | 0.12% | 1.44% | Base rate |
