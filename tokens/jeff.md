...
The highest honest JEFF yield right now is 165.53% on hybra-v4 (Hyperliquid L1), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [hybra-v4 →](https://www.defi.garden/?pool=edfa9d23-a931-5fec-9ce8-6105dfcb440f&src=seo_token) | Hyperliquid L1 | 165.53% | $113.7K |
...
JEFF shows up in 1 pools here, with rates from 165.53% to 165.53% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

1 of these 1 pool has a trustworthy 30-day average on file, with a median of 198.51% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| hybra-v4 | 165.53% | 198.51% | 100.00% incentives |
...
165.53% APY on hybra-v4 (Hyperliquid L1), based on live DefiLlama data.
