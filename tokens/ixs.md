...
The highest honest IXS yield right now is 6.90% on uniswap-v4 (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
IXS shows up in 2 pools here, with rates from 5.46% to 6.90% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 6.90% | 12.43% | Base rate |
| uniswap-v2 | 5.46% | 6.36% | Base rate |
