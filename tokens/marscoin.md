...
The highest honest MARSCOIN yield right now is 625.81% on uniswap-v3 (BSC), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
625.81% APY on uniswap-v3 (BSC), based on live DefiLlama data.
