...
The highest honest CKUSDT yield right now is 0.10% on icpswap (ICP), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
0.10% APY on icpswap (ICP), based on live DefiLlama data.
