...
The highest honest BPT yield right now is 52.73% on beets-dex (Sonic), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
BPT shows up in 2 pools here, with rates from 8.43% to 52.73% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| beets-dex-v3 | 8.43% | 8.69% | 91.30% incentives |
...
5 live pools clear this page's $100K TVL floor, $392.07M in total.
