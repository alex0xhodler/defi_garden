...
The highest honest AVLT yield right now is 850.92% on project-x (Hyperliquid L1), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
850.92% APY on project-x (Hyperliquid L1), based on live DefiLlama data.
