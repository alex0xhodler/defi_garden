...
The highest honest CKUSDC yield right now is 7.53% on icpswap (ICP), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
7.53% APY on icpswap (ICP), based on live DefiLlama data.
