...
The highest honest KODIWBTC yield right now is 34.83% on berapaw (Berachain), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
KODIWBTC shows up in 4 pools here, with rates from 1.23% to 34.83% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

4 of these 4 pools have a trustworthy 30-day average on file, with a median of 12.47% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| berapaw | 1.23% | 2.99% | 100.00% incentives |
| berapaw | 34.83% | 33.21% | 100.00% incentives |
| berapaw | 3.99% | 2.89% | 100.00% incentives |
