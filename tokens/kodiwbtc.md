...
The highest honest KODIWBTC yield right now is 34.55% on berapaw (Berachain), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
KODIWBTC shows up in 4 pools here, with rates from 1.22% to 34.55% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| berapaw | 1.22% | 3.07% | 100.00% incentives |
