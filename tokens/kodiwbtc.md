...
KODIWBTC shows up in 4 pools here, with rates from 2.77% to 35.84% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| berapaw | 2.77% | 3.05% | 100.00% incentives |
...
35.84% APY on berapaw (Berachain), based on live DefiLlama data.
