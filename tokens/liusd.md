...
LIUSD shows up in 4 pools here, with rates from 5.76% to 8.46% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
