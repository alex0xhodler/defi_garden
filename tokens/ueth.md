...
UETH shows up in 8 pools here, with rates from 0.18% to 197.34% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

8 of these 8 pools have a trustworthy 30-day average on file, with a median of 31.76% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| hyperlend-pooled | 1.38% | 2.48% | Base rate |
| project-x | 20.11% | 27.09% | Base rate |
| hyperswap-v3 | 0.18% | 1.98% | Base rate |
| ramses-cl-v2 | 80.50% | 75.64% | 26.27% incentives |
| nest-cl | 37.16% | 56.32% | 100.00% incentives |
| project-x | 1.81% | 4.84% | Base rate |
| ramses-cl-v2 | 197.34% | 36.42% | 100.00% incentives |
| ramses-cl-v2 | 38.11% | 88.59% | 100.00% incentives |
...
12 live pools clear this page's $100K TVL floor, $8.41M in total.
