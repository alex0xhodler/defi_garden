...
The highest honest UETH yield right now is 80.26% on ramses-cl-v2 (Hyperliquid L1), among 9 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
Based on APY history only, UETH's lower-variability candidates are hypurrfi-pooled (Hyperliquid L1), 0.06% APY, $176.5K TVL, https://www.defi.garden/?pool=1e4bfaf9-d95c-4025-bbbc-7af3343bc697&src=seo_token; hyperlend-pooled (Hyperliquid L1), 2.24% APY, $1.49M TVL, https://www.defi.garden/?pool=3002bd03-5e7e-4e38-9b0a-381c1109f77b&src=seo_token; project-x (Hyperliquid L1), 5.31% APY, $375.1K TVL, https://www.defi.garden/?pool=903b5eea-8973-41d4-9408-da8c2e53ff2f&src=seo_token; nest-cl (Hyperliquid L1), 22.19% APY, $146.7K TVL, https://www.defi.garden/?pool=1b66a769-28c2-4142-b558-224eb0be8a5f&src=seo_token; project-x (Hyperliquid L1), 33.31% APY, $1.98M TVL, https://www.defi.garden/?pool=5f952da0-ffd8-4665-9314-9319e4cafaa8&src=seo_token; ramses-cl-v2 (Hyperliquid L1), 80.26% APY, $392.1K TVL, https://www.defi.garden/?pool=fa2fa951-a1ff-43f6-b326-2db069497ef2&src=seo_token; nest-cl (Hyperliquid L1), 96.76% APY, $801.6K TVL, https://www.defi.garden/?pool=50b63c78-5597-42c0-a531-d593c9e482b9&src=seo_token; hyperswap-v3 (Hyperliquid L1), 2.01% APY, $662.3K TVL, https://www.defi.garden/?pool=7223e3c9-85ba-424a-91be-f02dcb6f155e&src=seo_token. This comparison does not measure protocol, exploit, depeg, liquidity, governance, or principal-loss risk.
...
UETH shows up in 8 pools here, with rates from 0.06% to 96.76% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

8 of these 8 pools have a trustworthy 30-day average on file, with a median of 12.16% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| project-x | 33.31% | 20.13% | Base rate |
| hyperlend-pooled | 2.24% | 3.28% | Base rate |
| nest-cl | 96.76% | 43.82% | 100.00% incentives |
| hyperswap-v3 | 2.01% | 1.64% | Base rate |
| ramses-cl-v2 | 80.26% | 53.64% | 7.43% incentives |
| project-x | 5.31% | 4.20% | Base rate |
| hypurrfi-pooled | 0.06% | 0.03% | Base rate |
| nest-cl | 22.19% | 24.97% | 100.00% incentives |
...
80.26% APY on ramses-cl-v2 (Hyperliquid L1), based on live DefiLlama data.

### How many UETH pools clear the TVL floor?

9 live pools clear this page's $100K TVL floor, $6.26M in total.
