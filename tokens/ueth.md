...
The highest honest UETH yield right now is 39.22% on ramses-cl-v2 (Hyperliquid L1), among 10 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
UETH shows up in 8 pools here, with rates from 0.02% to 39.22% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| hyperlend-pooled | 4.74% | 2.63% | Base rate |
| hyperswap-v3 | 1.48% | 1.05% | Base rate |
| nest-cl | 31.19% | 43.36% | 100.00% incentives |
| ramses-cl-v2 | 19.87% | 34.54% | 26.74% incentives |
| ramses-cl-v2 | 39.22% | 50.39% | 100.00% incentives |
...
39.22% APY on ramses-cl-v2 (Hyperliquid L1), based on live DefiLlama data.
