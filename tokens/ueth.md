...
The highest honest UETH yield right now is 34.28% on nest-cl (Hyperliquid L1), among 10 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
UETH shows up in 8 pools here, with rates from 0.02% to 34.28% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| hyperlend-pooled | 5.32% | 2.66% | Base rate |
| hyperswap-v3 | 0.20% | 1.05% | Base rate |
| nest-cl | 34.28% | 43.21% | 100.00% incentives |
| ramses-cl-v2 | 15.56% | 34.49% | 34.14% incentives |
| ramses-cl-v2 | 26.89% | 50.04% | 100.00% incentives |
...
34.28% APY on nest-cl (Hyperliquid L1), based on live DefiLlama data.
