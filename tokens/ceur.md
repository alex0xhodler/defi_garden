...
The highest honest CEUR yield right now is 0.38% on uniswap-v3 (Celo), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
CEUR shows up in 2 pools here, with rates from 0.38% to 1.42% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 0.38% | 0.16% | Base rate |
| moola-market | 1.42% | 0.71% | Base rate |
...
0.38% APY on uniswap-v3 (Celo), based on live DefiLlama data.
