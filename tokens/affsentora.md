...
The highest honest AFFSENTORA yield right now is 3.75% on affluent (TON), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
3.75% APY on affluent (TON), based on live DefiLlama data.
