...
The highest honest PBTC yield right now is 9.02% on raydium-amm (Solana), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
PBTC shows up in 2 pools here, with rates from 0.10% to 9.02% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 9.02% | 9.75% | Base rate |
| uniswap-v2 | 0.10% | 0.16% | Base rate |
