...
YZY shows up in 2 pools here, with rates from 3.55% to 5.53% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 5.53% | 8.42% | Base rate |
| raydium-amm | 3.55% | 3.20% | Base rate |
