...
NOT shows up in 2 pools here, with rates from 4.13% to 12.99% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| storm-trade | 12.99% | 13.11% | Base rate |
