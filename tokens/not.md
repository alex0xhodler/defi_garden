...
NOT shows up in 2 pools here, with rates from 3.92% to 12.40% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| storm-trade | 12.40% | 12.70% | Base rate |
| ston.fi | 3.92% | 12.38% | Base rate |
...
12.40% APY on storm-trade (TON), based on live DefiLlama data.
