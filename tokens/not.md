...
NOT shows up in 2 pools here, with rates from 4.69% to 12.97% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
