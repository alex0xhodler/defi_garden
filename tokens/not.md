...
NOT shows up in 2 pools here, with rates from 1.36% to 13.00% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| storm-trade | 13.00% | 13.12% | Base rate |
| ston.fi | 1.36% | 4.02% | Base rate |
