...
NOT shows up in 2 pools here, with rates from 3.38% to 13.00% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
