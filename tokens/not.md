...
NOT shows up in 2 pools here, with rates from 12.95% to 20.64% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| storm-trade | 12.95% | 13.07% | Base rate |
| ston.fi | 20.64% | 4.86% | Base rate |
