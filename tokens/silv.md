...
The highest honest SILV yield right now is 3.05% on raydium-amm (Solana), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SILV shows up in 2 pools here, with rates from 1.70% to 3.05% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| orca-dex | 1.70% | 16.33% | Base rate |
| raydium-amm | 3.05% | 4.92% | Base rate |
