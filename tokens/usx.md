...
USX shows up in 8 pools here, with rates from 0.11% to 5.88% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| kamino-lend | 2.32% | 2.31% | Base rate |
| orca-dex | 0.15% | 0.10% | Base rate |
| raydium-amm | 0.13% | 0.09% | Base rate |
| orca-dex | 0.11% | 0.13% | Base rate |
| loopscale | 1.98% | 2.18% | Base rate |
| raydium-amm | 0.12% | 0.22% | Base rate |
...
10 live pools clear this page's $100K TVL floor, $53.18M in total.
