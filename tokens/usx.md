...
The highest honest USX yield right now is 5.78% on loopscale (Solana), among 10 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USX shows up in 8 pools here, with rates from 0.04% to 5.78% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| raydium-amm | 0.07% | 0.25% | Base rate |
...
10 live pools clear this page's $100K TVL floor, $57.12M in total.
