...
USX shows up in 8 pools here, with rates from 0.02% to 5.95% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
