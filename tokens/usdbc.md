...
The highest honest USDBC yield right now is 15.41% on aerodrome-v1 (Base), among 10 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDBC shows up in 8 pools here, with rates from 0.01% to 15.41% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| aerodrome-v1 | 15.41% | 18.49% | 100.00% incentives |
| aerodrome-v1 | 0.82% | 1.47% | 100.00% incentives |
| aerodrome-v1 | 6.27% | 6.51% | 100.00% incentives |
| curve-dex | 7.73% | 6.28% | 99.61% incentives |
| aerodrome-slipstream | 0.70% | 0.84% | 66.17% incentives |
| alien-base-v3 | 0.01% | 0.07% | Base rate |
| alien-base-v3 | 3.40% | 4.46% | 99.06% incentives |
| symbiosis | 1.25% | 1.47% | Base rate |
...
15.41% APY on aerodrome-v1 (Base), based on live DefiLlama data.
