...
The highest honest USDBC yield right now is 15.46% on aerodrome-v1 (Base), among 10 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDBC shows up in 8 pools here, with rates from 0.11% to 15.46% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| aerodrome-v1 | 15.46% | 17.95% | 100.00% incentives |
| aerodrome-v1 | 0.82% | 1.26% | 100.00% incentives |
| aerodrome-v1 | 6.29% | 6.43% | 100.00% incentives |
| curve-dex | 8.93% | 6.40% | 98.10% incentives |
| aerodrome-slipstream | 0.60% | 0.82% | 77.48% incentives |
| alien-base-v3 | 0.11% | 0.07% | Base rate |
| alien-base-v3 | 3.52% | 4.39% | 99.01% incentives |
| symbiosis | 1.44% | 1.48% | Base rate |
...
15.46% APY on aerodrome-v1 (Base), based on live DefiLlama data.

### How many USDBC pools clear the TVL floor?

10 live pools clear this page's $100K TVL floor, $1.62M in total.
