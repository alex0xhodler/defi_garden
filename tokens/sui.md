...
The highest honest SUI yield right now is 32.41% on cetus-clmm (Sui), among 24 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SUI shows up in 8 pools here, with rates from 0.08% to 32.41% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

8 of these 8 pools have a trustworthy 30-day average on file, with a median of 4.82% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| cetus-clmm | 31.37% | 45.88% | 35.12% incentives |
| ember-protocol | 5.40% | 5.69% | Base rate |
| navi-lending | 2.01% | 2.19% | 17.98% incentives |
| cetus-clmm | 0.08% | 0.06% | Base rate |
| scallop-lend | 1.53% | 1.74% | Base rate |
| current | 2.40% | 3.95% | 78.07% incentives |
| cetus-clmm | 32.41% | 28.41% | 28.60% incentives |
| cetus-clmm | 17.00% | 13.30% | 16.30% incentives |
...
32.41% APY on cetus-clmm (Sui), based on live DefiLlama data.

### How many SUI pools clear the TVL floor?

24 live pools clear this page's $100K TVL floor, $26.41M in total.
