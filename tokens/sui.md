...
The highest honest SUI yield right now is 48.43% on bluefin-spot (Sui), among 24 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SUI shows up in 8 pools here, with rates from 0.01% to 48.43% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| cetus-clmm | 28.65% | 45.88% | 39.00% incentives |
| navi-lending | 2.01% | 2.20% | 17.95% incentives |
| cetus-clmm | 0.01% | 0.06% | Base rate |
| scallop-lend | 1.63% | 1.74% | Base rate |
| bluefin-spot | 48.43% | 41.79% | 56.14% incentives |
| current | 2.40% | 3.96% | 78.07% incentives |
| cetus-clmm | 34.23% | 28.39% | 27.05% incentives |
...
48.43% APY on bluefin-spot (Sui), based on live DefiLlama data.

### How many SUI pools clear the TVL floor?

24 live pools clear this page's $100K TVL floor, $26.71M in total.
