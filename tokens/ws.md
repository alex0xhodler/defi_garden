...
The highest honest WS yield right now is 56.21% on shadow-exchange-clmm (Sonic), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WS shows up in 6 pools here, with rates from 0.03% to 56.21% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| silo-v2 | 0.03% | 1.35% | Base rate |
| shadow-exchange-clmm | 56.21% | 111.34% | 100.00% incentives |
...
56.21% APY on shadow-exchange-clmm (Sonic), based on live DefiLlama data.
