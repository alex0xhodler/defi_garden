...
The highest honest WS yield right now is 84.46% on shadow-exchange-clmm (Sonic), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WS shows up in 6 pools here, with rates from 0.03% to 84.46% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| silo-v2 | 0.03% | 1.17% | Base rate |
| shadow-exchange-clmm | 84.46% | 107.12% | 100.00% incentives |
| beets-dex-v3 | 7.05% | 7.45% | 72.16% incentives |
