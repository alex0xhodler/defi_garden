...
The highest honest XRP yield right now is 79.23% on gmtrade (Solana), among 13 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
79.23% APY on gmtrade (Solana), based on live DefiLlama data.
