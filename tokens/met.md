...
The highest honest MET yield right now is 33.07% on aerodrome-v1 (Base), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
33.07% APY on aerodrome-v1 (Base), based on live DefiLlama data.
