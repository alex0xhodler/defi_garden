...
XAUT0 shows up in 5 pools here, with rates from 2.39% to 10.96% APY across 4 chains — the rate depends on which protocol and chain you pick, not just the token.

5 of these 5 pools have a trustworthy 30-day average on file, with a median of 3.85% — a useful check against today's number for whether the rate is steady or just having a good day.
...
| project-x | 9.96% | 10.03% | Base rate |
| ston.fi | 4.42% | 1.41% | Base rate |
| uniswap-v4 | 9.28% | 21.51% | Base rate |
