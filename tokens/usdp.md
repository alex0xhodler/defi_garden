...
The highest honest USDP yield right now is 12.37% on balancer-v3 (Hyperliquid L1), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDP shows up in 2 pools here, with rates from 10.64% to 12.37% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| balancer-v3 | 12.37% | 12.36% | 81.70% incentives |
...
12.37% APY on balancer-v3 (Hyperliquid L1), based on live DefiLlama data.
