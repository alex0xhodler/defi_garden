...
The highest honest USDP yield right now is 12.26% on balancer-v3 (Hyperliquid L1), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDP shows up in 2 pools here, with rates from 10.68% to 12.26% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| balancer-v3 | 12.26% | 12.39% | 82.01% incentives |
