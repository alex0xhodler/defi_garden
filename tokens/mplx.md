...
The highest honest MPLX yield right now is 1.39% on kamino-liquidity (Solana), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.39% APY on kamino-liquidity (Solana), based on live DefiLlama data.
