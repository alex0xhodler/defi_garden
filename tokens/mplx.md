...
MPLX shows up in 3 pools here, with rates from 2.00% to 4.11% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 4.11% | 4.62% | Base rate |
| orca-dex | 3.16% | 3.03% | Base rate |
| kamino-liquidity | 2.00% | 2.44% | Base rate |
