...
The highest honest IBTC yield right now is 5.96% on minswap-dex (Cardano), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [minswap-dex →](https://www.defi.garden/?pool=a8aea5e1-d9a1-420a-8695-9b0565a09737&src=seo_token) | Cardano | 5.96% | $111.4K |
...
IBTC shows up in 1 pools here, with rates from 5.96% to 5.96% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| minswap-dex | 5.96% | 6.62% | 14.26% incentives |
...
5.96% APY on minswap-dex (Cardano), based on live DefiLlama data.
