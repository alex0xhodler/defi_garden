...
The highest honest USH yield right now is 5.33% on xexchange (MultiversX), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
5.33% APY on xexchange (MultiversX), based on live DefiLlama data.
