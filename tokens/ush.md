...
The highest honest USH yield right now is 4.47% on xexchange (MultiversX), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4.47% APY on xexchange (MultiversX), based on live DefiLlama data.
