...
USH shows up in 2 pools here, with rates from 7.71% to 15.88% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
15.88% APY on xexchange (MultiversX), based on live DefiLlama data.

### How many USH pools clear the TVL floor?

2 live pools clear this page's $100K TVL floor, $266.4K in total.
