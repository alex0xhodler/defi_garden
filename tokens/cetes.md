...
CETES shows up in 1 pools here, with rates from 2.50% to 2.50% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
