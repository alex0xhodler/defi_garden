...
The highest honest WBNB yield right now is 10.87% on uniswap-v3 (BSC), among 35 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WBNB shows up in 8 pools here, with rates from 0.02% to 47.54% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
