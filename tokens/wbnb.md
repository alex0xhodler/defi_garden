...
The highest honest WBNB yield right now is 22.18% on uniswap-v3 (BSC), among 32 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WBNB shows up in 8 pools here, with rates from 0.01% to 22.18% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| venus-core-pool | 0.11% | 0.15% | Base rate |
| pancakeswap-amm | 0.98% | 1.38% | Base rate |
| uniswap-v3 | 11.36% | 10.04% | Base rate |
| uniswap-v3 | 10.69% | 10.71% | Base rate |
| uniswap-v3 | 22.18% | 26.28% | Base rate |
...
22.18% APY on uniswap-v3 (BSC), based on live DefiLlama data.

### How many WBNB pools clear the TVL floor?

32 live pools clear this page's $100K TVL floor, $380.27M in total.
