...
The highest honest WAVAX yield right now is 147.12% on pharaoh-v3 (Avalanche), among 21 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WAVAX shows up in 8 pools here, with rates from 0.73% to 147.12% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
147.12% APY on pharaoh-v3 (Avalanche), based on live DefiLlama data.

### How many WAVAX pools clear the TVL floor?

21 live pools clear this page's $100K TVL floor, $92.33M in total.
