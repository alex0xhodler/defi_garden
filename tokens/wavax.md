...
The highest honest WAVAX yield right now is 142.67% on pharaoh-v3 (Avalanche), among 21 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WAVAX shows up in 8 pools here, with rates from 0.73% to 142.67% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| pharaoh-v3 | 17.46% | 21.32% | 100.00% incentives |
| uniswap-v3 | 6.96% | 10.08% | Base rate |
| aave-v4 | 1.20% | 0.90% | Base rate |
| pharaoh-v3 | 18.84% | 23.37% | 100.00% incentives |
| pharaoh-v3 | 142.67% | 142.05% | 100.00% incentives |
| uniswap-v3 | 10.42% | 17.35% | Base rate |
| joe-v2.2 | 51.10% | 43.63% | Base rate |
...
142.67% APY on pharaoh-v3 (Avalanche), based on live DefiLlama data.

### How many WAVAX pools clear the TVL floor?

21 live pools clear this page's $100K TVL floor, $92.2M in total.
