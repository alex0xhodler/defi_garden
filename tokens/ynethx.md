...
YNETHX shows up in 4 pools here, with rates from 4.17% to 5.02% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
