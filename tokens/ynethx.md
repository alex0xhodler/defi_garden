...
The highest honest YNETHX yield right now is 5.48% on stake-dao (Ethereum), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
YNETHX shows up in 4 pools here, with rates from 4.18% to 5.48% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
5.48% APY on stake-dao (Ethereum), based on live DefiLlama data.
