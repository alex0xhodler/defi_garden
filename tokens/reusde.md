...
REUSDE shows up in 5 pools here, with rates from 0.16% to 18.21% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| pendle-v2 | 17.49% | 17.54% | 2.89% incentives |
| pendle-v2 | 18.21% | 18.13% | Base rate |
| curve-dex | 0.16% | 0.20% | Base rate |
| uniswap-v4 | 4.83% | 24.50% | Base rate |
