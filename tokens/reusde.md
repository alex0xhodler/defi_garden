...
REUSDE shows up in 5 pools here, with rates from 0.20% to 18.28% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| re | 12.28% | 12.41% | Base rate |
| pendle | 18.28% | 18.11% | Base rate |
| pendle | 17.67% | 18.72% | 2.89% incentives |
| curve-dex | 0.20% | 0.36% | Base rate |
| uniswap-v4 | 11.12% | 35.64% | Base rate |
