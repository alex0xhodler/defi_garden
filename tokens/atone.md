...
The highest honest ATONE yield right now is 12.36% on osmosis-dex (Osmosis), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
12.36% APY on osmosis-dex (Osmosis), based on live DefiLlama data.
