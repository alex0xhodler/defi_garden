...
The highest honest TBTC yield right now is 4.59% on convex-finance (Ethereum), among 56 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4.59% APY on convex-finance (Ethereum), based on live DefiLlama data.
