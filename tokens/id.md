...
The highest honest ID yield right now is 10.69% on sushiswap-v3 (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
ID shows up in 2 pools here, with rates from 0.03% to 10.69% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
10.69% APY on sushiswap-v3 (Ethereum), based on live DefiLlama data.
