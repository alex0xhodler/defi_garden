...
FTUSD shows up in 4 pools here, with rates from 6.86% to 21.59% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| curve-dex | 6.86% | 5.92% | 88.34% incentives |
| convex-finance | 10.42% | 7.93% | 92.32% incentives |
