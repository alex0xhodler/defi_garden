...
SUSDU shows up in 2 pools here, with rates from 10.50% to 11.61% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| unitas-usdu | 11.61% | 10.86% | Base rate |
| unitas-usdu | 10.50% | 12.03% | Base rate |
