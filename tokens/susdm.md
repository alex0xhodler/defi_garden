...
SUSDM shows up in 2 pools here, with rates from 2.43% to 9.00% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
