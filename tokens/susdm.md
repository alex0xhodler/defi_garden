...
The highest honest SUSDM yield right now is 0.78% on hybra-v4 (Hyperliquid L1), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
|---|---|---|---|
| monetrix | 3.46% | 7.64% | Base rate |
| hybra-v4 | 0.78% | 1.55% | 100.00% incentives |
...
0.78% APY on hybra-v4 (Hyperliquid L1), based on live DefiLlama data.
