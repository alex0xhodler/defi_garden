...
The highest honest SUSDM yield right now is 0.93% on hybra-v4 (Hyperliquid L1), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SUSDM shows up in 2 pools here, with rates from 0.93% to 3.52% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
0.93% APY on hybra-v4 (Hyperliquid L1), based on live DefiLlama data.
