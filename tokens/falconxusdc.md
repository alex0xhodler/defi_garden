...
FALCONXUSDC shows up in 2 pools here, with rates from 7.89% to 17.49% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| royco-v2 | 7.89% | 6.18% | Base rate |
| royco-v2 | 17.49% | 14.64% | Base rate |
