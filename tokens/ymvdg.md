...
The highest honest YMVDG yield right now is 3.17% on morpho-blue (Katana), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
3.17% APY on morpho-blue (Katana), based on live DefiLlama data.
