...
The highest honest EURM yield right now is 22.29% on mento-v3 (Monad), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
EURM shows up in 1 pools here, with rates from 22.29% to 22.29% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

1 of these 1 pool has a trustworthy 30-day average on file, with a median of 25.67% — a useful check against today's number for whether the rate is steady or just having a good day.
...
22.29% APY on mento-v3 (Monad), based on live DefiLlama data.
