...
The highest honest HBAR yield right now is 10.98% on saucerswap-v1 (Hedera), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
10.98% APY on saucerswap-v1 (Hedera), based on live DefiLlama data.
