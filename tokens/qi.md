...
QI shows up in 2 pools here, with rates from 0.01% to 6.55% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| pangolin-v2 | 6.55% | 7.75% | Base rate |
...
6.55% APY on pangolin-v2 (Avalanche), based on live DefiLlama data.
