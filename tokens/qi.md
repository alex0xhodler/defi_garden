...
The highest honest QI yield right now is 6.76% on pangolin-v2 (Avalanche), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
QI shows up in 1 pools here, with rates from 6.76% to 6.76% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pangolin-v2 | 6.76% | 7.29% | Base rate |
...
6.76% APY on pangolin-v2 (Avalanche), based on live DefiLlama data.
