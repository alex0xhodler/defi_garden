...
The highest honest QI yield right now is 1.86% on pangolin-v2 (Avalanche), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
QI shows up in 1 pools here, with rates from 1.86% to 1.86% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pangolin-v2 | 1.86% | 17.63% | Base rate |
...
1.86% APY on pangolin-v2 (Avalanche), based on live DefiLlama data.
