...
The highest honest CJPY yield right now is 13.02% on convex-finance (Ethereum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
CJPY shows up in 4 pools here, with rates from 6.41% to 13.02% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

4 of these 4 pools have a trustworthy 30-day average on file, with a median of 8.45% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| curve-dex | 6.41% | 6.38% | 99.53% incentives |
| curve-dex | 8.75% | 7.17% | 99.31% incentives |
| convex-finance | 13.02% | 10.24% | 99.54% incentives |
| convex-finance | 12.55% | 9.73% | 99.76% incentives |
