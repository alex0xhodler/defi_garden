...
AAVEGHO shows up in 3 pools here, with rates from 2.51% to 4.05% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| balancer-v3 | 2.51% | 2.40% | Base rate |
