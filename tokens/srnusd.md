...
SRNUSD shows up in 3 pools here, with rates from 4.01% to 8.27% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| strata-markets | 4.01% | 3.99% | Base rate |
| pendle | 5.77% | 5.70% | Base rate |
| pendle | 8.27% | 8.21% | Base rate |
