...
The highest honest USD0 yield right now is 1.41% on uniswap-v3 (Ethereum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USD0 shows up in 5 pools here, with rates from 0.01% to 1.41% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 1.41% | 0.92% | Base rate |
| uniswap-v3 | 0.42% | 0.56% | Base rate |
| curve-dex | 0.04% | 0.12% | Base rate |
