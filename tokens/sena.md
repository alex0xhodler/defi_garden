...
SENA shows up in 3 pools here, with rates from 0.11% to 14.62% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
