...
POPCAT shows up in 2 pools here, with rates from 11.29% to 11.44% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 11.44% | 10.77% | Base rate |
| raydium-amm | 11.29% | 15.19% | Base rate |
