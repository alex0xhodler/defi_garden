...
The highest honest JRUSDAT yield right now is 37.92% on strata-markets (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
JRUSDAT shows up in 3 pools here, with rates from 10.94% to 37.92% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| strata-markets | 37.92% | 46.24% | Base rate |
...
37.92% APY on strata-markets (Ethereum), based on live DefiLlama data.
