...
The highest honest JRUSDAT yield right now is 33.85% on strata-markets (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
33.85% APY on strata-markets (Ethereum), based on live DefiLlama data.
