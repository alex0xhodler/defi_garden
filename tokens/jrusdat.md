...
The highest honest JRUSDAT yield right now is 37.50% on strata-markets (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
37.50% APY on strata-markets (Ethereum), based on live DefiLlama data.
