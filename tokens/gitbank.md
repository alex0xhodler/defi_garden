...
The highest honest GITBANK yield right now is 4.32% on uniswap-v4 (Base), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4.32% APY on uniswap-v4 (Base), based on live DefiLlama data.
