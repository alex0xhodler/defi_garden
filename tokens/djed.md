...
The highest honest DJED yield right now is 12.69% on liqwid (Cardano), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
DJED shows up in 2 pools here, with rates from 10.94% to 12.69% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| liqwid | 12.69% | 12.91% | Base rate |
| minswap-dex | 10.94% | 10.52% | 7.22% incentives |
...
12.69% APY on liqwid (Cardano), based on live DefiLlama data.
