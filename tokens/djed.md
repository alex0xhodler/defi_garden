...
DJED shows up in 2 pools here, with rates from 9.73% to 12.82% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| minswap-dex | 9.73% | 10.69% | 8.43% incentives |
