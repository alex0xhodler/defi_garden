...
DJED shows up in 2 pools here, with rates from 9.70% to 12.82% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| liqwid | 12.82% | 12.94% | Base rate |
| minswap-dex | 9.70% | 10.68% | 8.45% incentives |
