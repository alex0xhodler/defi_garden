...
DJED shows up in 2 pools here, with rates from 9.69% to 12.87% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| minswap-dex | 9.69% | 10.89% | 8.46% incentives |
