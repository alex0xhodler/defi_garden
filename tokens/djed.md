...
DJED shows up in 2 pools here, with rates from 9.54% to 12.87% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| minswap-dex | 9.54% | 10.87% | 8.70% incentives |
