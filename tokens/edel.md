...
The highest honest EDEL yield right now is 109.28% on orca-dex (Solana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
EDEL shows up in 3 pools here, with rates from 86.84% to 109.28% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.

3 of these 3 pools have a trustworthy 30-day average on file, with a median of 134.17% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| aerodrome-v1 | 92.76% | 50.19% | 100.00% incentives |
| orca-dex | 86.84% | 150.19% | Base rate |
| orca-dex | 109.28% | 134.17% | Base rate |
...
109.28% APY on orca-dex (Solana), based on live DefiLlama data.
