...
The highest honest PENDLE yield right now is 19.69% on uniswap-v3 (Arbitrum), among 15 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
PENDLE shows up in 8 pools here, with rates from 0.15% to 118.06% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| camelot-v2 | 2.21% | 2.89% | Base rate |
| uniswap-v3 | 11.18% | 15.73% | Base rate |
| uniswap-v3 | 19.69% | 36.35% | Base rate |
| dolomite | 0.39% | 0.38% | Base rate |
| uniswap-v3 | 8.55% | 16.80% | Base rate |
| uniswap-v4 | 14.74% | 14.46% | Base rate |
| gmx-v2-perps | 0.15% | 2.45% | Base rate |
| uniswap-v3 | 118.06% | 42.68% | Base rate |
...
19.69% APY on uniswap-v3 (Arbitrum), based on live DefiLlama data.
