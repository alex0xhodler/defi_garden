...
The highest honest PENDLE yield right now is 18.83% on uniswap-v3 (Arbitrum), among 15 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
PENDLE shows up in 8 pools here, with rates from 0.15% to 100.45% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| camelot-v2 | 2.17% | 2.88% | Base rate |
| uniswap-v3 | 11.06% | 15.68% | Base rate |
| uniswap-v3 | 18.83% | 36.24% | Base rate |
| dolomite | 0.39% | 0.38% | Base rate |
| uniswap-v3 | 8.11% | 16.75% | Base rate |
| uniswap-v4 | 11.64% | 14.45% | Base rate |
| gmx-v2-perps | 0.15% | 2.44% | Base rate |
| uniswap-v3 | 100.45% | 42.72% | Base rate |
...
18.83% APY on uniswap-v3 (Arbitrum), based on live DefiLlama data.
