...
3 of these 3 pools have a trustworthy 30-day average on file, with a median of 11.72% — a useful check against today's number for whether the rate is steady or just having a good day.

All 3 pools pay a plain base rate right now — no incentive or reward APY mixed in.

| Protocol | APY | 30d Mean APY | Yield mix |
|---|---|---|---|
| parallel-protocol-v3 | 12.00% | 11.72% | Base rate |
...
3 live pools clear this page's $100K TVL floor, $683.8K in total.
