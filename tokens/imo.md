...
IMO shows up in 2 pools here, with rates from 0.12% to 4.49% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 4.49% | 3.00% | Base rate |
| balancer-v2 | 0.12% | 0.50% | Base rate |
