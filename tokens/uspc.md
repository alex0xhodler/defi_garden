...
USPC shows up in 2 pools here, with rates from 2.76% to 5.66% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| curve-dex | 2.76% | 2.76% | 100.00% incentives |
| convex-finance | 5.66% | 7.20% | 99.82% incentives |
