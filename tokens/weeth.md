...
The highest honest WEETH yield right now is 3.35% on stake-dao (Ethereum), among 67 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WEETH shows up in 8 pools here, with rates from 0.02% to 3.35% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| curve-dex | 2.54% | 2.42% | 26.82% incentives |
| convex-finance | 2.99% | 2.78% | 37.78% incentives |
| uniswap-v3 | 0.02% | 0.08% | Base rate |
| stake-dao | 3.35% | 3.02% | 42.41% incentives |
...
3.35% APY on stake-dao (Ethereum), based on live DefiLlama data.
