...
The highest honest OSMO yield right now is 4.95% on osmosis-dex (Osmosis), among 7 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4.95% APY on osmosis-dex (Osmosis), based on live DefiLlama data.
