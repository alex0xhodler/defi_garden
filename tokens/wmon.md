...
WMON shows up in 6 pools here, with rates from 0.02% to 118.88% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

6 of these 6 pools have a trustworthy 30-day average on file, with a median of 5.85% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| uniswap-v3 | 118.88% | 240.33% | Base rate |
| curve-dex | 5.35% | 13.23% | 100.00% incentives |
| curvance | 1.82% | 1.88% | 74.05% incentives |
| neverland | 8.23% | 8.84% | 41.29% incentives |
...
8.23% APY on neverland (Monad), based on live DefiLlama data.
