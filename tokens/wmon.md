...
The highest honest WMON yield right now is 27.11% on uniswap-v3 (Monad), among 9 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WMON shows up in 6 pools here, with rates from 0.03% to 27.11% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
27.11% APY on uniswap-v3 (Monad), based on live DefiLlama data.
