...
SIERRA shows up in 3 pools here, with rates from 0.01% to 8.10% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle | 5.61% | 5.81% | 2.99% incentives |
| pendle | 8.10% | 8.05% | Base rate |
