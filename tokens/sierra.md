...
The highest honest SIERRA yield right now is 9.56% on pendle (Ethereum), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
9.56% APY on pendle (Ethereum), based on live DefiLlama data.
