...
The highest honest COREWFLR yield right now is 3.80% on mystic-finance-lending (Flare), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
3.80% APY on mystic-finance-lending (Flare), based on live DefiLlama data.
