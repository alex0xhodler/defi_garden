...
ETHX shows up in 4 pools here, with rates from 2.23% to 6.88% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| curve-dex | 4.72% | 8.75% | 63.37% incentives |
| stake-dao-yield | 6.88% | 10.49% | 72.97% incentives |
| convex-finance | 6.56% | 9.53% | 73.64% incentives |
...
6.88% APY on stake-dao-yield (Ethereum), based on live DefiLlama data.

### How many ETHX pools clear the TVL floor?

6 live pools clear this page's $100K TVL floor, $204.01M in total.
