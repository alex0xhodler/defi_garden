...
The highest honest FET yield right now is 5.24% on minswap-dex (Cardano), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
FET shows up in 3 pools here, with rates from 3.20% to 5.24% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 3.20% | 7.91% | Base rate |
| uniswap-v4 | 3.20% | 5.80% | Base rate |
| minswap-dex | 5.24% | 6.07% | 40.65% incentives |
...
5.24% APY on minswap-dex (Cardano), based on live DefiLlama data.
