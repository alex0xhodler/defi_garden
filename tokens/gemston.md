...
GEMSTON shows up in 3 pools here, with rates from 0.30% to 0.89% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| ston.fi | 0.89% | 1.48% | Base rate |
| ston.fi | 0.30% | 0.49% | Base rate |
| ston.fi | 0.70% | 1.55% | Base rate |
