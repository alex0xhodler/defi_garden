...
The highest honest GEMSTON yield right now is 0.93% on ston.fi (TON), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
GEMSTON shows up in 3 pools here, with rates from 0.04% to 0.93% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| ston.fi | 0.93% | 1.31% | Base rate |
| ston.fi | 0.04% | 0.39% | Base rate |
| ston.fi | 0.77% | 1.40% | Base rate |
...
0.93% APY on ston.fi (TON), based on live DefiLlama data.
