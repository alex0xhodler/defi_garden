...
The highest honest GEMSTON yield right now is 0.74% on ston.fi (TON), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
GEMSTON shows up in 3 pools here, with rates from 0.04% to 0.74% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| ston.fi | 0.74% | 1.40% | Base rate |
| ston.fi | 0.04% | 0.42% | Base rate |
| ston.fi | 0.48% | 1.43% | Base rate |
...
0.74% APY on ston.fi (TON), based on live DefiLlama data.

### How many GEMSTON pools clear the TVL floor?

3 live pools clear this page's $100K TVL floor, $423.7K in total.
