...
The highest honest SYUSD yield right now is 5.45% on pendle (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SYUSD shows up in 2 pools here, with rates from 3.89% to 5.45% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle | 3.89% | 5.69% | Base rate |
| pendle | 5.45% | 4.99% | Base rate |
...
5.45% APY on pendle (Ethereum), based on live DefiLlama data.
