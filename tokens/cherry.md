...
The highest honest CHERRY yield right now is 10.18% on ston.fi (TON), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
10.18% APY on ston.fi (TON), based on live DefiLlama data.
