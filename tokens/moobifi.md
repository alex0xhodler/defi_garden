...
The highest honest MOOBIFI yield right now is 1.22% on velodrome-v2 (OP Mainnet), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
MOOBIFI shows up in 1 pools here, with rates from 1.22% to 1.22% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| velodrome-v2 | 1.22% | 1.39% | 100.00% incentives |
...
1.22% APY on velodrome-v2 (OP Mainnet), based on live DefiLlama data.
