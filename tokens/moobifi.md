...
MOOBIFI shows up in 1 pools here, with rates from 3.04% to 3.04% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| velodrome-v2 | 3.04% | 9.30% | 100.00% incentives |
...
3.04% APY on velodrome-v2 (OP Mainnet), based on live DefiLlama data.
