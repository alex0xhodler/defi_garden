...
BOBO shows up in 2 pools here, with rates from 0.09% to 0.32% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 0.32% | 0.38% | Base rate |
| uniswap-v2 | 0.09% | 0.07% | Base rate |
