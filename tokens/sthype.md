...
STHYPE shows up in 2 pools here, with rates from 2.27% to 2.28% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| pendle-v2 | 2.28% | 2.55% | 4.32% incentives |
