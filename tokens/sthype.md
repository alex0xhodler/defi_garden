...
The highest honest STHYPE yield right now is 2.51% on pendle-v2 (Hyperliquid L1), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
STHYPE shows up in 2 pools here, with rates from 2.20% to 2.51% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle-v2 | 2.20% | 2.17% | Base rate |
| pendle-v2 | 2.51% | 2.75% | 8.26% incentives |
...
2.51% APY on pendle-v2 (Hyperliquid L1), based on live DefiLlama data.
