...
The highest honest STHYPE yield right now is 2.41% on pendle-v2 (Hyperliquid L1), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
STHYPE shows up in 3 pools here, with rates from 0.18% to 2.41% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle-v2 | 2.41% | 2.46% | 9.02% incentives |
| pendle-v2 | 2.33% | 2.28% | Base rate |
| hyperswap-v3 | 0.18% | 0.66% | Base rate |
...
2.41% APY on pendle-v2 (Hyperliquid L1), based on live DefiLlama data.
