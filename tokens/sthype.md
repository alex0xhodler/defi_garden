...
STHYPE shows up in 3 pools here, with rates from 0.03% to 2.44% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle-v2 | 2.44% | 2.47% | 10.53% incentives |
| pendle-v2 | 2.27% | 2.27% | Base rate |
| hyperswap-v3 | 0.03% | 0.66% | Base rate |
