...
STHYPE shows up in 3 pools here, with rates from 0.01% to 2.28% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle-v2 | 2.25% | 2.49% | 2.29% incentives |
| pendle-v2 | 2.28% | 2.28% | Base rate |
| hyperswap-v3 | 0.01% | 0.68% | Base rate |
