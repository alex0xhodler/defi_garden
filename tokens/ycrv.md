...
The highest honest YCRV yield right now is 15.93% on yearn-finance (Ethereum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
YCRV shows up in 5 pools here, with rates from 8.54% to 15.93% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| yearn-finance | 15.93% | 18.70% | Base rate |
| curve-dex | 8.95% | 8.82% | 95.76% incentives |
| yearn-finance | 14.30% | 14.60% | Base rate |
| convex-finance | 15.45% | 15.19% | 97.54% incentives |
| stake-dao | 8.54% | 14.28% | Base rate |
...
15.93% APY on yearn-finance (Ethereum), based on live DefiLlama data.

### How many YCRV pools clear the TVL floor?

5 live pools clear this page's $100K TVL floor, $11.27M in total.
