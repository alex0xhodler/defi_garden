...
The highest honest YCRV yield right now is 15.97% on yearn-finance (Ethereum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
YCRV shows up in 5 pools here, with rates from 8.07% to 15.97% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
15.97% APY on yearn-finance (Ethereum), based on live DefiLlama data.

### How many YCRV pools clear the TVL floor?

5 live pools clear this page's $100K TVL floor, $11.84M in total.
