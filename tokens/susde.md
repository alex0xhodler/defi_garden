...
The highest honest SUSDE yield right now is 6.13% on convex-finance (Ethereum), among 60 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SUSDE shows up in 8 pools here, with rates from 2.06% to 12.02% APY across 4 chains — the rate depends on which protocol and chain you pick, not just the token.
