...
CDCBTC shows up in 2 pools here, with rates from 0.01% to 0.22% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| vvs-flawless | 0.22% | 1.17% | Base rate |
