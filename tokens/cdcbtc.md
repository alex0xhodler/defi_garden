...
The highest honest CDCBTC yield right now is 0.69% on tectonic (Cronos), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
0.69% APY on tectonic (Cronos), based on live DefiLlama data.
