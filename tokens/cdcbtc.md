...
The highest honest CDCBTC yield right now is 1.18% on vvs-flawless (Cronos), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.18% APY on vvs-flawless (Cronos), based on live DefiLlama data.
