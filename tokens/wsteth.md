...
The highest honest WSTETH yield right now is 4.58% on convex-finance (Ethereum), among 138 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WSTETH shows up in 8 pools here, with rates from 0.03% to 4.58% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| fluid-lending | 0.03% | 0.03% | Base rate |
| uniswap-v3 | 1.10% | 1.82% | Base rate |
