...
The highest honest MHYPER yield right now is 8.92% on pendle (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
MHYPER shows up in 2 pools here, with rates from 8.34% to 8.92% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle | 8.92% | 8.35% | Base rate |
| pendle | 8.34% | 8.39% | Base rate |
