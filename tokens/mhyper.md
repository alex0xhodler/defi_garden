...
MHYPER shows up in 2 pools here, with rates from 8.28% to 8.69% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
