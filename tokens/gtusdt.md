...
The highest honest GTUSDT yield right now is 2.98% on morpho-blue (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
GTUSDT shows up in 3 pools here, with rates from 2.07% to 2.98% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| morpho-blue | 2.98% | 3.38% | Base rate |
| morpho-blue | 2.07% | 2.95% | Base rate |
| morpho-blue | 2.80% | 5.96% | 35.66% incentives |
