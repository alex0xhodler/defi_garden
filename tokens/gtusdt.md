...
GTUSDT shows up in 3 pools here, with rates from 1.57% to 3.54% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
