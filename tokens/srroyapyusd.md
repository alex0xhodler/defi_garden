...
The highest honest SRROYAPYUSD yield right now is 91.44% on royco-v2 (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
91.44% APY on royco-v2 (Ethereum), based on live DefiLlama data.
