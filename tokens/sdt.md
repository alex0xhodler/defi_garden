...
The highest honest SDT yield right now is 10.36% on stake-dao (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SDT shows up in 2 pools here, with rates from 8.99% to 10.36% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| curve-dex | 8.99% | 9.46% | 98.66% incentives |
| stake-dao | 10.36% | 10.69% | 97.49% incentives |
...
10.36% APY on stake-dao (Ethereum), based on live DefiLlama data.
