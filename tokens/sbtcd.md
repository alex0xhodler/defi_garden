...
The highest honest SBTCD yield right now is 7.05% on btcd (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
7.05% APY on btcd (Ethereum), based on live DefiLlama data.
