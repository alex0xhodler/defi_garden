...
USYC shows up in 2 pools here, with rates from 3.24% to 3.24% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| circle-usyc | 3.24% | 3.19% | Base rate |
| circle-usyc | 3.24% | 3.19% | Base rate |
...
3.24% APY on circle-usyc (BSC), based on live DefiLlama data.
