...
The highest honest HEMIBTC yield right now is 0.15% on sushiswap-v3 (Hemi), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
HEMIBTC shows up in 4 pools here, with rates from 0.15% to 11.23% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| curve-dex | 6.53% | 3.34% | 66.44% incentives |
| stake-dao | 6.93% | 4.50% | 94.09% incentives |
| convex-finance | 11.23% | 6.54% | 80.50% incentives |
| sushiswap-v3 | 0.15% | 0.53% | Base rate |
...
0.15% APY on sushiswap-v3 (Hemi), based on live DefiLlama data.

### How many HEMIBTC pools clear the TVL floor?

5 live pools clear this page's $100K TVL floor, $6.96M in total.
