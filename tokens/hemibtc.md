...
The highest honest HEMIBTC yield right now is 0.14% on sushiswap-v3 (Hemi), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
HEMIBTC shows up in 4 pools here, with rates from 0.14% to 11.24% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| curve-dex | 6.53% | 3.34% | 66.48% incentives |
| stake-dao | 6.94% | 4.50% | 94.09% incentives |
| convex-finance | 11.24% | 6.54% | 80.51% incentives |
| sushiswap-v3 | 0.14% | 0.53% | Base rate |
