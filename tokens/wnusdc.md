...
The highest honest WNUSDC yield right now is 7.87% on balancer-v3 (Monad), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WNUSDC shows up in 1 pools here, with rates from 7.87% to 7.87% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
