...
The highest honest KDK yield right now is 30.14% on berapaw (Berachain), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
30.14% APY on berapaw (Berachain), based on live DefiLlama data.
