...
The highest honest ALD yield right now is 0.62% on convex-finance (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
ALD shows up in 2 pools here, with rates from 0.60% to 0.62% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
0.62% APY on convex-finance (Ethereum), based on live DefiLlama data.
