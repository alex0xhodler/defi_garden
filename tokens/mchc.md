...
The highest honest MCHC yield right now is 0.32% on quickswap-dex (Polygon), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
0.32% APY on quickswap-dex (Polygon), based on live DefiLlama data.
