...
The highest honest SBOLD yield right now is 5.25% on pendle (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SBOLD shows up in 2 pools here, with rates from 3.52% to 5.25% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle | 5.25% | 5.48% | 0.14% incentives |
| pendle | 3.52% | 3.56% | Base rate |
...
5.25% APY on pendle (Ethereum), based on live DefiLlama data.
