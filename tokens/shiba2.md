...
SHIBA2 shows up in 2 pools here, with rates from 2.09% to 5.30% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 2.09% | 1.57% | Base rate |
| uniswap-v3 | 5.30% | 3.17% | Base rate |
