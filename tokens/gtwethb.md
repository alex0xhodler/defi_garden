...
GTWETHB shows up in 2 pools here, with rates from 1.62% to 1.82% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| morpho-blue | 1.62% | 1.64% | Base rate |
| morpho-blue | 1.82% | 1.73% | Base rate |
