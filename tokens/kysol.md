...
KYSOL shows up in 2 pools here, with rates from 0.04% to 5.14% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| kyros | 5.14% | 5.40% | Base rate |
| raydium-amm | 0.04% | 0.07% | Base rate |
