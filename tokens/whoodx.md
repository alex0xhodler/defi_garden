...
The highest honest WHOODX yield right now is 0.66% on fluxion-network (Mantle), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
0.66% APY on fluxion-network (Mantle), based on live DefiLlama data.
