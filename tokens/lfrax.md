...
The highest honest LFRAX yield right now is 9.08% on stake-dao-yield (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
9.08% APY on stake-dao-yield (Ethereum), based on live DefiLlama data.
