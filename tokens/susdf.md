...
SUSDF shows up in 3 pools here, with rates from 4.47% to 6.37% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| falcon-finance | 4.47% | 4.96% | Base rate |
| pendle-v2 | 6.37% | 5.47% | Base rate |
| pendle-v2 | 5.55% | 5.12% | Base rate |
