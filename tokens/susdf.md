...
SUSDF shows up in 3 pools here, with rates from 4.27% to 5.33% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| falcon-finance | 4.27% | 5.03% | Base rate |
| pendle | 4.50% | 5.48% | Base rate |
...
3 live pools clear this page's $100K TVL floor, $67.52M in total.
