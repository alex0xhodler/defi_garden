...
PEAS shows up in 3 pools here, with rates from 3.03% to 6.45% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 3.03% | 16.56% | Base rate |
| uniswap-v3 | 6.45% | 26.87% | Base rate |
| uniswap-v3 | 4.91% | 10.97% | Base rate |
