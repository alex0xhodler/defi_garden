...
FIN shows up in 2 pools here, with rates from 4.81% to 6.35% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 6.35% | 28.47% | Base rate |
| uniswap-v4 | 4.81% | 6.13% | Base rate |
...
4.81% APY on uniswap-v4 (Polygon), based on live DefiLlama data.

### How many FIN pools clear the TVL floor?

4 live pools clear this page's $100K TVL floor, $845.4K in total.
