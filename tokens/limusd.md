...
The highest honest LIMUSD yield right now is 9.14% on liminal-basis (Ethereum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
9.14% APY on liminal-basis (Ethereum), based on live DefiLlama data.
