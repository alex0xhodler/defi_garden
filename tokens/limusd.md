...
The highest honest LIMUSD yield right now is 9.84% on pendle (Hyperliquid L1), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
LIMUSD shows up in 5 pools here, with rates from 7.61% to 9.84% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| liminal-basis | 7.89% | 7.73% | Base rate |
| pendle | 9.09% | 9.24% | Base rate |
| pendle | 9.84% | 8.70% | Base rate |
| liminal-basis | 7.89% | 7.73% | Base rate |
...
9.84% APY on pendle (Hyperliquid L1), based on live DefiLlama data.
