...
The highest honest LIMUSD yield right now is 11.19% on pendle-v2 (Hyperliquid L1), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
LIMUSD shows up in 4 pools here, with rates from 7.54% to 11.19% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
11.19% APY on pendle-v2 (Hyperliquid L1), based on live DefiLlama data.
