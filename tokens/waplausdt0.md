...
The highest honest WAPLAUSDT0 yield right now is 1.98% on balancer-v3 (Plasma), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.98% APY on balancer-v3 (Plasma), based on live DefiLlama data.
