...
WXDAI shows up in 3 pools here, with rates from 0.09% to 1.50% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
