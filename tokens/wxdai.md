...
The highest honest WXDAI yield right now is 1.80% on aave-v3 (Gnosis), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.80% APY on aave-v3 (Gnosis), based on live DefiLlama data.
