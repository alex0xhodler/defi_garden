...
WXDAI shows up in 3 pools here, with rates from 0.14% to 4.34% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| curve-dex | 0.14% | 0.27% | Base rate |
| aave-v3 | 1.91% | 2.92% | Base rate |
