...
The highest honest WAL yield right now is 52.58% on bluefin-spot (Sui), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
52.58% APY on bluefin-spot (Sui), based on live DefiLlama data.
