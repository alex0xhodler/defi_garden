...
EEARN shows up in 4 pools here, with rates from 10.08% to 41.37% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| current | 10.08% | 11.09% | 8.31% incentives |
| bluefin-spot | 41.37% | 14.76% | 19.32% incentives |
