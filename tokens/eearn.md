...
EEARN shows up in 4 pools here, with rates from 9.96% to 17.44% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| current | 11.27% | 11.07% | 9.57% incentives |
| bluefin-spot | 17.44% | 25.74% | 99.49% incentives |
...
17.44% APY on bluefin-spot (Sui), based on live DefiLlama data.
