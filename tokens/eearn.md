...
The highest honest EEARN yield right now is 17.67% on bluefin-spot (Sui), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
EEARN shows up in 4 pools here, with rates from 9.96% to 17.67% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| current | 11.27% | 11.08% | 9.61% incentives |
| bluefin-spot | 17.67% | 25.80% | 99.50% incentives |
...
17.67% APY on bluefin-spot (Sui), based on live DefiLlama data.
