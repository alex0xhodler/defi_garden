...
EURCV shows up in 2 pools here, with rates from 0.35% to 0.57% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 0.57% | 0.64% | Base rate |
