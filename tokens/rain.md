...
RAIN shows up in 3 pools here, with rates from 2.82% to 5.05% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 2.82% | 3.93% | Base rate |
| uniswap-v3 | 4.87% | 9.01% | Base rate |
| uniswap-v3 | 5.05% | 7.73% | Base rate |
