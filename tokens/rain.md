...
The highest honest RAIN yield right now is 15.18% on uniswap-v3 (Arbitrum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
RAIN shows up in 2 pools here, with rates from 2.14% to 15.18% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 15.18% | 2.96% | Base rate |
| uniswap-v3 | 2.14% | 14.39% | Base rate |
...
15.18% APY on uniswap-v3 (Arbitrum), based on live DefiLlama data.
