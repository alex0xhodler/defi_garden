...
NEUY shows up in 2 pools here, with rates from 6.72% to 44.54% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 6.72% | 6.16% | Base rate |
| uniswap-v3 | 44.54% | 33.18% | Base rate |
...
44.54% APY on uniswap-v3 (Base), based on live DefiLlama data.
