...
The highest honest NEUY yield right now is 5.56% on uniswap-v3 (Polygon), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
5.56% APY on uniswap-v3 (Polygon), based on live DefiLlama data.
