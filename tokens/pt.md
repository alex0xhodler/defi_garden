...
The highest honest PT yield right now is 4.87% on neverland (Monad), among 38 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
PT shows up in 5 pools here, with rates from 0.20% to 4.87% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| neverland | 4.87% | 3.96% | 100.00% incentives |
| curvance | 0.20% | 0.20% | 100.00% incentives |
...
4.87% APY on neverland (Monad), based on live DefiLlama data.

### How many PT pools clear the TVL floor?

38 live pools clear this page's $100K TVL floor, $429.98M in total.
