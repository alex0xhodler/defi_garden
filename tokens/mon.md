...
The highest honest MON yield right now is 6.47% on uniswap-v4 (Monad), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
6.47% APY on uniswap-v4 (Monad), based on live DefiLlama data.
