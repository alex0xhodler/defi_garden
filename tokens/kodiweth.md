...
The highest honest KODIWETH yield right now is 31.98% on berapaw (Berachain), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
31.98% APY on berapaw (Berachain), based on live DefiLlama data.
