...
VNXAU shows up in 2 pools here, with rates from 0.56% to 2.18% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 0.56% | 2.40% | Base rate |
