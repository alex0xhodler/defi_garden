...
USDD shows up in 4 pools here, with rates from 0.02% to 4.00% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| justlend-v1 | 4.00% | 4.00% | 99.98% incentives |
| raydium-amm | 0.03% | 0.13% | Base rate |
...
5 live pools clear this page's $100K TVL floor, $422.75M in total.
