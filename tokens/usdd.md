...
USDD shows up in 2 pools here, with rates from 0.11% to 3.93% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| justlend-v1 | 3.93% | 4.01% | 99.98% incentives |
...
3.93% APY on justlend-v1 (Tron), based on live DefiLlama data.

### How many USDD pools clear the TVL floor?

3 live pools clear this page's $100K TVL floor, $391.34M in total.
