...
The highest honest USDD yield right now is 4.10% on justlend-v1 (Tron), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDD shows up in 1 pools here, with rates from 4.10% to 4.10% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| justlend-v1 | 4.10% | 4.01% | 99.98% incentives |
...
2 live pools clear this page's $100K TVL floor, $406.53M in total.
