...
RSR shows up in 3 pools here, with rates from 1.72% to 57.94% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| steer-protocol | 57.94% | 29.83% | Base rate |
| uniswap-v3 | 50.17% | 35.49% | Base rate |
...
50.17% APY on uniswap-v3 (Ethereum), based on live DefiLlama data.
