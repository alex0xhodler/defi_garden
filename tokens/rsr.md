...
RSR shows up in 3 pools here, with rates from 2.39% to 6.20% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| steer-protocol | 6.20% | 23.65% | Base rate |
| uniswap-v3 | 5.49% | 21.36% | Base rate |
