...
HEGIC shows up in 1 pools here, with rates from 6.58% to 6.58% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
