...
HEGIC shows up in 2 pools here, with rates from 0.02% to 6.58% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 0.02% | 1.05% | Base rate |
