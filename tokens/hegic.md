...
HEGIC shows up in 2 pools here, with rates from 6.30% to 6.58% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 6.30% | 1.03% | Base rate |
