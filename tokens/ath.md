...
The highest honest ATH yield right now is 382.29% on uniswap-v4 (Polygon), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
ATH shows up in 2 pools here, with rates from 8.03% to 382.29% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.

2 of these 2 pools have a trustworthy 30-day average on file, with a median of 253.79% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| uniswap-v4 | 382.29% | 495.22% | Base rate |
| uniswap-v3 | 8.03% | 12.35% | Base rate |
...
382.29% APY on uniswap-v4 (Polygon), based on live DefiLlama data.
