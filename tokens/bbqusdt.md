...
The highest honest BBQUSDT yield right now is 4.03% on morpho-blue (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
BBQUSDT shows up in 2 pools here, with rates from 2.97% to 4.03% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| morpho-blue | 4.03% | 3.69% | Base rate |
| morpho-blue | 2.97% | 3.64% | Base rate |
