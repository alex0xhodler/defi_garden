...
The highest honest USTB yield right now is 3.51% on invesco-ustb (Ethereum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USTB shows up in 3 pools here, with rates from 3.51% to 3.51% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| invesco-ustb | 3.51% | 3.51% | Base rate |
| invesco-ustb | 3.51% | 3.51% | Base rate |
| invesco-ustb | 3.51% | 3.51% | Base rate |
...
3.51% APY on invesco-ustb (Ethereum), based on live DefiLlama data.
