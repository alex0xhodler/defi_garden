...
The highest honest STXRP yield right now is 2.96% on spectra-v2 (Flare), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
STXRP shows up in 4 pools here, with rates from 0.26% to 2.96% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| spectra-v2 | 2.63% | 2.88% | Base rate |
| spectra-v2 | 2.96% | 2.46% | Base rate |
...
2.96% APY on spectra-v2 (Flare), based on live DefiLlama data.

### How many STXRP pools clear the TVL floor?

4 live pools clear this page's $100K TVL floor, $10.4M in total.
