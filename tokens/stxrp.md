...
The highest honest STXRP yield right now is 3.01% on spectra-v2 (Flare), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
STXRP shows up in 4 pools here, with rates from 0.26% to 3.01% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

4 of these 4 pools have a trustworthy 30-day average on file, with a median of 1.98% — a useful check against today's number for whether the rate is steady or just having a good day.
...
| spectra-v2 | 2.66% | 2.88% | Base rate |
| spectra-v2 | 3.01% | 2.46% | Base rate |
...
3.01% APY on spectra-v2 (Flare), based on live DefiLlama data.
