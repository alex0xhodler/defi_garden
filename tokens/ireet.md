...
The highest honest IREET yield right now is 37.02% on convex-finance (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
IREET shows up in 3 pools here, with rates from 20.16% to 37.02% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
