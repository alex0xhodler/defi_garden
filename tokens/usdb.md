...
USDB shows up in 3 pools here, with rates from 0.01% to 0.09% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| cetus-clmm | 0.09% | 0.08% | 99.42% incentives |
