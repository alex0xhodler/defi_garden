...
The highest honest USDB yield right now is 0.56% on cetus-clmm (Sui), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDB shows up in 3 pools here, with rates from 0.01% to 0.56% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| cetus-clmm | 0.56% | 0.17% | 22.39% incentives |
...
0.56% APY on cetus-clmm (Sui), based on live DefiLlama data.
