...
The highest honest USDB yield right now is 0.14% on cetus-clmm (Sui), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDB shows up in 1 pools here, with rates from 0.14% to 0.14% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
