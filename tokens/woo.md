...
The highest honest WOO yield right now is 37.87% on aerodrome-slipstream (Base), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WOO shows up in 3 pools here, with rates from 2.58% to 37.87% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 2.58% | 2.82% | Base rate |
| uniswap-v4 | 2.84% | 6.42% | Base rate |
| aerodrome-slipstream | 37.87% | 54.85% | 95.38% incentives |
...
37.87% APY on aerodrome-slipstream (Base), based on live DefiLlama data.
