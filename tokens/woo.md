...
<<<<<<< HEAD
The highest honest WOO yield right now is 47.83% on aerodrome-slipstream (Base), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
<<<<<<< HEAD
47.83% APY on aerodrome-slipstream (Base), based on live DefiLlama data.
