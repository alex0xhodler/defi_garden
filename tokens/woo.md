...
WOO shows up in 3 pools here, with rates from 3.58% to 16.63% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v2 | 3.58% | 8.25% | Base rate |
| uniswap-v4 | 6.87% | 9.99% | Base rate |
| aerodrome-slipstream | 16.63% | 45.81% | 53.95% incentives |
...
6.87% APY on uniswap-v4 (Ethereum), based on live DefiLlama data.
