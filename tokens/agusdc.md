...
Based on APY history only, AGUSDC's lower-variability candidates are gami-labs (Avalanche), 7.61% APY, $1.04M TVL, https://www.defi.garden/?pool=3027f6e5-c7bf-4e44-a3a7-5e7211b374cc&src=seo_token; lagoon (Avalanche), 8.04% APY, $1.04M TVL, https://www.defi.garden/?pool=763f056b-94ce-47cc-843a-6beb6eee0946&src=seo_token. This comparison does not measure protocol, exploit, depeg, liquidity, governance, or principal-loss risk.
...
AGUSDC shows up in 2 pools here, with rates from 7.61% to 8.04% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| lagoon | 8.04% | 7.84% | Base rate |
| gami-labs | 7.61% | 8.75% | Base rate |
...
8.04% APY on lagoon (Avalanche), based on live DefiLlama data.
