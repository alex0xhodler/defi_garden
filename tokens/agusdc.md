...
AGUSDC shows up in 2 pools here, with rates from 7.93% to 8.04% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| gami-labs | 7.93% | 8.76% | Base rate |
| lagoon | 8.04% | 7.85% | Base rate |
