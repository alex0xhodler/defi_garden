...
TAROT shows up in 3 pools here, with rates from 8.61% to 64.82% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| velodrome-v2 | 64.82% | 60.08% | 100.00% incentives |
| aerodrome-v1 | 8.61% | 25.51% | 100.00% incentives |
| aerodrome-v1 | 17.78% | 27.81% | 100.00% incentives |
...
64.82% APY on velodrome-v2 (OP Mainnet), based on live DefiLlama data.

### How many TAROT pools clear the TVL floor?

3 live pools clear this page's $100K TVL floor, $634.9K in total.
