...
The highest honest TAROT yield right now is 62.10% on velodrome-v2 (OP Mainnet), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
TAROT shows up in 3 pools here, with rates from 26.60% to 62.10% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.

3 of these 3 pools have a trustworthy 30-day average on file, with a median of 32.20% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| velodrome-v2 | 62.10% | 55.96% | 100.00% incentives |
| aerodrome-v1 | 26.60% | 26.75% | 100.00% incentives |
| aerodrome-v1 | 29.03% | 32.20% | 100.00% incentives |
...
62.10% APY on velodrome-v2 (OP Mainnet), based on live DefiLlama data.
