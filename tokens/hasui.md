...
HASUI shows up in 3 pools here, with rates from 0.01% to 2.68% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
