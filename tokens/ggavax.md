...
The highest honest GGAVAX yield right now is 1.66% on hypha (Avalanche), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.66% APY on hypha (Avalanche), based on live DefiLlama data.
