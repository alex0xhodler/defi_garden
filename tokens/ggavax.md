...
The highest honest GGAVAX yield right now is 6.33% on hypha (Avalanche), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
GGAVAX shows up in 1 pools here, with rates from 6.33% to 6.33% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
6.33% APY on hypha (Avalanche), based on live DefiLlama data.
