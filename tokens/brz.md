...
The highest honest BRZ yield right now is 11.78% on curve-dex (Polygon), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
11.78% APY on curve-dex (Polygon), based on live DefiLlama data.
