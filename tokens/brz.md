...
BRZ shows up in 2 pools here, with rates from 0.72% to 14.30% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| curve-dex | 0.72% | 4.50% | Base rate |
| uniswap-v3 | 14.30% | 17.68% | Base rate |
...
14.30% APY on uniswap-v3 (Polygon), based on live DefiLlama data.

### How many BRZ pools clear the TVL floor?

2 live pools clear this page's $100K TVL floor, $475.7K in total.
