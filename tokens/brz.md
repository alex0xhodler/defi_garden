...
The highest honest BRZ yield right now is 1.88% on curve-dex (Polygon), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.88% APY on curve-dex (Polygon), based on live DefiLlama data.
