...
The highest honest GHST yield right now is 8.20% on aerodrome-slipstream (Base), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
GHST shows up in 2 pools here, with rates from 2.31% to 8.20% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| aerodrome-slipstream | 8.20% | 73.90% | 96.38% incentives |
| aerodrome-v1 | 2.31% | 5.16% | 100.00% incentives |
...
8.20% APY on aerodrome-slipstream (Base), based on live DefiLlama data.

### How many GHST pools clear the TVL floor?

2 live pools clear this page's $100K TVL floor, $716.3K in total.
