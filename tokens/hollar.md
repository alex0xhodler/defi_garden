...
The highest honest HOLLAR yield right now is 13.62% on hydration-dex (Polkadot), among 10 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
HOLLAR shows up in 8 pools here, with rates from 0.10% to 13.62% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| hydration-dex | 1.06% | 0.81% | Base rate |
| hydration-dex | 13.62% | 15.02% | 80.15% incentives |
| hydration-dex | 0.43% | 0.42% | Base rate |
...
13.62% APY on hydration-dex (Polkadot), based on live DefiLlama data.
