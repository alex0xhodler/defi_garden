...
HOLLAR shows up in 8 pools here, with rates from 0.10% to 2.71% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| hydration-dex | 1.06% | 0.83% | Base rate |
| hydration-dex | 2.71% | 14.71% | Base rate |
