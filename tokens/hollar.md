...
The highest honest HOLLAR yield right now is 1.07% on hydration-dex (Polkadot), among 10 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
HOLLAR shows up in 8 pools here, with rates from 0.10% to 2.72% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| hydration-dex | 2.72% | 14.79% | Base rate |
...
1.07% APY on hydration-dex (Polkadot), based on live DefiLlama data.
