...
EBTC shows up in 4 pools here, with rates from 0.31% to 0.83% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
