...
EBTC shows up in 4 pools here, with rates from 0.22% to 1.02% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| fluid-dex | 0.30% | 0.49% | Base rate |
| curve-dex | 0.84% | 0.36% | 39.25% incentives |
| convex-finance | 1.02% | 0.59% | 49.86% incentives |
...
1.02% APY on convex-finance (Ethereum), based on live DefiLlama data.
