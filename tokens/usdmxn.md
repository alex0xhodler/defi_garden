...
The highest honest USDMXN yield right now is 80.24% on gmx-solana (Solana), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
80.24% APY on gmx-solana (Solana), based on live DefiLlama data.
