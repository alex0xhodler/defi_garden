...
PSOL shows up in 2 pools here, with rates from 0.05% to 4.33% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| phantom-sol | 4.33% | 5.72% | Base rate |
