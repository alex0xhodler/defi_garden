...
The highest honest CSCORES yield right now is 5.65% on morpho-blue (Katana), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
5.65% APY on morpho-blue (Katana), based on live DefiLlama data.
