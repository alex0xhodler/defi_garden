...
The highest honest ORBS yield right now is 4.65% on quickswap-dex (Polygon), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4.65% APY on quickswap-dex (Polygon), based on live DefiLlama data.
