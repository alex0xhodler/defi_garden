...
The highest honest SATO yield right now is 9.40% on uniswap-v4 (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SATO shows up in 2 pools here, with rates from 4.79% to 9.40% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 4.79% | 11.11% | Base rate |
| uniswap-v4 | 9.40% | 15.41% | Base rate |
...
9.40% APY on uniswap-v4 (Ethereum), based on live DefiLlama data.
