...
HAEDAL shows up in 2 pools here, with rates from 3.90% to 5.11% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| cetus-clmm | 3.90% | 8.81% | Base rate |
