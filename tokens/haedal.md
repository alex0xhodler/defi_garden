...
The highest honest HAEDAL yield right now is 7.55% on cetus-clmm (Sui), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
7.55% APY on cetus-clmm (Sui), based on live DefiLlama data.
