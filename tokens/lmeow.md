...
The highest honest LMEOW yield right now is 35.41% on uniswap-v2 (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
35.41% APY on uniswap-v2 (Ethereum), based on live DefiLlama data.
