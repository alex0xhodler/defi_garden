...
CSPR shows up in 2 pools here, with rates from 0.72% to 0.72% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 0.72% | 0.91% | Base rate |
