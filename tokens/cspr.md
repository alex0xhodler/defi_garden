...
The highest honest CSPR yield right now is 0.86% on raydium-amm (Solana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [raydium-amm →](https://www.defi.garden/?pool=2a265415-e598-52de-a138-e90460d8a212&src=seo_token) | Solana | 0.86% | $1.77M |
...
CSPR shows up in 3 pools here, with rates from 0.14% to 0.86% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
