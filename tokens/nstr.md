...
The highest honest NSTR yield right now is 2.24% on nostra-pools (Starknet), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
2.24% APY on nostra-pools (Starknet), based on live DefiLlama data.
