...
The highest honest HNT yield right now is 28.20% on raydium-amm (Solana), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [raydium-amm →](https://www.defi.garden/?pool=4dcc59d7-0c21-4484-a2af-539181a9f8cd&src=seo_token) | Solana | 28.20% | $473.1K |
...
HNT shows up in 1 pools here, with rates from 28.20% to 28.20% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 28.20% | 15.32% | Base rate |
...
28.20% APY on raydium-amm (Solana), based on live DefiLlama data.
