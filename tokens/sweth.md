...
SWETH shows up in 2 pools here, with rates from 0.66% to 2.61% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 0.66% | 2.37% | Base rate |
...
2 live pools clear this page's $100K TVL floor, $27.94M in total.
