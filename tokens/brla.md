...
The highest honest BRLA yield right now is 15.63% on uniswap-v3 (Polygon), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
15.63% APY on uniswap-v3 (Polygon), based on live DefiLlama data.
