...
The highest honest BRLA yield right now is 21.37% on uniswap-v3 (Polygon), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
21.37% APY on uniswap-v3 (Polygon), based on live DefiLlama data.
