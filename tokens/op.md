...
The highest honest OP yield right now is 57.71% on uniswap-v3 (OP Mainnet), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
57.71% APY on uniswap-v3 (OP Mainnet), based on live DefiLlama data.
