...
VAULT shows up in 3 pools here, with rates from 10.72% to 13.65% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| 40-acres | 11.93% | 13.20% | Base rate |
| 40-acres | 13.65% | 18.03% | Base rate |
| 40-acres | 10.72% | 12.46% | Base rate |
