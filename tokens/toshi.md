...
The highest honest TOSHI yield right now is 9.56% on uniswap-v3 (Base), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [uniswap-v3 →](https://www.defi.garden/?pool=ee01656a-8aa1-465a-bc30-b80d6821edb0&src=seo_token) | Base | 9.56% | $1.09M |
...
TOSHI shows up in 1 pools here, with rates from 9.56% to 9.56% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 9.56% | 10.39% | Base rate |
