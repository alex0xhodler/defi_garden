...
The highest honest TOSHI yield right now is 5.68% on uniswap-v3 (Base), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [uniswap-v3 →](https://www.defi.garden/?pool=ee01656a-8aa1-465a-bc30-b80d6821edb0&src=seo_token) | Base | 5.68% | $1.06M |
...
TOSHI shows up in 1 pools here, with rates from 5.68% to 5.68% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 5.68% | 15.32% | Base rate |
