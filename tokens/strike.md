...
The highest honest STRIKE yield right now is 43.49% on minswap-dex (Cardano), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
43.49% APY on minswap-dex (Cardano), based on live DefiLlama data.
