...
The highest honest HYUSD yield right now is 7.48% on loopscale (Solana), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
HYUSD shows up in 5 pools here, with rates from 0.18% to 7.48% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
7.48% APY on loopscale (Solana), based on live DefiLlama data.
