...
ADI shows up in 2 pools here, with rates from 0.15% to 3.02% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 3.02% | 4.21% | Base rate |
| uniswap-v3 | 0.15% | 3.82% | Base rate |
