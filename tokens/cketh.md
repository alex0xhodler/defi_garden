...
The highest honest CKETH yield right now is 1.50% on icpswap (ICP), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.50% APY on icpswap (ICP), based on live DefiLlama data.
