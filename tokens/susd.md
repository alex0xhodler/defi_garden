...
The highest honest SUSD yield right now is 11.07% on velodrome-v2 (OP Mainnet), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SUSD shows up in 2 pools here, with rates from 0.13% to 11.07% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| velodrome-v2 | 11.07% | 11.21% | 100.00% incentives |
