...
The highest honest STRKBTC yield right now is 33.50% on ekubo (Starknet), among 16 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
STRKBTC shows up in 8 pools here, with rates from 1.84% to 33.50% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| ekubo | 9.32% | 10.08% | 97.99% incentives |
| ekubo | 33.50% | 28.68% | Base rate |
| ekubo | 12.78% | 13.72% | 100.00% incentives |
| ekubo | 18.00% | 24.18% | Base rate |
| ekubo | 6.06% | 6.76% | 100.00% incentives |
| endur | 1.84% | 2.01% | Base rate |
| troves | 3.51% | 5.59% | Base rate |
| troves | 2.14% | 3.98% | Base rate |
