...
LCAI shows up in 1 pools here, with rates from 2.68% to 2.68% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 2.68% | 2.25% | Base rate |
