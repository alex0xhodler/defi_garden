...
The highest honest CORE yield right now is 14.27% on b14g (CORE), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
CORE shows up in 3 pools here, with rates from 0.01% to 14.27% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
14.27% APY on b14g (CORE), based on live DefiLlama data.
