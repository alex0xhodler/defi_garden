...
The highest honest CORE yield right now is 11.48% on b14g (CORE), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
CORE shows up in 2 pools here, with rates from 3.39% to 11.48% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
