...
1 of these 1 pool has a trustworthy 30-day average on file, with a median of 120.09% — a useful check against today's number for whether the rate is steady or just having a good day.

All 1 pool pays a plain base rate right now — no incentive or reward APY mixed in.

| Protocol | APY | 30d Mean APY | Yield mix |
|---|---|---|---|
| native-credit-pool | 124.10% | 120.09% | Base rate |
