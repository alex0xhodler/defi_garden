...
MORPHO shows up in 6 pools here, with rates from 6.26% to 380.67% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.

6 of these 6 pools have a trustworthy 30-day average on file, with a median of 65.20% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| aerodrome-slipstream | 380.67% | 110.16% | 76.74% incentives |
| uniswap-v4 | 6.26% | 7.35% | Base rate |
| raydium-amm | 36.44% | 41.76% | Base rate |
| uniswap-v3 | 109.19% | 88.65% | Base rate |
| uniswap-v3 | 119.73% | 103.66% | Base rate |
| uniswap-v3 | 22.91% | 33.61% | Base rate |
...
119.73% APY on uniswap-v3 (Base), based on live DefiLlama data.

### How many MORPHO pools clear the TVL floor?

7 live pools clear this page's $100K TVL floor, $4.18M in total.
