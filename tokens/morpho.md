...
The highest honest MORPHO yield right now is 148.13% on uniswap-v3 (Base), among 7 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
Based on APY history only, MORPHO's lower-variability candidates are uniswap-v4 (Ethereum), 3.37% APY, $851K TVL, https://www.defi.garden/?pool=7f8017d4-98f7-4e4c-b626-c4863ba4d356&src=seo_token; raydium-amm (Solana), 52.57% APY, $448.1K TVL, https://www.defi.garden/?pool=2167056c-624c-57bd-a01f-28974d08de13&src=seo_token; uniswap-v3 (Ethereum), 36.28% APY, $132.3K TVL, https://www.defi.garden/?pool=53da6e5a-778d-40d5-a5f3-f188b27cb576&src=seo_token; uniswap-v3 (Base), 148.13% APY, $598.4K TVL, https://www.defi.garden/?pool=ccc0d82d-c94f-406f-ace2-20b2ec5e278a&src=seo_token; aerodrome-slipstream (Base), 113.87% APY, $2.17M TVL, https://www.defi.garden/?pool=f884e3f7-f6e1-4b9e-b041-8624411ccddf&src=seo_token; uniswap-v3 (Base), 76.91% APY, $368.5K TVL, https://www.defi.garden/?pool=b22b7d0b-f09e-4d4f-9790-8a5619646c41&src=seo_token. This comparison does not measure protocol, exploit, depeg, liquidity, governance, or principal-loss risk.
...
MORPHO shows up in 6 pools here, with rates from 3.37% to 148.13% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.

6 of these 6 pools have a trustworthy 30-day average on file, with a median of 63.57% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| aerodrome-slipstream | 113.87% | 125.68% | 10.71% incentives |
| uniswap-v4 | 3.37% | 7.76% | Base rate |
| uniswap-v3 | 148.13% | 108.50% | Base rate |
| raydium-amm | 52.57% | 44.08% | Base rate |
| uniswap-v3 | 76.91% | 83.06% | Base rate |
| uniswap-v3 | 36.28% | 35.33% | Base rate |
...
148.13% APY on uniswap-v3 (Base), based on live DefiLlama data.
