...
WBERA shows up in 4 pools here, with rates from 1.07% to 37.51% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| dolomite | 1.07% | 1.83% | Base rate |
| berapaw | 37.51% | 33.31% | 100.00% incentives |
| berapaw | 35.84% | 34.27% | 100.00% incentives |
| bex | 7.21% | 5.61% | Base rate |
