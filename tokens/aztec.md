...
AZTEC shows up in 1 pools here, with rates from 0.13% to 0.13% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 0.13% | 0.48% | Base rate |
