...
The highest honest LCAP yield right now is 49.89% on stake-dao (Base), among 9 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
LCAP shows up in 7 pools here, with rates from 4.46% to 49.89% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

7 of these 7 pools have a trustworthy 30-day average on file, with a median of 24.56% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| aerodrome-slipstream | 12.14% | 17.91% | 72.53% incentives |
| curve-dex | 47.51% | 34.43% | 99.14% incentives |
| stake-dao | 49.89% | 36.15% | 99.46% incentives |
| aerodrome-v1 | 4.46% | 4.62% | 100.00% incentives |
| aerodrome-slipstream | 20.29% | 34.70% | 79.46% incentives |
| aerodrome-v1 | 28.47% | 24.56% | 100.00% incentives |
| aerodrome-v1 | 13.15% | 13.60% | 100.00% incentives |
...
49.89% APY on stake-dao (Base), based on live DefiLlama data.
