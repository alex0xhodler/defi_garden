...
The highest honest LCAP yield right now is 49.91% on stake-dao (Base), among 9 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
LCAP shows up in 7 pools here, with rates from 4.48% to 49.91% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

7 of these 7 pools have a trustworthy 30-day average on file, with a median of 24.57% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| aerodrome-slipstream | 12.07% | 17.90% | 73.14% incentives |
| curve-dex | 47.68% | 34.50% | 99.14% incentives |
| stake-dao | 49.91% | 36.22% | 99.46% incentives |
| aerodrome-v1 | 4.48% | 4.62% | 100.00% incentives |
| aerodrome-slipstream | 20.20% | 34.67% | 80.02% incentives |
| aerodrome-v1 | 28.60% | 24.57% | 100.00% incentives |
| aerodrome-v1 | 13.21% | 13.59% | 100.00% incentives |
...
49.91% APY on stake-dao (Base), based on live DefiLlama data.
