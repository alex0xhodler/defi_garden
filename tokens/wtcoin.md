...
The highest honest WTCOIN yield right now is 55.97% on aerodrome-slipstream (Base), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
55.97% APY on aerodrome-slipstream (Base), based on live DefiLlama data.
