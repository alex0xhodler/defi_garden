...
The highest honest EUSD yield right now is 40.01% on curve-dex (Base), among 17 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
EUSD shows up in 8 pools here, with rates from 0.19% to 40.01% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| curve-dex | 0.19% | 3.35% | Base rate |
| convex-finance | 6.94% | 5.14% | 97.26% incentives |
| aerodrome-slipstream | 2.35% | 2.43% | 85.60% incentives |
| aerodrome-v1 | 7.00% | 8.12% | 100.00% incentives |
...
40.01% APY on curve-dex (Base), based on live DefiLlama data.
