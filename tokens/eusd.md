...
The highest honest EUSD yield right now is 40.04% on curve-dex (Base), among 17 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
EUSD shows up in 8 pools here, with rates from 0.24% to 40.04% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| curve-dex | 3.09% | 3.29% | Base rate |
| curve-dex | 0.24% | 3.33% | Base rate |
| convex-finance | 7.11% | 5.31% | 96.63% incentives |
| aerodrome-slipstream | 1.99% | 2.40% | 93.03% incentives |
| aerodrome-v1 | 6.95% | 8.05% | 100.00% incentives |
| stake-dao | 0.34% | 6.49% | Base rate |
| curve-dex | 40.04% | 31.73% | 100.00% incentives |
| curve-dex | 0.33% | 0.70% | Base rate |
...
40.04% APY on curve-dex (Base), based on live DefiLlama data.

### How many EUSD pools clear the TVL floor?

17 live pools clear this page's $100K TVL floor, $34.58M in total.
