...
The highest honest CBBTC yield right now is 15.92% on uniswap-v3 (Base), among 159 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
CBBTC shows up in 8 pools here, with rates from 0.01% to 15.92% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| aerodrome-slipstream | 3.63% | 7.15% | 64.35% incentives |
| curve-dex | 2.79% | 5.09% | Base rate |
| fluid-dex | 0.80% | 0.43% | Base rate |
| uniswap-v4 | 0.06% | 0.17% | Base rate |
| uniswap-v4 | 4.40% | 6.17% | Base rate |
| uniswap-v3 | 15.92% | 14.48% | Base rate |
...
15.92% APY on uniswap-v3 (Base), based on live DefiLlama data.

### How many CBBTC pools clear the TVL floor?

159 live pools clear this page's $100K TVL floor, $5.02B in total.
