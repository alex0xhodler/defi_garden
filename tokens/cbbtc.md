...
The highest honest CBBTC yield right now is 15.34% on uniswap-v3 (Base), among 158 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
CBBTC shows up in 8 pools here, with rates from 0.01% to 15.34% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| aerodrome-slipstream | 3.98% | 6.90% | 64.26% incentives |
| curve-dex | 1.53% | 5.11% | Base rate |
| fluid-dex | 0.57% | 0.44% | Base rate |
| uniswap-v4 | 0.07% | 0.17% | Base rate |
| uniswap-v4 | 4.36% | 6.24% | Base rate |
| uniswap-v3 | 15.34% | 14.48% | Base rate |
...
15.34% APY on uniswap-v3 (Base), based on live DefiLlama data.

### How many CBBTC pools clear the TVL floor?

158 live pools clear this page's $100K TVL floor, $5.02B in total.
