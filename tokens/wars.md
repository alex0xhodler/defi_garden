...
WARS shows up in 4 pools here, with rates from 0.02% to 24.09% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v4 | 0.07% | 0.43% | Base rate |
