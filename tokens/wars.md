...
The highest honest WARS yield right now is 24.01% on morpho-blue (Ethereum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WARS shows up in 4 pools here, with rates from 0.04% to 24.01% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v4 | 0.04% | 0.45% | Base rate |
| uniswap-v4 | 0.39% | 0.19% | Base rate |
