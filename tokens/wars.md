...
WARS shows up in 2 pools here, with rates from 0.20% to 24.00% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v4 | 0.20% | 8.32% | Base rate |
