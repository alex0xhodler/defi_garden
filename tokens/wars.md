...
WARS shows up in 3 pools here, with rates from 0.05% to 24.00% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
