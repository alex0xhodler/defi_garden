...
The highest honest GHO yield right now is 5.42% on fluid-lending (Ethereum), among 32 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
5.42% APY on fluid-lending (Ethereum), based on live DefiLlama data.
