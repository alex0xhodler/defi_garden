...
The highest honest FISH yield right now is 2.72% on dedust (TON), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
2.72% APY on dedust (TON), based on live DefiLlama data.
