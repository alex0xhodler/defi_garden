...
JRNUSD shows up in 3 pools here, with rates from 0.71% to 7.11% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| strata-markets | 0.71% | 3.08% | Base rate |
| pendle | 4.03% | 5.34% | Base rate |
| pendle | 7.11% | 6.92% | Base rate |
