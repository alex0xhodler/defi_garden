...
USDA shows up in 2 pools here, with rates from 16.95% to 17.40% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| minswap-dex | 17.40% | 20.64% | 73.91% incentives |
| liqwid | 16.95% | 19.58% | Base rate |
