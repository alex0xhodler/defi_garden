...
USDA shows up in 2 pools here, with rates from 16.39% to 17.44% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| minswap-dex | 17.44% | 23.97% | 77.06% incentives |
| liqwid | 16.39% | 21.50% | Base rate |
