...
USDA shows up in 1 pools here, with rates from 21.67% to 21.67% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
21.67% APY on minswap-dex (Cardano), based on live DefiLlama data.
