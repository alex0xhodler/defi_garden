...
USDA shows up in 2 pools here, with rates from 16.96% to 17.56% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
