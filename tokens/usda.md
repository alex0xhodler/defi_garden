...
The highest honest USDA yield right now is 17.38% on minswap-dex (Cardano), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDA shows up in 1 pools here, with rates from 17.38% to 17.38% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| minswap-dex | 17.38% | 17.63% | 73.71% incentives |
...
17.38% APY on minswap-dex (Cardano), based on live DefiLlama data.
