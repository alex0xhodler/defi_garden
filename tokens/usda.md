...
The highest honest USDA yield right now is 17.62% on minswap-dex (Cardano), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
17.62% APY on minswap-dex (Cardano), based on live DefiLlama data.
