...
XLEND shows up in 3 pools here, with rates from 6.86% to 7.24% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| liminal-basis | 7.24% | 7.18% | Base rate |
| liminal-basis | 6.86% | 7.10% | Base rate |
