...
|---|---|---|---|
| [liminal-basis →](https://www.defi.garden/?pool=a546653f-1bd8-57e1-ba26-2c0b975f7dd0&src=seo_token) | Hyperliquid L1 | 6.80% | $5.35M |
...
XLEND shows up in 3 pools here, with rates from 6.80% to 7.24% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| liminal-basis | 6.80% | 7.11% | Base rate |
