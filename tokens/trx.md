...
TRX shows up in 5 pools here, with rates from 0.12% to 11.66% APY across 4 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| raydium-amm | 0.90% | 0.97% | Base rate |
| uniswap-v2 | 0.50% | 0.63% | Base rate |
| pancakeswap-amm | 0.12% | 0.41% | Base rate |
...
6 live pools clear this page's $100K TVL floor, $792.36M in total.
