...
FRONTIER shows up in 2 pools here, with rates from 7.06% to 23.22% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| concrete | 7.06% | 9.36% | Base rate |
| concrete | 23.22% | 8.60% | Base rate |
