...
The highest honest FRONTIER yield right now is 5.74% on concrete (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
FRONTIER shows up in 1 pools here, with rates from 5.74% to 5.74% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
