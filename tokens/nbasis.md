...
The highest honest NBASIS yield right now is 1.99% on plume-vaults (Plume Mainnet), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.99% APY on plume-vaults (Plume Mainnet), based on live DefiLlama data.
