...
The highest honest BABYDOGE yield right now is 6.07% on raydium-amm (Solana), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
BABYDOGE shows up in 2 pools here, with rates from 0.29% to 6.07% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 0.29% | 1.15% | Base rate |
| raydium-amm | 6.07% | 2.93% | Base rate |
