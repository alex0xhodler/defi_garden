...
The highest honest FUN yield right now is 2.35% on raydium-amm (Solana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
FUN shows up in 3 pools here, with rates from 0.56% to 402.61% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| aerodrome-slipstream | 402.61% | 844.36% | 97.34% incentives |
| raydium-amm | 2.35% | 4.64% | Base rate |
