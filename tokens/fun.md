...
The highest honest FUN yield right now is 3.63% on raydium-amm (Solana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
FUN shows up in 3 pools here, with rates from 0.56% to 289.53% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| aerodrome-slipstream | 289.53% | 833.73% | 96.18% incentives |
| raydium-amm | 3.63% | 4.64% | Base rate |
