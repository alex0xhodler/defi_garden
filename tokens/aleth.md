...
ALETH shows up in 8 pools here, with rates from 1.11% to 6.88% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| alchemix-v3 | 6.88% | 5.29% | Base rate |
| curve-dex | 1.11% | 1.21% | 94.58% incentives |
| velodrome-v2 | 6.56% | 6.87% | 100.00% incentives |
| stake-dao-yield | 1.44% | 1.55% | 93.75% incentives |
| stake-dao-yield | 2.10% | 2.33% | 92.37% incentives |
| convex-finance | 2.28% | 2.60% | 97.37% incentives |
| yearn-finance | 6.26% | 6.56% | Base rate |
...
6.88% APY on alchemix-v3 (Ethereum), based on live DefiLlama data.

### How many ALETH pools clear the TVL floor?

13 live pools clear this page's $100K TVL floor, $26.94M in total.
