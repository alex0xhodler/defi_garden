...
The highest honest SSV yield right now is 59.14% on uniswap-v3 (Ethereum), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
59.14% APY on uniswap-v3 (Ethereum), based on live DefiLlama data.
