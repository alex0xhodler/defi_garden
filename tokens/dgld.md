...
The highest honest DGLD yield right now is 0.17% on uniswap-v4 (Base), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
DGLD shows up in 2 pools here, with rates from 0.17% to 0.19% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 0.19% | 1.57% | Base rate |
