...
API3 shows up in 2 pools here, with rates from 0.83% to 9.12% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v4 | 0.83% | 7.54% | Base rate |
...
2 live pools clear this page's $100K TVL floor, $14.59M in total.
