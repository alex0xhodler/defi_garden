...
The highest honest BALANCERRETH yield right now is 7.61% on balancer-v3 (Arbitrum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
BALANCERRETH shows up in 3 pools here, with rates from 4.61% to 7.61% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
