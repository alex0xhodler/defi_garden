...
The highest honest SKHY yield right now is 55.95% on raydium-amm (Solana), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
55.95% APY on raydium-amm (Solana), based on live DefiLlama data.
