...
The highest honest FBOMB yield right now is 100.03% on aerodrome-v1 (Base), among 8 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
FBOMB shows up in 8 pools here, with rates from 1.16% to 100.03% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.

8 of these 8 pools have a trustworthy 30-day average on file, with a median of 33.00% — a useful check against today's number for whether the rate is steady or just having a good day.
...
| aerodrome-v1 | 100.03% | 101.93% | 100.00% incentives |
| aerodrome-v1 | 19.44% | 85.16% | 100.00% incentives |
| velodrome-v2 | 46.29% | 60.51% | 100.00% incentives |
| aerodrome-v1 | 4.95% | 5.49% | 100.00% incentives |
| shadow-exchange-legacy | 2.06% | 4.53% | 100.00% incentives |
| aerodrome-v1 | 2.44% | 3.19% | 100.00% incentives |
| shadow-exchange-legacy | 1.16% | 2.84% | 100.00% incentives |
...
100.03% APY on aerodrome-v1 (Base), based on live DefiLlama data.
