...
MOODENG shows up in 2 pools here, with rates from 2.09% to 3.75% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 3.75% | 4.98% | Base rate |
| uniswap-v2 | 2.09% | 4.99% | Base rate |
