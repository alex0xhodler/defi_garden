...
The highest honest NYA yield right now is 0.16% on uniswap-v3 (Base), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
NYA shows up in 3 pools here, with rates from 0.02% to 0.16% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 0.16% | 0.01% | Base rate |
