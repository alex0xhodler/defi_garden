...
The highest honest CARDS yield right now is 75.30% on raydium-amm (Solana), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
75.30% APY on raydium-amm (Solana), based on live DefiLlama data.
