...
The highest honest IBERA yield right now is 3.61% on infrared-finance (Berachain), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
3.61% APY on infrared-finance (Berachain), based on live DefiLlama data.
