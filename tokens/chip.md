...
The highest honest CHIP yield right now is 46.23% on aerodrome-slipstream (Base), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
46.23% APY on aerodrome-slipstream (Base), based on live DefiLlama data.
