...
The highest honest CHIP yield right now is 20.97% on uniswap-v3 (Arbitrum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
20.97% APY on uniswap-v3 (Arbitrum), based on live DefiLlama data.
