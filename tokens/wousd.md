...
The highest honest WOUSD yield right now is 6.67% on pendle (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WOUSD shows up in 2 pools here, with rates from 6.25% to 6.67% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle | 6.67% | 4.93% | Base rate |
| pendle | 6.25% | 5.47% | Base rate |
