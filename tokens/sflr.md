...
The highest honest SFLR yield right now is 13.05% on sceptre-liquid (Flare), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
13.05% APY on sceptre-liquid (Flare), based on live DefiLlama data.
