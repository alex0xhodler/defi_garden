...
The highest honest SFLR yield right now is 14.23% on spectra-v2 (Flare), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SFLR shows up in 6 pools here, with rates from 0.52% to 14.23% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
14.23% APY on spectra-v2 (Flare), based on live DefiLlama data.
