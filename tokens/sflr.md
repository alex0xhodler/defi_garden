...
SFLR shows up in 6 pools here, with rates from 0.52% to 13.67% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| sceptre-liquid | 8.57% | 7.36% | Base rate |
