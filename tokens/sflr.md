...
The highest honest SFLR yield right now is 14.52% on spectra-v2 (Flare), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
SFLR shows up in 6 pools here, with rates from 0.51% to 14.52% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| sceptre-liquid | 8.70% | 7.58% | Base rate |
| kinetic | 0.51% | 0.51% | 88.84% incentives |
| sparkdex-v4 | 6.16% | 6.92% | 99.00% incentives |
| spectra-v2 | 14.52% | 13.14% | Base rate |
| spectra-v2 | 8.33% | 7.06% | Base rate |
...
14.52% APY on spectra-v2 (Flare), based on live DefiLlama data.
