...
SFLR shows up in 6 pools here, with rates from 0.51% to 15.93% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| sceptre-liquid | 7.87% | 7.73% | Base rate |
| kinetic | 0.51% | 0.51% | 90.28% incentives |
| sparkdex-v4 | 6.32% | 6.80% | 98.61% incentives |
| spectra-v2 | 15.93% | 13.42% | Base rate |
| spectra-v2 | 9.25% | 7.32% | Base rate |
...
6 live pools clear this page's $100K TVL floor, $21.52M in total.
