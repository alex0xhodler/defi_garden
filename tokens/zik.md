...
ZIK shows up in 2 pools here, with rates from 0.10% to 0.10% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 0.10% | 0.06% | Base rate |
