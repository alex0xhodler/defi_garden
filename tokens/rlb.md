...
RLB shows up in 3 pools here, with rates from 2.72% to 8.60% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 2.72% | 3.36% | Base rate |
| uniswap-v3 | 6.61% | 6.09% | Base rate |
| uniswap-v3 | 8.60% | 7.12% | Base rate |
...
8.60% APY on uniswap-v3 (Ethereum), based on live DefiLlama data.

### How many RLB pools clear the TVL floor?

3 live pools clear this page's $100K TVL floor, $5.6M in total.
