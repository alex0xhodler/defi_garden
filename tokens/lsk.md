...
The highest honest LSK yield right now is 15.33% on aerodrome-slipstream (Base), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
LSK shows up in 2 pools here, with rates from 7.22% to 15.33% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 7.22% | 11.39% | Base rate |
| aerodrome-slipstream | 15.33% | 13.74% | 79.42% incentives |
...
15.33% APY on aerodrome-slipstream (Base), based on live DefiLlama data.
