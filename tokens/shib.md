...
SHIB shows up in 7 pools here, with rates from 0.09% to 77.26% APY across 4 chains — the rate depends on which protocol and chain you pick, not just the token.
