...
The highest honest CSRHONEY yield right now is 6.42% on berapaw (Berachain), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
6.42% APY on berapaw (Berachain), based on live DefiLlama data.
