...
The highest honest CSRHONEY yield right now is 5.85% on berapaw (Berachain), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
5.85% APY on berapaw (Berachain), based on live DefiLlama data.
