...
The highest honest WM yield right now is 1.04% on uniswap-v3 (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WM shows up in 1 pools here, with rates from 1.04% to 1.04% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 1.04% | 1.00% | Base rate |
