...
The highest honest WM yield right now is 3.41% on uniswap-v3 (Ethereum), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WM shows up in 1 pools here, with rates from 3.41% to 3.41% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 3.41% | 1.01% | Base rate |
