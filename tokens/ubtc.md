...
The highest honest UBTC yield right now is 30.02% on nest-cl (Hyperliquid L1), among 16 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
| [hyperswap-v3 →](https://www.defi.garden/?pool=296529ba-2569-45a5-aa69-4ea4158527ef&src=seo_token) | Hyperliquid L1 | 1.56% | $1.69M |
...
UBTC shows up in 8 pools here, with rates from 0.18% to 30.02% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| hyperswap-v3 | 1.56% | 20.19% | Base rate |
| project-x | 8.33% | 5.24% | Base rate |
| project-x | 19.60% | 12.49% | Base rate |
...
30.02% APY on nest-cl (Hyperliquid L1), based on live DefiLlama data.
