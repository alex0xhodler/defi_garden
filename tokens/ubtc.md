...
The highest honest UBTC yield right now is 28.05% on nest-cl (Hyperliquid L1), among 16 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.

| Protocol | Chain | APY | TVL |
|---|---|---|---|
| [hyperlend-pooled →](https://www.defi.garden/?pool=96e6c755-2821-407b-83fb-9f8816bdac54&src=seo_token) | Hyperliquid L1 | 0.18% | $8.13M |
...
| [hyperswap-v3 →](https://www.defi.garden/?pool=296529ba-2569-45a5-aa69-4ea4158527ef&src=seo_token) | Hyperliquid L1 | 25.22% | $1.69M |
...
UBTC shows up in 8 pools here, with rates from 0.18% to 28.05% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.

8 of these 8 pools have a trustworthy 30-day average on file, with a median of 12.64% — a useful check against today's number for whether the rate is steady or just having a good day.
...
| hyperswap-v3 | 25.22% | 20.07% | Base rate |
| project-x | 8.33% | 5.20% | Base rate |
| project-x | 19.60% | 12.39% | Base rate |
| ramses-cl-v2 | 19.87% | 34.54% | 26.74% incentives |
...
28.05% APY on nest-cl (Hyperliquid L1), based on live DefiLlama data.

### How many UBTC pools clear the TVL floor?

16 live pools clear this page's $100K TVL floor, $36.85M in total.
