...
The highest honest UBTC yield right now is 40.90% on nest-cl (Hyperliquid L1), among 16 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
UBTC shows up in 8 pools here, with rates from 0.12% to 40.90% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| nest-cl | 40.90% | 36.68% | 100.00% incentives |
| project-x | 2.62% | 2.83% | Base rate |
| project-x | 0.17% | 5.66% | Base rate |
| project-x | 0.17% | 13.18% | Base rate |
...
40.90% APY on nest-cl (Hyperliquid L1), based on live DefiLlama data.

### How many UBTC pools clear the TVL floor?

16 live pools clear this page's $100K TVL floor, $37.31M in total.
