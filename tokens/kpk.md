...
The highest honest KPK yield right now is 6.50% on morpho-blue (Ethereum), among 9 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
KPK shows up in 8 pools here, with rates from 0.03% to 6.50% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
9 live pools clear this page's $100K TVL floor, $37.74M in total.
