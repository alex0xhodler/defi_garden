...
The highest honest WFRXETH yield right now is 4.96% on stake-dao (Fraxtal), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
WFRXETH shows up in 2 pools here, with rates from 0.51% to 4.96% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
