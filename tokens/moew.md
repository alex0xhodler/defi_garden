...
MOEW shows up in 2 pools here, with rates from 0.91% to 3.56% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 0.91% | 2.82% | Base rate |
| raydium-amm | 3.56% | 3.32% | Base rate |
