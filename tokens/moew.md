...
MOEW shows up in 2 pools here, with rates from 3.56% to 5.58% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 5.58% | 2.83% | Base rate |
| raydium-amm | 3.56% | 3.13% | Base rate |
...
2 live pools clear this page's $100K TVL floor, $544.2K in total.
