...
The highest honest DAI yield right now is 3.29% on aave-v3 (Ethereum), among 64 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
DAI shows up in 8 pools here, with rates from 0.30% to 3.29% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| aave-v3 | 3.29% | 3.86% | Base rate |
| yearn-finance | 3.04% | 3.00% | Base rate |
| sushiswap-v3 | 0.63% | 7.89% | Base rate |
| uniswap-v2 | 0.30% | 1.90% | Base rate |
| uniswap-v3 | 0.41% | 5.75% | Base rate |
| quickswap-dex | 0.55% | 0.55% | Base rate |
| aave-v3 | 1.57% | 1.91% | Base rate |
...
64 live pools clear this page's $100K TVL floor, $352.87M in total.
