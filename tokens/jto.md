...
The highest honest JTO yield right now is 17.62% on orca-dex (Solana), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
JTO shows up in 3 pools here, with rates from 0.02% to 17.62% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| orca-dex | 17.62% | 18.37% | Base rate |
| kamino-liquidity | 12.22% | 11.63% | Base rate |
