...
The highest honest YNUSDX yield right now is 0.60% on curve-dex (Ethereum), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
YNUSDX shows up in 2 pools here, with rates from 0.28% to 0.60% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
