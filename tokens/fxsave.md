...
FXSAVE shows up in 4 pools here, with rates from 1.95% to 10.07% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle | 10.07% | 10.75% | Base rate |
| pendle | 7.11% | 5.95% | Base rate |
| curve-dex | 1.95% | 2.73% | 0.01% incentives |
