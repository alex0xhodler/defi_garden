...
FXSAVE shows up in 4 pools here, with rates from 2.25% to 6.23% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| pendle | 5.77% | 11.45% | Base rate |
| pendle | 6.23% | 6.59% | Base rate |
| curve-dex | 2.25% | 2.62% | 0.01% incentives |
| convex-finance | 2.25% | 2.61% | Base rate |
...
7 live pools clear this page's $100K TVL floor, $62.8M in total.
