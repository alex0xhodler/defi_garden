...
The highest honest STRUSD yield right now is 11.79% on pendle-v2 (Ethereum), among 6 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
STRUSD shows up in 4 pools here, with rates from 5.08% to 11.79% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
11.79% APY on pendle-v2 (Ethereum), based on live DefiLlama data.
