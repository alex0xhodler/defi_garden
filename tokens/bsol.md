...
The highest honest BSOL yield right now is 5.88% on kamino-liquidity (Solana), among 8 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
BSOL shows up in 6 pools here, with rates from 0.02% to 5.88% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
5.88% APY on kamino-liquidity (Solana), based on live DefiLlama data.
