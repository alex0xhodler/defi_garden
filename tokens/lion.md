...
LION shows up in 4 pools here, with rates from 0.01% to 6.13% APY across 4 chains — the rate depends on which protocol and chain you pick, not just the token.
