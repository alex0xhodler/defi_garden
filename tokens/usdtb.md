...
USDTB shows up in 4 pools here, with rates from 0.04% to 4.93% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| fluid-lending | 2.89% | 6.16% | Base rate |
