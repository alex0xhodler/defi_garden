...
USDX shows up in 2 pools here, with rates from 1.20% to 3.50% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| raydium-amm | 1.20% | 1.34% | Base rate |
