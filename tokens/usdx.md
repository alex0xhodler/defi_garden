...
The highest honest USDX yield right now is 15.18% on pendle-v2 (Ethereum), among 5 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
USDX shows up in 5 pools here, with rates from 2.55% to 15.18% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| curve-dex | 2.55% | 1.57% | Base rate |
| curve-dex | 9.98% | 11.70% | Base rate |
| pendle-v2 | 9.30% | 10.85% | 25.55% incentives |
| pendle-v2 | 15.18% | 15.16% | Base rate |
...
15.18% APY on pendle-v2 (Ethereum), based on live DefiLlama data.

### How many USDX pools clear the TVL floor?

5 live pools clear this page's $100K TVL floor, $23.92M in total.
