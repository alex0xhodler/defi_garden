...
USDX shows up in 2 pools here, with rates from 1.33% to 3.50% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| raydium-amm | 1.33% | 1.41% | Base rate |
...
3.50% APY on clearpool-lending (Flare), based on live DefiLlama data.
