...
The highest honest STATOM yield right now is 0.02% on osmosis-dex (Osmosis), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
STATOM shows up in 1 pools here, with rates from 0.02% to 0.02% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
0.02% APY on osmosis-dex (Osmosis), based on live DefiLlama data.
