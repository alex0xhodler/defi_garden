...
XUSD shows up in 2 pools here, with rates from 0.94% to 1.77% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v3 | 1.77% | 3.68% | Base rate |
