...
The highest honest XUSD yield right now is 8.50% on uniswap-v3 (Ethereum), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
XUSD shows up in 3 pools here, with rates from 0.41% to 8.50% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 8.50% | 6.38% | Base rate |
