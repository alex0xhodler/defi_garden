...
The highest honest XUSD yield right now is 0.99% on sovryn-dex (Rootstock), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
XUSD shows up in 3 pools here, with rates from 0.94% to 13.10% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 13.10% | 7.89% | Base rate |
