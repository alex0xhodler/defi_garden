...
XUSD shows up in 3 pools here, with rates from 0.94% to 12.40% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 12.40% | 1.60% | Base rate |
