...
The highest honest XUSD yield right now is 0.52% on sovryn-dex (Rootstock), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
XUSD shows up in 1 pools here, with rates from 0.52% to 0.52% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
