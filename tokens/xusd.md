...
XUSD shows up in 3 pools here, with rates from 0.12% to 1.68% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| uniswap-v3 | 1.68% | 7.01% | Base rate |
