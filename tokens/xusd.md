...
XUSD shows up in 2 pools here, with rates from 0.52% to 0.95% APY across 2 chains — the rate depends on which protocol and chain you pick, not just the token.
...
| overnight-finance | 0.95% | 0.90% | Base rate |
