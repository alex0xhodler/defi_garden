...
The highest honest SNEK yield right now is 59.57% on minswap-dex (Cardano), among 2 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
59.57% APY on minswap-dex (Cardano), based on live DefiLlama data.
