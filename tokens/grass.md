...
The highest honest GRASS yield right now is 1.19% on raydium-amm (Solana), among 3 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
GRASS shows up in 2 pools here, with rates from 0.02% to 1.19% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| raydium-amm | 1.19% | 1.55% | Base rate |
