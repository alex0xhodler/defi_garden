...
PEPU shows up in 2 pools here, with rates from 0.09% to 2.95% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| uniswap-v4 | 2.95% | 1.23% | Base rate |
