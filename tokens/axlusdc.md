...
1 of these 1 pool has a trustworthy 30-day average on file, with a median of 6.36% — a useful check against today's number for whether the rate is steady or just having a good day.
...
|---|---|---|---|
| curve-dex | 6.25% | 6.36% | 99.04% incentives |
