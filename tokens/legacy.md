...
The highest honest LEGACY yield right now is 1.74% on ekubo (Starknet), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
1.74% APY on ekubo (Starknet), based on live DefiLlama data.
