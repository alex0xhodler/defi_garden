...
YMVOG shows up in 5 pools here, with rates from 1.96% to 6.05% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| morpho-blue | 6.05% | 6.63% | 10.83% incentives |
| morpho-blue | 1.96% | 4.94% | Base rate |
| morpho-blue | 4.99% | 4.95% | Base rate |
