...
YMVOG shows up in 5 pools here, with rates from 1.84% to 6.84% APY across 3 chains — the rate depends on which protocol and chain you pick, not just the token.
