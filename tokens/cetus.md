...
CETUS shows up in 3 pools here, with rates from 0.49% to 19.98% APY across 1 chains — the rate depends on which protocol and chain you pick, not just the token.
...
|---|---|---|---|
| cetus-clmm | 19.98% | 28.32% | 25.83% incentives |
| cetus-clmm | 9.15% | 8.82% | Base rate |
...
19.98% APY on cetus-clmm (Sui), based on live DefiLlama data.
