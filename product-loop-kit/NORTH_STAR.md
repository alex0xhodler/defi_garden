...
- 2026-07-10 · execution moved to GitHub Actions (.github/workflows/product-loop.yml, human directive after macOS cron failed 3 ways: quarantine, TCC, locks) — heartbeat fable-5, builds sonnet-5, verifier subagent, self-pushing; Mac crons retired; Cowork = oversight/judging/reports only
