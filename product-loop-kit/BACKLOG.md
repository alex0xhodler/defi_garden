...
| 018 | NL search actually works (behavior on live data, Playwright drives the real UI) | 9.0 | BLOCKED — this build session's sandbox has no egress to unpkg.com/yields.llama.fi (403), so the live-UI acceptance criteria can't be verified here (specs/018-notes.md) | HIGH | specs/018.md | 1 | — |
