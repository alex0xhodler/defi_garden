...
/**
 * Deposits USDC into the Seamless USDC vault for a user, sponsoring the gas fee.
...
/**
 * Withdraws USDC from the Seamless USDC vault by redeeming vault shares.
...
/**
 * Fetches a user's balance in the Seamless USDC vault.
 * It returns both the raw share balance (SMUSDC) and the underlying USDC asset value.
...
/**
 * Fetches the current APY for the Seamless USDC vault from the DeFiLlama API.
...
/**
 * Fetches general information about the Seamless USDC vault, including its Total Value Locked (TVL).
