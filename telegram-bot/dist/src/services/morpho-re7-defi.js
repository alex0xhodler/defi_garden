...
exports.deployToMorphoRe7 = deployToMorphoRe7;
exports.withdrawFromMorphoRe7 = withdrawFromMorphoRe7;
exports.getMorphoRe7Balance = getMorphoRe7Balance;
exports.getMorphoRe7APY = getMorphoRe7APY;
exports.getMorphoRe7VaultInfo = getMorphoRe7VaultInfo;
...
const MORPHO_RE7_CONTRACTS = {
    ...
    MORPHO_RE7_USDC_VAULT: "0xB7890CEE6CF4792cdCC13489D36D9d42726ab863", // Re7 Universal USDC vault address
 ...
 */
async function deployToMorphoRe7(userId, usdcAmount, testSmartAccount // Optional parameter for testing
) {
    try {
 ...
 */
async function withdrawFromMorphoRe7(userId, sharesAmount, testSmartAccount // Optional parameter for testing
) {
    try {
 ...
 */
async function getMorphoRe7Balance(userAddress) {
    try {
 ...
 */
async function getMorphoRe7APY() {
    try {
 ...
 */
async function getMorphoRe7VaultInfo() {
    try {
