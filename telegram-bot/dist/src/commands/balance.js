        ...
        try {
            ...
            try {
                ...
                if (balances) {
                    ...
                    if (usdcBalance) {
                        smartWalletUsdcBalance = parseFloat((0, token_wallet_1.formatTokenAmount)(usdcBalance.balance, 6, 2));
                    }
                }
                // Get DeFi positions
                ...
                try {
                    ...
                    console.log(`🔍 Balance command - Index positions: ${userIndexPositions.length} positions, $${userIndexPositions.reduce((sum, p) => sum + p.currentValue, 0).toFixed(2)} total value`);
