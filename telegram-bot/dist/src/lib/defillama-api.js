...
async function fetchRealTimeYields() {
    try {
        ...
        const pools = await fetchSpecificPools([
            ...
            exports.POOL_IDS.MORPHO,
            exports.POOL_IDS.SPARK,
            exports.POOL_IDS.SEAMLESS,
            exports.POOL_IDS.MOONWELL,
            exports.POOL_IDS.MORPHO_RE7
        ]);
        ...
        const morphoPool = pools.find(p => p.pool === exports.POOL_IDS.MORPHO);
        const sparkPool = pools.find(p => p.pool === exports.POOL_IDS.SPARK);
        const seamlessPool = pools.find(p => p.pool === exports.POOL_IDS.SEAMLESS);
        const moonwellPool = pools.find(p => p.pool === exports.POOL_IDS.MOONWELL);
        const morphoRe7Pool = pools.find(p => p.pool === exports.POOL_IDS.MORPHO_RE7);
        const opportunities = [];
        // Process Aave
        if (aavePool) {
        ...
        if (morphoPool) {
            ...
            if (cachedMorpho) {
                ...
                opportunities.push(convertToYieldOpportunity({}, "Morpho", 10.0));
            }
        }
        // Process Spark
        if (sparkPool) {
            ...
            if (cachedSpark) {
                ...
                opportunities.push(convertToYieldOpportunity({}, "Spark", 8.0));
            }
        }
        // Process Seamless
        if (seamlessPool) {
            ...
            if (cachedSeamless) {
                ...
                opportunities.push(convertToYieldOpportunity({}, "Seamless", 5.0));
            }
        }
        // Process Moonwell
        if (moonwellPool) {
            ...
            if (cachedMoonwell) {
                ...
                opportunities.push(convertToYieldOpportunity({}, "Moonwell USDC", 5.0));
            }
        }
        ...
        if (morphoRe7Pool) {
            ...
            if (cachedMorphoRe7) {
                ...
                opportunities.push(convertToYieldOpportunity({}, "Re7 Universal USDC", 6.0));
            }
        }
        ...
        try {
            ...
            return [
                ...
                convertToYieldOpportunity({}, "Morpho", 10.0),
                convertToYieldOpportunity({}, "Spark", 8.0),
                convertToYieldOpportunity({}, "Seamless", 5.0),
                convertToYieldOpportunity({}, "Re7 Universal USDC", 6.0)
            ];
        }
    }
}
