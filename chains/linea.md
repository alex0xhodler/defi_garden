...
The highest honest Linea yield right now is 4.60% on aave-v3 (Linea), among 11 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
4.60% APY on aave-v3 (Linea), based on live DefiLlama data.
