...
The highest honest Etherlink yield right now is 3.33% on midas-rwa (Etherlink), among 4 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
3.33% APY on midas-rwa (Etherlink), based on live DefiLlama data.
