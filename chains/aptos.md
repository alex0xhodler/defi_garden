...
The highest honest Aptos yield right now is 20.80% on thalaswap (Aptos), among 26 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
20.80% APY on thalaswap (Aptos), based on live DefiLlama data.
