...
The highest honest Ink yield right now is 2.82% on tydro (Ink), among 18 pools above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
2.82% APY on tydro (Ink), based on live DefiLlama data.
