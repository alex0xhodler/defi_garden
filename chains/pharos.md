...
The highest honest Pharos yield right now is 3.84% on centrifuge-protocol (Pharos), among 1 pool above the $100K TVL floor. Rates are live from DefiLlama and exclude anomalous (>1000% APY) pools.
...
3.84% APY on centrifuge-protocol (Pharos), based on live DefiLlama data.
