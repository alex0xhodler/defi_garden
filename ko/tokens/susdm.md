...
현재 SUSDM의 가장 높은 정직한 수익률은 Hyperliquid L1의 hybra-v4에서 0.78%이며, $100K TVL 기준을 넘는 2개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
|---|---|---|---|
| monetrix | 3.46% | 7.64% | 기본 금리 |
| hybra-v4 | 0.78% | 1.55% | 인센티브 100.00% |
...
DefiLlama 실시간 데이터 기준, Hyperliquid L1의 hybra-v4에서 APY 0.78%예요.
