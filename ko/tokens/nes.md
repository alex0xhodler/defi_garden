...
NES 풀은 여기 6개가 있고, 2개 체인에서 APY가 0.07%부터 76.87%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

6개 풀 중 6개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 18.78%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| uniswap-v4 | 2.66% | 6.96% | 기본 금리 |
| uniswap-v4 | 3.07% | 2.34% | 기본 금리 |
| uniswap-v4 | 0.07% | 0.18% | 기본 금리 |
| uniswap-v4 | 28.03% | 106.28% | 기본 금리 |
| uniswap-v4 | 65.11% | 30.60% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 23개이며, 합산 TVL은 $10.85M예요.
