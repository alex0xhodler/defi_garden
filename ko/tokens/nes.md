...
NES 풀은 여기 6개가 있고, 2개 체인에서 APY가 0.27%부터 76.87%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v4 | 2.66% | 7.40% | 기본 금리 |
| uniswap-v4 | 1.79% | 2.52% | 기본 금리 |
| uniswap-v4 | 0.27% | 0.27% | 기본 금리 |
| uniswap-v4 | 28.03% | 106.28% | 기본 금리 |
| uniswap-v4 | 18.28% | 8.87% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 23개이며, 합산 TVL은 $10.84M예요.
