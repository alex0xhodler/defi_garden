...
현재 NES의 가장 높은 정직한 수익률은 Ethereum의 uniswap-v4에서 12.86%이며, $100K TVL 기준을 넘는 25개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
NES 풀은 여기 5개가 있고, 2개 체인에서 APY가 5.21%부터 28.17%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| uniswap-v4 | 7.40% | 584.78% | 기본 금리 |
| uniswap-v4 | 28.17% | 114.48% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 25개이며, 합산 TVL은 $10.36M예요.
