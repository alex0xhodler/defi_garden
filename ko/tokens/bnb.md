...
BNB 풀은 여기 6개가 있고, 5개 체인에서 APY가 0.11%부터 108.51%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| lista-lending | 0.11% | 0.09% | 기본 금리 |
| raydium-amm | 0.20% | 0.12% | 기본 금리 |
| sovryn-dex | 0.16% | 0.07% | 인센티브 100.00% |
| gmx-v2-perps | 0.31% | 0.28% | 기본 금리 |
| uniswap-v3 | 37.88% | 28.79% | 기본 금리 |
| gmtrade | 108.51% | 88.05% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 6개이며, 합산 TVL은 $302.39M예요.
