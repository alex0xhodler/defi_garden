...
BNB 풀은 여기 8개가 있고, 4개 체인에서 APY가 0.16%부터 34.00%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| uniswap-v4 | 17.11% | 11.73% | 기본 금리 |
| uniswap-v4 | 0.40% | 0.94% | 기본 금리 |
| sovryn-dex | 0.40% | 0.21% | 인센티브 100.00% |
| uniswap-v4 | 5.46% | 8.85% | 기본 금리 |
| gmx-v2-perps | 0.89% | 0.53% | 기본 금리 |
| uniswap-v3 | 34.00% | 38.63% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 uniswap-v3에서 APY 34.00%예요.

### BNB 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 22개이며, 합산 TVL은 $364.63M예요.
