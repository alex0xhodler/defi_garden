...
SRUSDE 풀은 여기 3개가 있고, 1개 체인에서 APY가 3.14%부터 3.98%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| strata-markets | 3.14% | 3.25% | 기본 금리 |
| pendle | 3.98% | 3.90% | 기본 금리 |
| pendle | 3.63% | 4.00% | 인센티브 7.57% |
