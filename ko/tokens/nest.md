...
현재 NEST의 가장 높은 정직한 수익률은 Hyperliquid L1의 nest-cl에서 140.44%이며, $100K TVL 기준을 넘는 3개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
NEST 풀은 여기 3개가 있고, 1개 체인에서 APY가 34.55%부터 140.44%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| nest-cl | 65.80% | 49.78% | 인센티브 100.00% |
| nest-amm | 34.55% | 54.79% | 인센티브 100.00% |
| nest-cl | 140.44% | 189.77% | 인센티브 100.00% |
...
DefiLlama 실시간 데이터 기준, Hyperliquid L1의 nest-cl에서 APY 140.44%예요.

### NEST 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 3개이며, 합산 TVL은 $701.6K예요.
