...
현재 USDP의 가장 높은 정직한 수익률은 Hyperliquid L1의 balancer-v3에서 12.33%이며, $100K TVL 기준을 넘는 2개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
USDP 풀은 여기 2개가 있고, 2개 체인에서 APY가 10.60%부터 12.33%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| balancer-v3 | 12.33% | 12.34% | 인센티브 81.65% |
...
DefiLlama 실시간 데이터 기준, Hyperliquid L1의 balancer-v3에서 APY 12.33%예요.
