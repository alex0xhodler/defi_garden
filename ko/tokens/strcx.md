...
현재 STRCX의 가장 높은 정직한 수익률은 Ethereum의 pendle-v2에서 26.19%이며, $100K TVL 기준을 넘는 5개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
STRCX 풀은 여기 4개가 있고, 2개 체인에서 APY가 25.88%부터 106.49%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

4개 풀 중 4개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 33.36%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| pendle-v2 | 25.88% | 33.92% | 인센티브 24.97% |
| pendle-v2 | 26.19% | 27.40% | 기본 금리 |
| raydium-amm | 105.72% | 32.79% | 기본 금리 |
| raydium-amm | 106.49% | 232.13% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 pendle-v2에서 APY 26.19%예요.
