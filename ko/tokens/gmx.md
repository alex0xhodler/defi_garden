...
GMX 풀은 여기 6개가 있고, 1개 체인에서 APY가 0.08%부터 29.92%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| gmx-v2-perps | 7.56% | 36.96% | 기본 금리 |
| gmx-v2-perps | 1.79% | 3.53% | 기본 금리 |
| gmx-v2-perps | 1.79% | 3.53% | 기본 금리 |
| uniswap-v3 | 12.80% | 17.03% | 기본 금리 |
| uniswap-v3 | 29.92% | 71.97% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Arbitrum의 uniswap-v3에서 APY 12.80%예요.

### GMX 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 8개이며, 합산 TVL은 $5.52M예요.
