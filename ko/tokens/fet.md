...
FET 풀은 여기 3개가 있고, 2개 체인에서 APY가 2.30%부터 6.78%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v3 | 3.00% | 8.19% | 기본 금리 |
| uniswap-v4 | 2.30% | 6.06% | 기본 금리 |
| minswap-dex | 6.78% | 6.18% | 인센티브 56.64% |
