...
FET 풀은 여기 3개가 있고, 2개 체인에서 APY가 4.67%부터 12.66%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v3 | 12.66% | 8.29% | 기본 금리 |
| uniswap-v4 | 4.67% | 6.33% | 기본 금리 |
| minswap-dex | 6.80% | 6.38% | 인센티브 57.65% |
