...
현재 WMATIC의 가장 높은 정직한 수익률은 Polygon의 quickswap-dex에서 3.62%이며, $100K TVL 기준을 넘는 10개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
WMATIC 풀은 여기 8개가 있고, 1개 체인에서 APY가 0.04%부터 89.23%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

8개 풀 중 6개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 5.51%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| uniswap-v3 | 59.20% | 34.47% | 기본 금리 |
| uniswap-v3 | 0.04% | 0.04% | 기본 금리 |
| quickswap-dex | 4.47% | — | 기본 금리 |
| quickswap-dex | 8.35% | — | 기본 금리 |
| uniswap-v3 | 17.28% | 6.44% | 기본 금리 |
| quickswap-dex | 3.62% | 4.57% | 기본 금리 |
| uniswap-v3 | 89.23% | 25.22% | 기본 금리 |
| uniswap-v3 | 3.19% | 3.61% | 기본 금리 |
