...
현재 AGUSDC의 가장 높은 정직한 수익률은 Avalanche의 gami-labs에서 7.54%이며, $100K TVL 기준을 넘는 2개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
APY 이력만 기준으로 비교한 AGUSDC의 변동성 낮은 후보는 Avalanche의 gami-labs, APY 7.54%, TVL $1.05M, https://www.defi.garden/?pool=3027f6e5-c7bf-4e44-a3a7-5e7211b374cc&src=seo_token; Avalanche의 lagoon, APY 5.79%, TVL $1.05M, https://www.defi.garden/?pool=763f056b-94ce-47cc-843a-6beb6eee0946&src=seo_token예요. 이 비교는 프로토콜, 익스플로잇, 디페그, 유동성, 거버넌스 또는 원금 손실 위험을 측정하지 않아요.
...
AGUSDC 풀은 여기 2개가 있고, 1개 체인에서 APY가 5.79%부터 7.54%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| lagoon | 5.79% | 7.44% | 기본 금리 |
| gami-labs | 7.54% | 8.35% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Avalanche의 gami-labs에서 APY 7.54%예요.
