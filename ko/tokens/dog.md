...
DOG 풀은 여기 3개가 있고, 3개 체인에서 APY가 0.02%부터 0.32%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
