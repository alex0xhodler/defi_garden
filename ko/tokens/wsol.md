...
현재 WSOL의 가장 높은 정직한 수익률은 Solana의 raydium-amm에서 103.83%이며, $100K TVL 기준을 넘는 199개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
WSOL 풀은 여기 8개가 있고, 1개 체인에서 APY가 0.08%부터 103.83%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| raydium-amm | 103.83% | 124.88% | 기본 금리 |
| jupiter-lend | 3.86% | 4.04% | 기본 금리 |
| jupiter-lend | 3.86% | 4.04% | 기본 금리 |
| raydium-amm | 0.08% | 0.21% | 기본 금리 |
| raydium-amm | 21.11% | 8.85% | 기본 금리 |
| raydium-amm | 11.94% | 3.68% | 기본 금리 |
| raydium-amm | 2.04% | 1.98% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Solana의 raydium-amm에서 APY 103.83%예요.

### WSOL 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 199개이며, 합산 TVL은 $456.81M예요.
