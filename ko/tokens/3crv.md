...
현재 3CRV의 가장 높은 정직한 수익률은 Ethereum의 convex-finance에서 40.56%이며, $100K TVL 기준을 넘는 12개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
3CRV 풀은 여기 7개가 있고, 1개 체인에서 APY가 0.02%부터 40.56%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| curve-dex | 15.65% | 15.05% | 인센티브 98.98% |
| convex-finance | 40.56% | 29.54% | 인센티브 99.61% |
...
DefiLlama 실시간 데이터 기준, Ethereum의 convex-finance에서 APY 40.56%예요.
