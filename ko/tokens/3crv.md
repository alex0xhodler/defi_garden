...
현재 3CRV의 가장 높은 정직한 수익률은 Ethereum의 convex-finance에서 33.56%이며, $100K TVL 기준을 넘는 12개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
3CRV 풀은 여기 8개가 있고, 1개 체인에서 APY가 0.01%부터 33.56%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| curve-dex | 0.59% | 0.98% | 인센티브 84.62% |
| curve-dex | 0.03% | 0.06% | 인센티브 0.03% |
| curve-dex | 2.99% | 3.01% | 기본 금리 |
| convex-finance | 0.03% | 0.06% | 기본 금리 |
| curve-dex | 19.12% | 12.45% | 인센티브 99.90% |
| curve-dex | 0.04% | 0.17% | 인센티브 76.70% |
| convex-finance | 33.56% | 23.26% | 인센티브 99.94% |
...
DefiLlama 실시간 데이터 기준, Ethereum의 convex-finance에서 APY 33.56%예요.
