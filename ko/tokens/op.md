...
OP 풀은 여기 6개가 있고, 1개 체인에서 APY가 0.06%부터 107.63%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| uniswap-v4 | 107.63% | 99.16% | 기본 금리 |
| uniswap-v3 | 80.99% | — | 기본 금리 |
| curve-dex | 17.08% | 16.06% | 인센티브 90.45% |
...
DefiLlama 실시간 데이터 기준, OP Mainnet의 uniswap-v4에서 APY 107.63%예요.
