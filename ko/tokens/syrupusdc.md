...
현재 SYRUPUSDC의 가장 높은 정직한 수익률은 Solana의 orca-dex에서 2.89%이며, $100K TVL 기준을 넘는 19개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
SYRUPUSDC 풀은 여기 8개가 있고, 4개 체인에서 APY가 0.01%부터 2.89%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v4 | 1.01% | 0.95% | 기본 금리 |
| orca-dex | 0.07% | 0.91% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Solana의 orca-dex에서 APY 2.89%예요.
