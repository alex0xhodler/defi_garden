...
현재 SYRUPUSDC의 가장 높은 정직한 수익률은 Solana의 orca-dex에서 3.10%이며, $100K TVL 기준을 넘는 19개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
SYRUPUSDC 풀은 여기 8개가 있고, 4개 체인에서 APY가 0.21%부터 3.25%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| kamino-liquidity | 0.23% | 0.73% | 기본 금리 |
| uniswap-v4 | 3.16% | 0.69% | 기본 금리 |
| orca-dex | 0.21% | 0.09% | 기본 금리 |
| fluid-dex | 1.92% | 1.35% | 기본 금리 |
| uniswap-v4 | 3.25% | 0.08% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Solana의 orca-dex에서 APY 3.10%예요.

### SYRUPUSDC 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 19개이며, 합산 TVL은 $459.31M예요.
