...
현재 EURC의 가장 높은 정직한 수익률은 Base의 aerodrome-slipstream에서 55.06%이며, $100K TVL 기준을 넘는 33개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
EURC 풀은 여기 8개가 있고, 4개 체인에서 APY가 1.98%부터 55.06%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| jupiter-lend | 4.84% | 3.52% | 기본 금리 |
| aave-v3 | 2.84% | 2.38% | 기본 금리 |
| aerodrome-slipstream | 23.15% | 25.41% | 인센티브 17.97% |
| fluid-lending | 3.36% | 3.15% | 기본 금리 |
| aerodrome-slipstream | 55.06% | 83.67% | 인센티브 33.96% |
| blend-pools-v2 | 4.80% | 5.46% | 기본 금리 |
| uniswap-v4 | 1.98% | 8.35% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Base의 aerodrome-slipstream에서 APY 55.06%예요.

### EURC 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 33개이며, 합산 TVL은 $37.22M예요.
