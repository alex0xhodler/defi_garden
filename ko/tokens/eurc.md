...
현재 EURC의 가장 높은 정직한 수익률은 Base의 aerodrome-v1에서 16.55%이며, $100K TVL 기준을 넘는 32개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
EURC 풀은 여기 8개가 있고, 4개 체인에서 APY가 2.03%부터 30.57%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| uniswap-v4 | 30.57% | 14.56% | 기본 금리 |
| blend-pools-v2 | 4.45% | 4.96% | 기본 금리 |
| aerodrome-v1 | 16.55% | 12.23% | 인센티브 100.00% |
...
DefiLlama 실시간 데이터 기준, Base의 aerodrome-v1에서 APY 16.55%예요.

### EURC 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 32개이며, 합산 TVL은 $43.89M예요.
