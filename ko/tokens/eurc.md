...
EURC 풀은 여기 8개가 있고, 4개 체인에서 APY가 1.31%부터 89.32%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| aave-v3 | 2.39% | 2.44% | 기본 금리 |
| jupiter-lend | 4.55% | 3.74% | 기본 금리 |
| aave-v3 | 1.96% | 2.18% | 기본 금리 |
| uniswap-v4 | 26.49% | 13.50% | 기본 금리 |
| aerodrome-slipstream | 42.03% | 22.59% | 인센티브 4.41% |
| fluid-lending | 2.68% | 3.00% | 기본 금리 |
| aerodrome-slipstream | 89.32% | 109.52% | 인센티브 15.36% |
...
DefiLlama 실시간 데이터 기준, Base의 aerodrome-slipstream에서 APY 89.32%예요.

### EURC 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 30개이며, 합산 TVL은 $42.65M예요.
