...
현재 EURC의 가장 높은 정직한 수익률은 Base의 aerodrome-slipstream에서 46.74%이며, $100K TVL 기준을 넘는 33개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
EURC 풀은 여기 8개가 있고, 4개 체인에서 APY가 0.64%부터 46.74%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| aave-v3 | 2.82% | 2.85% | 기본 금리 |
| jupiter-lend | 4.89% | 3.54% | 기본 금리 |
| aave-v3 | 2.77% | 2.39% | 기본 금리 |
| aerodrome-slipstream | 24.35% | 25.36% | 인센티브 17.32% |
| fluid-lending | 3.38% | 3.16% | 기본 금리 |
| aerodrome-slipstream | 46.74% | 83.93% | 인센티브 25.70% |
| blend-pools-v2 | 4.78% | 5.45% | 기본 금리 |
| uniswap-v4 | 0.64% | 8.26% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Base의 aerodrome-slipstream에서 APY 46.74%예요.

### EURC 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 33개이며, 합산 TVL은 $37.53M예요.
