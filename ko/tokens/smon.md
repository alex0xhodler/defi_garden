...
현재 SMON의 가장 높은 정직한 수익률은 Monad의 curve-dex에서 14.70%이며, $100K TVL 기준을 넘는 4개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
SMON 풀은 여기 3개가 있고, 1개 체인에서 APY가 1.63%부터 14.70%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| kintsu | 11.19% | 11.56% | 기본 금리 |
| curve-dex | 14.70% | 23.60% | 인센티브 100.00% |
| neverland | 1.63% | 0.78% | 인센티브 100.00% |
