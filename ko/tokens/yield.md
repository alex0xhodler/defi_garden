...
현재 YIELD의 가장 높은 정직한 수익률은 Ethereum의 morpho-blue에서 7.23%이며, $100K TVL 기준을 넘는 5개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
YIELD 풀은 여기 5개가 있고, 2개 체인에서 APY가 0.06%부터 7.23%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| morpho-blue | 7.23% | 7.01% | 기본 금리 |
| morpho-blue | 0.06% | 0.22% | 기본 금리 |
| morpho-blue | 2.82% | 2.75% | 기본 금리 |
| morpho-blue | 3.01% | 3.67% | 기본 금리 |
| morpho-blue | 2.58% | 2.88% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 5개이며, 합산 TVL은 $12.81M예요.
