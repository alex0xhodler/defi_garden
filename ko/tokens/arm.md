...
현재 ARM의 가장 높은 정직한 수익률은 Ethereum의 origin-arm에서 7.97%이며, $100K TVL 기준을 넘는 5개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
ARM 풀은 여기 5개가 있고, 1개 체인에서 APY가 1.40%부터 7.97%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| origin-arm | 4.36% | 4.60% | 인센티브 34.38% |
| origin-arm | 2.14% | 2.21% | 기본 금리 |
| origin-arm | 6.76% | 8.07% | 인센티브 29.59% |
| origin-arm | 1.40% | 1.53% | 기본 금리 |
| origin-arm | 7.97% | 11.30% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 origin-arm에서 APY 7.97%예요.
