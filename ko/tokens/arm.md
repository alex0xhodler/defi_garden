...
ARM 풀은 여기 7개가 있고, 1개 체인에서 APY가 1.28%부터 9.55%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

7개 풀 중 7개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 3.57%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| origin-arm | 1.99% | 3.84% | 기본 금리 |
| origin-arm | 1.81% | 2.49% | 기본 금리 |
| origin-arm | 9.55% | 7.14% | 기본 금리 |
| origin-arm | 1.28% | 1.34% | 기본 금리 |
| origin-arm | 4.68% | 4.98% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 origin-arm에서 APY 9.55%예요.

### ARM 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 7개이며, 합산 TVL은 $14.44M예요.
