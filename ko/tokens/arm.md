...
현재 ARM의 가장 높은 정직한 수익률은 Ethereum의 origin-arm에서 7.50%이며, $100K TVL 기준을 넘는 5개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
ARM 풀은 여기 5개가 있고, 1개 체인에서 APY가 1.40%부터 7.50%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| origin-arm | 4.34% | 4.59% | 인센티브 34.59% |
| origin-arm | 2.16% | 2.21% | 기본 금리 |
| origin-arm | 6.81% | 8.04% | 인센티브 29.35% |
| origin-arm | 1.40% | 1.52% | 기본 금리 |
| origin-arm | 7.50% | 11.20% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 origin-arm에서 APY 7.50%예요.

### ARM 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 5개이며, 합산 TVL은 $9.44M예요.
