...
MUSD 풀은 여기 4개가 있고, 3개 체인에서 APY가 0.62%부터 5.98%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| aerodrome-slipstream | 5.22% | 10.42% | 인센티브 92.50% |
| aave-v3 | 5.98% | 7.92% | 인센티브 65.73% |
