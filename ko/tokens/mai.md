...
<<<<<<< HEAD
현재 MAI의 가장 높은 정직한 수익률은 Base의 extra-finance-leverage-farming에서 6.52%이며, $100K TVL 기준을 넘는 8개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
<<<<<<< HEAD
DefiLlama 실시간 데이터 기준, Base의 extra-finance-leverage-farming에서 APY 6.52%예요.
=======
