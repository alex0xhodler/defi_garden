...
현재 STONKS의 가장 높은 정직한 수익률은 Hyperliquid L1의 hyperswap-v2에서 0.19%이며, $100K TVL 기준을 넘는 1개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.

| 프로토콜 | 체인 | APY | TVL |
|---|---|---|---|
| [hyperswap-v2 →](https://www.defi.garden/?pool=0ec69e97-4f27-42b2-8d88-02a97f5fa1f2&src=seo_token) | Hyperliquid L1 | 0.19% | $108.8K |
...
DefiLlama 실시간 데이터 기준, Hyperliquid L1의 hyperswap-v2에서 APY 0.19%예요.
