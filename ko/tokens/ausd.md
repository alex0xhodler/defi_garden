...
현재 AUSD의 가장 높은 정직한 수익률은 Monad의 accountable에서 8.15%이며, $100K TVL 기준을 넘는 34개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
| euler-v2 | 7.33% | 7.38% | 인센티브 17.04% |
| accountable | 8.15% | 5.52% | 인센티브 17.18% |
| uniswap-v3 | 0.68% | 0.38% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 34개이며, 합산 TVL은 $686.57M예요.
