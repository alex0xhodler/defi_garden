...
현재 FIN의 가장 높은 정직한 수익률은 Polygon의 uniswap-v4에서 3.04%이며, $100K TVL 기준을 넘는 4개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
APY 이력만 기준으로 비교한 FIN의 변동성 낮은 후보는 Polygon의 uniswap-v4, APY 3.04%, TVL $157.1K, https://www.defi.garden/?pool=e1b8d982-a466-4eec-8fa8-d623b882c41d&src=seo_token; Polygon의 uniswap-v4, APY 5.36%, TVL $238.3K, https://www.defi.garden/?pool=b538e6df-798c-4aa7-b42d-47b138f64eee&src=seo_token예요. 이 비교는 프로토콜, 익스플로잇, 디페그, 유동성, 거버넌스 또는 원금 손실 위험을 측정하지 않아요.
...
FIN 풀은 여기 2개가 있고, 1개 체인에서 APY가 3.04%부터 5.36%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v4 | 5.36% | 22.43% | 기본 금리 |
| uniswap-v4 | 3.04% | 5.77% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Polygon의 uniswap-v4에서 APY 3.04%예요.
