...
현재 SUSDX의 가장 높은 정직한 수익률은 Ethereum의 pendle-v2에서 19.58%이며, $100K TVL 기준을 넘는 5개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
SUSDX 풀은 여기 4개가 있고, 1개 체인에서 APY가 9.89%부터 19.58%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| axis | 17.97% | 23.21% | 기본 금리 |
| pendle-v2 | 19.58% | 23.89% | 인센티브 1.86% |
| pendle-v2 | 17.92% | 19.27% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 pendle-v2에서 APY 19.58%예요.

### SUSDX 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 5개이며, 합산 TVL은 $50.42M예요.
