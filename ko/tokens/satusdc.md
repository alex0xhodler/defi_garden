...
SATUSDC 풀은 여기 2개가 있고, 2개 체인에서 APY가 5.33%부터 7.00%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| morpho-blue | 7.00% | 5.32% | 인센티브 14.03% |
| morpho-blue | 5.33% | 5.44% | 기본 금리 |
