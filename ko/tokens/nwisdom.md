...
현재 NWISDOM의 가장 높은 정직한 수익률은 Plume Mainnet의 plume-vaults에서 10.48%이며, $100K TVL 기준을 넘는 1개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.

| 프로토콜 | 체인 | APY | TVL |
|---|---|---|---|
| [plume-vaults →](https://www.defi.garden/?pool=8479e5cf-e8b8-4e50-b1ef-cc9d2c1abd4e&src=seo_token) | Plume Mainnet | 10.48% | $2.87M |

<!-- rate-stability:insufficient -->
## APY 이력 기반 수익률 안정성

비교할 수 있는 NWISDOM 풀의 APY 이력이 충분하지 않아요. 이 내용은 APY 이력만 다루며 프로토콜, 익스플로잇, 디페그, 유동성, 거버넌스 또는 원금 손실 위험을 측정하지 않아요.
...
DefiLlama 실시간 데이터 기준, Plume Mainnet의 plume-vaults에서 APY 10.48%예요.
...
### NWISDOM 풀 중 APY 이력이 가장 안정적인 후보는 무엇인가요?
