...
현재 NWISDOM의 가장 높은 정직한 수익률은 Plume Mainnet의 plume-vaults에서 1.64%이며, $100K TVL 기준을 넘는 1개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.

| 프로토콜 | 체인 | APY | TVL |
|---|---|---|---|
| [plume-vaults →](https://www.defi.garden/?pool=8479e5cf-e8b8-4e50-b1ef-cc9d2c1abd4e&src=seo_token) | Plume Mainnet | 1.64% | $2.87M |
...
DefiLlama 실시간 데이터 기준, Plume Mainnet의 plume-vaults에서 APY 1.64%예요.
