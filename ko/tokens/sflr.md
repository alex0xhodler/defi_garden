...
현재 SFLR의 가장 높은 정직한 수익률은 Flare의 spectra-v2에서 14.23%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
SFLR 풀은 여기 6개가 있고, 1개 체인에서 APY가 0.52%부터 14.23%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| sceptre-liquid | 8.57% | 7.44% | 기본 금리 |
| kinetic | 0.52% | 0.50% | 인센티브 88.78% |
| sparkdex-v4 | 6.28% | 6.98% | 인센티브 99.74% |
| spectra-v2 | 14.23% | 13.02% | 기본 금리 |
| spectra-v2 | 7.89% | 6.94% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Flare의 spectra-v2에서 APY 14.23%예요.
