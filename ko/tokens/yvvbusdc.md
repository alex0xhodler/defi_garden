...
현재 YVVBUSDC의 가장 높은 정직한 수익률은 Katana의 spectra-v2에서 6.05%이며, $100K TVL 기준을 넘는 3개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
YVVBUSDC 풀은 여기 2개가 있고, 1개 체인에서 APY가 1.19%부터 6.05%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| spectra-v2 | 6.05% | 8.13% | 인센티브 19.63% |
| spectra-v2 | 1.19% | 7.64% | 인센티브 100.00% |
...
DefiLlama 실시간 데이터 기준, Katana의 spectra-v2에서 APY 6.05%예요.
