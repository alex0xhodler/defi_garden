...
현재 USOL의 가장 높은 정직한 수익률은 Base의 aerodrome-slipstream에서 26.62%이며, $100K TVL 기준을 넘는 4개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
USOL 풀은 여기 4개가 있고, 2개 체인에서 APY가 0.56%부터 26.62%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| aerodrome-slipstream | 26.62% | 47.46% | 인센티브 26.21% |
| uniswap-v3 | 4.54% | 6.59% | 기본 금리 |
| project-x | 0.56% | 15.26% | 기본 금리 |
| hyperlend-pooled | 6.26% | 9.91% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Base의 aerodrome-slipstream에서 APY 26.62%예요.
