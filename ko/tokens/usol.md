...
현재 USOL의 가장 높은 정직한 수익률은 Base의 aerodrome-slipstream에서 44.02%이며, $100K TVL 기준을 넘는 4개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
USOL 풀은 여기 4개가 있고, 2개 체인에서 APY가 7.95%부터 44.02%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| aerodrome-slipstream | 44.02% | 45.39% | 인센티브 19.67% |
| uniswap-v3 | 8.10% | 6.53% | 기본 금리 |
| project-x | 8.58% | 13.92% | 기본 금리 |
| hyperlend-pooled | 7.95% | 9.44% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Base의 aerodrome-slipstream에서 APY 44.02%예요.
