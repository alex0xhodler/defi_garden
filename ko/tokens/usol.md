...
현재 USOL의 가장 높은 정직한 수익률은 Base의 aerodrome-slipstream에서 27.71%이며, $100K TVL 기준을 넘는 4개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
USOL 풀은 여기 4개가 있고, 2개 체인에서 APY가 4.34%부터 28.73%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

4개 풀 중 4개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 12.65%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| aerodrome-slipstream | 27.71% | 47.98% | 인센티브 25.68% |
| uniswap-v3 | 4.34% | 6.62% | 기본 금리 |
| project-x | 28.73% | 15.36% | 기본 금리 |
| hyperlend-pooled | 6.23% | 9.94% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Base의 aerodrome-slipstream에서 APY 27.71%예요.
