...
USOL 풀은 여기 4개가 있고, 2개 체인에서 APY가 2.94%부터 33.82%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| aerodrome-slipstream | 33.82% | 34.42% | 인센티브 6.70% |
| uniswap-v3 | 8.48% | 10.58% | 기본 금리 |
| project-x | 13.87% | 28.52% | 기본 금리 |
| hyperlend-pooled | 2.94% | 7.21% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Base의 aerodrome-slipstream에서 APY 33.82%예요.
