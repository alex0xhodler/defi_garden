...
현재 XAUT0의 가장 높은 정직한 수익률은 Celo의 uniswap-v3에서 33.35%이며, $100K TVL 기준을 넘는 10개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
XAUT0 풀은 여기 6개가 있고, 4개 체인에서 APY가 1.22%부터 33.35%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| raydium-amm | 1.62% | 1.59% | 기본 금리 |
| uniswap-v4 | 4.29% | 2.13% | 기본 금리 |
| affluent | 2.97% | 2.71% | 기본 금리 |
| ston.fi | 1.22% | 1.44% | 기본 금리 |
| uniswap-v3 | 33.35% | 30.09% | 기본 금리 |
| uniswap-v4 | 3.92% | 8.27% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 10개이며, 합산 TVL은 $6.56M예요.
