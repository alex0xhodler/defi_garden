...
현재 USDX의 가장 높은 정직한 수익률은 Ethereum의 pendle-v2에서 15.08%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
USDX 풀은 여기 6개가 있고, 3개 체인에서 APY가 0.40%부터 15.08%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

6개 풀 중 6개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 6.74%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
| curve-dex | 0.40% | 1.29% | 기본 금리 |
| curve-dex | 11.46% | 9.98% | 기본 금리 |
| pendle-v2 | 11.14% | 11.09% | 인센티브 33.97% |
| pendle-v2 | 15.08% | 15.01% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 pendle-v2에서 APY 15.08%예요.
