...
현재 USDX의 가장 높은 정직한 수익률은 Ethereum의 curve-dex에서 15.99%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
USDX 풀은 여기 6개가 있고, 3개 체인에서 APY가 0.56%부터 15.99%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| pendle-v2 | 11.06% | 11.05% | 인센티브 29.26% |
| pendle-v2 | 15.52% | 15.10% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 curve-dex에서 APY 15.99%예요.
