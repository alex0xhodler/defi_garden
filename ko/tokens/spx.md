...
현재 SPX의 가장 높은 정직한 수익률은 Solana의 orca-dex에서 22.28%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
SPX 풀은 여기 6개가 있고, 3개 체인에서 APY가 0.13%부터 22.28%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v2 | 3.15% | 5.34% | 기본 금리 |
| raydium-amm | 5.27% | 8.90% | 기본 금리 |
| aerodrome-v1 | 9.88% | 14.95% | 인센티브 100.00% |
| orca-dex | 22.28% | 31.72% | 기본 금리 |
| uniswap-v3 | 11.04% | 20.40% | 기본 금리 |
| uniswap-v4 | 0.13% | 1.49% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Solana의 orca-dex에서 APY 22.28%예요.
