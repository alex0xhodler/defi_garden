...
현재 YFI의 가장 높은 정직한 수익률은 Ethereum의 convex-finance에서 8.92%이며, $100K TVL 기준을 넘는 8개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
YFI 풀은 여기 4개가 있고, 2개 체인에서 APY가 2.04%부터 8.92%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| curve-dex | 5.99% | 5.47% | 인센티브 94.16% |
| convex-finance | 8.92% | 7.72% | 인센티브 96.08% |
| uniswap-v2 | 2.04% | 3.16% | 기본 금리 |
