...
FXN 풀은 여기 4개가 있고, 1개 체인에서 APY가 1.04%부터 7.73%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
