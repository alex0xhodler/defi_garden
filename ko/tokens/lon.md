...
현재 LON의 가장 높은 정직한 수익률은 Ethereum의 sushiswap에서 0.39%이며, $100K TVL 기준을 넘는 3개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
LON 풀은 여기 3개가 있고, 2개 체인에서 APY가 0.13%부터 0.39%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v2 | 0.16% | 0.37% | 기본 금리 |
| uniswap-v3 | 0.13% | 0.08% | 기본 금리 |
| sushiswap | 0.39% | 0.81% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 sushiswap에서 APY 0.39%예요.
