...
| [sushiswap →](https://www.defi.garden/?pool=53327beb-9e23-46f3-ad6e-9be0eb7e3338&src=seo_token) | Ethereum | 0.27% | $128.2K |

수익률은 DefiLlama의 실시간 데이터예요. 이 페이지의 풀은 최소 TVL $100K 기준을 충족하고 이상 수치는 제외했어요 — 이는 이 페이지의 게재 기준일 뿐, 안전을 보장하는 것은 아니에요. 투자 조언이 아닌 교육 목적의 정보예요.

## 이 수익률은 어떻게 움직였을까요

LON 풀은 여기 3개가 있고, 2개 체인에서 APY가 0.02%부터 0.27%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v2 | 0.02% | 0.27% | 기본 금리 |
| uniswap-v3 | 0.06% | 0.07% | 기본 금리 |
| sushiswap | 0.27% | 0.84% | 기본 금리 |
