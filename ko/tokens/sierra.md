...
SIERRA 풀은 여기 3개가 있고, 2개 체인에서 APY가 0.97%부터 8.15%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| pendle | 8.15% | 8.39% | 기본 금리 |
| pendle | 4.94% | 6.61% | 인센티브 5.62% |
| joe-v2.2 | 0.97% | 1.07% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 5개이며, 합산 TVL은 $23.21M예요.
