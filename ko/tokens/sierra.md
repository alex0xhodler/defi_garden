...
SIERRA 풀은 여기 5개가 있고, 2개 체인에서 APY가 0.02%부터 8.10%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

5개 풀 중 5개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 1.13%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| pendle | 8.10% | 8.82% | 기본 금리 |
| pendle | 4.59% | 8.92% | 인센티브 16.51% |
| uniswap-v4 | 0.03% | 0.49% | 기본 금리 |
| uniswap-v4 | 0.02% | 0.65% | 기본 금리 |
| joe-v2.2 | 0.05% | 1.13% | 기본 금리 |
