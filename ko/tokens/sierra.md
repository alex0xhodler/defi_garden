...
현재 SIERRA의 가장 높은 정직한 수익률은 Ethereum의 pendle에서 8.06%이며, $100K TVL 기준을 넘는 5개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
APY 이력만 기준으로 비교한 SIERRA의 변동성 낮은 후보는 Ethereum의 uniswap-v4, APY 0.02%, TVL $3.16M, https://www.defi.garden/?pool=640a9171-635a-4acd-a614-b4baca312769&src=seo_token; Avalanche의 joe-v2.2, APY 0.11%, TVL $163.8K, https://www.defi.garden/?pool=752371ac-d9cd-46b5-b2d9-28fbce6bb571&src=seo_token예요. 이 비교는 프로토콜, 익스플로잇, 디페그, 유동성, 거버넌스 또는 원금 손실 위험을 측정하지 않아요.
...
SIERRA 풀은 여기 5개가 있고, 2개 체인에서 APY가 0.02%부터 8.06%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| pendle | 8.06% | 8.77% | 기본 금리 |
| pendle | 4.31% | 8.62% | 인센티브 9.96% |
| uniswap-v4 | 0.03% | 0.48% | 기본 금리 |
| uniswap-v4 | 0.02% | 0.65% | 기본 금리 |
| joe-v2.2 | 0.11% | 1.11% | 기본 금리 |
