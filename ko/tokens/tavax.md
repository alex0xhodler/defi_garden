...
현재 TAVAX의 가장 높은 정직한 수익률은 Avalanche의 pharaoh-v3에서 0.46%이며, $100K TVL 기준을 넘는 2개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
APY 이력만 기준으로 비교한 TAVAX의 변동성 낮은 후보는 Avalanche의 treehouse-protocol, APY 0.32%, TVL $9.76M, https://www.defi.garden/?pool=40a1e447-058d-4c5b-b567-30543ea185c3&src=seo_token; Avalanche의 pharaoh-v3, APY 0.46%, TVL $159.1K, https://www.defi.garden/?pool=29630e33-15fa-41aa-857e-595ea7878580&src=seo_token예요. 이 비교는 프로토콜, 익스플로잇, 디페그, 유동성, 거버넌스 또는 원금 손실 위험을 측정하지 않아요.
...
TAVAX 풀은 여기 2개가 있고, 1개 체인에서 APY가 0.32%부터 0.46%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| treehouse-protocol | 0.32% | 3.95% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Avalanche의 pharaoh-v3에서 APY 0.46%예요.
