...
현재 XBTC의 가장 높은 정직한 수익률은 Sui의 bluefin-spot에서 25.06%이며, $100K TVL 기준을 넘는 19개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
XBTC 풀은 여기 8개가 있고, 5개 체인에서 APY가 0.37%부터 25.06%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| navi-lending | 1.17% | 1.19% | 인센티브 78.61% |
| orca-dex | 1.09% | 2.62% | 기본 금리 |
| kamino-liquidity | 0.69% | 2.08% | 기본 금리 |
| liminal-basis | 6.83% | 7.19% | 기본 금리 |
| liminal-basis | 4.40% | 6.60% | 기본 금리 |
| hyperion | 0.37% | 0.37% | 기본 금리 |
| bluefin-spot | 25.06% | 29.22% | 인센티브 49.64% |
...
DefiLlama 실시간 데이터 기준, Sui의 bluefin-spot에서 APY 25.06%예요.

### XBTC 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 19개이며, 합산 TVL은 $44M예요.
