...
현재 UETH의 가장 높은 정직한 수익률은 Hyperliquid L1의 nest-cl에서 33.85%이며, $100K TVL 기준을 넘는 10개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
UETH 풀은 여기 8개가 있고, 1개 체인에서 APY가 0.02%부터 33.85%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| project-x | 10.04% | 10.97% | 기본 금리 |
| hyperlend-pooled | 6.06% | 2.67% | 기본 금리 |
| hyperswap-v3 | 0.25% | 1.05% | 기본 금리 |
| nest-cl | 33.85% | 43.18% | 인센티브 100.00% |
| ramses-cl-v2 | 14.58% | 34.45% | 인센티브 36.35% |
| ramses-cl-v2 | 26.77% | 49.98% | 인센티브 100.00% |
| hypurrfi-pooled | 0.02% | 0.02% | 기본 금리 |
| project-x | 5.18% | 2.78% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Hyperliquid L1의 nest-cl에서 APY 33.85%예요.
