...
YOG 풀은 여기 3개가 있고, 3개 체인에서 APY가 6.11%부터 7.25%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| morpho-blue | 7.25% | 2.87% | 인센티브 8.80% |
| morpho-blue | 6.11% | 7.22% | 인센티브 21.46% |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 3개이며, 합산 TVL은 $7.29M예요.
