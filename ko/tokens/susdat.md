...
현재 SUSDAT의 가장 높은 정직한 수익률은 Monad의 pendle에서 142.12%이며, $100K TVL 기준을 넘는 17개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
SUSDAT 풀은 여기 8개가 있고, 3개 체인에서 APY가 3.48%부터 142.12%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

8개 풀 중 7개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 13.98%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.

8개 풀 중 2개는 기본 금리에 인센티브·리워드 APY가 더해져 있어요. 인센티브 수익률은 보상 프로그램이 줄어들면서 시간이 지나면 낮아지는 경향이 있으니, 기본 금리가 더 오래가는 숫자예요.

| 프로토콜 | APY | 30일 평균 APY | 수익 구성 |
|---|---|---|---|
| saturn | 19.40% | 26.48% | 기본 금리 |
| pendle | 11.21% | 11.31% | 기본 금리 |
| pendle | 3.48% | 3.22% | 인센티브 13.62% |
| pendle | 7.19% | 8.41% | 기본 금리 |
| pendle | 13.60% | 13.98% | 기본 금리 |
| pendle | 142.12% | 226.34% | 인센티브 2.23% |
| pendle | 27.65% | 25.48% | 기본 금리 |
| curve-dex | 11.35% | — | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Monad의 pendle에서 APY 142.12%예요.

### SUSDAT 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 17개이며, 합산 TVL은 $116.18M예요.
