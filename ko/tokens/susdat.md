...
현재 SUSDAT의 가장 높은 정직한 수익률은 Monad의 pendle에서 18.38%이며, $100K TVL 기준을 넘는 14개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
APY 이력만 기준으로 비교한 SUSDAT의 변동성 낮은 후보는 Ethereum의 saturn, APY 14.93%, TVL $80.57M, https://www.defi.garden/?pool=47e72726-3b2b-4fe6-b4a9-a26e1fcd9a50&src=seo_token; Ethereum의 curve-dex, APY 42.37%, TVL $102K, https://www.defi.garden/?pool=a5ed9aac-3cec-4c88-b996-94b6cc76c2fe&src=seo_token예요. 이 비교는 프로토콜, 익스플로잇, 디페그, 유동성, 거버넌스 또는 원금 손실 위험을 측정하지 않아요.
...
SUSDAT 풀은 여기 7개가 있고, 2개 체인에서 APY가 11.81%부터 164.11%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

7개 풀 중 7개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 20.05%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.

7개 풀 중 2개는 기본 금리에 인센티브·리워드 APY가 더해져 있어요. 인센티브 수익률은 보상 프로그램이 줄어들면서 시간이 지나면 낮아지는 경향이 있으니, 기본 금리가 더 오래가는 숫자예요.

| 프로토콜 | APY | 30일 평균 APY | 수익 구성 |
|---|---|---|---|
| saturn | 14.93% | 19.79% | 기본 금리 |
| pendle | 18.38% | 20.05% | 기본 금리 |
| pendle | 61.52% | 38.41% | 인센티브 0.58% |
| pendle | 164.11% | 59.16% | 인센티브 6.89% |
| pendle | 14.74% | 18.63% | 기본 금리 |
| curve-dex | 11.81% | 5.18% | 기본 금리 |
| curve-dex | 42.37% | 188.01% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Monad의 pendle에서 APY 18.38%예요.

### SUSDAT 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 14개이며, 합산 TVL은 $106.89M예요.
