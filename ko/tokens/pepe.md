...
현재 PEPE의 가장 높은 정직한 수익률은 Ethereum의 uniswap-v3에서 4.72%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
PEPE 풀은 여기 6개가 있고, 3개 체인에서 APY가 0.55%부터 12.49%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v2 | 2.73% | 2.94% | 기본 금리 |
| raydium-amm | 0.55% | 0.30% | 기본 금리 |
| uniswap-v3 | 4.72% | 5.74% | 기본 금리 |
| uniswap-v3 | 2.70% | 2.50% | 기본 금리 |
| uniswap-v4 | 12.49% | 7.24% | 기본 금리 |
| raydium-amm | 1.13% | 1.90% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 6개이며, 합산 TVL은 $25.76M예요.
