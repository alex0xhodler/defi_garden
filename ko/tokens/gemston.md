...
GEMSTON 풀은 여기 3개가 있고, 1개 체인에서 APY가 0.04%부터 0.77%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| ston.fi | 0.77% | 1.32% | 기본 금리 |
| ston.fi | 0.04% | 0.40% | 기본 금리 |
| ston.fi | 0.59% | 1.40% | 기본 금리 |
