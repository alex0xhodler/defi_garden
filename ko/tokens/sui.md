...
SUI 풀은 여기 8개가 있고, 1개 체인에서 APY가 0.08%부터 149.24%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| ember-protocol | 3.07% | 3.91% | 기본 금리 |
| cetus-clmm | 123.33% | 119.00% | 인센티브 16.76% |
| cetus-clmm | 0.08% | 0.05% | 기본 금리 |
| navi-lending | 2.29% | 2.23% | 인센티브 16.73% |
| scallop-lend | 2.20% | 1.65% | 기본 금리 |
| current | 2.92% | 3.04% | 인센티브 67.48% |
| bluefin-spot | 149.24% | 159.29% | 인센티브 24.65% |
| bluefin-spot | 18.87% | 8.69% | 인센티브 34.63% |
...
DefiLlama 실시간 데이터 기준, Sui의 bluefin-spot에서 APY 149.24%예요.

### SUI 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 22개이며, 합산 TVL은 $21.22M예요.
