...
현재 LIMUSD의 가장 높은 정직한 수익률은 Hyperliquid L1의 pendle에서 9.84%이며, $100K TVL 기준을 넘는 5개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
LIMUSD 풀은 여기 5개가 있고, 3개 체인에서 APY가 7.61%부터 9.84%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| liminal-basis | 7.89% | 7.73% | 기본 금리 |
| pendle | 9.09% | 9.24% | 기본 금리 |
| pendle | 9.84% | 8.70% | 기본 금리 |
| liminal-basis | 7.89% | 7.73% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Hyperliquid L1의 pendle에서 APY 9.84%예요.
