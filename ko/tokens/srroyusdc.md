...
현재 SRROYUSDC의 가장 높은 정직한 수익률은 Ethereum의 concrete에서 6.92%이며, $100K TVL 기준을 넘는 4개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
SRROYUSDC 풀은 여기 3개가 있고, 1개 체인에서 APY가 3.02%부터 8.56%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| concrete | 6.92% | 5.51% | 기본 금리 |
| curve-dex | 3.02% | 4.71% | 인센티브 65.62% |
| stake-dao | 8.56% | 4.54% | 인센티브 26.72% |
