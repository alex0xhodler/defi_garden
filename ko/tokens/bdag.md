...
현재 BDAG의 가장 높은 정직한 수익률은 Solana의 raydium-amm에서 1.06%이며, $100K TVL 기준을 넘는 7개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
BDAG 풀은 여기 4개가 있고, 1개 체인에서 APY가 0.04%부터 1.06%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| raydium-amm | 1.06% | 0.86% | 기본 금리 |
| raydium-amm | 0.04% | 0.03% | 기본 금리 |
| raydium-amm | 0.65% | 0.62% | 기본 금리 |
