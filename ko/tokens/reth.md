...
현재 RETH의 가장 높은 정직한 수익률은 Ethereum의 convex-finance에서 6.79%이며, $100K TVL 기준을 넘는 25개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
RETH 풀은 여기 8개가 있고, 1개 체인에서 APY가 1.18%부터 9.72%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| balancer-v3 | 9.72% | 6.00% | 인센티브 33.95% |
| convex-finance | 6.79% | 6.15% | 인센티브 67.47% |
| uniswap-v3 | 5.43% | 1.69% | 기본 금리 |
