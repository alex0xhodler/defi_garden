...
현재 AVUSD의 가장 높은 정직한 수익률은 Ethereum의 stake-dao에서 11.87%이며, $100K TVL 기준을 넘는 7개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
AVUSD 풀은 여기 7개가 있고, 2개 체인에서 APY가 5.00%부터 11.87%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

7개 풀 중 7개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 9.12%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.

7개 풀 중 7개는 기본 금리에 인센티브·리워드 APY가 더해져 있어요. 인센티브 수익률은 보상 프로그램이 줄어들면서 시간이 지나면 낮아지는 경향이 있으니, 기본 금리가 더 오래가는 숫자예요.

| 프로토콜 | APY | 30일 평균 APY | 수익 구성 |
|---|---|---|---|
| balancer-v3 | 10.57% | 9.12% | 인센티브 91.09% |
| curve-dex | 7.59% | 6.09% | 인센티브 99.60% |
| curve-dex | 5.00% | 5.87% | 인센티브 100.00% |
| stake-dao | 9.48% | 7.39% | 인센티브 99.47% |
| curve-dex | 10.99% | 10.28% | 인센티브 97.09% |
| stake-dao | 11.87% | 11.65% | 인센티브 98.32% |
| convex-finance | 11.06% | 10.94% | 인센티브 99.73% |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 7개이며, 합산 TVL은 $6.06M예요.
