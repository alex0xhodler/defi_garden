...
SHMON 풀은 여기 3개가 있고, 1개 체인에서 APY가 1.46%부터 16.00%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| shmonad | 12.91% | 11.88% | 기본 금리 |
| neverland | 1.46% | 0.85% | 인센티브 100.00% |
