...
현재 SHMON의 가장 높은 정직한 수익률은 Monad의 curve-dex에서 13.91%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
SHMON 풀은 여기 4개가 있고, 1개 체인에서 APY가 0.03%부터 13.91%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| shmonad | 12.33% | 11.86% | 기본 금리 |
| neverland | 1.55% | 0.80% | 인센티브 100.00% |
...
DefiLlama 실시간 데이터 기준, Monad의 curve-dex에서 APY 13.91%예요.

### SHMON 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 6개이며, 합산 TVL은 $11.32M예요.
