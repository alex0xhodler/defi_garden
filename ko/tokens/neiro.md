...
NEIRO 풀은 여기 5개가 있고, 2개 체인에서 APY가 0.15%부터 4.46%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v2 | 4.46% | 11.91% | 기본 금리 |
| raydium-amm | 2.05% | 3.74% | 기본 금리 |
| raydium-amm | 2.19% | 2.63% | 기본 금리 |
| uniswap-v2 | 0.15% | 0.50% | 기본 금리 |
| uniswap-v3 | 0.20% | 25.32% | 기본 금리 |
