...
현재 XRP의 가장 높은 정직한 수익률은 Solana의 gmtrade에서 75.74%이며, $100K TVL 기준을 넘는 12개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
XRP 풀은 여기 7개가 있고, 4개 체인에서 APY가 0.53%부터 75.74%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| uniswap-v3 | 11.77% | 9.13% | 기본 금리 |
| pancakeswap-amm | 2.55% | 1.34% | 기본 금리 |
| vvs-standard | 7.01% | 2.00% | 기본 금리 |
| uniswap-v3 | 16.33% | 9.66% | 기본 금리 |
| gmtrade | 75.74% | 61.84% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Solana의 gmtrade에서 APY 75.74%예요.

### XRP 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 12개이며, 합산 TVL은 $9.97M예요.
