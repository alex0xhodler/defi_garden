...
SUSDAI 풀은 여기 8개가 있고, 2개 체인에서 APY가 0.01%부터 11.24%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| usd-ai | 7.00% | 7.38% | 기본 금리 |
| fluid-dex | 0.04% | 0.11% | 기본 금리 |
| fluid-dex | 0.34% | 0.04% | 기본 금리 |
| fluid-dex | 0.02% | 0.17% | 기본 금리 |
| fluid-dex | 0.01% | 0.15% | 기본 금리 |
| pendle-v2 | 8.30% | 8.83% | 인센티브 2.08% |
| pendle-v2 | 11.24% | 10.64% | 기본 금리 |
| pendle-v2 | 9.97% | 9.60% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Arbitrum의 pendle-v2에서 APY 11.24%예요.

### SUSDAI 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 23개이며, 합산 TVL은 $762.07M예요.
