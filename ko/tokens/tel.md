...
현재 TEL의 가장 높은 정직한 수익률은 Polygon의 uniswap-v4에서 24.98%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
TEL 풀은 여기 6개가 있고, 2개 체인에서 APY가 1.80%부터 24.98%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| balancer-v2 | 4.55% | 3.51% | 기본 금리 |
| balancer-v2 | 2.75% | 7.07% | 기본 금리 |
| balancer-v2 | 1.80% | 4.31% | 기본 금리 |
| uniswap-v4 | 24.98% | 36.48% | 기본 금리 |
| uniswap-v3 | 17.86% | 40.24% | 기본 금리 |
| uniswap-v4 | 5.10% | 13.38% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Polygon의 uniswap-v4에서 APY 24.98%예요.
