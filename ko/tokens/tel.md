...
현재 TEL의 가장 높은 정직한 수익률은 Polygon의 balancer-v2에서 1.91%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
TEL 풀은 여기 6개가 있고, 2개 체인에서 APY가 1.84%부터 116.95%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

6개 풀 중 6개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 10.20%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| balancer-v2 | 1.91% | 3.50% | 기본 금리 |
| balancer-v2 | 2.80% | 7.07% | 기본 금리 |
| balancer-v2 | 1.84% | 4.30% | 기본 금리 |
| uniswap-v4 | 116.95% | 36.20% | 기본 금리 |
| uniswap-v3 | 19.54% | 40.29% | 기본 금리 |
| uniswap-v4 | 5.10% | 13.34% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Polygon의 balancer-v2에서 APY 1.91%예요.
