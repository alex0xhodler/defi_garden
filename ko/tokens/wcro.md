...
현재 WCRO의 가장 높은 정직한 수익률은 Cronos의 vvs-standard에서 2.18%이며, $100K TVL 기준을 넘는 26개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
WCRO 풀은 여기 8개가 있고, 1개 체인에서 APY가 0.01%부터 2.18%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| vvs-standard | 1.85% | 2.89% | 기본 금리 |
| vvs-standard | 0.01% | 0.01% | 기본 금리 |
| vvs-standard | 0.79% | 1.27% | 기본 금리 |
| vvs-standard | 0.40% | 0.52% | 기본 금리 |
| vvs-standard | 2.18% | 1.79% | 기본 금리 |
| vvs-standard | 0.33% | 0.56% | 기본 금리 |
| vvs-standard | 1.18% | 0.09% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 26개이며, 합산 TVL은 $53.48M예요.
