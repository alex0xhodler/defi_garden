...
현재 WETH.E의 가장 높은 정직한 수익률은 Avalanche의 blackhole-clmm에서 276.14%이며, $100K TVL 기준을 넘는 7개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
WETH.E 풀은 여기 7개가 있고, 1개 체인에서 APY가 1.35%부터 276.14%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| benqi-lending | 1.70% | 1.53% | 기본 금리 |
| uniswap-v3 | 12.34% | 17.54% | 기본 금리 |
| deltaprime | 5.70% | 4.67% | 기본 금리 |
| pangolin-v2 | 1.79% | 1.99% | 기본 금리 |
| blackhole-clmm | 276.14% | 424.64% | 인센티브 100.00% |
...
DefiLlama 실시간 데이터 기준, Avalanche의 blackhole-clmm에서 APY 276.14%예요.

### WETH.E 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 7개이며, 합산 TVL은 $11.89M예요.
