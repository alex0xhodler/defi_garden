...
WETH.E 풀은 여기 7개가 있고, 1개 체인에서 APY가 0.20%부터 20.03%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| benqi-lending | 3.86% | 3.32% | 기본 금리 |
| uniswap-v3 | 20.03% | 14.32% | 기본 금리 |
| deltaprime | 1.22% | 2.19% | 기본 금리 |
| pangolin-v2 | 5.02% | 2.60% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Avalanche의 uniswap-v3에서 APY 20.03%예요.
