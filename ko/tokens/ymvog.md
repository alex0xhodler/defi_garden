...
현재 YMVOG의 가장 높은 정직한 수익률은 Ethereum의 morpho-blue에서 6.00%이며, $100K TVL 기준을 넘는 5개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
YMVOG 풀은 여기 5개가 있고, 3개 체인에서 APY가 1.96%부터 6.00%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| morpho-blue | 6.00% | 6.63% | 인센티브 10.83% |
| morpho-blue | 1.96% | 4.95% | 기본 금리 |
| morpho-blue | 5.00% | 4.95% | 기본 금리 |
