...
WHETH 풀은 여기 3개가 있고, 1개 체인에서 APY가 39.96%부터 55.27%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

3개 풀 중 3개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 45.72%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
| orca-dex | 55.27% | 16.77% | 기본 금리 |
| orca-dex | 39.96% | 55.17% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Solana의 orca-dex에서 APY 54.45%예요.
