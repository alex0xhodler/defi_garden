...
JRROYAPYUSD 풀은 여기 3개가 있고, 1개 체인에서 APY가 8.13%부터 38.58%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| royco-v2 | 38.58% | 167.22% | 기본 금리 |
| pendle-v2 | 8.13% | 7.91% | 인센티브 2.42% |
