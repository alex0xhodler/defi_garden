...
MIN 풀은 여기 2개가 있고, 1개 체인에서 APY가 2.26%부터 3.37%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
