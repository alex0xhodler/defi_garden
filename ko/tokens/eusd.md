...
현재 EUSD의 가장 높은 정직한 수익률은 Base의 curve-dex에서 44.69%이며, $100K TVL 기준을 넘는 16개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
EUSD 풀은 여기 8개가 있고, 2개 체인에서 APY가 0.41%부터 44.69%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| curve-dex | 1.08% | 2.88% | 기본 금리 |
| convex-finance | 7.76% | 6.34% | 인센티브 86.09% |
| curve-dex | 2.45% | 3.28% | 기본 금리 |
| aerodrome-slipstream | 4.29% | 2.79% | 인센티브 53.16% |
| aerodrome-v1 | 6.62% | 7.67% | 인센티브 100.00% |
...
DefiLlama 실시간 데이터 기준, Base의 curve-dex에서 APY 44.69%예요.
