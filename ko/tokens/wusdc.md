...
현재 WUSDC의 가장 높은 정직한 수익률은 Sui의 cetus-clmm에서 1.77%이며, $100K TVL 기준을 넘는 3개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
WUSDC 풀은 여기 3개가 있고, 1개 체인에서 APY가 1.19%부터 1.77%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| cetus-clmm | 1.77% | 2.18% | 기본 금리 |
| navi-lending | 1.48% | 1.47% | 기본 금리 |
| scallop-lend | 1.19% | 1.36% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Sui의 cetus-clmm에서 APY 1.77%예요.
