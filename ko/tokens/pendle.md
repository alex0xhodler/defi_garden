...
현재 PENDLE의 가장 높은 정직한 수익률은 Arbitrum의 uniswap-v3에서 23.72%이며, $100K TVL 기준을 넘는 15개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
PENDLE 풀은 여기 8개가 있고, 2개 체인에서 APY가 0.20%부터 89.98%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

8개 풀 중 8개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 16.11%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| camelot-v2 | 2.43% | 2.91% | 기본 금리 |
| uniswap-v3 | 12.08% | 16.40% | 기본 금리 |
| uniswap-v3 | 23.72% | 38.67% | 기본 금리 |
| dolomite | 0.39% | 0.37% | 기본 금리 |
| uniswap-v3 | 10.50% | 17.80% | 기본 금리 |
| uniswap-v4 | 6.59% | 15.83% | 기본 금리 |
| gmx-v2-perps | 0.20% | 2.68% | 기본 금리 |
| uniswap-v3 | 89.98% | 38.87% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Arbitrum의 uniswap-v3에서 APY 23.72%예요.

### PENDLE 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 15개이며, 합산 TVL은 $5.44M예요.
