...
현재 SRUSDAT의 가장 높은 정직한 수익률은 Ethereum의 pendle-v2에서 14.51%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
SRUSDAT 풀은 여기 5개가 있고, 2개 체인에서 APY가 8.11%부터 14.51%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| pendle-v2 | 11.13% | 15.73% | 기본 금리 |
| pendle-v2 | 10.42% | 12.50% | 기본 금리 |
| pendle-v2 | 14.51% | 15.19% | 인센티브 39.84% |
| pendle-v2 | 9.14% | 9.70% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 pendle-v2에서 APY 14.51%예요.
