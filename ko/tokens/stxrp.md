...
STXRP 풀은 여기 4개가 있고, 1개 체인에서 APY가 0.34%부터 3.01%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| spectra-v2 | 2.66% | 2.86% | 기본 금리 |
| spectra-v2 | 3.01% | 2.44% | 기본 금리 |
| spectra-v2 | 0.34% | 0.27% | 기본 금리 |
