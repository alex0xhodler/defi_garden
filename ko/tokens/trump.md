...
TRUMP 풀은 여기 5개가 있고, 2개 체인에서 APY가 0.05%부터 42.07%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

5개 풀 중 4개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 31.26%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| orca-dex | 11.71% | 35.28% | 기본 금리 |
| raydium-amm | 11.37% | 27.24% | 기본 금리 |
| uniswap-v2 | 0.05% | 0.62% | 기본 금리 |
| orca-dex | 42.07% | 104.20% | 기본 금리 |
| kamino-liquidity | 36.87% | — | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Solana의 orca-dex에서 APY 42.07%예요.

### TRUMP 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 6개이며, 합산 TVL은 $3.11M예요.
