...
현재 APYUSD의 가장 높은 정직한 수익률은 Ethereum의 pendle에서 17.82%이며, $100K TVL 기준을 넘는 16개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
APYUSD 풀은 여기 6개가 있고, 2개 체인에서 APY가 0.34%부터 17.82%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| curve-dex | 7.18% | 8.17% | 기본 금리 |
| pendle | 16.86% | 15.94% | 인센티브 0.97% |
| pendle | 17.82% | 16.37% | 기본 금리 |
| pendle | 15.67% | 16.50% | 인센티브 2.65% |
| pendle | 15.53% | 14.65% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 16개이며, 합산 TVL은 $97.96M예요.
