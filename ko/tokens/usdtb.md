...
현재 USDTB의 가장 높은 정직한 수익률은 Ethereum의 fluid-lending에서 5.85%이며, $100K TVL 기준을 넘는 5개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
USDTB 풀은 여기 5개가 있고, 1개 체인에서 APY가 0.30%부터 5.85%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| curve-dex | 0.30% | 0.32% | 기본 금리 |
| aave-v3 | 5.63% | 6.22% | 인센티브 60.38% |
| fluid-lending | 5.85% | 5.91% | 인센티브 58.12% |
| fluid-dex | 1.43% | 1.13% | 기본 금리 |
| euler-v2 | 2.17% | 9.53% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 fluid-lending에서 APY 5.85%예요.

### USDTB 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 5개이며, 합산 TVL은 $31.04M예요.
