...
USDTB 풀은 여기 5개가 있고, 1개 체인에서 APY가 0.01%부터 5.85%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| curve-dex | 0.03% | 0.28% | 기본 금리 |
| aave-v3 | 5.59% | 6.28% | 인센티브 60.86% |
| fluid-lending | 5.85% | 5.92% | 인센티브 58.12% |
| fluid-dex | 0.01% | 0.96% | 기본 금리 |
| euler-v2 | 2.48% | 9.18% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 5개이며, 합산 TVL은 $31.29M예요.
