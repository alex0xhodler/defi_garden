...
STEAKUSDC 풀은 여기 8개가 있고, 3개 체인에서 APY가 1.41%부터 5.54%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| morpho-blue | 3.99% | 3.59% | 기본 금리 |
| morpho-blue | 3.91% | 4.26% | 기본 금리 |
| morpho-blue | 5.54% | 4.87% | 기본 금리 |
| morpho-blue | 1.41% | 1.60% | 기본 금리 |
| morpho-blue | 1.44% | 2.94% | 인센티브 73.44% |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 8개이며, 합산 TVL은 $984.59M예요.
