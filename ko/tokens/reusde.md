...
현재 REUSDE의 가장 높은 정직한 수익률은 Ethereum의 uniswap-v4에서 55.10%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
REUSDE 풀은 여기 5개가 있고, 1개 체인에서 APY가 1.08%부터 55.10%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| re | 12.28% | 14.67% | 기본 금리 |
| pendle | 17.64% | 18.47% | 기본 금리 |
| pendle | 17.12% | 20.74% | 인센티브 3.56% |
| curve-dex | 1.08% | 0.47% | 기본 금리 |
| uniswap-v4 | 55.10% | 53.88% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 uniswap-v4에서 APY 55.10%예요.

### REUSDE 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 6개이며, 합산 TVL은 $29.31M예요.
