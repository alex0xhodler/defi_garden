...
5개 풀 중 5개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 18.31%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.

5개 풀 중 1개는 기본 금리에 인센티브·리워드 APY가 더해져 있어요. 인센티브 수익률은 보상 프로그램이 줄어들면서 시간이 지나면 낮아지는 경향이 있으니, 기본 금리가 더 오래가는 숫자예요.

| 프로토콜 | APY | 30일 평균 APY | 수익 구성 |
|---|---|---|---|
| re | 12.29% | 13.58% | 기본 금리 |
| pendle | 17.70% | 18.31% | 기본 금리 |
| pendle | 17.12% | 20.03% | 인센티브 3.10% |
| curve-dex | 0.13% | 0.43% | 기본 금리 |
| uniswap-v4 | 15.98% | 45.89% | 기본 금리 |
