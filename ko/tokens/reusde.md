...
현재 REUSDE의 가장 높은 정직한 수익률은 Ethereum의 uniswap-v4에서 30.70%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
REUSDE 풀은 여기 5개가 있고, 1개 체인에서 APY가 0.13%부터 30.70%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| pendle | 17.40% | 17.55% | 인센티브 3.46% |
| curve-dex | 0.13% | 0.28% | 기본 금리 |
| uniswap-v4 | 30.70% | 25.02% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 uniswap-v4에서 APY 30.70%예요.
