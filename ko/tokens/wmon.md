...
현재 WMON의 가장 높은 정직한 수익률은 Monad의 curve-dex에서 14.65%이며, $100K TVL 기준을 넘는 10개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
WMON 풀은 여기 7개가 있고, 1개 체인에서 APY가 0.01%부터 97.06%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v3 | 97.06% | 37.30% | 기본 금리 |
| curve-dex | 14.65% | 23.96% | 인센티브 100.00% |
| curvance | 2.84% | 2.70% | 인센티브 47.58% |
| neverland | 10.72% | 7.98% | 인센티브 25.97% |
