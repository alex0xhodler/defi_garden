...
BTC 풀은 여기 8개가 있고, 6개 체인에서 APY가 0.01%부터 3.10%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| mezo-earn | 3.10% | 3.18% | 인센티브 99.30% |
| midas-rwa | 1.28% | 1.79% | 기본 금리 |
| chainflip-amm | 2.83% | 5.18% | 기본 금리 |
| midas-rwa | 1.28% | 1.79% | 기본 금리 |
| chainflip-lending | 0.41% | 0.34% | 기본 금리 |
| liquidium | 0.01% | 0.01% | 기본 금리 |
| gmx-v2-perps | 2.95% | 8.85% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Mezo의 mezo-earn에서 APY 3.10%예요.

### BTC 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 24개이며, 합산 TVL은 $804.59M예요.
