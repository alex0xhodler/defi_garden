...
현재 TSTON의 가장 높은 정직한 수익률은 TON의 tonco에서 42.51%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
TSTON 풀은 여기 5개가 있고, 1개 체인에서 APY가 0.99%부터 42.51%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| tonco | 42.51% | 44.05% | 기본 금리 |
| affluent | 14.34% | 13.30% | 기본 금리 |
| ston.fi | 0.99% | 3.11% | 기본 금리 |
| affluent | 2.81% | 2.84% | 기본 금리 |
| ston.fi | 1.01% | 3.40% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, TON의 tonco에서 APY 42.51%예요.
