...
현재 GHO의 가장 높은 정직한 수익률은 Plasma의 aave-v3에서 7.38%이며, $100K TVL 기준을 넘는 32개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
GHO 풀은 여기 8개가 있고, 3개 체인에서 APY가 0.14%부터 14.91%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| fluid-lending | 5.37% | 5.43% | 인센티브 35.94% |
| aave-v3 | 1.84% | 1.39% | 기본 금리 |
| fluid-dex | 0.98% | 0.23% | 기본 금리 |
| fluid-lending | 14.91% | 7.38% | 인센티브 12.54% |
| aave-v3 | 7.38% | 6.19% | 인센티브 66.19% |
| aave-v3 | 5.97% | 6.88% | 인센티브 61.74% |
...
DefiLlama 실시간 데이터 기준, Plasma의 aave-v3에서 APY 7.38%예요.

### GHO 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 32개이며, 합산 TVL은 $178.92M예요.
