...
현재 GHO의 가장 높은 정직한 수익률은 Plasma의 aave-v3에서 6.19%이며, $100K TVL 기준을 넘는 32개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
GHO 풀은 여기 8개가 있고, 3개 체인에서 APY가 1.11%부터 6.19%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| aave-v3 | 1.35% | 1.60% | 기본 금리 |
| fluid-lending | 5.92% | 5.42% | 인센티브 32.09% |
| aave-v3 | 1.78% | 1.40% | 기본 금리 |
| fluid-dex | 1.11% | 0.24% | 기본 금리 |
| fluid-lending | 6.02% | 7.39% | 인센티브 32.89% |
| aave-v3 | 6.19% | 6.20% | 인센티브 66.93% |
| uniswap-v4 | 1.20% | 0.27% | 기본 금리 |
| aave-v3 | 6.00% | 6.86% | 인센티브 61.88% |
...
DefiLlama 실시간 데이터 기준, Plasma의 aave-v3에서 APY 6.19%예요.

### GHO 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 32개이며, 합산 TVL은 $178.69M예요.
