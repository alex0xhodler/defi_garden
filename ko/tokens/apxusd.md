...
현재 APXUSD의 가장 높은 정직한 수익률은 Ethereum의 apyx-protocol에서 12.75%이며, $100K TVL 기준을 넘는 24개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
| curve-dex | 3.93% | 5.90% | 기본 금리 |
| orca-dex | 0.02% | 0.09% | 기본 금리 |
| uniswap-v4 | 9.35% | 6.67% | 기본 금리 |
| pendle | 10.55% | 8.86% | 기본 금리 |
| pendle | 3.29% | 2.31% | 인센티브 19.87% |
| orca-dex | 1.58% | 3.76% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 24개이며, 합산 TVL은 $231.06M예요.
