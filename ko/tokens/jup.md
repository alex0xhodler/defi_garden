...
현재 JUP의 가장 높은 정직한 수익률은 Solana의 kamino-liquidity에서 11.50%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
JUP 풀은 여기 3개가 있고, 1개 체인에서 APY가 11.34%부터 13.45%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| kamino-liquidity | 13.45% | 28.91% | 기본 금리 |
| orca-dex | 11.34% | 19.47% | 기본 금리 |
| kamino-liquidity | 11.50% | 10.92% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Solana의 kamino-liquidity에서 APY 11.50%예요.
