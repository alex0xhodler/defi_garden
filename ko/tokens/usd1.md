...
현재 USD1의 가장 높은 정직한 수익률은 Solana의 raydium-amm에서 9.29%이며, $100K TVL 기준을 넘는 21개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
USD1 풀은 여기 8개가 있고, 5개 체인에서 APY가 0.23%부터 9.29%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| lista-lending | 0.72% | 0.72% | 기본 금리 |
| dolomite | 7.81% | 7.51% | 인센티브 79.90% |
| curve-dex | 0.23% | 0.27% | 기본 금리 |
| raydium-amm | 0.60% | 0.48% | 기본 금리 |
| bitway-earn | 8.00% | 8.00% | 기본 금리 |
| raydium-amm | 9.29% | 11.86% | 기본 금리 |
| echelon-market | 3.76% | 3.66% | 인센티브 15.76% |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 21개이며, 합산 TVL은 $307.96M예요.
