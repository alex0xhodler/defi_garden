...
WBTC 풀은 여기 8개가 있고, 3개 체인에서 APY가 0.01%부터 6.52%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
DefiLlama 실시간 데이터 기준, Arbitrum의 uniswap-v3에서 APY 6.52%예요.
