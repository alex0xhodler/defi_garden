...
현재 XSGD의 가장 높은 정직한 수익률은 Base의 aerodrome-slipstream에서 165.95%이며, $100K TVL 기준을 넘는 4개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
XSGD 풀은 여기 4개가 있고, 2개 체인에서 APY가 10.40%부터 165.95%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| aerodrome-slipstream | 165.95% | 128.05% | 인센티브 99.35% |
| aerodrome-slipstream | 24.09% | 31.50% | 인센티브 89.35% |
| uniswap-v3 | 10.40% | 11.51% | 기본 금리 |
| uniswap-v3 | 13.03% | 9.23% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Base의 aerodrome-slipstream에서 APY 165.95%예요.

### XSGD 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 4개이며, 합산 TVL은 $987.4K예요.
