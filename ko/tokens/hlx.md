...
HLX 풀은 여기 4개가 있고, 1개 체인에서 APY가 0.78%부터 139.75%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v3 | 139.75% | 107.87% | 기본 금리 |
| curve-dex | 0.78% | 1.12% | 기본 금리 |
| uniswap-v3 | 5.88% | 4.44% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 uniswap-v3에서 APY 139.75%예요.
