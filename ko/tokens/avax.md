...
AVAX 풀은 여기 7개가 있고, 2개 체인에서 APY가 0.01%부터 7.00%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| benqi-lending | 0.53% | 1.54% | 기본 금리 |
| gmx-v2-perps | 2.26% | 4.55% | 기본 금리 |
| folks-finance-xchain | 0.35% | 0.45% | 기본 금리 |
| gmx-v2-perps | 5.28% | 12.18% | 기본 금리 |
| gmx-v2-perps | 7.00% | 24.70% | 기본 금리 |
