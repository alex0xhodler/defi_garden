...
AVAX 풀은 여기 8개가 있고, 2개 체인에서 APY가 0.02%부터 13.20%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| gmx-v2-perps | 13.20% | 12.90% | 기본 금리 |
| folks-finance-xchain | 0.12% | 0.17% | 기본 금리 |
| gmx-v2-perps | 4.23% | 7.82% | 기본 금리 |
| gmx-v2-perps | 6.97% | 21.75% | 기본 금리 |
| gmx-v2-perps | 0.02% | 0.50% | 기본 금리 |
| gmx-v2-perps | 0.02% | 0.50% | 기본 금리 |
| gmx-v2-perps | 2.24% | 5.11% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Avalanche의 gmx-v2-perps에서 APY 13.20%예요.
