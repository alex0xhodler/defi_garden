...
현재 AVAX의 가장 높은 정직한 수익률은 Avalanche의 folks-finance-xchain에서 0.35%이며, $100K TVL 기준을 넘는 7개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
AVAX 풀은 여기 7개가 있고, 2개 체인에서 APY가 0.01%부터 6.88%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| benqi-lending | 0.57% | 1.52% | 기본 금리 |
| gmx-v2-perps | 2.20% | 4.52% | 기본 금리 |
| folks-finance-xchain | 0.35% | 0.45% | 기본 금리 |
| gmx-v2-perps | 5.89% | 12.21% | 기본 금리 |
| gmx-v2-perps | 6.88% | 24.60% | 기본 금리 |
| gmx-v2-perps | 0.01% | 0.83% | 기본 금리 |
| gmx-v2-perps | 0.01% | 0.83% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Avalanche의 folks-finance-xchain에서 APY 0.35%예요.
