...
현재 LDO의 가장 높은 정직한 수익률은 Ethereum의 uniswap-v3에서 38.20%이며, $100K TVL 기준을 넘는 5개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
LDO 풀은 여기 5개가 있고, 1개 체인에서 APY가 0.06%부터 38.20%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v3 | 38.20% | 30.09% | 기본 금리 |
| uniswap-v3 | 8.15% | 14.61% | 기본 금리 |
| curve-dex | 1.07% | 2.22% | 인센티브 7.84% |
| convex-finance | 0.99% | 2.24% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 uniswap-v3에서 APY 38.20%예요.
