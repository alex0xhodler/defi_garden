...
STHYPE 풀은 여기 3개가 있고, 1개 체인에서 APY가 0.11%부터 2.44%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| pendle-v2 | 2.44% | 2.46% | 인센티브 10.38% |
| pendle-v2 | 2.29% | 2.27% | 기본 금리 |
| hyperswap-v3 | 0.11% | 0.64% | 기본 금리 |
