...
STHYPE 풀은 여기 3개가 있고, 1개 체인에서 APY가 0.01%부터 2.42%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| pendle-v2 | 2.42% | 2.46% | 인센티브 9.66% |
| pendle-v2 | 2.35% | 2.28% | 기본 금리 |
| hyperswap-v3 | 0.01% | 0.65% | 기본 금리 |
