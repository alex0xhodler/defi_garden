...
STHYPE 풀은 여기 3개가 있고, 1개 체인에서 APY가 0.24%부터 4.49%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| pendle | 4.49% | 2.73% | 기본 금리 |
| pendle | 2.98% | 2.36% | 기본 금리 |
| hyperswap-v3 | 0.24% | 0.19% | 기본 금리 |
