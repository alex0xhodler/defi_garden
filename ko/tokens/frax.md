...
현재 FRAX의 가장 높은 정직한 수익률은 Ethereum의 curve-dex에서 6.58%이며, $100K TVL 기준을 넘는 36개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
FRAX 풀은 여기 8개가 있고, 2개 체인에서 APY가 0.02%부터 6.58%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| curve-dex | 6.58% | 8.26% | 인센티브 96.66% |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 36개이며, 합산 TVL은 $99.08M예요.
