...
현재 ELON의 가장 높은 정직한 수익률은 Ethereum의 uniswap-v2에서 1.09%이며, $100K TVL 기준을 넘는 7개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
ELON 풀은 여기 3개가 있고, 2개 체인에서 APY가 1.09%부터 3.16%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v2 | 1.09% | 1.06% | 기본 금리 |
| uniswap-v3 | 3.16% | 0.95% | 기본 금리 |
| raydium-amm | 1.28% | 16.85% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 7개이며, 합산 TVL은 $9.5M예요.
