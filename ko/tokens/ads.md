...
현재 ADS의 가장 높은 정직한 수익률은 Base의 uniswap-v3에서 6.42%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
ADS 풀은 여기 5개가 있고, 2개 체인에서 APY가 0.01%부터 6.42%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| uniswap-v4 | 0.09% | 27.91% | 기본 금리 |
| uniswap-v4 | 0.09% | 0.13% | 기본 금리 |
| uniswap-v3 | 6.42% | 5.52% | 기본 금리 |
| uniswap-v3 | 0.46% | 2.48% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Base의 uniswap-v3에서 APY 6.42%예요.
