...
USDC.E 풀은 여기 8개가 있고, 5개 체인에서 APY가 0.03%부터 6.95%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| sparkdex-v3.1 | 0.03% | 0.06% | 기본 금리 |
| sparkdex-v4 | 6.95% | 6.88% | 인센티브 99.15% |
| uniswap-v3 | 3.78% | 5.88% | 기본 금리 |
| aave-v3 | 2.93% | 2.75% | 기본 금리 |
| curve-dex | 0.10% | 0.18% | 기본 금리 |
| dolomite | 3.85% | 3.90% | 기본 금리 |
| symbiosis | 3.66% | 1.45% | 기본 금리 |
| sushiswap-v3 | 4.85% | 6.93% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 30개이며, 합산 TVL은 $17.24M예요.
