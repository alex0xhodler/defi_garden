...
현재 USDC.E의 가장 높은 정직한 수익률은 Flare의 sparkdex-v4에서 6.92%이며, $100K TVL 기준을 넘는 30개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
USDC.E 풀은 여기 8개가 있고, 6개 체인에서 APY가 0.01%부터 6.92%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| sparkdex-v4 | 6.92% | 6.88% | 인센티브 99.70% |
| uniswap-v3 | 4.00% | 5.88% | 기본 금리 |
| aave-v3 | 2.91% | 2.75% | 기본 금리 |
| curve-dex | 0.11% | 0.18% | 기본 금리 |
| shadow-exchange-clmm | 1.65% | 2.01% | 인센티브 100.00% |
| dolomite | 3.85% | 3.90% | 기본 금리 |
| symbiosis | 3.66% | 1.43% | 기본 금리 |
