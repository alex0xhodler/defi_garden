...
CASH 풀은 여기 4개가 있고, 1개 체인에서 APY가 2.98%부터 3.65%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| orca-dex | 3.65% | 1.19% | 기본 금리 |
| kamino-lend | 3.29% | 4.22% | 기본 금리 |
| kamino-liquidity | 3.11% | 0.38% | 기본 금리 |
| kamino-lend | 2.98% | 4.43% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 4개이며, 합산 TVL은 $13.98M예요.
