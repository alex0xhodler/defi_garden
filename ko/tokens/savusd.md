...
현재 SAVUSD의 가장 높은 정직한 수익률은 Avalanche의 avant-avusd에서 8.74%이며, $100K TVL 기준을 넘는 8개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
APY 이력만 기준으로 비교한 SAVUSD의 변동성 낮은 후보는 Avalanche의 avant-avusd, APY 8.74%, TVL $109.22M, https://www.defi.garden/?pool=c74227a1-e738-4021-bbe1-13363815aecb&src=seo_token; Monad의 curve-dex, APY 5.00%, TVL $759.9K, https://www.defi.garden/?pool=008de1a7-4b49-48dd-ae72-c0651092ae73&src=seo_token예요. 이 비교는 프로토콜, 익스플로잇, 디페그, 유동성, 거버넌스 또는 원금 손실 위험을 측정하지 않아요.
...
SAVUSD 풀은 여기 2개가 있고, 2개 체인에서 APY가 5.00%부터 8.74%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 8개이며, 합산 TVL은 $152.47M예요.
