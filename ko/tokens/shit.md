...
SHIT 풀은 여기 2개가 있고, 2개 체인에서 APY가 1.17%부터 5.91%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v4 | 1.17% | 3.23% | 기본 금리 |
| raydium-amm | 5.91% | 2.69% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 3개이며, 합산 TVL은 $707.1K예요.
