...
SUSHI 풀은 여기 3개가 있고, 1개 체인에서 APY가 9.78%부터 16.98%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| sushiswap-v3 | 9.78% | 3.74% | 기본 금리 |
| sushiswap | 10.20% | 4.03% | 기본 금리 |
| uniswap-v2 | 16.98% | 4.96% | 기본 금리 |
