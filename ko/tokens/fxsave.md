...
FXSAVE 풀은 여기 4개가 있고, 1개 체인에서 APY가 1.66%부터 10.17%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| pendle | 10.17% | 11.13% | 기본 금리 |
| pendle | 7.23% | 6.17% | 기본 금리 |
| curve-dex | 1.66% | 2.66% | 인센티브 0.01% |
| convex-finance | 1.66% | 2.65% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 7개이며, 합산 TVL은 $61.83M예요.
