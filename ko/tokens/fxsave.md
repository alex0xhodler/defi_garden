...
FXSAVE 풀은 여기 4개가 있고, 1개 체인에서 APY가 1.95%부터 10.07%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| pendle | 10.07% | 10.79% | 기본 금리 |
| pendle | 7.11% | 5.96% | 기본 금리 |
| curve-dex | 1.95% | 2.72% | 인센티브 0.01% |
| convex-finance | 1.95% | 2.72% | 기본 금리 |
