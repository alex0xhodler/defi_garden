...
FXSAVE 풀은 여기 5개가 있고, 1개 체인에서 APY가 3.17%부터 13.25%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

5개 풀 중 5개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 6.34%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| morpho-blue | 5.42% | 6.34% | 인센티브 100.00% |
| pendle-v2 | 13.25% | 9.83% | 기본 금리 |
| pendle-v2 | 8.32% | 7.35% | 기본 금리 |
| curve-dex | 3.17% | 1.94% | 인센티브 0.01% |
| convex-finance | 3.17% | 1.94% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 pendle-v2에서 APY 13.25%예요.
