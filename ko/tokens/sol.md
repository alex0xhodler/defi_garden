...
현재 SOL의 가장 높은 정직한 수익률은 Solana의 orca-dex에서 42.61%이며, $100K TVL 기준을 넘는 79개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
SOL 풀은 여기 8개가 있고, 2개 체인에서 APY가 0.30%부터 42.61%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| orca-dex | 42.61% | 35.51% | 기본 금리 |
| kamino-lend | 4.52% | 5.24% | 기본 금리 |
| save | 2.03% | 2.38% | 기본 금리 |
| orca-dex | 0.35% | 0.50% | 기본 금리 |
| kamino-liquidity | 0.30% | 0.39% | 기본 금리 |
| orca-dex | 25.22% | 25.28% | 기본 금리 |
| orca-dex | 21.84% | 16.75% | 기본 금리 |
| gmx-v2-perps | 8.71% | 4.82% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 79개이며, 합산 TVL은 $126.12M예요.
