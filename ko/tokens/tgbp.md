...
TGBP 풀은 여기 2개가 있고, 2개 체인에서 APY가 0.86%부터 47.24%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| aerodrome-slipstream | 47.24% | 5.56% | 인센티브 93.07% |
...
DefiLlama 실시간 데이터 기준, Base의 aerodrome-slipstream에서 APY 47.24%예요.
