...
현재 BTC.B의 가장 높은 정직한 수익률은 Avalanche의 pharaoh-v3에서 28.59%이며, $100K TVL 기준을 넘는 18개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
BTC.B 풀은 여기 8개가 있고, 2개 체인에서 APY가 0.01%부터 28.59%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| uniswap-v3 | 3.01% | 5.35% | 기본 금리 |
| joe-v2.1 | 0.43% | 1.78% | 기본 금리 |
| uniswap-v3 | 0.66% | 1.31% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Avalanche의 pharaoh-v3에서 APY 28.59%예요.

### BTC.B 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 18개이며, 합산 TVL은 $104.45M예요.
