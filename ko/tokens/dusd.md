...
DUSD 풀은 여기 7개가 있고, 2개 체인에서 APY가 0.06%부터 20.00%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

7개 풀 중 7개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 5.80%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.

7개 풀 중 4개는 기본 금리에 인센티브·리워드 APY가 더해져 있어요. 인센티브 수익률은 보상 프로그램이 줄어들면서 시간이 지나면 낮아지는 경향이 있으니, 기본 금리가 더 오래가는 숫자예요.

| 프로토콜 | APY | 30일 평균 APY | 수익 구성 |
|---|---|---|---|
| makina | 5.49% | 5.80% | 기본 금리 |
| curve-dex | 9.63% | 5.71% | 인센티브 100.00% |
| convex-finance | 13.07% | 8.07% | 인센티브 99.92% |
| curve-dex | 7.10% | 4.32% | 인센티브 82.67% |
| stake-dao | 20.00% | 13.15% | 인센티브 99.95% |
