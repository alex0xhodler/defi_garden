...
<<<<<<< HEAD
현재 MEBT의 가장 높은 정직한 수익률은 Polygon의 quickswap-dex에서 13.26%이며, $100K TVL 기준을 넘는 1개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.

| 프로토콜 | 체인 | APY | TVL |
|---|---|---|---|
| [quickswap-dex →](https://www.defi.garden/?pool=356d19f3-8ba1-417b-9f28-aa4f49f25807&src=seo_token) | Polygon | 13.26% | $408.1K |
=======
현재 MEBT의 가장 높은 정직한 수익률은 Polygon의 quickswap-dex에서 12.94%이며, $100K TVL 기준을 넘는 1개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
<<<<<<< HEAD
DefiLlama 실시간 데이터 기준, Polygon의 quickswap-dex에서 APY 13.26%예요.

### MEBT 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 1개이며, 합산 TVL은 $408.1K예요.
=======
DefiLlama 실시간 데이터 기준, Polygon의 quickswap-dex에서 APY 12.94%예요.
