...
WFLR 풀은 여기 8개가 있고, 1개 체인에서 APY가 1.09%부터 28.06%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
DefiLlama 실시간 데이터 기준, Flare의 sparkdex-v4에서 APY 28.06%예요.
