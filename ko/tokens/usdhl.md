...
현재 USDHL의 가장 높은 정직한 수익률은 Hyperliquid L1의 hyperswap-v3에서 0.70%이며, $100K TVL 기준을 넘는 1개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.

| 프로토콜 | 체인 | APY | TVL |
|---|---|---|---|
| [hyperswap-v3 →](https://www.defi.garden/?pool=39bdd699-8e90-4724-988d-4533b0031fdc&src=seo_token) | Hyperliquid L1 | 0.70% | $130.6K |
...
DefiLlama 실시간 데이터 기준, Hyperliquid L1의 hyperswap-v3에서 APY 0.70%예요.
