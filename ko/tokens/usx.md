...
USX 풀은 여기 8개가 있고, 2개 체인에서 APY가 0.08%부터 2.21%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| orca-dex | 0.10% | 0.44% | 기본 금리 |
| orca-dex | 0.24% | 0.35% | 기본 금리 |
| raydium-amm | 0.08% | 0.37% | 기본 금리 |
| orca-dex | 0.10% | 0.32% | 기본 금리 |
| raydium-amm | 0.11% | 0.38% | 기본 금리 |
| loopscale | 2.21% | 2.21% | 기본 금리 |
| velodrome-v2 | 0.30% | 0.26% | 인센티브 100.00% |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 10개이며, 합산 TVL은 $46.63M예요.
