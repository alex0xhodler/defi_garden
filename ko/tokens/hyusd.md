...
현재 HYUSD의 가장 높은 정직한 수익률은 Solana의 loopscale에서 7.48%이며, $100K TVL 기준을 넘는 5개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
HYUSD 풀은 여기 5개가 있고, 1개 체인에서 APY가 0.18%부터 7.48%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| kamino-liquidity | 2.07% | 3.49% | 기본 금리 |
| orca-dex | 3.57% | 4.39% | 기본 금리 |
| loopscale | 7.48% | 6.40% | 인센티브 21.54% |
...
DefiLlama 실시간 데이터 기준, Solana의 loopscale에서 APY 7.48%예요.
