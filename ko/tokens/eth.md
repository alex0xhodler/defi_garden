...
ETH 풀은 여기 8개가 있고, 2개 체인에서 APY가 0.71%부터 5.39%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
DefiLlama 실시간 데이터 기준, Ethereum의 stakewise-v3에서 APY 2.43%예요.

### ETH 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 422개이며, 합산 TVL은 $2.93B예요.
