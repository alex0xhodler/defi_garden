...
현재 BUCK의 가장 높은 정직한 수익률은 Sui의 cetus-clmm에서 4.17%이며, $100K TVL 기준을 넘는 7개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
BUCK 풀은 여기 4개가 있고, 2개 체인에서 APY가 0.06%부터 4.17%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| raydium-amm | 1.80% | 2.47% | 기본 금리 |
| cetus-clmm | 4.17% | 5.16% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Sui의 cetus-clmm에서 APY 4.17%예요.
