...
현재 SYBTC의 가장 높은 정직한 수익률은 BSC의 uniswap-v3에서 2.57%이며, $100K TVL 기준을 넘는 4개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
4개 풀 중 4개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 8.57%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
