...
WOLF 풀은 여기 5개가 있고, 3개 체인에서 APY가 0.25%부터 13.17%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v2 | 1.42% | 4.41% | 기본 금리 |
| raydium-amm | 0.25% | 3.79% | 기본 금리 |
| uniswap-v4 | 13.17% | 34.10% | 기본 금리 |
