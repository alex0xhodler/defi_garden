...
현재 WOLF의 가장 높은 정직한 수익률은 Ethereum의 uniswap-v2에서 4.86%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
WOLF 풀은 여기 5개가 있고, 3개 체인에서 APY가 0.25%부터 15.20%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v2 | 4.86% | 4.52% | 기본 금리 |
| raydium-amm | 0.25% | 3.60% | 기본 금리 |
| uniswap-v4 | 15.20% | 35.21% | 기본 금리 |
| raydium-amm | 0.54% | 3.93% | 기본 금리 |
| raydium-amm | 1.34% | 1.42% | 기본 금리 |
