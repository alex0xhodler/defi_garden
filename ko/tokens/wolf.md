...
WOLF 풀은 여기 5개가 있고, 3개 체인에서 APY가 0.25%부터 14.65%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v2 | 1.61% | 4.40% | 기본 금리 |
| raydium-amm | 0.25% | 3.84% | 기본 금리 |
| uniswap-v4 | 14.65% | 33.32% | 기본 금리 |
| raydium-amm | 0.54% | 4.14% | 기본 금리 |
