...
현재 AAVE의 가장 높은 정직한 수익률은 Ethereum의 uniswap-v3에서 7.23%이며, $100K TVL 기준을 넘는 29개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
AAVE 풀은 여기 8개가 있고, 2개 체인에서 APY가 0.11%부터 26.27%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

8개 풀 중 7개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 20.81%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
| uniswap-v4 | 1.47% | 11.24% | 기본 금리 |
| uniswap-v3 | 7.23% | 11.52% | 기본 금리 |
| uniswap-v4 | 7.79% | 20.81% | 기본 금리 |
| uniswap-v4 | 4.79% | 24.36% | 기본 금리 |
| uniswap-v4 | 8.43% | 20.27% | 기본 금리 |
| aerodrome-slipstream | 26.27% | 56.86% | 인센티브 63.24% |
| uniswap-v3 | 1.66% | 53.47% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 29개이며, 합산 TVL은 $105.66M예요.
