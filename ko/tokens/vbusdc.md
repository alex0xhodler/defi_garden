...
현재 VBUSDC의 가장 높은 정직한 수익률은 Katana의 spectra-metavaults에서 12.70%이며, $100K TVL 기준을 넘는 3개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
VBUSDC 풀은 여기 3개가 있고, 1개 체인에서 APY가 2.07%부터 12.70%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

3개 풀 중 3개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 5.90%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| yearn-finance | 4.11% | 4.97% | 인센티브 61.38% |
| morpho-blue | 2.07% | 5.90% | 기본 금리 |
| spectra-metavaults | 12.70% | 13.33% | 인센티브 18.78% |
...
DefiLlama 실시간 데이터 기준, Katana의 spectra-metavaults에서 APY 12.70%예요.

### VBUSDC 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 3개이며, 합산 TVL은 $13.12M예요.
