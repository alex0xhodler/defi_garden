...
<<<<<<< HEAD
현재 ATXM의 가장 높은 정직한 수익률은 Polygon의 uniswap-v4에서 12.87%이며, $100K TVL 기준을 넘는 1개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.

| 프로토콜 | 체인 | APY | TVL |
|---|---|---|---|
| [uniswap-v4 →](https://www.defi.garden/?pool=bb4f946a-a9d1-4b13-a377-202bfd3262f0&src=seo_token) | Polygon | 12.87% | $152.6K |
=======
현재 ATXM의 가장 높은 정직한 수익률은 Polygon의 uniswap-v4에서 10.66%이며, $100K TVL 기준을 넘는 1개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
<<<<<<< HEAD
DefiLlama 실시간 데이터 기준, Polygon의 uniswap-v4에서 APY 12.87%예요.

### ATXM 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 1개이며, 합산 TVL은 $152.6K예요.
=======
DefiLlama 실시간 데이터 기준, Polygon의 uniswap-v4에서 APY 10.66%예요.
