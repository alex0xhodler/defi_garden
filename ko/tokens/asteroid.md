...
<<<<<<< HEAD
현재 ASTEROID의 가장 높은 정직한 수익률은 Ethereum의 uniswap-v2에서 20.55%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.

| 프로토콜 | 체인 | APY | TVL |
|---|---|---|---|
| [uniswap-v2 →](https://www.defi.garden/?pool=c9b04a13-5d5b-4a30-baa9-e41a994c6636&src=seo_token) | Ethereum | 34.37% | $1.74M |
...
=======
현재 ASTEROID의 가장 높은 정직한 수익률은 Ethereum의 uniswap-v2에서 39.61%이며, $100K TVL 기준을 넘는 6개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
<<<<<<< HEAD
DefiLlama 실시간 데이터 기준, Ethereum의 uniswap-v2에서 APY 20.55%예요.

### ASTEROID 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 6개이며, 합산 TVL은 $6.2M예요.
=======
DefiLlama 실시간 데이터 기준, Ethereum의 uniswap-v2에서 APY 39.61%예요.
