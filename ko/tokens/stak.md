...
STAK 풀은 여기 2개가 있고, 1개 체인에서 APY가 0.04%부터 10.67%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
DefiLlama 실시간 데이터 기준, Ethereum의 spectra-v2에서 APY 10.67%예요.
