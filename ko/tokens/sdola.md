...
현재 SDOLA의 가장 높은 정직한 수익률은 Ethereum의 curve-dex에서 7.03%이며, $100K TVL 기준을 넘는 16개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
SDOLA 풀은 여기 8개가 있고, 1개 체인에서 APY가 2.88%부터 18.27%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

8개 풀 중 8개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 7.47%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
| curve-dex | 7.03% | 7.42% | 인센티브 17.52% |
| stake-dao | 6.91% | 7.68% | 인센티브 20.24% |
| curve-dex | 2.88% | 2.82% | 인센티브 73.64% |
| curve-dex | 18.27% | 8.72% | 인센티브 87.25% |
...
DefiLlama 실시간 데이터 기준, Ethereum의 curve-dex에서 APY 7.03%예요.
