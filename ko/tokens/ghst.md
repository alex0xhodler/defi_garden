...
GHST 풀은 여기 2개가 있고, 1개 체인에서 APY가 70.22%부터 703.18%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

2개 풀 중 2개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 76.96%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| aerodrome-slipstream | 703.18% | 146.50% | 인센티브 97.26% |
| aerodrome-v1 | 70.22% | 7.42% | 인센티브 100.00% |
...
DefiLlama 실시간 데이터 기준, Base의 aerodrome-slipstream에서 APY 703.18%예요.
