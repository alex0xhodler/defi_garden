...
현재 COINX의 가장 높은 정직한 수익률은 Solana의 raydium-amm에서 60.08%이며, $100K TVL 기준을 넘는 3개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
COINX 풀은 여기 3개가 있고, 1개 체인에서 APY가 22.67%부터 60.08%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

3개 풀 중 3개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 57.82%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| raydium-amm | 60.08% | 63.33% | 기본 금리 |
| raydium-amm | 54.76% | 57.82% | 기본 금리 |
| raydium-amm | 22.67% | 52.14% | 기본 금리 |
