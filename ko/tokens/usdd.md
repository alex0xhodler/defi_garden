...
USDD 풀은 여기 3개가 있고, 3개 체인에서 APY가 0.11%부터 3.99%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| raydium-amm | 0.11% | 1.07% | 기본 금리 |
| uniswap-v3 | 0.30% | 0.01% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 3개이며, 합산 TVL은 $388.14M예요.
