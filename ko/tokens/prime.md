...
현재 PRIME의 가장 높은 정직한 수익률은 Ethereum의 hastra에서 6.93%이며, $100K TVL 기준을 넘는 16개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
PRIME 풀은 여기 8개가 있고, 2개 체인에서 APY가 0.01%부터 6.93%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| hastra | 6.93% | 6.96% | 기본 금리 |
| hastra | 6.93% | 5.42% | 기본 금리 |
| morpho-blue | 3.78% | 3.91% | 기본 금리 |
| orca-dex | 0.76% | 0.67% | 기본 금리 |
| uniswap-v3 | 6.41% | 3.26% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Ethereum의 hastra에서 APY 6.93%예요.

### PRIME 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 16개이며, 합산 TVL은 $938.72M예요.
