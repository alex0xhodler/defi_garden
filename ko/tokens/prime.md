...
PRIME 풀은 여기 8개가 있고, 2개 체인에서 APY가 0.05%부터 6.88%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| hastra | 6.88% | 6.89% | 기본 금리 |
| hastra | 6.88% | 5.45% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 16개이며, 합산 TVL은 $939.13M예요.
