...
VVS 풀은 여기 8개가 있고, 1개 체인에서 APY가 0.01%부터 3.53%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| vvs-standard | 1.96% | 4.28% | 기본 금리 |
| vvs-standard | 1.68% | 2.85% | 기본 금리 |
| vvs-flawless | 3.53% | 6.53% | 기본 금리 |
| vvs-standard | 0.33% | 0.86% | 기본 금리 |
| vvs-standard | 0.50% | 0.72% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Cronos의 vvs-flawless에서 APY 3.53%예요.

### VVS 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 9개이며, 합산 TVL은 $32.19M예요.
