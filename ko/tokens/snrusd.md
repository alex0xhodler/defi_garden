...
<<<<<<< HEAD
현재 SNRUSD의 가장 높은 정직한 수익률은 Berachain의 berapaw에서 15.32%이며, $100K TVL 기준을 넘는 1개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.

| 프로토콜 | 체인 | APY | TVL |
|---|---|---|---|
| [berapaw →](https://www.defi.garden/?pool=7cda51b1-4378-423f-b77d-7304b8b9386c&src=seo_token) | Berachain | 15.32% | $160.4K |
=======
현재 SNRUSD의 가장 높은 정직한 수익률은 Berachain의 berapaw에서 17.84%이며, $100K TVL 기준을 넘는 1개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
=======
DefiLlama 실시간 데이터 기준, Berachain의 berapaw에서 APY 17.84%예요.
>>>>>>> origin/main
