...
현재 LP의 가장 높은 정직한 수익률은 Arbitrum의 wombat-exchange에서 0.63%이며, $100K TVL 기준을 넘는 5개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
| 4 | [wombat-exchange →](https://www.defi.garden/?pool=bdd318d9-d4f8-45f8-8146-895c451eb16a&src=seo_token) | Arbitrum | 0.63% | $102.9K |
...
LP 풀은 여기 5개가 있고, 2개 체인에서 APY가 0.01%부터 0.63%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| wombat-exchange | 0.05% | 0.06% | 인센티브 90.82% |
| wombat-exchange | 0.09% | 0.09% | 인센티브 100.00% |
| wombat-exchange | 0.63% | 0.28% | 인센티브 16.19% |
...
DefiLlama 실시간 데이터 기준, Arbitrum의 wombat-exchange에서 APY 0.63%예요.
