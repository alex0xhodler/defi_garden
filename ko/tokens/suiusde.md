...
SUIUSDE 풀은 여기 3개가 있고, 1개 체인에서 APY가 0.03%부터 1.47%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| cetus-clmm | 0.32% | 0.27% | 기본 금리 |
| bluefin-spot | 0.03% | 0.14% | 기본 금리 |
| navi-lending | 1.47% | 1.04% | 기본 금리 |
