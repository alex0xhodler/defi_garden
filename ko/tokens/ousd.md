...
현재 OUSD의 가장 높은 정직한 수익률은 Ethereum의 stake-dao에서 7.71%이며, $100K TVL 기준을 넘는 5개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
OUSD 풀은 여기 5개가 있고, 1개 체인에서 APY가 3.54%부터 7.71%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

5개 풀 중 5개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 5.11%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.

5개 풀 중 4개는 기본 금리에 인센티브·리워드 APY가 더해져 있어요. 인센티브 수익률은 보상 프로그램이 줄어들면서 시간이 지나면 낮아지는 경향이 있으니, 기본 금리가 더 오래가는 숫자예요.

| 프로토콜 | APY | 30일 평균 APY | 수익 구성 |
|---|---|---|---|
| origin-dollar | 5.56% | 5.11% | 기본 금리 |
| curve-dex | 5.03% | 3.89% | 인센티브 99.40% |
| curve-dex | 6.47% | 4.87% | 인센티브 99.85% |
| curve-dex | 3.54% | 5.57% | 인센티브 100.00% |
| stake-dao | 7.71% | 5.86% | 인센티브 99.61% |
...
DefiLlama 실시간 데이터 기준, Ethereum의 stake-dao에서 APY 7.71%예요.
