...
현재 SUPER의 가장 높은 정직한 수익률은 Avalanche의 blackhole-amm에서 10.66%이며, $100K TVL 기준을 넘는 3개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
SUPER 풀은 여기 3개가 있고, 2개 체인에서 APY가 4.16%부터 10.66%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v2 | 4.16% | 2.95% | 기본 금리 |
| blackhole-amm | 7.66% | 7.25% | 인센티브 34.13% |
| blackhole-amm | 10.66% | 11.33% | 인센티브 72.75% |
...
DefiLlama 실시간 데이터 기준, Avalanche의 blackhole-amm에서 APY 10.66%예요.
