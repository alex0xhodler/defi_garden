...
현재 WBTC.B의 가장 높은 정직한 수익률은 Arbitrum의 gmx-v2-perps에서 12.41%이며, $100K TVL 기준을 넘는 30개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
WBTC.B 풀은 여기 8개가 있고, 1개 체인에서 APY가 0.65%부터 12.41%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| gmx-v2-perps | 3.56% | 6.07% | 기본 금리 |
| gmx-v2-perps | 1.65% | 4.21% | 기본 금리 |
| gmx-v2-perps | 1.65% | 4.21% | 기본 금리 |
| gmx-v2-perps | 9.10% | 8.98% | 기본 금리 |
| gmx-v2-perps | 0.65% | 0.77% | 기본 금리 |
| gmx-v2-perps | 10.03% | 2.03% | 기본 금리 |
| gmx-v2-perps | 12.41% | 13.60% | 기본 금리 |
| gmx-v2-perps | 3.50% | 8.31% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Arbitrum의 gmx-v2-perps에서 APY 12.41%예요.

### WBTC.B 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 30개이며, 합산 TVL은 $70.28M예요.
