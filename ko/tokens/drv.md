...
현재 DRV의 가장 높은 정직한 수익률은 Hyperliquid L1의 nest-cl에서 115.79%이며, $100K TVL 기준을 넘는 5개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
DRV 풀은 여기 5개가 있고, 2개 체인에서 APY가 8.07%부터 120.66%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

5개 풀 중 5개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 192.94%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| uniswap-v4 | 8.07% | 211.04% | 기본 금리 |
| aerodrome-slipstream | 95.20% | 249.53% | 인센티브 74.18% |
| aerodrome-v1 | 21.84% | 44.54% | 인센티브 100.00% |
| nest-cl | 120.66% | 77.11% | 인센티브 100.00% |
| nest-cl | 115.79% | 192.94% | 인센티브 100.00% |
...
DefiLlama 실시간 데이터 기준, Hyperliquid L1의 nest-cl에서 APY 115.79%예요.
