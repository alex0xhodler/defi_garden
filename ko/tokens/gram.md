...
GRAM 풀은 여기 8개가 있고, 1개 체인에서 APY가 0.01%부터 38.64%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| ston.fi | 3.35% | 4.41% | 기본 금리 |
| ston.fi | 5.47% | 6.86% | 기본 금리 |
| storm-trade | 6.28% | 6.19% | 기본 금리 |
| evaa-protocol | 5.66% | 5.56% | 기본 금리 |
| affluent | 14.44% | 14.33% | 기본 금리 |
| ston.fi | 0.01% | 0.00% | 기본 금리 |
| dedust | 10.14% | 13.65% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 31개이며, 합산 TVL은 $19.67M예요.
