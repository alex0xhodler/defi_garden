...
RAY 풀은 여기 8개가 있고, 1개 체인에서 APY가 7.76%부터 222.23%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

8개 풀 중 8개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 25.75%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| raydium-amm | 131.53% | 29.06% | 기본 금리 |
| raydium-amm | 124.86% | 23.22% | 기본 금리 |
| raydium-amm | 192.92% | 60.48% | 기본 금리 |
| raydium-amm | 100.52% | 23.95% | 기본 금리 |
| raydium-amm | 7.76% | 3.37% | 기본 금리 |
| raydium-amm | 135.35% | 27.56% | 기본 금리 |
| raydium-amm | 222.23% | 48.46% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Solana의 raydium-amm에서 APY 222.23%예요.

### RAY 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 10개이며, 합산 TVL은 $16.91M예요.
