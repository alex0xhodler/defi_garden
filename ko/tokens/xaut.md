...
XAUT 풀은 여기 8개가 있고, 2개 체인에서 APY가 0.44%부터 5.96%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| lista-lending | 3.66% | 0.81% | 기본 금리 |
| uniswap-v3 | 1.35% | 1.87% | 기본 금리 |
| uniswap-v4 | 5.96% | 6.24% | 기본 금리 |
| uniswap-v3 | 0.47% | 0.47% | 기본 금리 |
| uniswap-v3 | 2.69% | 6.39% | 기본 금리 |
| fluid-dex | 0.44% | 0.48% | 기본 금리 |
| uniswap-v4 | 5.90% | 4.95% | 기본 금리 |
| uniswap-v3 | 2.48% | 3.97% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 29개이며, 합산 TVL은 $117.97M예요.
