...
현재 QQQB의 가장 높은 정직한 수익률은 BSC의 native-credit-pool에서 25.33%이며, $100K TVL 기준을 넘는 24개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
QQQB 풀은 여기 4개가 있고, 1개 체인에서 APY가 0.57%부터 120.84%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

4개 풀 중 4개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 55.67%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| native-credit-pool | 25.33% | 23.42% | 기본 금리 |
| uniswap-v3 | 120.84% | 324.73% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 24개이며, 합산 TVL은 $7.44M예요.
