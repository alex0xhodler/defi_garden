...
TRX 풀은 여기 5개가 있고, 4개 체인에서 APY가 0.30%부터 11.36%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| justlend-v1 | 0.30% | 0.36% | 기본 금리 |
| tr-energy | 11.36% | 11.39% | 기본 금리 |
| raydium-amm | 1.81% | 0.95% | 기본 금리 |
| uniswap-v2 | 2.55% | 0.48% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 6개이며, 합산 TVL은 $793.59M예요.
