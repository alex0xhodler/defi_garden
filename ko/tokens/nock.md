...
현재 NOCK의 가장 높은 정직한 수익률은 Base의 uniswap-v4에서 253.62%이며, $100K TVL 기준을 넘는 5개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
NOCK 풀은 여기 3개가 있고, 1개 체인에서 APY가 127.41%부터 253.62%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

3개 풀 중 3개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 428.00%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| uniswap-v4 | 253.62% | 428.00% | 기본 금리 |
| uniswap-v4 | 127.41% | 173.20% | 기본 금리 |
| uniswap-v4 | 179.54% | 515.60% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, Base의 uniswap-v4에서 APY 253.62%예요.
