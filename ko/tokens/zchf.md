...
현재 ZCHF의 가장 높은 정직한 수익률은 Ethereum의 convex-finance에서 10.73%이며, $100K TVL 기준을 넘는 9개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
ZCHF 풀은 여기 8개가 있고, 3개 체인에서 APY가 0.68%부터 10.73%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| curve-dex | 4.76% | 4.40% | 인센티브 100.00% |
| frankencoin | 3.50% | 3.50% | 기본 금리 |
| convex-finance | 10.73% | 9.09% | 인센티브 93.38% |
| uniswap-v3 | 6.05% | 4.03% | 기본 금리 |
| stake-dao | 9.88% | 7.98% | 인센티브 92.81% |
...
DefiLlama 실시간 데이터 기준, Ethereum의 convex-finance에서 APY 10.73%예요.
