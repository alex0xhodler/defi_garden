...
현재 ICP의 가장 높은 정직한 수익률은 ICP의 icpswap에서 7.82%이며, $100K TVL 기준을 넘는 7개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
ICP 풀은 여기 6개가 있고, 3개 체인에서 APY가 2.79%부터 189.05%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| icpswap | 7.82% | 8.49% | 기본 금리 |
| uniswap-v3 | 3.69% | 2.57% | 기본 금리 |
| icpswap | 4.40% | 5.65% | 기본 금리 |
| aerodrome-slipstream | 189.05% | 118.14% | 인센티브 94.85% |
...
DefiLlama 실시간 데이터 기준, ICP의 icpswap에서 APY 7.82%예요.
