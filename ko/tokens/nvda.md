...
현재 NVDA의 가장 높은 정직한 수익률은 Robinhood Chain의 ekubo에서 107.25%이며, $100K TVL 기준을 넘는 3개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
NVDA 풀은 여기 2개가 있고, 2개 체인에서 APY가 25.24%부터 107.25%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.

2개 풀 중 2개는 믿을 수 있는 30일 평균값이 있고, 중앙값은 80.60%예요 — 오늘 수익률과 비교하면 꾸준한 편인지 일시적으로 튄 값인지 가늠할 수 있어요.
...
|---|---|---|---|
| gmtrade | 25.24% | 38.28% | 기본 금리 |
| ekubo | 107.25% | 122.92% | 인센티브 100.00% |
...
DefiLlama 실시간 데이터 기준, Robinhood Chain의 ekubo에서 APY 107.25%예요.
