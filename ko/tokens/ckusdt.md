...
현재 CKUSDT의 가장 높은 정직한 수익률은 ICP의 icpswap에서 0.87%이며, $100K TVL 기준을 넘는 1개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.

| 프로토콜 | 체인 | APY | TVL |
|---|---|---|---|
| [icpswap →](https://www.defi.garden/?pool=6feacbd4-c28f-4e73-8c2e-5857db3594ee&src=seo_token) | ICP | 0.87% | $131K |
...
DefiLlama 실시간 데이터 기준, ICP의 icpswap에서 APY 0.87%예요.
