...
SAND 풀은 여기 3개가 있고, 3개 체인에서 APY가 1.48%부터 14.94%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| uniswap-v2 | 1.48% | 2.29% | 기본 금리 |
| quickswap-dex | 3.05% | 4.55% | 기본 금리 |
| aerodrome-slipstream | 14.94% | 49.70% | 인센티브 87.88% |
