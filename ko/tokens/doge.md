...
현재 DOGE의 가장 높은 정직한 수익률은 Ethereum의 uniswap-v2에서 2.18%이며, $100K TVL 기준을 넘는 8개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
|---|---|---|---|
| uniswap-v2 | 2.18% | 1.52% | 기본 금리 |
| uniswap-v2 | 1.42% | 0.84% | 기본 금리 |
| uniswap-v2 | 0.38% | 2.48% | 기본 금리 |
| pancakeswap-amm | 5.36% | 2.48% | 기본 금리 |
| gmtrade | 113.05% | 72.35% | 기본 금리 |
