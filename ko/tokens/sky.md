...
현재 SKY의 가장 높은 정직한 수익률은 Ethereum의 uniswap-v3에서 25.07%이며, $100K TVL 기준을 넘는 10개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
SKY 풀은 여기 7개가 있고, 2개 체인에서 APY가 0.64%부터 25.07%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| uniswap-v4 | 3.41% | 6.90% | 기본 금리 |
| uniswap-v3 | 3.56% | 19.14% | 기본 금리 |
| uniswap-v4 | 1.27% | 10.24% | 기본 금리 |
| uniswap-v3 | 25.07% | 27.99% | 기본 금리 |
| hydration-dex | 0.64% | 1.16% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 10개이며, 합산 TVL은 $931.6M예요.
