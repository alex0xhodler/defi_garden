...
SKY 풀은 여기 6개가 있고, 1개 체인에서 APY가 4.19%부터 36.38%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| sky-lending | 4.19% | 6.10% | 인센티브 100.00% |
| uniswap-v4 | 5.65% | 2.81% | 기본 금리 |
| origami-finance | 6.83% | 6.84% | 기본 금리 |
| uniswap-v4 | 19.37% | 15.89% | 기본 금리 |
| uniswap-v3 | 5.69% | 21.86% | 기본 금리 |
| uniswap-v4 | 36.38% | 11.33% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 9개이며, 합산 TVL은 $608.72M예요.
