...
SKY 풀은 여기 7개가 있고, 2개 체인에서 APY가 0.20%부터 8.35%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| uniswap-v4 | 4.53% | 7.19% | 기본 금리 |
| uniswap-v3 | 8.35% | 18.19% | 기본 금리 |
| uniswap-v4 | 3.18% | 9.49% | 기본 금리 |
| uniswap-v3 | 0.20% | 27.23% | 기본 금리 |
| hydration-dex | 0.58% | 1.11% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 10개이며, 합산 TVL은 $914.76M예요.
