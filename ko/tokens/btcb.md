...
현재 BTCB의 가장 높은 정직한 수익률은 BSC의 uniswap-v3에서 20.43%이며, $100K TVL 기준을 넘는 20개 풀 중 최고예요. 수익률은 DefiLlama의 실시간 데이터이며 이상 수치(APY 1000% 초과) 풀은 제외했어요.
...
BTCB 풀은 여기 8개가 있고, 1개 체인에서 APY가 0.01%부터 20.43%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
| uniswap-v3 | 9.81% | 18.78% | 기본 금리 |
| uniswap-v3 | 20.43% | 21.02% | 기본 금리 |
| kinza-finance | 0.01% | 0.00% | 기본 금리 |
| uniswap-v3 | 2.57% | 2.70% | 기본 금리 |
| pancakeswap-amm | 1.63% | 2.22% | 기본 금리 |
...
DefiLlama 실시간 데이터 기준, BSC의 uniswap-v3에서 APY 20.43%예요.

### BTCB 풀 중 TVL 기준을 통과한 풀은 몇 개인가요?

이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 20개이며, 합산 TVL은 $549.73M예요.
