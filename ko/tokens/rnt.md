...
RNT 풀은 여기 3개가 있고, 2개 체인에서 APY가 1.48%부터 16.21%까지 나타나요 — 같은 토큰이라도 어떤 프로토콜과 체인을 고르느냐에 따라 수익률이 달라져요.
...
|---|---|---|---|
| raydium-amm | 1.48% | 5.27% | 기본 금리 |
| gt3 | 5.80% | 9.79% | 기본 금리 |
| gt3 | 16.21% | 21.86% | 기본 금리 |
...
이 페이지의 $100K TVL 기준을 통과한 실시간 풀은 3개이며, 합산 TVL은 $694.4K예요.
