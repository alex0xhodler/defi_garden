# DOM-USDC — uniswap-v3 on Polygon
...
This pool's rate moves a lot: 5.64% right now vs a 0.66% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
