...
**Total APY:** 0.42% (0.08% Base · + 0.34% Rewards)
...
This pool's rate moves a lot: 0.42% right now vs a 4.80% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
