...
**Total APY:** 27.57% (27.57% Base · + 0.00% Rewards)
...
This pool's rate moves a lot: 27.57% right now vs a 49.28% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
