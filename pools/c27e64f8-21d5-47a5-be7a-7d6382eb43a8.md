...
**Total APY:** 1.89% (0.21% Base · + 1.68% Rewards)
...
This pool's rate moves a lot: 1.89% right now vs a 0.89% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
