...
**Total APY:** 1.78% (0.23% Base · + 1.55% Rewards)
...
This pool's rate moves a lot: 1.78% right now vs a 1.15% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
