...
**Total APY:** 0.62% (0.07% Base · + 0.55% Rewards)
...
This pool's rate moves a lot: 0.62% right now vs a 3.12% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
