...
**Total APY:** 16.28% (0.00% Base · + 16.28% Rewards)
...
This pool's rate moves a lot: 16.28% right now vs a 26.02% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
