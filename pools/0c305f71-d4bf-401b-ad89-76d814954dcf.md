...
**Total APY:** 2.45% (2.07% Base · + 0.39% Rewards)
...
This pool's rate moves a lot: 2.45% right now vs a 9.10% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
