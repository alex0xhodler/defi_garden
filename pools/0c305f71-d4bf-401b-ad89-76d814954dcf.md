...
**Total APY:** 2.46% (2.07% Base · + 0.39% Rewards)
...
This pool's rate moves a lot: 2.46% right now vs a 9.08% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
