...
**Total APY:** 2.85% (2.37% Base · + 0.48% Rewards)
...
This pool's rate moves a lot: 2.85% right now vs a 8.55% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
