...
**Total APY:** 2.71% (2.43% Base · + 0.28% Rewards)
...
This pool's rate moves a lot: 2.71% right now vs a 7.88% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
