...
**Total APY:** 2.72% (2.30% Base · + 0.41% Rewards)
...
This pool's rate moves a lot: 2.72% right now vs a 8.12% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
