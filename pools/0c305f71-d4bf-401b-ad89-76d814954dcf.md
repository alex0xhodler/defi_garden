...
**Total APY:** 2.67% (2.21% Base · + 0.45% Rewards)
...
This pool's rate moves a lot: 2.67% right now vs a 8.36% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
