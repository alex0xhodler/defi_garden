...
**Total APY:** 3.13% (2.60% Base · + 0.53% Rewards)
...
This pool's rate moves a lot: 3.13% right now vs a 8.85% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
