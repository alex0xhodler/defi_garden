...
**Total APY:** 2.79% (2.49% Base · + 0.30% Rewards)
...
This pool's rate moves a lot: 2.79% right now vs a 5.51% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
