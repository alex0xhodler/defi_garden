...
**Total APY:** 2.70% (2.43% Base · + 0.27% Rewards)
...
This pool's rate moves a lot: 2.70% right now vs a 7.91% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
