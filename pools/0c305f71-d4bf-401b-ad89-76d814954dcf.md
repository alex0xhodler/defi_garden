...
**Total APY:** 2.68% (2.21% Base · + 0.46% Rewards)
...
This pool's rate moves a lot: 2.68% right now vs a 8.40% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
