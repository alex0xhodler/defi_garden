...
**Total APY:** 3.12% (2.60% Base · + 0.52% Rewards)
...
This pool's rate moves a lot: 3.12% right now vs a 8.83% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
