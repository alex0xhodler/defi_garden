...
**Total APY:** 2.78% (2.33% Base · + 0.45% Rewards)
...
This pool's rate moves a lot: 2.78% right now vs a 6.62% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
