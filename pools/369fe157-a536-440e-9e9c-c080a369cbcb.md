...
**Total APY:** 1.07% (0.68% Base · + 0.39% Rewards)
...
This pool's rate moves a lot: 1.07% right now vs a 0.34% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
