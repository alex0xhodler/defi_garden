...
**Total APY:** 2.77% (0.05% Base · + 2.72% Rewards)
...
This pool's rate moves a lot: 2.77% right now vs a 6.14% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
