...
**Total APY:** 3.14% (0.04% Base · + 3.10% Rewards)
...
This pool's rate moves a lot: 3.14% right now vs a 5.64% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
