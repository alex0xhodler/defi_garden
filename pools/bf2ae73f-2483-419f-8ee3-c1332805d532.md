...
**Total APY:** 4.02% (0.09% Base · + 3.93% Rewards)
...
This pool's rate moves a lot: 4.02% right now vs a 7.32% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
