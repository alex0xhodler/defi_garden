...
**Total APY:** 3.86% (2.28% Base · + 1.58% Rewards)
...
This pool's rate moves a lot: 3.86% right now vs a 6.57% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
