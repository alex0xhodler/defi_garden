# USDCV-USDC — uniswap-v3 on Ethereum
...
This pool's rate moves a lot: 0.31% right now vs a 0.00% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
