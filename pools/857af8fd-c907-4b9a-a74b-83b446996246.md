...
**Total APY:** 3.34% (3.15% Base · + 0.19% Rewards)
...
This pool's rate moves a lot: 3.34% right now vs a 5.32% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
