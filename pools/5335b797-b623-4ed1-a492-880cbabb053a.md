...
**Total APY:** 3.32% (0.02% Base · + 3.29% Rewards)
...
This pool's rate moves a lot: 3.32% right now vs a 1.92% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
