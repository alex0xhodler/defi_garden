...
**Total APY:** 2.30% (0.99% Base · + 1.31% Rewards)
...
This pool's rate moves a lot: 2.30% right now vs a 4.96% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
