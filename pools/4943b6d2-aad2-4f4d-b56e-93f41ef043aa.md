...
**Total APY:** 2.67% (0.72% Base · + 1.95% Rewards)
...
This pool's rate moves a lot: 2.67% right now vs a 5.04% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
