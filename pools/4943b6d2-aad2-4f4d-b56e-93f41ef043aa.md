...
**Total APY:** 3.73% (0.91% Base · + 2.83% Rewards)
...
This pool's rate moves a lot: 3.73% right now vs a 7.30% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
