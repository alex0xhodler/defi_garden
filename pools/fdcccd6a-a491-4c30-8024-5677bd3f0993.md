...
This pool's rate moves a lot: 0.32% right now vs a 0.65% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
