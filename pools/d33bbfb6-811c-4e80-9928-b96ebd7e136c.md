...
**Total APY:** 0.51% (0.50% Base · + 0.01% Rewards)
...
This pool's rate moves a lot: 0.51% right now vs a 0.23% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
