...
**Total APY:** 1.22% (1.06% Base · + 0.16% Rewards)
...
This pool's rate moves a lot: 1.22% right now vs a 0.74% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
