...
**Total APY:** 1.18% (0.00% Base · + 1.18% Rewards)
...
This pool's rate moves a lot: 1.18% right now vs a 0.13% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
