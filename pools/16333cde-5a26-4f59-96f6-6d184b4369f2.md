...
**Total APY:** 0.80% (0.58% Base · + 0.22% Rewards)
...
This pool's rate moves a lot: 0.80% right now vs a 16.96% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
