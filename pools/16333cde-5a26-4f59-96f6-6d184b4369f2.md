...
**Total APY:** 0.81% (0.54% Base · + 0.27% Rewards)
...
This pool's rate moves a lot: 0.81% right now vs a 21.03% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
