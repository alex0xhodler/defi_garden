...
**Total APY:** 0.78% (0.52% Base · + 0.26% Rewards)
...
This pool's rate moves a lot: 0.78% right now vs a 21.31% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
