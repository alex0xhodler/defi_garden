...
**Total APY:** 0.76% (0.54% Base · + 0.22% Rewards)
...
This pool's rate moves a lot: 0.76% right now vs a 17.04% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
