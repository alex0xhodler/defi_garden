...
**Total APY:** 3.33% (0.24% Base · + 3.09% Rewards)
...
This pool's rate moves a lot: 3.33% right now vs a 9.91% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
