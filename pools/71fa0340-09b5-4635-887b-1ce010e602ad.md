...
**Total APY:** 3.36% (0.11% Base · + 3.25% Rewards)
...
This pool's rate moves a lot: 3.36% right now vs a 9.61% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
