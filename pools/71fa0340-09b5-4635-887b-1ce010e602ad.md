...
**Total APY:** 2.38% (0.06% Base · + 2.32% Rewards)
...
This pool's rate moves a lot: 2.38% right now vs a 4.80% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
