...
**Total APY:** 3.18% (0.12% Base · + 3.06% Rewards)
...
This pool's rate moves a lot: 3.18% right now vs a 9.74% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
