...
**Total APY:** 2.70% (0.06% Base · + 2.64% Rewards)
...
This pool's rate moves a lot: 2.70% right now vs a 4.85% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
