...
**Total APY:** 3.13% (0.02% Base · + 3.11% Rewards)
...
This pool's rate moves a lot: 3.13% right now vs a 6.25% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
