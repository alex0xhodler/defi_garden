...
**Total APY:** 3.37% (0.11% Base · + 3.26% Rewards)
...
This pool's rate moves a lot: 3.37% right now vs a 7.72% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
