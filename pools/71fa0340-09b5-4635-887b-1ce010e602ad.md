...
**Total APY:** 3.18% (0.02% Base · + 3.16% Rewards)
...
This pool's rate moves a lot: 3.18% right now vs a 6.49% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
