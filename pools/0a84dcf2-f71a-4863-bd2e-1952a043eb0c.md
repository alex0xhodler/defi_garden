...
**Total APY:** 5.30% (1.25% Base · + 4.05% Rewards)
...
This pool's rate moves a lot: 5.30% right now vs a 9.59% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
