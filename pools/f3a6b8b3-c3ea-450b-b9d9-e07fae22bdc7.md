...
Projected at ⅓ haircut (10.24% headline) — farm rates decay. Active management required.

This pool's rate moves a lot: 10.24% right now vs a 21.14% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
