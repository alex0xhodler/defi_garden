...
Projected at ⅓ haircut (12.31% headline) — farm rates decay. Active management required.

This pool's rate moves a lot: 12.31% right now vs a 20.98% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
