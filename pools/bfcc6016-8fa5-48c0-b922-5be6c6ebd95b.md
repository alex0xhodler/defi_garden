...
**Total APY:** 1.73% (1.07% Base · + 0.66% Rewards)
...
This pool's rate moves a lot: 1.73% right now vs a 1.03% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
