...
**Total APY:** 3.37% (1.19% Base · + 2.18% Rewards)
...
This pool's rate moves a lot: 3.37% right now vs a 5.11% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
