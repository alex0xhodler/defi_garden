...
**Total APY:** 3.35% (1.20% Base · + 2.15% Rewards)
...
This pool's rate moves a lot: 3.35% right now vs a 5.21% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
