...
**Total APY:** 3.33% (1.19% Base · + 2.15% Rewards)
...
This pool's rate moves a lot: 3.33% right now vs a 5.17% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
