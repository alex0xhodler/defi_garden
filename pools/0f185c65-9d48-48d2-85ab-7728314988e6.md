...
**Total APY:** 3.34% (1.20% Base · + 2.14% Rewards)
...
This pool's rate moves a lot: 3.34% right now vs a 5.22% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
