...
**Total APY:** 16.95% (0.73% Base · + 16.22% Rewards)
...
This pool's rate moves a lot: 16.95% right now vs a 26.49% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
