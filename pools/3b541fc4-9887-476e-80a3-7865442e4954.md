...
**Total APY:** 1.17% (0.54% Base · + 0.63% Rewards)
...
This pool's rate moves a lot: 1.17% right now vs a 3.19% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
