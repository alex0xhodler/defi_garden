...
**Total APY:** 2.39% (1.83% Base · + 0.56% Rewards)
...
This pool's rate moves a lot: 2.39% right now vs a 3.80% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
