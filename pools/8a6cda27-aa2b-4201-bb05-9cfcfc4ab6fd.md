...
**Total APY:** 8.92% (0.48% Base · + 8.44% Rewards)
...
This pool's rate moves a lot: 8.92% right now vs a 5.38% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
