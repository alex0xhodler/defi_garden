...
**Total APY:** 11.72% (0.94% Base · + 10.79% Rewards)
...
This pool's rate moves a lot: 11.72% right now vs a 5.15% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
