# WFAI-WETH — uniswap-v2 on Ethereum
...
This pool's rate moves a lot: 0.53% right now vs a 0.01% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
