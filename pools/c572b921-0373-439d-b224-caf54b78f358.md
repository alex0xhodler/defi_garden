...
**Total APY:** 5.13% (1.99% Base · + 3.14% Rewards)
...
This pool's rate moves a lot: 5.13% right now vs a 8.22% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
