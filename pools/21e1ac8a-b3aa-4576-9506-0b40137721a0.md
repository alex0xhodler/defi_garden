...
**Total APY:** 2.34% (1.83% Base · + 0.51% Rewards)
...
This pool's rate moves a lot: 2.34% right now vs a 4.14% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
