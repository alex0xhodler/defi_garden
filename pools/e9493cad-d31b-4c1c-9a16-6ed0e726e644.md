...
**Total APY:** 18.33% (2.90% Base · + 15.43% Rewards)
...
This pool's rate moves a lot: 18.33% right now vs a 43.56% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
