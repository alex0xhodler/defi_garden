# USD.INFRA-SUSD.INFRA — orca-dex on Solana
...
This pool's rate moves a lot: 1.20% right now vs a 0.73% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
