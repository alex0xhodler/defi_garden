# WHYPE-USD₮0 — project-x on Hyperliquid L1
...
This pool's rate moves a lot: 0.29% right now vs a 12.83% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
