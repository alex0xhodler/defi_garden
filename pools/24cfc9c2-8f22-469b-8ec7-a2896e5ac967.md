# WETH-BLUEAGENT — uniswap-v4 on Base
...
This pool's rate moves a lot: 0.03% right now vs a 5.18% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
