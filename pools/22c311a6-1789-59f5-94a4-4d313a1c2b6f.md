# USDC-EXM — uniswap-v4 on Ethereum
...
This pool's rate moves a lot: 0.07% right now vs a 2.33% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
