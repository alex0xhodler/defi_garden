...
**Total APY:** 91.29% (5.88% Base · + 85.41% Rewards)
...
This pool's rate moves a lot: 91.29% right now vs a 228.72% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
