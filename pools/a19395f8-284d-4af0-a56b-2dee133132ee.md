...
**Total APY:** 15.04% (9.06% Base · + 5.98% Rewards)
...
This pool's rate moves a lot: 15.04% right now vs a 7.57% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
