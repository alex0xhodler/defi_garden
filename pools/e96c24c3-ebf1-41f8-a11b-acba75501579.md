...
**Total APY:** 21.24% (1.47% Base · + 19.77% Rewards)
...
This pool's rate moves a lot: 21.24% right now vs a 106.75% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
