...
**Total APY:** 0.14% (0.00% Base · + 0.14% Rewards)
...
This pool's rate moves a lot: 0.14% right now vs a 1.47% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
