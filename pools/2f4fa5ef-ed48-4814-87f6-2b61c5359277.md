...
**Total APY:** 0.04% (0.02% Base · + 0.02% Rewards)
...
This pool's rate moves a lot: 0.04% right now vs a 0.24% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
