...
**Total APY:** 1.21% (1.17% Base · + 0.04% Rewards)
...
This pool's rate moves a lot: 1.21% right now vs a 9.43% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
