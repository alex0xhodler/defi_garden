...
**Total APY:** 0.52% (0.09% Base · + 0.43% Rewards)
...
This pool's rate moves a lot: 0.52% right now vs a 1.55% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
