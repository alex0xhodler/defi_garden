...
**Total APY:** 3.78% (0.07% Base · + 3.71% Rewards)
...
This pool's rate moves a lot: 3.78% right now vs a 6.32% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
