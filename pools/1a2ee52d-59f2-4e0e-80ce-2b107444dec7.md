...
**Total APY:** 3.60% (0.44% Base · + 3.16% Rewards)
...
This pool's rate moves a lot: 3.60% right now vs a 5.73% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
