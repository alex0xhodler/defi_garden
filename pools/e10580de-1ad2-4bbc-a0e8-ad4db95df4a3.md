...
**Total APY:** 3.74% (3.07% Base · + 0.66% Rewards)
...
This pool's rate moves a lot: 3.74% right now vs a 6.80% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
