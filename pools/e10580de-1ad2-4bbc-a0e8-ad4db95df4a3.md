...
**Total APY:** 3.72% (3.08% Base · + 0.64% Rewards)
...
This pool's rate moves a lot: 3.72% right now vs a 7.15% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
