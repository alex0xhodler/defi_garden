...
**Total APY:** 3.73% (3.08% Base · + 0.65% Rewards)
...
This pool's rate moves a lot: 3.73% right now vs a 7.18% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
