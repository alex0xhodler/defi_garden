...
**Total APY:** 1.23% (0.47% Base · + 0.76% Rewards)
...
This pool's rate moves a lot: 1.23% right now vs a 6.76% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
