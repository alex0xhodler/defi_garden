...
**Total APY:** 0.47% (0.13% Base · + 0.33% Rewards)
...
This pool's rate moves a lot: 0.47% right now vs a 8.28% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
