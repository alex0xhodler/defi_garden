...
**Total APY:** 0.91% (0.09% Base · + 0.82% Rewards)
...
This pool's rate moves a lot: 0.91% right now vs a 2.06% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
