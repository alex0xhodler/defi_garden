...
**Total APY:** 0.53% (0.50% Base · + 0.03% Rewards)
...
This pool's rate moves a lot: 0.53% right now vs a 0.90% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
