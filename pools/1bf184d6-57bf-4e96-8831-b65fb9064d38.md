...
**Total APY:** 2.61% (2.29% Base · + 0.31% Rewards)
...
This pool's rate moves a lot: 2.61% right now vs a 4.13% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
