...
**Total APY:** 2.35% (2.08% Base · + 0.27% Rewards)
...
This pool's rate moves a lot: 2.35% right now vs a 4.17% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
