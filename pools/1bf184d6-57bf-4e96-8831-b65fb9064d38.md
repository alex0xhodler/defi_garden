...
**Total APY:** 2.29% (2.11% Base · + 0.18% Rewards)
...
This pool's rate moves a lot: 2.29% right now vs a 4.16% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
