...
**Total APY:** 0.47% (0.05% Base · + 0.42% Rewards)
...
This pool's rate moves a lot: 0.47% right now vs a 1.23% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
