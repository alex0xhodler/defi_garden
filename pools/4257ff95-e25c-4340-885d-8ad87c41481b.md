...
**Total APY:** 2.34% (0.21% Base · + 2.13% Rewards)
...
This pool's rate moves a lot: 2.34% right now vs a 6.36% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
