...
**Total APY:** 1.22% (0.07% Base · + 1.15% Rewards)
...
This pool's rate moves a lot: 1.22% right now vs a 3.55% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
