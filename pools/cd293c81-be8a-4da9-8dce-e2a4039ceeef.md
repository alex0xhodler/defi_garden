...
**Total APY:** 3.17% (2.55% Base · + 0.61% Rewards)
...
This pool's rate moves a lot: 3.17% right now vs a 6.46% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
