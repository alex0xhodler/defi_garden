...
**Total APY:** 3.34% (2.62% Base · + 0.72% Rewards)
...
This pool's rate moves a lot: 3.34% right now vs a 5.83% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
