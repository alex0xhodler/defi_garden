...
**Total APY:** 3.32% (2.62% Base · + 0.70% Rewards)
...
This pool's rate moves a lot: 3.32% right now vs a 6.07% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
