...
**Total APY:** 3.11% (2.50% Base · + 0.61% Rewards)
...
This pool's rate moves a lot: 3.11% right now vs a 6.31% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
