...
**Total APY:** 19.07% (0.86% Base · + 18.21% Rewards)
...
This pool's rate moves a lot: 19.07% right now vs a 33.84% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
