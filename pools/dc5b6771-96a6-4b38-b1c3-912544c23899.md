...
**Total APY:** 1.07% (0.43% Base · + 0.64% Rewards)
...
This pool's rate moves a lot: 1.07% right now vs a 4.17% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
