...
**Total APY:** 1.26% (0.66% Base · + 0.60% Rewards)
...
This pool's rate moves a lot: 1.26% right now vs a 2.33% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
