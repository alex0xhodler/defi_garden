...
**Total APY:** 1.76% (1.15% Base · + 0.62% Rewards)
...
This pool's rate moves a lot: 1.76% right now vs a 2.80% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
