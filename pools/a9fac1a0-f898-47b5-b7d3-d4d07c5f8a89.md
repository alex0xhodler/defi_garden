...
**Total APY:** 3.64% (0.57% Base · + 3.07% Rewards)
...
This pool's rate moves a lot: 3.64% right now vs a 7.14% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
