...
This pool's rate moves a lot: 14.05% right now vs a 104.91% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
