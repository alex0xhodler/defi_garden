...
**Total APY:** 0.05% (0.01% Base · + 0.04% Rewards)
...
This pool's rate moves a lot: 0.05% right now vs a 2.00% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
