...
**Total APY:** 0.32% (0.27% Base · + 0.05% Rewards)
...
This pool's rate moves a lot: 0.32% right now vs a 2.04% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
