...
**Total APY:** 10.26% (2.06% Base · + 8.20% Rewards)
...
This pool's rate moves a lot: 10.26% right now vs a 91.41% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
