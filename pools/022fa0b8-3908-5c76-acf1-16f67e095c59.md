# ADI-USDC — raydium-amm on Solana
...
This pool's rate moves a lot: 0.04% right now vs a 166.94% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
