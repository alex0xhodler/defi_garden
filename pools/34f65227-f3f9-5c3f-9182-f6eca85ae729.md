...
**Total APY:** 1.20% (0.20% Base · + 1.00% Rewards)
...
This pool's rate moves a lot: 1.20% right now vs a 5.10% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
