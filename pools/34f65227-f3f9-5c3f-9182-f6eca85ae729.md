...
**Total APY:** 1.18% (0.18% Base · + 1.00% Rewards)
...
This pool's rate moves a lot: 1.18% right now vs a 4.40% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
