...
**Total APY:** 25.16% (0.04% Base · + 25.12% Rewards)
...
This pool's rate moves a lot: 25.16% right now vs a 195.08% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
