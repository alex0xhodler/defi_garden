...
**Total APY:** 5.56% (4.93% Base · + 0.63% Rewards)
...
This pool's rate moves a lot: 5.56% right now vs a 2.95% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
