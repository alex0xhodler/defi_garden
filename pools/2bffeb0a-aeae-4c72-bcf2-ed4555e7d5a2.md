...
**Total APY:** 21.65% (0.07% Base · + 21.58% Rewards)
...
This pool's rate moves a lot: 21.65% right now vs a 8.33% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
