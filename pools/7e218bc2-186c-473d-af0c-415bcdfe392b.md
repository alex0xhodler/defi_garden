...
**Total APY:** 124.73% (124.73% Base · + 0.00% Rewards)
...
This pool's rate moves a lot: 124.73% right now vs a 209.51% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
