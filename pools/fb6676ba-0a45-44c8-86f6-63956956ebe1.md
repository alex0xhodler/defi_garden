...
**Total APY:** 16.34% (0.15% Base · + 16.19% Rewards)
...
This pool's rate moves a lot: 16.34% right now vs a 10.30% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
