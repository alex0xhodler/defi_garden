...
**Total APY:** 83.32% (6.09% Base · + 77.24% Rewards)
...
Projected at ⅓ haircut (83.32% headline) — farm rates decay. Active management required.

This pool's rate moves a lot: 83.32% right now vs a 46.06% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
