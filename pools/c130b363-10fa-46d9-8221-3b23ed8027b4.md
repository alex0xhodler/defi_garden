...
**Total APY:** 3.73% (0.22% Base · + 3.51% Rewards)
...
This pool's rate moves a lot: 3.73% right now vs a 5.89% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
