...
**Total APY:** 3.12% (0.05% Base · + 3.07% Rewards)
...
This pool's rate moves a lot: 3.12% right now vs a 9.55% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
