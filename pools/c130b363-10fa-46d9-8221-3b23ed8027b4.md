...
**Total APY:** 7.57% (0.01% Base · + 7.56% Rewards)
...
This pool's rate moves a lot: 7.57% right now vs a 12.22% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
