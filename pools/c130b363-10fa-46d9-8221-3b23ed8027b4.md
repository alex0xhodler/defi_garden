...
**Total APY:** 3.13% (0.05% Base · + 3.08% Rewards)
...
This pool's rate moves a lot: 3.13% right now vs a 9.58% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
