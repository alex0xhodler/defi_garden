...
**Total APY:** 1.26% (1.19% Base · + 0.07% Rewards)
...
This pool's rate moves a lot: 1.26% right now vs a 2.71% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
