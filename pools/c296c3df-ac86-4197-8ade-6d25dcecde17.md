...
**Total APY:** 2.96% (1.61% Base · + 1.34% Rewards)
...
This pool's rate moves a lot: 2.96% right now vs a 5.83% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
