...
**Total APY:** 0.90% (0.00% Base · + 0.89% Rewards)
...
This pool's rate moves a lot: 0.90% right now vs a 1.63% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
