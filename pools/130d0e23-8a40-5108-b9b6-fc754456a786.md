...
**Total APY:** 3.72% (1.85% Base · + 1.88% Rewards)
...
This pool's rate moves a lot: 3.72% right now vs a 5.82% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
