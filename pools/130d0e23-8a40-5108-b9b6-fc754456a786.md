...
**Total APY:** 3.73% (1.85% Base · + 1.89% Rewards)
...
This pool's rate moves a lot: 3.73% right now vs a 5.83% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
