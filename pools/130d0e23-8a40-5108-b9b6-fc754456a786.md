...
**Total APY:** 3.56% (0.57% Base · + 2.99% Rewards)
...
This pool's rate moves a lot: 3.56% right now vs a 6.22% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
