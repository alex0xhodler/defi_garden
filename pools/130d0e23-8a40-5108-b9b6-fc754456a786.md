...
**Total APY:** 3.64% (1.85% Base · + 1.79% Rewards)
...
This pool's rate moves a lot: 3.64% right now vs a 5.73% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
