...
**Total APY:** 2.68% (0.11% Base · + 2.57% Rewards)
...
This pool's rate moves a lot: 2.68% right now vs a 4.54% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
