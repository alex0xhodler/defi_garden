...
**Total APY:** 2.46% (0.22% Base · + 2.24% Rewards)
...
This pool's rate moves a lot: 2.46% right now vs a 4.12% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
