...
**Total APY:** 2.67% (0.11% Base · + 2.56% Rewards)
...
This pool's rate moves a lot: 2.67% right now vs a 4.41% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
