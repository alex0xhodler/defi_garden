...
Projected at ⅓ haircut (10.10% headline) — farm rates decay. Active management required.

This pool's rate moves a lot: 10.10% right now vs a 3.38% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
