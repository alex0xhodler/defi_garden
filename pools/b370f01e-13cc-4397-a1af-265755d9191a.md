...
**Total APY:** 6.48% (2.58% Base · + 3.91% Rewards)
...
This pool's rate moves a lot: 6.48% right now vs a 4.22% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
