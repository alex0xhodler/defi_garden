...
**Total APY:** 1.24% (0.13% Base · + 1.11% Rewards)
...
This pool's rate moves a lot: 1.24% right now vs a 648.30% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
