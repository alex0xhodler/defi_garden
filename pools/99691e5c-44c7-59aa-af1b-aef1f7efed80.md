...
**Total APY:** 1.28% (0.13% Base · + 1.15% Rewards)
...
This pool's rate moves a lot: 1.28% right now vs a 631.27% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
