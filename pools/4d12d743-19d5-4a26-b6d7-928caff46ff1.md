...
**Total APY:** 0.27% (0.15% Base · + 0.11% Rewards)
...
This pool's rate moves a lot: 0.27% right now vs a 0.55% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
