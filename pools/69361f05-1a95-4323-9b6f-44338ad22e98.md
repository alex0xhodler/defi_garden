...
**Total APY:** 0.41% (0.31% Base · + 0.10% Rewards)
...
This pool's rate moves a lot: 0.41% right now vs a 2.58% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
