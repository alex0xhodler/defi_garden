# KAS-USDC — raydium-amm on Solana
...
This pool's rate moves a lot: 0.03% right now vs a 52.79% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
