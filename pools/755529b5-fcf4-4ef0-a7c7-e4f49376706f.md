...
**Total APY:** 0.40% (0.05% Base · + 0.35% Rewards)
...
This pool's rate moves a lot: 0.40% right now vs a 0.81% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
