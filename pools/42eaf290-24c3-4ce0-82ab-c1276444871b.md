...
**Total APY:** 2.30% (1.57% Base · + 0.73% Rewards)
...
This pool's rate moves a lot: 2.30% right now vs a 3.84% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
