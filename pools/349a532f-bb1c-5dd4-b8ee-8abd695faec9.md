# KFV — t3tris-finance on Robinhood Chain

**Total APY:** 20.48% (20.48% Base · + 0.00% Rewards)
...
This pool's rate moves a lot: 20.48% right now vs a 2.66% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
