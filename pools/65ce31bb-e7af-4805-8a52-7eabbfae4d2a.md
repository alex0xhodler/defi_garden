...
**Total APY:** 16.93% (0.00% Base · + 16.93% Rewards)
...
This pool's rate moves a lot: 16.93% right now vs a 11.17% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
