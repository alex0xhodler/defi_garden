...
**Total APY:** 3.32% (2.41% Base · + 0.91% Rewards)
...
This pool's rate moves a lot: 3.32% right now vs a 1.49% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
