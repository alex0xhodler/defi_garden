# WSOL-VAL — raydium-amm on Solana
...
This pool's rate moves a lot: 10.26% right now vs a 6.68% 30-day average. Reward emissions change daily — projections on this page use the current rate and will move with it.
