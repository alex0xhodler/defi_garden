  ...
  <script>
    (function() {
      ...
      function updateCtaText() {
        ...
        if (lasoIssueBtn) {
          lasoIssueBtn.textContent = currentLasoMode === 'live'
            ...
            : ('🧪 Simulate Card Issuance ($' + amt.toFixed(2) + ') →');
        }
      }
      ...
      function updateStep(stepNum, msg) {
        ...
        for (var i = 1; i <= 5; i++) {
          var dot = document.getElementById('laso-dot-' + i);
          var line = document.getElementById('laso-line-' + (i - 1));
          if (dot) {
            if (i <= stepNum) dot.classList.add('is-active');
            else dot.classList.remove('is-active');
          }
          if (line) {
            if (i <= stepNum) line.classList.add('is-active');
      ...
      function showError(msg) {
        ...
        if (lasoErrorView) {
          lasoErrorView.style.display = 'block';
      ...
      function showCard(card) {
        ...
        if (lasoCvvText) lasoCvvText.textContent = card.cvv ? '•••' : '•••';
        if (lasoBalText) {
          var balNum = Number(card.available_balance || card.initial_amount || 5);
      ...
      if (lasoIssueBtn) {
        lasoIssueBtn.addEventListener('click', function() {
          ...
          if (currentLasoMode === 'live') {
            updateStep(1, 'Connecting wallet & verifying Base network...');
            ...
            updateStep(1, 'Requesting CAIP-122 wallet signature (SIWx)...');
            if (typeof window !== 'undefined' && window.LasoService) {
              ...
              setTimeout(function() {
                updateStep(3, 'Laso BaaS issuing USA Prepaid Visa Debit card...');
                setTimeout(function() {
                  showCard({
