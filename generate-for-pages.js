            ...
            <div class="yield-card-reservation" id="reservation-card">
              ...
              <div class="laso-terminal-container" id="laso-terminal" style="display:none; margin-top:14px;">
                <div class="laso-terminal-header">
                  ...
                  <div class="laso-mode-badge">🧪 Instant Simulator</div>
                </div>
                <div class="laso-idle-card" id="laso-idle-view">
                  <p class="laso-terminal-desc">
                  ...
                  <div class="laso-specs-grid">
                    ...
                    <div class="laso-spec-item">
                      <span class="laso-spec-k">Fee:</span>
                      <span class="laso-spec-v highlight">0% (Zero Fee)</span>
                    </div>
                    <div class="laso-spec-item">
                      <span class="laso-spec-k">Speed:</span>
                      <span class="laso-spec-v">Instant (~7-10s)</span>
                    </div>
                  </div>
                  <button type="button" class="laso-issue-cta-btn" id="laso-issue-btn">
                    ⚡ Issue Virtual Visa Card ($${sub.taxBufferMonthlyUsd.toFixed(2)}) →
                  </button>
                </div>
                <div class="laso-issuing-progress-box" id="laso-progress-view" style="display:none;">
                  ...
                  <div class="laso-spinner-msg-row">
                    ...
                    <span class="laso-progress-text" id="laso-msg-text">Requesting CAIP-122 wallet signature (SIWx)...</span>
                  </div>
                </div>
                <div class="laso-active-card-surface" id="laso-card-view" style="display:none;">
                  <div class="laso-issued-card">
                    ...
                    <div class="laso-card-meta-row">
                      ...
                      <div>
                        ...
                        <span class="laso-meta-val balance" id="laso-bal-text">$${sub.taxBufferMonthlyUsd.toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
                  <div class="laso-billing-address-box">
                    ...
                    <p class="billing-text">1209 Orange St, Suite 400, Wilmington, DE 19801, US</p>
                  </div>
    ...
    (function() {
        ...
        lasoIssueBtn.addEventListener('click', function() {
          ...
          if (typeof window !== 'undefined' && window.LasoService) {
            window.LasoService.simulateIssuance({
              amount: ${sub.taxBufferMonthlyUsd.toFixed(2)},
              subName: '${sub.name}',
              ...
              if (lasoPanText) lasoPanText.textContent = '•••• •••• •••• ' + (card.card_number ? card.card_number.slice(-4) : '8842');
              if (lasoExpText) lasoExpText.textContent = (card.exp_month || '02') + '/' + (card.exp_year || '32');
              if (lasoCvvText) lasoCvvText.textContent = '•••';
            });
          } else {
            setTimeout(function() {
              updateStep(2, 'Transacting USDC on Base via x402...');
              setTimeout(function() {
                updateStep(3, 'Laso BaaS issuing USA Prepaid Visa Debit card...');
                setTimeout(function() {
                  updateStep(4, 'Virtual Visa Card ready for ${sub.name}!');
                  currentLasoCard = {
      ...
      if (lasoPanToggleBtn && lasoPanText) {
        lasoPanToggleBtn.addEventListener('click', function() {
          ...
          var pan = currentLasoCard ? currentLasoCard.card_number : '4242884919208842';
      ...
      if (lasoCvvToggleBtn && lasoCvvText) {
        lasoCvvToggleBtn.addEventListener('click', function() {
          ...
          lasoCvvText.textContent = isCvvRevealed ? (currentLasoCard ? currentLasoCard.cvv : '942') : '•••';
        });
      }

      if (lasoCvvCopyBtn) {
        lasoCvvCopyBtn.addEventListener('click', function() {
          var cvv = currentLasoCard ? currentLasoCard.cvv : '942';
          if (navigator.clipboard) {
      ...
      if (lasoAddrCopyBtn) {
        lasoAddrCopyBtn.addEventListener('click', function() {
          if (navigator.clipboard) {
            navigator.clipboard.writeText('1209 Orange St, Suite 400, Wilmington, DE 19801, US');
