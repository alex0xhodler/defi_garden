    ...
    <div class="portal-shell">
      ...
      <details class="trust-accordion">
        ...
        <div class="trust-accordion-body">
          ...
          <!-- Email Waitlist Reservation -->
          <div class="checkout-flow" id="panel-waitlist" style="margin-top:24px; border-top:1px solid var(--ui-border); padding-top:16px;">
            <div class="checkout-header">
              <h4 class="checkout-product-title" style="font-size:1.15rem;">Launch Waitlist Reservation</h4>
              <p class="checkout-product-desc">Prefer email notification? We will email you the moment automated Base vault compounding launches.</p>
            </div>
          ...
          <div class="yield-card-receipt" id="receipt-card" style="display:none; margin-top:16px;">
  ...
  <script>
    (function() {
      ...
      function updateCtaText() {
        if (checkoutTotalVal) checkoutTotalVal.textContent = '$' + serviceAmount.toFixed(2);
        if (lasoIssueBtn) {
          lasoIssueBtn.textContent = 'Pay $' + serviceAmount.toFixed(2) + ' USDC on Laso →';
        }
        if (stickyBtn) {
          stickyBtn.textContent = 'Pay $' + serviceAmount.toFixed(2) + ' on Laso →';
        }
      }
