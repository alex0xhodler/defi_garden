...
const YIELD_CARD_CATALOG_KR = [
  { id: 'claude', name: 'Claude Pro', monthlyCostKrw: 29000, monthlyCostUsd: 20.00, taxBufferMonthlyUsd: 24.00, domain: 'claude.ai', emoji: '🤖', category: ['ai_service', 'software_subscription'] },
  { id: 'cursor', name: 'Cursor Pro', monthlyCostKrw: 29000, monthlyCostUsd: 20.00, taxBufferMonthlyUsd: 24.00, domain: 'cursor.com', emoji: '⚡', category: ['developer_tool', 'ai_service'] },
  { id: 'chatgpt', name: 'ChatGPT Plus', monthlyCostKrw: 29000, monthlyCostUsd: 20.00, taxBufferMonthlyUsd: 24.00, domain: 'openai.com', emoji: '💬', category: ['ai_service', 'software_subscription'] },
  { id: 'spotify', name: 'Spotify', monthlyCostKrw: 15900, monthlyCostUsd: 11.99, taxBufferMonthlyUsd: 14.39, domain: 'spotify.com', emoji: '🎵', category: ['music', 'streaming'] },
  { id: 'netflix', name: 'Netflix', monthlyCostKrw: 24000, monthlyCostUsd: 17.99, taxBufferMonthlyUsd: 21.59, domain: 'netflix.com', emoji: '🍿', category: ['entertainment', 'streaming'] },
  { id: 'amazonprime', name: 'Amazon Prime', monthlyCostKrw: 20000, monthlyCostUsd: 15.00, taxBufferMonthlyUsd: 18.00, domain: 'amazon.com', emoji: '📦', category: ['shopping', 'entertainment'] },
  { id: 'opencode_go', name: 'OpenCode Go', monthlyCostKrw: 6800, monthlyCostUsd: 5.00, taxBufferMonthlyUsd: 6.00, domain: 'opencode.ai', emoji: '⚡', category: ['developer_tool', 'ai_service'] },
  { id: 'aws', name: 'AWS Cloud', monthlyCostKrw: 68000, monthlyCostUsd: 50.00, taxBufferMonthlyUsd: 60.00, domain: 'amazon.com', emoji: '☁️', category: ['cloud_compute', 'infrastructure'] },
  { id: 'github', name: 'GitHub', monthlyCostKrw: 13800, monthlyCostUsd: 10.00, taxBufferMonthlyUsd: 12.00, domain: 'github.com', emoji: '🐙', category: ['developer_tool', 'software_subscription'] },
  { id: 'youtube', name: 'YouTube', monthlyCostKrw: 14900, monthlyCostUsd: 13.99, taxBufferMonthlyUsd: 16.79, domain: 'youtube.com', emoji: '▶️', category: ['video', 'subscription'] },
  { id: 'disney', name: 'Disney+', monthlyCostKrw: 19900, monthlyCostUsd: 15.99, taxBufferMonthlyUsd: 19.19, domain: 'disneyplus.com', emoji: '🏰', category: ['entertainment', 'streaming'] },
  { id: 'max', name: 'Max (HBO)', monthlyCostKrw: 22000, monthlyCostUsd: 16.99, taxBufferMonthlyUsd: 20.39, domain: 'max.com', emoji: '🎬', category: ['entertainment', 'streaming'] },
  { id: 'hulu', name: 'Hulu', monthlyCostKrw: 25000, monthlyCostUsd: 18.99, taxBufferMonthlyUsd: 22.79, domain: 'hulu.com', emoji: '📺', category: ['entertainment', 'streaming'] },
  { id: 'appletv', name: 'Apple TV+', monthlyCostKrw: 17000, monthlyCostUsd: 12.99, taxBufferMonthlyUsd: 15.59, domain: 'apple.com', emoji: '🍎', category: ['entertainment', 'streaming'] },
  { id: 'gamepass', name: 'Xbox Game Pass', monthlyCostKrw: 26000, monthlyCostUsd: 19.99, taxBufferMonthlyUsd: 23.99, domain: 'xbox.com', emoji: '🎮', category: ['gaming', 'subscription'] },
  { id: 'paramount', name: 'Paramount+', monthlyCostKrw: 13000, monthlyCostUsd: 9.99, taxBufferMonthlyUsd: 11.99, domain: 'paramountplus.com', emoji: '⛰️', category: ['entertainment', 'streaming'] },
  { id: 'peacock', name: 'Peacock', monthlyCostKrw: 14500, monthlyCostUsd: 10.99, taxBufferMonthlyUsd: 13.19, domain: 'peacocktv.com', emoji: '🦚', category: ['entertainment', 'streaming'] },
  { id: 'doordash', name: 'DoorDash', monthlyCostKrw: 13500, monthlyCostUsd: 9.99, taxBufferMonthlyUsd: 11.99, domain: 'doordash.com', emoji: '🥡', category: ['food_delivery', 'lifestyle'] },
  { id: 'uber', name: 'Uber One', monthlyCostKrw: 13500, monthlyCostUsd: 9.99, taxBufferMonthlyUsd: 11.99, domain: 'uber.com', emoji: '🚗', category: ['lifestyle', 'mobility'] },
  { id: 'audible', name: 'Audible', monthlyCostKrw: 19900, monthlyCostUsd: 14.95, taxBufferMonthlyUsd: 17.94, domain: 'audible.com', emoji: '🎧', category: ['audiobooks', 'media'] },
  { id: 'walmart', name: 'Walmart+', monthlyCostKrw: 17500, monthlyCostUsd: 12.95, taxBufferMonthlyUsd: 15.54, domain: 'walmart.com', emoji: '🛒', category: ['shopping', 'delivery'] }
];

const YIELD_CARD_CATALOG_USD = [
  { id: 'claude', name: 'Claude Pro', monthlyCostUsd: 20.00, taxBufferMonthlyUsd: 24.00, domain: 'claude.ai', emoji: '🤖', category: ['ai_service', 'software_subscription'] },
  { id: 'cursor', name: 'Cursor Pro', monthlyCostUsd: 20.00, taxBufferMonthlyUsd: 24.00, domain: 'cursor.com', emoji: '⚡', category: ['developer_tool', 'ai_service'] },
  { id: 'chatgpt', name: 'ChatGPT Plus', monthlyCostUsd: 20.00, taxBufferMonthlyUsd: 24.00, domain: 'openai.com', emoji: '💬', category: ['ai_service', 'software_subscription'] },
  { id: 'spotify', name: 'Spotify', monthlyCostUsd: 11.99, taxBufferMonthlyUsd: 14.39, domain: 'spotify.com', emoji: '🎵', category: ['music', 'streaming'] },
  { id: 'netflix', name: 'Netflix', monthlyCostUsd: 17.99, taxBufferMonthlyUsd: 21.59, domain: 'netflix.com', emoji: '🍿', category: ['entertainment', 'streaming'] },
  { id: 'amazonprime', name: 'Amazon Prime', monthlyCostUsd: 15.00, taxBufferMonthlyUsd: 18.00, domain: 'amazon.com', emoji: '📦', category: ['shopping', 'entertainment'] },
  { id: 'opencode_go', name: 'OpenCode Go', monthlyCostUsd: 5.00, taxBufferMonthlyUsd: 6.00, domain: 'opencode.ai', emoji: '⚡', category: ['developer_tool', 'ai_service'] },
  { id: 'aws', name: 'AWS Cloud', monthlyCostUsd: 50.00, taxBufferMonthlyUsd: 60.00, domain: 'amazon.com', emoji: '☁️', category: ['cloud_compute', 'infrastructure'] },
  { id: 'github', name: 'GitHub', monthlyCostUsd: 10.00, taxBufferMonthlyUsd: 12.00, domain: 'github.com', emoji: '🐙', category: ['developer_tool', 'software_subscription'] },
  { id: 'youtube', name: 'YouTube', monthlyCostUsd: 13.99, taxBufferMonthlyUsd: 16.79, domain: 'youtube.com', emoji: '▶️', category: ['video', 'subscription'] },
  { id: 'disney', name: 'Disney+', monthlyCostUsd: 15.99, taxBufferMonthlyUsd: 19.19, domain: 'disneyplus.com', emoji: '🏰', category: ['entertainment', 'streaming'] },
  { id: 'max', name: 'Max (HBO)', monthlyCostUsd: 16.99, taxBufferMonthlyUsd: 20.39, domain: 'max.com', emoji: '🎬', category: ['entertainment', 'streaming'] },
  { id: 'hulu', name: 'Hulu', monthlyCostUsd: 18.99, taxBufferMonthlyUsd: 22.79, domain: 'hulu.com', emoji: '📺', category: ['entertainment', 'streaming'] },
  { id: 'appletv', name: 'Apple TV+', monthlyCostUsd: 12.99, taxBufferMonthlyUsd: 15.59, domain: 'apple.com', emoji: '🍎', category: ['entertainment', 'streaming'] },
  { id: 'gamepass', name: 'Xbox Game Pass', monthlyCostUsd: 19.99, taxBufferMonthlyUsd: 23.99, domain: 'xbox.com', emoji: '🎮', category: ['gaming', 'subscription'] },
  { id: 'paramount', name: 'Paramount+', monthlyCostUsd: 9.99, taxBufferMonthlyUsd: 11.99, domain: 'paramountplus.com', emoji: '⛰️', category: ['entertainment', 'streaming'] },
  { id: 'peacock', name: 'Peacock', monthlyCostUsd: 10.99, taxBufferMonthlyUsd: 13.19, domain: 'peacocktv.com', emoji: '🦚', category: ['entertainment', 'streaming'] },
  { id: 'doordash', name: 'DoorDash', monthlyCostUsd: 9.99, taxBufferMonthlyUsd: 11.99, domain: 'doordash.com', emoji: '🥡', category: ['food_delivery', 'lifestyle'] },
  { id: 'uber', name: 'Uber One', monthlyCostUsd: 9.99, taxBufferMonthlyUsd: 11.99, domain: 'uber.com', emoji: '🚗', category: ['lifestyle', 'mobility'] },
  { id: 'audible', name: 'Audible', monthlyCostUsd: 14.95, taxBufferMonthlyUsd: 17.94, domain: 'audible.com', emoji: '🎧', category: ['audiobooks', 'media'] },
  { id: 'walmart', name: 'Walmart+', monthlyCostUsd: 12.95, taxBufferMonthlyUsd: 15.54, domain: 'walmart.com', emoji: '🛒', category: ['shopping', 'delivery'] }
];
...
function serializeWaitlistPayload(opts) {
  ...
  const emailPrefix = String(opts.email || '').split('@')[0].replace(/[^a-zA-Z0-9]/g, '').slice(0, 8).toLowerCase();
  const randomHex = Math.random().toString(16).substring(2, 8);
  const waitlistId = `yc_${randomHex}`;
  const refCode = `yc_${emailPrefix ? emailPrefix + '_' : ''}${randomHex}`;
...
function YieldCardWidget({
  ...
  const [showLasoTerminal, setShowLasoTerminal] = useState(false);
  const [lasoIssuingState, setLasoIssuingState] = useState('idle'); // 'idle' | 'issuing' | 'issued' | 'error'
  const [lasoProgressStep, setLasoProgressStep] = useState(0);
  const [lasoProgressMessage, setLasoProgressMessage] = useState('');
  ...
  const handleSearchLasoMerchant = (e) => {
    if (e && e.preventDefault) e.preventDefault();
    if (!lasoMerchantQuery || !lasoMerchantQuery.trim()) return;
    setLasoMerchantSearching(true);
    try {
      const q = lasoMerchantQuery.toLowerCase().trim();
      const known = ['amazon', 'claude', 'anthropic', 'openai', 'chatgpt', 'cursor', 'spotify', 'netflix', 'aws', 'github', 'youtube', 'google', 'apple', 'hulu', 'disney', 'max', 'uber', 'doordash', 'walmart', 'audible'];
      const isAccepted = known.some(k => q.includes(k) || k.includes(q));
      setLasoMerchantResult({ query: lasoMerchantQuery, status: isAccepted ? 'accepted' : 'unknown' });
    } catch (_) {
      setLasoMerchantResult({ query: lasoMerchantQuery, status: 'unknown' });
    } finally {
  ...
  const renderLasoTerminal = () => {
    return React.createElement('div', { className: 'laso-terminal-container animate-on-mount' },
      // Header
      React.createElement('div', { className: 'laso-terminal-header' },
        React.createElement('div', { className: 'laso-brand-title' },
      ...
      lasoIssuingState === 'issuing' && React.createElement('div', { className: 'laso-issuing-progress-box' },
        React.createElement('div', { className: 'laso-steps-track' },
          React.createElement('div', { className: `laso-step-dot ${lasoProgressStep >= 1 ? 'is-active' : ''}` }, '1'),
          React.createElement('div', { className: `laso-step-line ${lasoProgressStep >= 2 ? 'is-active' : ''}` }),
          React.createElement('div', { className: `laso-step-dot ${lasoProgressStep >= 2 ? 'is-active' : ''}` }, '2'),
        ...
        React.createElement('div', { className: 'laso-spinner-msg-row' },
          React.createElement('span', { className: 'laso-pulse-spinner' }),
          React.createElement('span', { className: 'laso-progress-text' }, lasoProgressMessage)
        )
      ),

      lasoIssuingState === 'issued' && lasoCardData && React.createElement('div', { className: 'laso-active-card-surface' },
        ...
        React.createElement('div', { className: 'laso-issued-card' },
          ...
          React.createElement('div', { className: 'laso-card-pan-row' },
            ...
            React.createElement('div', { className: 'laso-pan-controls' },
              ...
              }, lasoPanRevealed ? 'Hide' : 'Show'),
              React.createElement('button', {
                type: 'button',
                className: 'laso-mini-btn highlight',
                onClick: () => handleCopyLasoField('pan', lasoCardData.card_number || '4242884919208842')
              }, lasoCopiedField === 'pan' ? 'Copied!' : 'Copy PAN')
            )
          ),
          React.createElement('div', { className: 'laso-card-meta-row' },
            React.createElement('div', null,
              React.createElement('span', { className: 'laso-meta-label' }, 'EXP: '),
              React.createElement('span', { className: 'laso-meta-val' }, `${lasoCardData.exp_month || '02'}/${lasoCardData.exp_year || '32'}`)
            ),
            React.createElement('div', null,
              React.createElement('span', { className: 'laso-meta-label' }, 'CVV: '),
              React.createElement('span', { className: 'laso-meta-val' }, lasoCvvRevealed ? (lasoCardData.cvv || '942') : '•••'),
              React.createElement('button', {
                type: 'button',
                className: 'laso-mini-btn text-only',
                onClick: () => setLasoCvvRevealed(!lasoCvvRevealed)
              }, lasoCvvRevealed ? 'Hide' : 'Show'),
              React.createElement('button', {
                type: 'button',
                className: 'laso-mini-btn',
                onClick: () => handleCopyLasoField('cvv', lasoCardData.cvv || '942')
              }, lasoCopiedField === 'cvv' ? 'Copied!' : 'Copy')
            ),
            React.createElement('div', null,
              React.createElement('span', { className: 'laso-meta-label' }, 'BAL: '),
              React.createElement('span', { className: 'laso-meta-val balance' }, `$${Number(lasoCardData.available_balance || totalMonthlyWithBuffer).toFixed(2)}`)
            )
          )
        ),
        ...
        React.createElement('form', { className: 'laso-merchant-search-box', onSubmit: handleSearchLasoMerchant },
          ...
          }, lasoMerchantSearching ? '…' : 'Check'),
          lasoMerchantResult && React.createElement('div', { className: `laso-merchant-badge ${lasoMerchantResult.status}` },
            lasoMerchantResult.status === 'accepted' ? '✅ Accepted for US Checkout' : '⚠️ Unknown / Test Required'
          )
        ),

        // Action Buttons
        React.createElement('div', { className: 'laso-issued-footer-actions' },
          React.createElement('button', {
            type: 'button',
            className: 'laso-refresh-btn',
            onClick: handleRefreshLasoBalance,
            disabled: lasoBalanceRefreshing
          }, lasoBalanceRefreshing ? 'Refreshing…' : '🔄 Refresh Live Balance'),
          React.createElement('button', {
            type: 'button',
  ...
  const formatReqCap = (costUsd, costKrw) => {
    ...
    const req = calculateRequiredCapital(cost * 1.2, totalApy);
  ...
  const handleSubmit = (e) => {
    ...
    const ref = payload.referral_code || `yc_${Math.random().toString(16).substring(2, 8)}`;
    setMyRefCode(ref);
      ...
      if (typeof fetch !== 'undefined') {
        ...
        if (payload.referred_by && payload.referred_by !== 'none' && payload.referred_by !== 'direct') {
          fetch(`/api/referral?ref=${encodeURIComponent(payload.referred_by)}&action=track`, {
            ...
            body: JSON.stringify({ ref: payload.referred_by, action: 'track', email: trimmedEmail })
          }).catch(() => {});
        }
      }
    } catch (_) {}
  ...
  useEffect(() => {
    ...
    const checkEdgeStatus = () => {
      ...
      fetch(`/api/referral?code=${encodeURIComponent(myRefCode)}`)
        .then((res) => res.json())
        .then((data) => {
    ...
    checkEdgeStatus();
    const interval = setInterval(checkEdgeStatus, 4000);
    const onFocus = () => checkEdgeStatus();
  ...
  const handleCheckInviteStatus = () => {
    ...
    React.createElement('div', { className: 'yield-card-bottom-row yield-card-showcase-single' },
      ...
      React.createElement('div', { className: 'yield-card-reservation-wrapper' },
        React.createElement('div', { className: 'yield-card-reservation' },
          React.createElement('h3', { className: 'reservation-title' },
            isKorean ? `${pool.symbol || 'USDC'} 이자 직결 가상 Visa 카드` : `Get ${pool.symbol || 'USDC'} Yield Card`
          ),
          React.createElement('p', { className: 'reservation-subtitle' },
            isKorean ? '원금 100% 보존 • 전 세계 Visa 결제 • Laso 공식 파트너 제휴' : 'Spend your idle yield anywhere Visa is accepted worldwide • 100% principal protected'
          ),
          ...
          }, isKorean ? '⚡ Laso에서 Visa 카드 발급받기 →' : 'Get Visa Card on Laso →'),
          React.createElement('p', { className: 'reservation-micro-hint' },
            isKorean
              ? '파트너 제휴 링크 적용 • 발급 수수료 면제 • 전 세계 Visa Debit'
              : 'Sponsored partner referral • Zero issuance fee • Worldwide Visa Debit'
          )
        )
      )
    ),
...
function PoolDetail({
  ...
  const [simTicketSize, setSimTicketSize] = useState(100000);
  ...
  const poolTvl = Number(pool.tvlUsd) || 100000;
  const projectLower = (pool.project || '').toLowerCase();
  const poolTypeLower = (poolType || '').toLowerCase();

  const isPendle = projectLower.includes('pendle') || poolTypeLower.includes('derivative');
  const isLending = !isPendle && (poolTypeLower.includes('lending') || ['aave', 'compound', 'morpho', 'spark', 'fluid', 'sky-lending', 'maker', 'euler'].some(p => projectLower.includes(p)));
  const isClmm = !isPendle && !isLending && (poolTypeLower.includes('lp') || poolTypeLower.includes('dex') || ['uniswap', 'aerodrome', 'curve', 'balancer', 'pancakeswap', 'sushiswap', 'camelot', 'trader-joe'].some(p => projectLower.includes(p)));
  ...
  let heroMetric1Value = formatCurrency(poolTvl * (1 - 0.78));
  let heroMetric2Label = 'Kink Buffer';
  let heroMetric2Value = formatCurrency(Math.max(0, poolTvl * (1 - (0.78 / 0.90))));
  let heroStatusLabel = '✓ Safe Headroom';
  let heroStatusColor = 'var(--cert-green, #7CC9A0)';

  // Terminal Card 1: Yield Decomposition
  let yieldOrganicLabel = 'Organic Base Yield';
  let yieldOrganicVal = _formatApy(pool.apyBase || 0);
  let yieldOrganicHint = 'Realized borrower interest cash flows';

  let yieldRewardLabel = 'Perishable Rewards';
  let yieldRewardVal = (pool.apyReward > 0) ? ('+' + _formatApy(pool.apyReward)) : '0.00%';
  let yieldRewardHint = (pool.apyReward > 0) ? 'Subject to emissions decay & cliff risk' : 'Zero token emission dependency';

  // Terminal Card 2: Exit Liquidity
  let exitMetric1Label = 'Atomic Cash Headroom';
  let exitMetric1Val = formatCurrency(poolTvl * (1 - 0.78));
  let exitMetric1Hint = 'Unborrowed cash available for immediate withdrawal';

  let exitMetric2Label = 'Kink Distance Headroom';
  let exitMetric2Val = formatCurrency(Math.max(0, poolTvl * (1 - (0.78 / 0.90))));
  let exitMetric2Hint = 'Buffer before borrowing interest rate jumps';

  let trafficLight = 'GREEN';
  let trafficLightText = '✓ Safe Headroom';
  let trafficLightColor = 'var(--cert-green, #7CC9A0)';

  let postDepositApy = totalApy;
  let dilutionBps = 0;
  ...
  if (isPendle) {
    ...
    const spreadBps = Math.round((forwardApy - impliedApy) * 100);
    const ptDepth = poolTvl * 0.45;

    heroMetric1Label = 'Pool Depth';
    heroMetric1Value = formatCurrency(ptDepth);
    heroMetric2Label = 'Forward Spread';
    ...
    const kinkUtil = 0.90;
    const wMaxAtomic = poolTvl * (1 - currentUtil);
    const wKinkFrozen = Math.max(0, poolTvl * (1 - (currentUtil / kinkUtil)));

    heroMetric1Label = 'Cash Headroom';
    heroMetric1Value = formatCurrency(wMaxAtomic);
    heroMetric2Label = 'Kink Buffer';
    ...
    const postTvl = poolTvl + simTicketSize;
    const postUtil = (poolTvl * currentUtil) / postTvl;
    ...
    heroMetric2Label = '30d In-Range';
    heroMetric2Value = pIn + '%';
    ...
    heroMetric2Label = 'Redemption Time';
  ...
  return React.createElement('div', {
    ...
    React.createElement('div', {
      ...
      React.createElement('div', { className: 'pool-hero-content' },
        ...
        React.createElement('div', { className: 'pool-hero-identity' },
          ...
          React.createElement('div', { className: 'trust-indicators' },
            ...
            // Risk Assessment badge (fallback when no institutional DeFi Score)
            ...
            }, `${t ? t('riskAssessment') : 'Risk'}: ${riskAssessment.level}`),

            // DeFi Score Hero Chip
            (pool.defiScore && typeof pool.defiScore.score === 'number') && React.createElement('div', {
            ...
            }, `Score: ${Math.round(pool.defiScore.score)} (${pool.defiScore.rating})`)
          )
        ),
        ...
        React.createElement('div', { className: 'pool-hero-metric' },
          React.createElement('div', {
            ...
            (pool.forecast && typeof pool.forecast.p50 === 'number') && React.createElement('div', {
              ...
              React.createElement('span', { className: 'forecast-lead' },
                `${t ? t('forecast14d') : '14d Forecast'}: ${_formatApy(pool.forecast.p50)}`
              ),
              (typeof pool.forecast.p10 === 'number' && Math.abs(pool.forecast.p50 - pool.forecast.p10) >= 0.05) &&
              React.createElement('span', { className: 'forecast-floor', style: { opacity: 0.7, marginLeft: '4px' } },
                `(${t ? t('forecastFloor', _formatApy(pool.forecast.p10)) : 'Floor: ' + _formatApy(pool.forecast.p10)})`
              ),
              pool.forecast.crashRisk === 'HIGH' && React.createElement('span', {
                className: 'forecast-risk-pill risk-high',
                style: { marginLeft: '6px', color: 'var(--color-error, #ef4444)', fontWeight: 600, fontSize: '11px' }
              }, ' ⚠ ' + (t ? t('crashRiskHigh') : 'High Crash Risk')),
              pool.forecast.crashRisk === 'LOW' && React.createElement('span', {
                className: 'forecast-risk-pill risk-low',
                style: { marginLeft: '6px', color: 'var(--color-success, #10b981)', fontWeight: 600, fontSize: '11px' }
        ...
        React.createElement('div', {
          ...
          React.createElement('div', { className: 'hero-uw-header' },
            React.createElement('span', { className: 'hero-uw-tag' }, 'Underwriting · ' + archetypeTag),
            React.createElement('a', {
              className: 'hero-uw-jump',
              href: '#decision-terminal',
              onClick: (e) => {
                e.preventDefault();
                document.getElementById('decision-terminal')?.scrollIntoView({ behavior: 'smooth' });
              }
            }, 'Decision Terminal ↓')
          ),
          React.createElement('div', { className: 'hero-uw-grid' },
            React.createElement('div', { className: 'hero-uw-cell' },
              React.createElement('div', { className: 'hero-uw-cell-label' }, heroMetric1Label),
              React.createElement('div', { className: 'hero-uw-cell-val' }, heroMetric1Value)
            ),
            React.createElement('div', { className: 'hero-uw-cell' },
              React.createElement('div', { className: 'hero-uw-cell-label' }, heroMetric2Label),
              React.createElement('div', { className: 'hero-uw-cell-val' }, heroMetric2Value)
            ),
            React.createElement('div', { className: 'hero-uw-cell' },
              React.createElement('div', { className: 'hero-uw-cell-label' }, 'Capacity Status'),
              React.createElement('div', {
                className: 'hero-uw-cell-status',
                style: { color: heroStatusColor }
              }, heroStatusLabel)
            )
          )
        )
      ...
      React.createElement('div', { className: 'pool-hero-actions' },
        ...
        // ═══ DECISION TERMINAL (Institutional Forward Underwriting) ══════════════
        React.createElement('div', {
          className: 'decision-terminal-card animate-on-mount',
          id: 'decision-terminal'
        },
          React.createElement('div', { className: 'dt-header' },
            React.createElement('div', { className: 'dt-header-left' },
              React.createElement('span', { className: 'dt-badge-tag' }, 'INSTITUTIONAL UNDERWRITING · ' + archetypeTag),
              React.createElement('h2', { className: 'dt-title' }, t ? t('decisionTerminalTitle') : 'Liquidity & Forward Dilution Terminal'),
              React.createElement('p', { className: 'dt-subtitle' }, engineSubtitle)
            ),
            React.createElement('div', { className: 'dt-header-right' },
              React.createElement('span', { className: 'dt-engine-pill' }, enginePill)
            )
          ),
          ...
          React.createElement('div', { className: 'dt-grid' },
            ...
            React.createElement('div', { className: 'dt-panel' },
              React.createElement('div', { className: 'dt-panel-label' }, '1. Yield Cash Flow Attribution'),
              React.createElement('div', { className: 'dt-yield-pair' },
                React.createElement('div', { className: 'dt-yield-box dt-yield-organic' },
                  React.createElement('div', { className: 'dt-yield-type' }, yieldOrganicLabel),
                  React.createElement('div', { className: 'dt-yield-num' }, yieldOrganicVal),
                  React.createElement('div', { className: 'dt-yield-hint' }, yieldOrganicHint)
                ),
                React.createElement('div', { className: 'dt-yield-box dt-yield-reward' },
                  React.createElement('div', { className: 'dt-yield-type' }, yieldRewardLabel),
                  React.createElement('div', { className: 'dt-yield-num' }, yieldRewardVal),
                  React.createElement('div', { className: 'dt-yield-hint' }, yieldRewardHint)
                )
              )
            ),
            ...
            React.createElement('div', { className: 'dt-panel' },
              React.createElement('div', { className: 'dt-panel-label' }, '2. Protocol Capacity & Exit Gauge'),
              React.createElement('div', { className: 'dt-metric-row' },
                React.createElement('div', { className: 'dt-metric' },
                  React.createElement('div', { className: 'dt-metric-name' }, exitMetric1Label),
                  React.createElement('div', { className: 'dt-metric-val' }, exitMetric1Val),
                  React.createElement('div', { className: 'dt-yield-hint', style: { fontSize: '10px' } }, exitMetric1Hint)
                ),
                React.createElement('div', { className: 'dt-metric' },
                  React.createElement('div', { className: 'dt-metric-name' }, exitMetric2Label),
                  React.createElement('div', { className: 'dt-metric-val' }, exitMetric2Val),
                  React.createElement('div', { className: 'dt-yield-hint', style: { fontSize: '10px' } }, exitMetric2Hint)
                )
              ),
              React.createElement('div', {
                className: 'dt-traffic-light dt-tl-' + trafficLight.toLowerCase(),
                style: { borderLeftColor: trafficLightColor }
              },
                React.createElement('span', { className: 'dt-tl-dot', style: { backgroundColor: trafficLightColor } }),
                React.createElement('span', { className: 'dt-tl-text', style: { color: trafficLightColor } }, trafficLightText)
              )
            ),

            // Card 3: Interactive Ticket Dilution Simulator
            React.createElement('div', { className: 'dt-panel dt-panel-full' },
              React.createElement('div', { className: 'dt-panel-label' }, '3. Interactive Ticket Impact Simulator'),
              React.createElement('div', { className: 'dt-ticket-presets' },
                [100000, 500000, 1000000, 5000000, 10000000].map(function (amt) {
                  return React.createElement('button', {
                    key: amt,
                    type: 'button',
                    className: 'dt-preset-btn ' + (simTicketSize === amt ? 'is-active' : ''),
                    onClick: function () { setSimTicketSize(amt); }
                  }, formatCurrency(amt));
                })
              ),
              React.createElement('div', { className: 'dt-sim-result-row' },
                React.createElement('div', { className: 'dt-sim-item' },
                  React.createElement('span', { className: 'dt-sim-lbl' }, t ? t('simulatedTicket') : 'Simulated Ticket'),
                  React.createElement('span', { className: 'dt-sim-val' }, formatCurrency(simTicketSize))
                ),
                React.createElement('div', { className: 'dt-sim-item' },
                  React.createElement('span', { className: 'dt-sim-lbl' }, t ? t('postDepositApy') : 'Post-Deposit APY'),
                  React.createElement('span', { className: 'dt-sim-val', style: { color: 'var(--cert-green)' } }, _formatApy(postDepositApy))
                ),
                React.createElement('div', { className: 'dt-sim-item' },
                  React.createElement('span', { className: 'dt-sim-lbl' }, isPendle ? 'AMM Slippage Drag' : (t ? t('dilutionBps') : 'Dilution Impact')),
                  React.createElement('span', { className: 'dt-sim-val', style: { color: dilutionBps > 50 ? 'var(--cert-red)' : 'var(--cert-amber)' } }, '-' + dilutionBps + ' bps')
                )
              )
            )
          )
    ...
    React.createElement('div', {
      ...
      poolInfoExpanded && React.createElement('div', {
        ...
        React.createElement('div', { className: 'pool-facts' },
          ...
          (pool.forecast && typeof pool.forecast.p50 === 'number') && React.createElement('div', { className: 'pool-fact-row' },
            React.createElement('div', { className: 'pool-fact-label' }, t ? t('forecast14d') : '14d AI Forecast'),
            React.createElement('div', { className: 'pool-fact-value' },
              ...
              pool.forecast.crashRisk === 'HIGH' && React.createElement('span', {
                ...
                style: { marginLeft: '6px', fontSize: '11px', color: 'var(--color-error, #ef4444)', fontWeight: 600 }
              }, ' ⚠ ' + (t ? t('crashRiskHigh') : 'High Crash Risk')),
              pool.forecast.crashRisk === 'LOW' && React.createElement('span', {
                className: 'pool-risk-pill-safe',
                style: { marginLeft: '6px', fontSize: '11px', color: 'var(--color-success, #10b981)', fontWeight: 600 }
              }, ' ✓ ' + (t ? t('crashRiskLow') : 'Stable Downside'))
            )
          ),

          // Yield Decomposition (if reward yield is present)
          (pool.forecast && typeof pool.forecast.rewardApy === 'number' && pool.forecast.rewardApy > 0) && React.createElement('div', { className: 'pool-fact-row' },
            React.createElement('div', { className: 'pool-fact-label' }, t ? t('yieldDecomp') : 'Yield Mix'),
            React.createElement('div', { className: 'pool-fact-value' },
          ...
          (pool.defiScore && typeof pool.defiScore.score === 'number') && React.createElement('div', { className: 'pool-fact-row' },
            ...
            React.createElement('div', {
              ...
              style: {
                ...
                color: pool.defiScore.score >= 75 ? 'var(--color-success, #10b981)' :
                       pool.defiScore.score >= 50 ? 'var(--color-primary, #3b82f6)' : 'var(--color-warning, #f59e0b)'
              }
