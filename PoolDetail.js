        ...
        !isSubmitted ? React.createElement('div', { className: 'yield-card-reservation' },
          ...
          React.createElement('div', { className: 'receipt-badge-row' },
            React.createElement('div', { className: 'receipt-spot-badge' },
              _t('yieldCard.spotReserved') || 'Early Access Reserved'
            ),
          ...
          React.createElement('div', { className: `receipt-gamification-box${invitedCount >= 1 ? ' is-unlocked' : ''}` },
            ...
            React.createElement('div', { className: 'gamification-progress-bar' },
              React.createElement('div', {
                ...
                style: { width: invitedCount >= 1 ? '100%' : '25%' }
              })
            ),
            ...
            invitedCount < 1 && React.createElement('button', {
              type: 'button',
              className: 'laso-instant-launch-toggle-btn',
              onClick: () => setShowLasoTerminal(!showLasoTerminal)
          ...
          invitedCount === 0 && React.createElement('button', {
            type: 'button',
